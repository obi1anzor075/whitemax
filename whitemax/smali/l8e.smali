...
.method static constructor <clinit>()V
    ...
    sput-object v0, Ll8e;->X:Ljava/lang/String;
...
.method public constructor <init>(Landroid/content/Context;Litf;)V
    ...
    invoke-direct {v1, p1}, Lk8e;-><init>(Landroid/content/Context;)V

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Ll8e;->a:Landroid/content/Context;

    iput-object p2, p0, Ll8e;->c:Litf;

    iput-object v0, p0, Ll8e;->b:Landroid/app/job/JobScheduler;

    iput-object v1, p0, Ll8e;->o:Lk8e;
...
.method public static a(Landroid/app/job/JobScheduler;I)V
    ...
    sget-object v1, Ll8e;->X:Ljava/lang/String;

    invoke-virtual {v0, v1, p1, p0}, La24;->y(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public static b(Landroid/content/Context;Landroid/app/job/JobScheduler;)Ljava/util/ArrayList;
    ...
    invoke-virtual {v1, v2, v3, p1}, La24;->y(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public static f(Landroid/app/job/JobInfo;)Lbtf;
    .locals 3
    ...
    invoke-direct {v2, p0, v1}, Lbtf;-><init>(Ljava/lang/String;I)V
    :try_end_0
...
.method public final d(Ljava/lang/String;)V
    ...
    iget-object v0, p0, Ll8e;->a:Landroid/content/Context;

    iget-object v1, p0, Ll8e;->b:Landroid/app/job/JobScheduler;

    invoke-static {v0, v1}, Ll8e;->b(Landroid/content/Context;Landroid/app/job/JobScheduler;)Ljava/util/ArrayList;
    ...
    invoke-static {v3}, Ll8e;->f(Landroid/app/job/JobInfo;)Lbtf;
    ...
    invoke-static {v1, v2}, Ll8e;->a(Landroid/app/job/JobScheduler;I)V

    goto :goto_2

    :cond_3
    iget-object p0, p0, Ll8e;->c:Litf;

    iget-object p0, p0, Litf;->c:Landroidx/work/impl/WorkDatabase;

    invoke-virtual {p0}, Landroidx/work/impl/WorkDatabase;->v()Lj8e;
...
.method public final varargs e([Lztf;)V
    ...
    iget-object v7, v5, Lztf;->a:Ljava/lang/String;

    invoke-virtual {v6, v7}, Lbuf;->l(Ljava/lang/String;)Lztf;
    ...
    sget-object v8, Ll8e;->X:Ljava/lang/String;

    iget-object v9, v5, Lztf;->a:Ljava/lang/String;
    ...
    invoke-virtual {v5, v8, v6}, La24;->k0(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :cond_0
    :try_start_2
    iget-object v6, v6, Lztf;->b:Lctf;

    sget-object v10, Lctf;->a:Lctf;
    ...
    :cond_1
    invoke-static {v5}, Lvx3;->o(Lztf;)Lbtf;
    ...
    invoke-virtual {v7, v6}, Lj8e;->r(Lbtf;)Li8e;
    ...
    invoke-direct {v9, v2, v8}, Lap6;-><init>(Le3;I)V

    iget-object v8, v2, Le3;->a:Ljava/lang/Object;

    check-cast v8, Landroidx/work/impl/WorkDatabase;

    invoke-virtual {v8, v9}, Laec;->p(Ljava/util/concurrent/Callable;)Ljava/lang/Object;
    ...
    iget-object v9, v6, Lbtf;->a:Ljava/lang/String;

    iget v6, v6, Lbtf;->b:I

    invoke-direct {v7, v9, v6, v8}, Li8e;-><init>(Ljava/lang/String;II)V

    iget-object v6, v0, Litf;->c:Landroidx/work/impl/WorkDatabase;

    invoke-virtual {v6}, Landroidx/work/impl/WorkDatabase;->v()Lj8e;

    move-result-object v6

    invoke-virtual {v6, v7}, Lj8e;->s(Li8e;)V

    :cond_3
    invoke-virtual {p0, v5, v8}, Ll8e;->g(Lztf;I)V
...
.method public final g(Lztf;I)V
    .locals 11

    iget-object v0, p0, Ll8e;->b:Landroid/app/job/JobScheduler;

    iget-object v1, p0, Ll8e;->o:Lk8e;

    invoke-virtual {v1}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iget-object v2, p1, Lztf;->j:Lif3;
    ...
    iget-object v5, p1, Lztf;->a:Ljava/lang/String;
    ...
    invoke-static {v9}, Lus8;->u(I)Ljava/lang/String;
    ...
    sget-object v9, Lk8e;->b:Ljava/lang/String;

    invoke-virtual {v3, v9, v8}, La24;->t(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :cond_7
    :goto_3
    iget-object v3, v2, Lif3;->h:Ljava/util/Set;
    ...
    iget-boolean v9, v4, Lhf3;->b:Z

    new-instance v10, Landroid/app/job/JobInfo$TriggerContentUri;

    iget-object v4, v4, Lhf3;->a:Landroid/net/Uri;
    ...
    invoke-static {v1}, Lc88;->n(Landroid/app/job/JobInfo$Builder;)V
    ...
    invoke-virtual {v1, v4, v2}, La24;->k0(Ljava/lang/String;Ljava/lang/String;)V

    iget-boolean v1, p1, Lztf;->q:Z

    if-eqz v1, :cond_d

    iget-object v1, p1, Lztf;->r:Lvga;

    sget-object v2, Lvga;->a:Lvga;

    if-ne v1, v2, :cond_d

    iput-boolean v7, p1, Lztf;->q:Z
    ...
    invoke-virtual {p0, p1, p2}, Ll8e;->g(Lztf;I)V
    :try_end_0
    ...
    invoke-virtual {p2, v4, p1, p0}, La24;->y(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    :goto_9
    iget-object p2, p0, Ll8e;->a:Landroid/content/Context;

    invoke-static {p2, v0}, Ll8e;->b(Landroid/content/Context;Landroid/app/job/JobScheduler;)Ljava/util/ArrayList;
    ...
    invoke-virtual {v1}, Lbuf;->i()Ljava/util/ArrayList;
    ...
    invoke-virtual {v0, v4, p2}, La24;->x(Ljava/lang/String;Ljava/lang/String;)V

    new-instance v0, Ljava/lang/IllegalStateException;

    invoke-direct {v0, p2, p1}, Ljava/lang/IllegalStateException;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V

    iget-object p0, p0, Litf;->b:Lsa3;
