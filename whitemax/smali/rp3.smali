...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Lrp3;->X:Landroid/content/ContentResolver;
...
.method public final G(Lyz3;)J
    ...
    :try_start_0
    iget-object v4, v1, Lyz3;->a:Landroid/net/Uri;

    invoke-virtual {v4}, Landroid/net/Uri;->normalizeScheme()Landroid/net/Uri;

    move-result-object v4

    iput-object v4, v0, Lrp3;->Y:Landroid/net/Uri;
    ...
    iget-object v6, v0, Lrp3;->X:Landroid/content/ContentResolver;
    ...
    :goto_0
    iput-object v5, v0, Lrp3;->Z:Landroid/content/res/AssetFileDescriptor;
    ...
    iput-object v2, v0, Lrp3;->w0:Ljava/io/FileInputStream;
    :try_end_1
    ...
    :goto_3
    iput-wide v6, v0, Lrp3;->x0:J

    :cond_7
    const/4 v5, 0x1

    iput-boolean v5, v0, Lrp3;->y0:Z
...
.method public final close()V
    ...
    iput-object v0, p0, Lrp3;->Y:Landroid/net/Uri;
    ...
    :try_start_0
    iget-object v3, p0, Lrp3;->w0:Ljava/io/FileInputStream;
    ...
    :cond_0
    :goto_0
    iput-object v0, p0, Lrp3;->w0:Ljava/io/FileInputStream;

    :try_start_1
    iget-object v3, p0, Lrp3;->Z:Landroid/content/res/AssetFileDescriptor;
    ...
    :cond_1
    :goto_1
    iput-object v0, p0, Lrp3;->Z:Landroid/content/res/AssetFileDescriptor;

    iget-boolean v0, p0, Lrp3;->y0:Z

    if-eqz v0, :cond_2

    iput-boolean v2, p0, Lrp3;->y0:Z
    ...
    :try_start_4
    iget-object v4, p0, Lrp3;->Z:Landroid/content/res/AssetFileDescriptor;
...
.method public final getUri()Landroid/net/Uri;
    ...
    iget-object p0, p0, Lrp3;->Y:Landroid/net/Uri;
...
.method public final read([BII)I
    ...
    :goto_0
    iget-object v0, p0, Lrp3;->w0:Ljava/io/FileInputStream;
