...
# static fields
.field public static final d:Lp93;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v1, v3}, Lqic;-><init>(Ljava/lang/String;)V

    invoke-direct {v0, v1}, Luj9;-><init>(Ljava/util/concurrent/ThreadFactory;)V

    sput-object v0, Lr93;->g:Lq93;
    ...
    invoke-direct {v3, v4, v0, v1}, Lqic;-><init>(Ljava/lang/String;IZ)V

    sput-object v3, Lr93;->e:Lqic;

    new-instance v0, Lp93;

    invoke-direct {v0, v2, v3}, Lp93;-><init>(ILjava/util/concurrent/ThreadFactory;)V

    sput-object v0, Lr93;->d:Lp93;

    iget-object v0, v0, Lp93;->b:[Lq93;
...
.method public constructor <init>()V
    ...
    sget-object v1, Lr93;->d:Lp93;

    invoke-direct {v0, v1}, Ljava/util/concurrent/atomic/AtomicReference;-><init>(Ljava/lang/Object;)V

    iput-object v0, p0, Lr93;->c:Ljava/util/concurrent/atomic/AtomicReference;

    new-instance v0, Lp93;

    sget v2, Lr93;->f:I

    sget-object v3, Lr93;->e:Lqic;

    invoke-direct {v0, v2, v3}, Lp93;-><init>(ILjava/util/concurrent/ThreadFactory;)V

    :cond_0
    iget-object v2, p0, Lr93;->c:Ljava/util/concurrent/atomic/AtomicReference;
...
.method public final a()Lomc;
    ...
    iget-object p0, p0, Lr93;->c:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    invoke-virtual {p0}, Lp93;->a()Lq93;

    move-result-object p0

    invoke-direct {v0, p0}, Lo93;-><init>(Lq93;)V
...
.method public final c(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;)Lxi4;
    ...
    iget-object p0, p0, Luj9;->a:Ljava/util/concurrent/ScheduledThreadPoolExecutor;
...
.method public final d(Ljava/lang/Runnable;JJLjava/util/concurrent/TimeUnit;)Lxi4;
    .locals 10
    ...
    iget-object v1, v1, Lr93;->c:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    sget-object v7, Lcw4;->a:Lcw4;

    iget-object v1, v1, Luj9;->a:Ljava/util/concurrent/ScheduledThreadPoolExecutor;

    if-gtz v6, :cond_1

    new-instance v6, Lyy6;

    invoke-direct {v6, p1, v1}, Lyy6;-><init>(Ljava/lang/Runnable;Ljava/util/concurrent/ScheduledExecutorService;)V
    ...
    :goto_0
    invoke-virtual {v6, v0}, Lyy6;->a(Ljava/util/concurrent/Future;)V
    :try_end_0
    .catch Ljava/util/concurrent/RejectedExecutionException; {:try_start_0 .. :try_end_0} :catch_0
