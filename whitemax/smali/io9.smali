...
.method public constructor <init>(Landroid/widget/FrameLayout;Lf3b;)V
    .locals 1
    ...
    .line 3
    iput-object p1, p0, Lio9;->c:Ljava/lang/Object;

    .line 4
    iput-object p2, p0, Lio9;->d:Ljava/lang/Object;
...
.method public a(Landroid/os/Bundle;)V
    ...
    iget-boolean v0, p0, Lio9;->a:Z

    if-eqz v0, :cond_0

    const-string v0, "android.summaryText"

    iget-object v1, p0, Lio9;->d:Ljava/lang/Object;
    ...
    :cond_0
    iget-object v0, p0, Lio9;->c:Ljava/lang/Object;
    ...
    :cond_1
    invoke-virtual {p0}, Lio9;->e()Ljava/lang/String;
...
.method public abstract b(Lb0d;)V
.end method
...
.method public c(I)Landroid/widget/RemoteViews;
    ...
    iget-object v2, v2, Lun9;->a:Landroid/content/Context;
    ...
    iget-object p1, p0, Lio9;->b:Ljava/lang/Object;

    check-cast p1, Lun9;

    iget v2, p1, Lun9;->k:I

    iget-object p1, p1, Lun9;->i:Landroidx/core/graphics/drawable/IconCompat;
    ...
    iget-object v3, v3, Lun9;->i:Landroidx/core/graphics/drawable/IconCompat;

    invoke-virtual {p0, v3, v2, v2}, Lio9;->d(Landroidx/core/graphics/drawable/IconCompat;II)Landroid/graphics/Bitmap;
    ...
    iget-object p1, p1, Lun9;->e:Ljava/lang/CharSequence;

    if-eqz p1, :cond_1

    sget v3, Lwpb;->title:I
    ...
    iget-object p1, p1, Lun9;->f:Ljava/lang/CharSequence;
    ...
    :goto_0
    iget-object v4, p0, Lio9;->b:Ljava/lang/Object;
    ...
    sget p1, Lirb;->status_bar_notification_info_maxnum:I
    ...
    sget v4, Lrtb;->status_bar_notification_info_overflow:I
    ...
    iget-boolean v6, v4, Lun9;->l:Z

    const-wide/16 v7, 0x0

    if-eqz v6, :cond_5

    iget-object v6, v4, Lun9;->F:Landroid/app/Notification;
    ...
    iget-boolean v0, v4, Lun9;->m:Z

    if-eqz v0, :cond_7

    sget v0, Lwpb;->chronometer:I
    ...
    iget-object v4, v4, Lun9;->F:Landroid/app/Notification;
    ...
    iget-boolean v4, p0, Lun9;->l:Z

    if-eqz v4, :cond_8

    iget-object p0, p0, Lun9;->F:Landroid/app/Notification;
...
.method public d(Landroidx/core/graphics/drawable/IconCompat;II)Landroid/graphics/Bitmap;
    ...
    :cond_4
    :goto_1
    invoke-static {p1, p0}, Lzn6;->d(Landroidx/core/graphics/drawable/IconCompat;Landroid/content/Context;)Landroid/graphics/drawable/Icon;

    move-result-object p1

    invoke-static {p1, p0}, Lzn6;->c(Landroid/graphics/drawable/Icon;Landroid/content/Context;)Landroid/graphics/drawable/Drawable;
...
.method public abstract l(Ly4e;Lxz;)V
.end method

.method public m()V
    .locals 7

    invoke-virtual {p0}, Lio9;->f()Landroid/view/View;

    move-result-object v0

    if-eqz v0, :cond_8

    iget-boolean v1, p0, Lio9;->a:Z
    ...
    :cond_6
    :goto_2
    invoke-virtual {p0, v1, v2}, Lf3b;->e(Landroid/util/Size;I)Landroid/graphics/RectF;
    ...
    iget-object v3, p0, Lf3b;->a:Landroid/util/Size;
...
.method public n(Lun9;)V
    ...
    iput-object p1, p0, Lio9;->b:Ljava/lang/Object;

    if-eqz p1, :cond_0

    invoke-virtual {p1, p0}, Lun9;->q(Lio9;)V

    :cond_0
    return-void
.end method

.method public abstract o()Lch7;
.end method
