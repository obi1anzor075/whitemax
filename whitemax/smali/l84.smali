...
.field public final y0:Lotf;

.field public final z0:Lotf;


# direct methods
.method public constructor <init>(Ljava/lang/String;IIZLotf;)V
    .locals 1

    const/4 v0, 0x1

    invoke-direct {p0, v0}, Lfh0;-><init>(Z)V

    iput-object p1, p0, Ll84;->x0:Ljava/lang/String;

    iput p2, p0, Ll84;->Z:I

    iput p3, p0, Ll84;->w0:I

    iput-boolean p4, p0, Ll84;->X:Z

    const/4 p1, 0x0

    iput-boolean p1, p0, Ll84;->Y:Z

    iput-object p5, p0, Ll84;->y0:Lotf;

    const/4 p2, 0x0

    iput-object p2, p0, Ll84;->A0:Lu1b;

    new-instance p2, Lotf;

    const/16 p3, 0x13

    invoke-direct {p2, p3}, Lotf;-><init>(I)V

    iput-object p2, p0, Ll84;->z0:Lotf;

    iput-boolean p1, p0, Ll84;->B0:Z
...
.method public final G(Lyz3;)J
    ...
    iput-wide v2, v1, Ll84;->H0:J

    iput-wide v2, v1, Ll84;->G0:J

    invoke-virtual/range {p0 .. p0}, Lfh0;->d()V

    const/4 v4, 0x1

    :try_start_0
    invoke-virtual/range {p0 .. p1}, Ll84;->j(Lyz3;)Ljava/net/HttpURLConnection;

    move-result-object v5

    iput-object v5, v1, Ll84;->C0:Ljava/net/HttpURLConnection;

    invoke-virtual {v5}, Ljava/net/HttpURLConnection;->getResponseCode()I

    move-result v6

    iput v6, v1, Ll84;->F0:I

    invoke-virtual {v5}, Ljava/net/HttpURLConnection;->getResponseMessage()Ljava/lang/String;
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_5

    iget v6, v1, Ll84;->F0:I
    ...
    iget-object v15, v1, Ll84;->A0:Lu1b;

    if-eqz v15, :cond_3

    invoke-interface {v15, v6}, Lu1b;->apply(Ljava/lang/Object;)Z
    ...
    :cond_2
    invoke-virtual/range {p0 .. p0}, Ll84;->f()V

    new-instance v0, Landroidx/media3/datasource/HttpDataSource$InvalidContentTypeException;

    const-string v1, "Invalid content type: "

    invoke-static {v1, v6}, Lrf0;->h(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    sget-object v13, Lym6;->a:Ljava/util/regex/Pattern;
    ...
    invoke-static {v9}, Lez3;->A(Ljava/lang/String;)V
    ...
    sget-object v14, Lym6;->a:Ljava/util/regex/Pattern;
    ...
    invoke-static {v2}, Lez3;->A(Ljava/lang/String;)V
    ...
    iput-object v3, v1, Ll84;->D0:Ljava/io/InputStream;

    if-eqz v6, :cond_b

    new-instance v3, Ljava/util/zip/GZIPInputStream;

    iget-object v5, v1, Ll84;->D0:Ljava/io/InputStream;
    ...
    :cond_b
    :goto_7
    iput-boolean v4, v1, Ll84;->E0:Z

    invoke-virtual/range {p0 .. p1}, Lfh0;->e(Lyz3;)V

    :try_start_4
    invoke-virtual {v1, v11, v12}, Ll84;->n(J)V
    :try_end_4
    .catch Ljava/io/IOException; {:try_start_4 .. :try_end_4} :catch_3

    iget-wide v0, v1, Ll84;->G0:J
    ...
    sget-object v7, Lym6;->a:Ljava/util/regex/Pattern;
    ...
    :cond_e
    sget-object v7, Lym6;->b:Ljava/util/regex/Pattern;
...
.method public final a()Ljava/util/Map;
    ...
    iget-object p0, p0, Ll84;->C0:Ljava/net/HttpURLConnection;
...
.method public final close()V
    ...
    :try_start_0
    iget-object v2, p0, Ll84;->D0:Ljava/io/InputStream;

    if-eqz v2, :cond_1

    iget-wide v3, p0, Ll84;->G0:J
    ...
    :cond_0
    iget-wide v5, p0, Ll84;->H0:J

    sub-long v5, v3, v5

    :goto_0
    iget-object v3, p0, Ll84;->C0:Ljava/net/HttpURLConnection;

    invoke-static {v3, v5, v6}, Ll84;->l(Ljava/net/HttpURLConnection;J)V
    :try_end_0
    ...
    :cond_1
    :goto_1
    iput-object v1, p0, Ll84;->D0:Ljava/io/InputStream;

    invoke-virtual {p0}, Ll84;->f()V

    iget-boolean v1, p0, Ll84;->E0:Z

    if-eqz v1, :cond_2

    iput-boolean v0, p0, Ll84;->E0:Z
...
.method public final f()V
    ...
    iget-object v0, p0, Ll84;->C0:Ljava/net/HttpURLConnection;
    ...
    iput-object v0, p0, Ll84;->C0:Ljava/net/HttpURLConnection;
...
.method public final h(Ljava/net/URL;Ljava/lang/String;)Ljava/net/URL;
    ...
    invoke-static {p1, p2}, Lrf0;->h(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public final j(Lyz3;)Ljava/net/HttpURLConnection;
    .locals 25
    ...
    iget-object v0, v12, Lyz3;->a:Landroid/net/Uri;
    ...
    :goto_0
    iget-boolean v0, v11, Ll84;->X:Z

    iget-boolean v15, v11, Ll84;->B0:Z

    iget v3, v12, Lyz3;->c:I

    iget-object v4, v12, Lyz3;->d:[B

    iget-wide v9, v12, Lyz3;->f:J

    iget-wide v6, v12, Lyz3;->g:J

    if-nez v0, :cond_1

    iget-boolean v0, v11, Ll84;->Y:Z
    ...
    iget-object v12, v12, Lyz3;->e:Ljava/util/Map;
    ...
    invoke-virtual/range {v0 .. v10}, Ll84;->k(Ljava/net/URL;I[BJJZZLjava/util/Map;)Ljava/net/HttpURLConnection;
    ...
    iget-object v3, v12, Lyz3;->e:Ljava/util/Map;
    ...
    :goto_3
    invoke-virtual {v11, v1, v2}, Ll84;->h(Ljava/net/URL;Ljava/lang/String;)Ljava/net/URL;
    ...
    invoke-static {v3, v2}, Lwn6;->h(ILjava/lang/String;)Ljava/lang/String;
...
.method public final k(Ljava/net/URL;I[BJJZZLjava/util/Map;)Ljava/net/HttpURLConnection;
    ...
    iget-object v1, p0, Ll84;->y0:Lotf;

    if-eqz v1, :cond_0

    invoke-virtual {v1}, Lotf;->I()Ljava/util/Map;
    ...
    :cond_0
    iget-object v1, p0, Ll84;->z0:Lotf;
    ...
    :cond_1
    sget-object p10, Lym6;->a:Ljava/util/regex/Pattern;
    ...
    :cond_4
    iget-object p0, p0, Ll84;->x0:Ljava/lang/String;
...
.method public final n(J)V
    ...
    iget-object v5, p0, Ll84;->D0:Ljava/io/InputStream;
    ...
    invoke-virtual {p0, v4}, Lfh0;->b(I)V
...
.method public final read([BII)I
    ...
    :cond_2
    iget-object v0, p0, Ll84;->D0:Ljava/io/InputStream;
    ...
    :cond_3
    iget-wide p2, p0, Ll84;->H0:J

    int-to-long v0, p1

    add-long/2addr p2, v0

    iput-wide p2, p0, Ll84;->H0:J
