...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lc2d;->j:Ljava/util/List;

    return-void
.end method

.method public constructor <init>(Ljava/util/ArrayList;Ljava/util/ArrayList;Ljava/util/ArrayList;Ljava/util/ArrayList;Lpw1;La2d;Landroid/hardware/camera2/params/InputConfiguration;ILra0;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lc2d;->a:Ljava/util/List;

    invoke-static {p2}, Ljava/util/Collections;->unmodifiableList(Ljava/util/List;)Ljava/util/List;

    move-result-object p1

    iput-object p1, p0, Lc2d;->c:Ljava/util/List;

    invoke-static {p3}, Ljava/util/Collections;->unmodifiableList(Ljava/util/List;)Ljava/util/List;

    move-result-object p1

    iput-object p1, p0, Lc2d;->d:Ljava/util/List;

    invoke-static {p4}, Ljava/util/Collections;->unmodifiableList(Ljava/util/List;)Ljava/util/List;

    move-result-object p1

    iput-object p1, p0, Lc2d;->e:Ljava/util/List;

    iput-object p6, p0, Lc2d;->f:La2d;

    iput-object p5, p0, Lc2d;->g:Lpw1;

    iput-object p7, p0, Lc2d;->i:Landroid/hardware/camera2/params/InputConfiguration;

    iput p8, p0, Lc2d;->h:I

    iput-object p9, p0, Lc2d;->b:Lra0;

    return-void
.end method

.method public static a()Lc2d;
    .locals 20
...
.method public final b()Ljava/util/List;
    ...
    iget-object p0, p0, Lc2d;->a:Ljava/util/List;
    ...
    iget-object v2, v1, Lra0;->a:Lxc4;

    invoke-virtual {v0, v2}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    iget-object v1, v1, Lra0;->b:Ljava/util/List;
