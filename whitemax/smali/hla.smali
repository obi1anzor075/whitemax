...
.method public final dispatch(Lhu3;Ljava/lang/Runnable;)V
    ...
    invoke-virtual {v0, p1}, Lju3;->isDispatchNeeded(Lhu3;)Z
    ...
    :cond_2
    iget-object p1, p0, Lhi4;->d:Ljava/util/ArrayDeque;
    ...
    invoke-direct {v1, p0, v2, p2}, Ldr1;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    invoke-virtual {v0, p1, v1}, Lju3;->dispatch(Lhu3;Ljava/lang/Runnable;)V
