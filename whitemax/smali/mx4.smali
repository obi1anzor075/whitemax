...
# direct methods
.method public synthetic constructor <init>(Lxx4;JI)V
    .locals 0

    iput p4, p0, Lmx4;->a:I

    iput-object p1, p0, Lmx4;->b:Lxx4;

    iput-wide p2, p0, Lmx4;->c:J
...
.method public final run()V
    ...
    iget-object v0, p0, Lmx4;->b:Lxx4;

    iget-wide v1, p0, Lmx4;->c:J
    ...
    invoke-virtual {v0, p0}, Lxx4;->i(I)V

    goto/16 :goto_4

    :pswitch_2
    iput-object v6, v0, Lxx4;->w:Ljava/lang/Long;

    iget-object p0, v0, Lxx4;->o:Ljava/util/ArrayDeque;
    ...
    iget-object v8, v0, Lxx4;->o:Ljava/util/ArrayDeque;
    ...
    iget-boolean p0, v0, Lxx4;->c:Z

    if-nez p0, :cond_1

    sget-object p0, Lxf4;->a:Lxe6;
    ...
    invoke-static {v6, p0}, Lwn6;->g(ILjava/lang/String;)Landroid/os/Bundle;

    move-result-object p0

    iget-object v1, v0, Lxx4;->e:Landroid/media/MediaCodec;

    invoke-virtual {v1, p0}, Landroid/media/MediaCodec;->setParameters(Landroid/os/Bundle;)V

    iget-object p0, v0, Lxx4;->f:Lex4;

    instance-of v1, p0, Ltx4;

    if-eqz v1, :cond_3

    check-cast p0, Ltx4;

    invoke-virtual {p0, v7}, Ltx4;->a(Z)V
    ...
    invoke-virtual {v0}, Lxx4;->g()V

    :cond_4
    invoke-virtual {v0, v3}, Lxx4;->i(I)V
    ...
    :try_start_0
    iget-boolean p0, v0, Lxx4;->z:Z

    if-eqz p0, :cond_5

    invoke-virtual {v0}, Lxx4;->h()V
    ...
    iput-object p0, v0, Lxx4;->t:Landroid/util/Range;

    iget-object p0, v0, Lxx4;->e:Landroid/media/MediaCodec;
    ...
    invoke-virtual {v0, v7, v1, p0}, Lxx4;->b(ILjava/lang/String;Ljava/lang/Throwable;)V
