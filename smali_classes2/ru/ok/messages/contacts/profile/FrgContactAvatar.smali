...
.method public final H0(Landroid/view/MenuItem;)Z
    ...
    :cond_0
    sget v0, Lyqb;->menu_avatar_photo__save_to_gallery:I
    ...
    iget-object p1, p0, Lru/ok/messages/contacts/profile/FrgContactAvatar;->G1:Ljava/util/ArrayList;

    invoke-static {p1}, Lek8;->u(Ljava/lang/Iterable;)Ljava/lang/Object;
    ...
    :cond_1
    sget v0, Lyqb;->menu_avatar_photo__share:I
    ...
    iput-wide v1, p0, Lru/ok/messages/contacts/profile/FrgContactAvatar;->K1:J
    ...
    iget-object v0, p0, Lru/ok/messages/contacts/profile/FrgContactAvatar;->G1:Ljava/util/ArrayList;

    invoke-static {v0}, Lek8;->u(Ljava/lang/Iterable;)Ljava/lang/Object;
    ...
    invoke-virtual {p1, v6, p0}, Lxq6;->a(Ljava/lang/String;Lwq6;)V

    goto/16 :goto_0

    :cond_2
    sget v0, Lyqb;->menu_avatar_photo__make_main:I
    ...
    iget-object p1, p0, Lru/ok/messages/contacts/profile/FrgContactAvatar;->H1:Ljava/lang/Long;

    invoke-virtual {p1}, Ljava/lang/Long;->longValue()J

    move-result-wide v2

    iget-object p0, p0, Lru/ok/messages/contacts/profile/FrgContactAvatar;->G1:Ljava/util/ArrayList;

    invoke-static {p0}, Lek8;->u(Ljava/lang/Iterable;)Ljava/lang/Object;
    ...
    iget-object p1, v1, Lru/ok/messages/contacts/profile/ActContactAvatars;->k1:Lpn1;

    invoke-static {p1}, Ltic;->b(Lxi4;)V

    new-instance p1, Ly5;

    invoke-direct {p1, v1, p0, v2, v3}, Ly5;-><init>(Lru/ok/messages/contacts/profile/ActContactAvatars;Ljava/lang/String;J)V

    iget-object p0, v1, Lr5;->O0:Lv2b;
    ...
    invoke-direct {v0, v1, v2, v3, v4}, Lx5;-><init>(Lru/ok/messages/contacts/profile/ActContactAvatars;JI)V
    ...
    invoke-static {p1, p0, v0, v2, v3}, Ltic;->a(Lj6;Lqmc;Lj6;Lof3;Lqmc;)Lpn1;

    move-result-object p0

    iput-object p0, v1, Lru/ok/messages/contacts/profile/ActContactAvatars;->k1:Lpn1;

    goto :goto_0

    :cond_4
    sget v0, Lyqb;->menu_avatar_photo__delete:I
    ...
    iget-object p0, p0, Lru/ok/messages/contacts/profile/FrgContactAvatar;->H1:Ljava/lang/Long;
    ...
    iget-object v0, v1, Lru/ok/messages/contacts/profile/ActContactAvatars;->k1:Lpn1;
    ...
    invoke-direct {v0, v1, p0, p1, v2}, Lx5;-><init>(Lru/ok/messages/contacts/profile/ActContactAvatars;JI)V

    iget-object v2, v1, Lr5;->O0:Lv2b;
    ...
    invoke-direct {v3, v1, p0, p1, v4}, Lx5;-><init>(Lru/ok/messages/contacts/profile/ActContactAvatars;JI)V
    ...
    invoke-static {v0, v2, v3, p0, p1}, Ltic;->a(Lj6;Lqmc;Lj6;Lof3;Lqmc;)Lpn1;
...
.method public final M0(Landroid/os/Bundle;)V
    ...
    iget-wide v1, p0, Lru/ok/messages/contacts/profile/FrgContactAvatar;->K1:J

    invoke-virtual {p1, v0, v1, v2}, Landroid/os/BaseBundle;->putLong(Ljava/lang/String;J)V

    const-string v0, "ru.ok.tamtam.extra.EXTRA_DOWNLOAD_AS_BG_REQ_ID"

    iget-wide v1, p0, Lru/ok/messages/contacts/profile/FrgContactAvatar;->L1:J

    invoke-virtual {p1, v0, v1, v2}, Landroid/os/BaseBundle;->putLong(Ljava/lang/String;J)V

    const-string v0, "ru.ok.tamtam.extra.IMAGE_LOAD_FAILED"

    iget-boolean p0, p0, Lru/ok/messages/contacts/profile/FrgContactAvatar;->M1:Z
...
.method public onEvent(Lbk4;)V
    ...
    .line 1
    iget-wide v0, p0, Lru/ok/messages/contacts/profile/FrgContactAvatar;->K1:J
    ...
    invoke-static {p1, v0, v1}, Lswb;->N(Landroidx/fragment/app/b;Ljava/io/File;Lmg5;)V
    ...
    .line 6
    :cond_1
    iget-wide v6, p0, Lru/ok/messages/contacts/profile/FrgContactAvatar;->L1:J
...
.method public onEvent(Ldk4;)V
    ...
    .line 30
    :cond_1
    iget-wide v5, p0, Lru/ok/messages/contacts/profile/FrgContactAvatar;->L1:J
...
.method public final w0(Landroid/os/Bundle;)V
    ...
    iput-object v0, p0, Lru/ok/messages/contacts/profile/FrgContactAvatar;->G1:Ljava/util/ArrayList;
    ...
    iput-object v0, p0, Lru/ok/messages/contacts/profile/FrgContactAvatar;->H1:Ljava/lang/Long;
    ...
    iput-boolean v0, p0, Lru/ok/messages/contacts/profile/FrgContactAvatar;->I1:Z
    ...
    iput-boolean v0, p0, Lru/ok/messages/contacts/profile/FrgContactAvatar;->J1:Z
    ...
    iput-wide v0, p0, Lru/ok/messages/contacts/profile/FrgContactAvatar;->K1:J
    ...
    iput-wide v0, p0, Lru/ok/messages/contacts/profile/FrgContactAvatar;->L1:J
    ...
    iput-boolean p1, p0, Lru/ok/messages/contacts/profile/FrgContactAvatar;->M1:Z
...
.method public final x0(Landroid/view/Menu;Landroid/view/MenuInflater;)V
    ...
    iget-object v0, p0, Lru/ok/messages/contacts/profile/FrgContactAvatar;->H1:Ljava/lang/Long;
    ...
    iget v3, v2, Lru/ok/messages/contacts/profile/ActContactAvatars;->h1:I

    if-ltz v3, :cond_2

    iget-object v7, v2, Lru/ok/messages/contacts/profile/ActContactAvatars;->e1:Ljava/util/ArrayList;
    ...
    :cond_1
    iget v2, v2, Lru/ok/messages/contacts/profile/ActContactAvatars;->h1:I
    ...
    sget v0, Lbsb;->menu_avatar_photo:I
    ...
    instance-of p2, p1, Lyle;

    if-eqz p2, :cond_3

    check-cast p1, Lyle;

    invoke-interface {p1}, Lyle;->a()Lmif;
    ...
    :cond_4
    sget p1, Lyqb;->menu_avatar_photo__make_main:I

    invoke-virtual {v4, p1}, Lmif;->g(I)Landroid/view/MenuItem;
    ...
    iget-boolean v3, p0, Lru/ok/messages/contacts/profile/FrgContactAvatar;->I1:Z

    if-eqz v3, :cond_5

    iget-boolean v3, p0, Lru/ok/messages/contacts/profile/FrgContactAvatar;->J1:Z

    if-eqz v3, :cond_5

    iget-object v3, p0, Lru/ok/messages/contacts/profile/FrgContactAvatar;->H1:Ljava/lang/Long;
    ...
    :cond_6
    sget p1, Lyqb;->menu_avatar_photo__delete:I
...
.method public final y0(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    invoke-direct {v3, v4, p0}, Ltz;-><init>(ILjava/lang/Object;)V
    ...
    invoke-direct {v2, v1, v3}, Lcg3;-><init>(Landroid/view/GestureDetector;I)V
    ...
    invoke-direct {v1, p0, p2, p1, v2}, Lxz;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;I)V

    invoke-virtual {p2, v1}, Lone/me/sdk/zoom/ZoomableDraweeView;->setListener(Ldwf;)V
    ...
    iget-object v2, p0, Lru/ok/messages/contacts/profile/FrgContactAvatar;->G1:Ljava/util/ArrayList;
    ...
    invoke-static {v4}, Ltr6;->b(Ljava/lang/String;)Ltr6;
    ...
    invoke-direct {v7, v5, v6, v4}, Ler6;-><init>(Lfr6;Ltr6;Ljava/lang/Object;)V
    ...
    invoke-direct {v2, v3, v0}, Lnv6;-><init>(Ljava/util/List;Z)V

    iput-object v2, v1, Ln0;->g:Lo3e;
    ...
    invoke-virtual {p2, v0}, Lone/me/sdk/zoom/ZoomableDraweeView;->setController(Lgn4;)V
