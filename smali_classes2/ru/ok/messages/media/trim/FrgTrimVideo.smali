...
.method public final f1()V
    ...
    iget-object v0, p0, Lru/ok/messages/media/trim/FrgTrimVideo;->x1:Landroid/media/MediaMetadataRetriever;
    ...
    :cond_0
    iget-object v0, p0, Lru/ok/messages/media/trim/FrgTrimVideo;->y1:Lvi9;
    ...
    iget-object v2, v2, Lbk9;->p0:Lru/ok/messages/video/widgets/VideoView;

    invoke-virtual {v2}, Lru/ok/messages/video/widgets/VideoView;->b()V

    iget-object v2, v0, Lvi9;->Y:Lge8;

    check-cast v2, Lyp7;

    iget-object v3, v2, Lyp7;->g:Lee8;

    if-ne v3, v0, :cond_1

    invoke-virtual {v2}, Lyp7;->t()V

    iput-object v1, v2, Lyp7;->e:Lu2;

    invoke-virtual {v2, v1}, Lyp7;->q(Landroid/view/Surface;)V

    iput-object v1, v2, Lyp7;->g:Lee8;

    :cond_1
    iget-object v2, v0, Lvi9;->t0:Ltd7;

    invoke-static {v2}, Ldoc;->b(Lam4;)V

    iput-object v1, v0, Lvi9;->t0:Ltd7;

    iget-object v2, v0, Lvi9;->s0:Ltd7;

    invoke-static {v2}, Ldoc;->b(Lam4;)V

    iput-object v1, v0, Lvi9;->s0:Ltd7;

    iput-object v1, p0, Lru/ok/messages/media/trim/FrgTrimVideo;->y1:Lvi9;
...
.method public final m0(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    iput-object v0, v2, Lru/ok/messages/media/trim/FrgTrimVideo;->z1:Landroid/net/Uri;
    ...
    invoke-virtual {v0, v1}, Lp5;->W(Lru/ok/messages/media/mediabar/ActLocalMedias;)V
    ...
    invoke-direct {v4, v2}, Lb9g;-><init>(Lru/ok/messages/views/fragments/base/FrgBase;)V
    ...
    invoke-direct/range {v0 .. v6}, Lbk9;-><init>(Landroid/content/Context;Landroid/view/ViewGroup;Lru/ok/messages/media/trim/FrgTrimVideo;Lb9g;Lru/ok/messages/media/trim/FrgTrimVideo;Lmg;)V

    move-object v2, v3

    iget-object v1, v2, Lru/ok/messages/views/fragments/base/FrgBase;->l1:Lt4b;
    ...
    iget-object v4, v2, Lru/ok/messages/media/trim/FrgTrimVideo;->z1:Landroid/net/Uri;
    ...
    invoke-interface {v5}, Lhe8;->b()Lge8;
    ...
    invoke-direct/range {v0 .. v10}, Lvi9;-><init>(Lbk9;Lru/ok/messages/media/trim/FrgTrimVideo;Luc;Ljava/lang/String;Lge8;JJZ)V
    ...
    iput-object v1, v2, Lru/ok/messages/media/trim/FrgTrimVideo;->y1:Lvi9;
...
.method public final onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    iget-object p0, p0, Lru/ok/messages/media/trim/FrgTrimVideo;->y1:Lvi9;
    ...
    iget-wide v1, p0, Lvi9;->q0:J

    iget-wide v3, p0, Lvi9;->o0:J

    iget-wide v5, p0, Lvi9;->p0:J

    iget-wide v7, p0, Lvi9;->Z:J
