...
.method public final V0()Landroid/app/Dialog;
    ...
    invoke-direct {v3, v4, v5}, Lxt3;-><init>(Landroid/content/Context;I)V

    new-instance v4, Ln08;

    const/4 v5, 0x0

    invoke-direct {v4, v3, v5}, Ln08;-><init>(Landroid/content/Context;I)V

    iget-object v3, v4, Lmc;->a:Lic;

    iget-object v6, v3, Lic;->a:Landroid/view/ContextThemeWrapper;
    ...
    iget-object v2, v3, Lic;->a:Landroid/view/ContextThemeWrapper;

    invoke-virtual {v2, v1}, Landroid/content/Context;->getText(I)Ljava/lang/CharSequence;

    move-result-object v1

    iput-object v1, v3, Lic;->f:Ljava/lang/CharSequence;

    new-instance v1, Lg56;

    const/4 v2, 0x0

    invoke-direct {v1, p0, v2}, Lg56;-><init>(Lru/ok/messages/views/dialogs/FrgDlgPermissions;I)V

    invoke-virtual {v4, v0, v1}, Ln08;->c(ILandroid/content/DialogInterface$OnClickListener;)Ln08;

    move-result-object v0

    iget-object v1, v0, Lmc;->a:Lic;

    iput-boolean v5, v1, Lic;->m:Z
    ...
    invoke-direct {v3, p0, v4}, Lg56;-><init>(Lru/ok/messages/views/dialogs/FrgDlgPermissions;I)V

    iget-object p0, v1, Lic;->a:Landroid/view/ContextThemeWrapper;

    invoke-virtual {p0, v2}, Landroid/content/Context;->getText(I)Ljava/lang/CharSequence;

    move-result-object p0

    iput-object p0, v1, Lic;->k:Ljava/lang/CharSequence;

    iput-object v3, v1, Lic;->l:Landroid/content/DialogInterface$OnClickListener;
