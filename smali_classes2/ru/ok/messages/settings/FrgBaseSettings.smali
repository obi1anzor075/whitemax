...
.method public final j1()V
    ...
    iget-object v0, p0, Lru/ok/messages/settings/FrgBaseSettings;->x1:Ljava/util/List;
    ...
    iget-object v0, p0, Lru/ok/messages/settings/FrgBaseSettings;->z1:Landroidx/recyclerview/widget/RecyclerView;
...
.method public final m0(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    invoke-virtual {p3, v0}, Llx2;->l(Ljava/lang/String;)V

    :cond_0
    sget p3, Lqwb;->frg_settings_base:I
    ...
    sget p2, Lpvb;->frg_settings__rv_content:I
    ...
    iput-object p2, p0, Lru/ok/messages/settings/FrgBaseSettings;->z1:Landroidx/recyclerview/widget/RecyclerView;
    ...
    iput-object p2, p0, Lru/ok/messages/settings/FrgBaseSettings;->x1:Ljava/util/List;
    ...
    invoke-direct {p2, p3, v0, p0}, Lkcd;-><init>(Landroidx/fragment/app/b;Ljava/util/List;Lru/ok/messages/settings/FrgBaseSettings;)V

    iput-object p2, p0, Lru/ok/messages/settings/FrgBaseSettings;->y1:Lkcd;

    iget-object p0, p0, Lru/ok/messages/settings/FrgBaseSettings;->z1:Landroidx/recyclerview/widget/RecyclerView;

    invoke-virtual {p0, p2}, Landroidx/recyclerview/widget/RecyclerView;->setAdapter(Lgbc;)V
