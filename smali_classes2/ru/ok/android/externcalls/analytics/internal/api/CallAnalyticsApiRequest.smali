...
.field private final items:Loq0;
...
# direct methods
.method public constructor <init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ILoq0;Lru/ok/android/externcalls/analytics/log/CallAnalyticsLogger;)V
    .locals 0
    ...
    iput-object p7, p0, Lru/ok/android/externcalls/analytics/internal/api/CallAnalyticsApiRequest;->items:Loq0;
...
.method public static synthetic a(Lru/ok/android/externcalls/analytics/internal/api/CallAnalyticsApiRequest;Lm67;)Ljava/lang/Void;
    .locals 0

    invoke-direct {p0, p1}, Lru/ok/android/externcalls/analytics/internal/api/CallAnalyticsApiRequest;->lambda$getOkParser$0(Lm67;)Ljava/lang/Void;
...
.method private synthetic lambda$getOkParser$0(Lm67;)Ljava/lang/Void;
    .locals 2
...
.method private writeString(Lt67;Ljava/lang/String;Ljava/lang/String;)V
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    .line 1
    invoke-direct {p0, p1, p2, p3, v0}, Lru/ok/android/externcalls/analytics/internal/api/CallAnalyticsApiRequest;->writeString(Lt67;Ljava/lang/String;Ljava/lang/String;Z)V

    return-void
.end method

.method private writeString(Lt67;Ljava/lang/String;Ljava/lang/String;Z)V
    .locals 0
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    .line 3
    :cond_0
    invoke-interface {p1, p2}, Lt67;->g0(Ljava/lang/String;)Lt67;

    .line 4
    invoke-interface {p1, p3}, Lt67;->i(Ljava/lang/String;)V
...
.method public canRepeat()Z
    ...
    iget-object p0, p0, Lru/ok/android/externcalls/analytics/internal/api/CallAnalyticsApiRequest;->items:Loq0;
...
.method public writeParams(Lt67;)V
    ...
    invoke-direct {p0, p1, v2, v0, v1}, Lru/ok/android/externcalls/analytics/internal/api/CallAnalyticsApiRequest;->writeString(Lt67;Ljava/lang/String;Ljava/lang/String;Z)V
    ...
    invoke-direct {p0, p1, v0, v1}, Lru/ok/android/externcalls/analytics/internal/api/CallAnalyticsApiRequest;->writeString(Lt67;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, p1}, Loq0;->write(Lt67;)V
...
.method public bridge synthetic writeSupplyParams(Lt67;)V
    .locals 0
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;,
