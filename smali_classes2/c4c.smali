...
.field public final F0:Lzh;


# direct methods
.method public constructor <init>(Landroid/content/Context;Ld4c;)V
    .locals 7
    ...
    iput-object p2, p0, Lc4c;->B0:Ld4c;
    ...
    iput-object v1, p0, Lc4c;->C0:Landroid/graphics/drawable/GradientDrawable;
    ...
    invoke-static {v5, v2, v2}, Ld46;->D(Ljava/lang/Integer;Ljava/lang/Integer;Ljava/lang/Integer;)Landroid/graphics/drawable/GradientDrawable;
    ...
    iput-object v6, p0, Lc4c;->D0:Landroid/graphics/drawable/RippleDrawable;
    ...
    invoke-static {p1, v4}, Lmna;->M(IF)I
    ...
    iput-object v1, p0, Lc4c;->E0:Landroid/graphics/drawable/RippleDrawable;
    ...
    iput-object p1, p0, Lc4c;->F0:Lzh;

    new-instance p1, Lobc;

    invoke-virtual {p2}, Ld4c;->a()I
    ...
    invoke-direct {p1, v1, p2}, Lobc;-><init>(II)V
...
# virtual methods
.method public final D(Lb4c;)V
    .locals 4

    iget-boolean v0, p1, Lb4c;->o:Z

    if-eqz v0, :cond_1

    iget-object v1, p0, Lc4c;->B0:Ld4c;

    invoke-virtual {v1}, Ld4c;->a()I

    move-result v2

    iget-object v1, v1, Ld4c;->a:Landroid/content/Context;

    invoke-static {v1}, Lp54;->v(Landroid/content/Context;)I
    ...
    iget-object p0, p0, Lc4c;->D0:Landroid/graphics/drawable/RippleDrawable;

    goto :goto_2

    :cond_2
    iget-object p0, p0, Lc4c;->E0:Landroid/graphics/drawable/RippleDrawable;

    :goto_2
    invoke-virtual {v2, p0}, Landroid/view/View;->setBackground(Landroid/graphics/drawable/Drawable;)V

    iget-object p0, p1, Lb4c;->c:Landroid/graphics/drawable/Drawable;
...
.method public final onThemeChanged(Lyha;)V
    ...
    invoke-static {v0, v1}, Lmna;->M(IF)I
    ...
    iget-object v2, p0, Lc4c;->D0:Landroid/graphics/drawable/RippleDrawable;
    ...
    iget-object v2, p0, Lc4c;->C0:Landroid/graphics/drawable/GradientDrawable;
    ...
    invoke-static {p1, v1}, Lmna;->M(IF)I
...
.method public final bridge synthetic x(Lol7;)V
    ...
    invoke-virtual {p0, p1}, Lc4c;->D(Lb4c;)V
