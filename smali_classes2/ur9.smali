...
.field public final e:Lx4b;

.field public f:Landroid/app/NotificationManager;


# direct methods
.method public constructor <init>(Landroid/content/Context;Llba;Lb94;Lc8a;Lx4b;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lur9;->a:Landroid/content/Context;

    iput-object p2, p0, Lur9;->b:Llba;

    iput-object p3, p0, Lur9;->c:Lb94;

    iput-object p4, p0, Lur9;->d:Lc8a;

    iput-object p5, p0, Lur9;->e:Lx4b;
...
.method public final a()Ltr9;
    ...
    iget-object v0, p0, Lur9;->c:Lb94;

    invoke-virtual {v0}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iget-object p0, p0, Lur9;->a:Landroid/content/Context;

    sget v0, Lwzb;->tt_notif_category_active_calls:I
    ...
    invoke-direct/range {v1 .. v11}, Ltr9;-><init>(Ljava/lang/String;Ljava/lang/String;ZZLandroid/net/Uri;Z[JZIZ)V

    return-object v1
.end method

.method public final b()Ltr9;
    .locals 14

    iget-object v0, p0, Lur9;->e:Lx4b;

    check-cast v0, La5b;

    iget-object v1, v0, La5b;->c:Lzo;

    const-string v2, "app.notification.chats.ringtone"

    invoke-virtual {v1, v2}, Lzo;->u(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p0, v1}, Lur9;->h(Z)Landroid/net/Uri;
    ...
    sget v1, Lwzb;->tt_notif_category_chats:I

    invoke-virtual {p0, v1}, Landroid/content/Context;->getString(I)Ljava/lang/String;

    move-result-object v5

    iget-object p0, v0, La5b;->c:Lzo;
    ...
    invoke-virtual {p0, v0, v2}, Lme7;->getBoolean(Ljava/lang/String;Z)Z
    ...
    invoke-direct/range {v3 .. v13}, Ltr9;-><init>(Ljava/lang/String;Ljava/lang/String;ZZLandroid/net/Uri;Z[JZIZ)V

    return-object v3
.end method

.method public final c()Ltr9;
    .locals 14
    ...
    invoke-virtual {p0, v2}, Lur9;->h(Z)Landroid/net/Uri;
    ...
    sget v1, Lwzb;->tt_notif_category_dialogs:I
...
.method public final d()Ltr9;
    .locals 13

    iget-object v0, p0, Lur9;->b:Llba;
    ...
    iget-object v0, p0, Lur9;->a:Landroid/content/Context;

    sget v1, Lwzb;->tt_notif_category_inapp:I

    invoke-virtual {v0, v1}, Landroid/content/Context;->getString(I)Ljava/lang/String;

    move-result-object v4

    iget-object p0, p0, Lur9;->e:Lx4b;
    ...
    invoke-direct/range {v2 .. v12}, Ltr9;-><init>(Ljava/lang/String;Ljava/lang/String;ZZLandroid/net/Uri;Z[JZIZ)V
...
.method public final e(Ltr9;)V
    ...
    iget-boolean v0, p1, Ltr9;->c:Z

    const/4 v2, 0x4

    if-eqz v0, :cond_1

    iget-boolean v0, p1, Ltr9;->f:Z
    ...
    iget-object v5, p1, Ltr9;->b:Ljava/lang/String;

    invoke-direct {v3, v1, v5, v0}, Landroid/app/NotificationChannel;-><init>(Ljava/lang/String;Ljava/lang/CharSequence;I)V

    iget-object v0, p1, Ltr9;->e:Landroid/net/Uri;

    if-eqz v0, :cond_5

    iget-object v5, p0, Lur9;->c:Lb94;
    ...
    invoke-virtual {v0}, Llba;->d()I

    move-result v0

    invoke-virtual {v3, v0}, Landroid/app/NotificationChannel;->setLightColor(I)V

    iget-object v0, p0, Lur9;->d:Lc8a;

    invoke-virtual {v0, v1}, Lc8a;->b(Ljava/lang/String;)Ljava/lang/String;
...
.method public final f()V
    ...
    iget-object v1, v0, Lur9;->d:Lc8a;

    iget-object v2, v1, Lc8a;->e:Lwfe;
    ...
    invoke-virtual {v1, v4, v2}, Lc8a;->a(ILjava/lang/String;)V
    ...
    invoke-virtual {v1, v3, v2}, Lc8a;->a(ILjava/lang/String;)V

    :cond_3
    invoke-virtual {v0}, Lur9;->i()Landroid/app/NotificationManager;
    ...
    invoke-virtual {v0}, Lur9;->b()Ltr9;

    move-result-object v3

    invoke-virtual {v0, v3}, Lur9;->e(Ltr9;)V
    ...
    iget-object v6, v0, Lur9;->e:Lx4b;

    iget-object v7, v0, Lur9;->a:Landroid/content/Context;
    ...
    iget-object v8, v3, La5b;->c:Lzo;

    const-string v9, "app.notification.ringtone"

    invoke-virtual {v8, v9}, Lzo;->u(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v0, v5}, Lur9;->h(Z)Landroid/net/Uri;

    move-result-object v14

    sget v8, Lwzb;->tt_notif_category_misc:I
    ...
    invoke-virtual {v3, v4, v5}, Lme7;->getBoolean(Ljava/lang/String;Z)Z
    ...
    invoke-direct/range {v9 .. v19}, Ltr9;-><init>(Ljava/lang/String;Ljava/lang/String;ZZLandroid/net/Uri;Z[JZIZ)V

    invoke-virtual {v0, v9}, Lur9;->e(Ltr9;)V
    ...
    sget v3, Lwzb;->tt_notif_category_file_loading:I
    ...
    invoke-direct/range {v8 .. v18}, Ltr9;-><init>(Ljava/lang/String;Ljava/lang/String;ZZLandroid/net/Uri;Z[JZIZ)V

    invoke-virtual {v0, v8}, Lur9;->e(Ltr9;)V
    ...
    sget v3, Lwzb;->tt_notif_category_media:I
    ...
    sget v3, Lwzb;->tt_notif_category_incoming_calls:I
    ...
    sget v3, Lwzb;->tt_notif_category_live_location:I
...
.method public final h(Z)Landroid/net/Uri;
    ...
    iget-object p1, v0, La5b;->c:Lzo;

    const-string v0, "app.notification.ringtone"

    invoke-virtual {p1, v0}, Lzo;->u(Ljava/lang/String;)Ljava/lang/String;
...
.method public final i()Landroid/app/NotificationManager;
    ...
    iget-object v0, p0, Lur9;->f:Landroid/app/NotificationManager;
    ...
    iput-object v0, p0, Lur9;->f:Landroid/app/NotificationManager;

    :cond_0
    iget-object p0, p0, Lur9;->f:Landroid/app/NotificationManager;
