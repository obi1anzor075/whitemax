...
# direct methods
.method public constructor <init>(JJJJJLjava/lang/String;Ljava/lang/String;Lsw8;Ljava/util/List;Ljava/util/List;Z)V
    .locals 0

    invoke-direct/range {p0 .. p2}, Lhl;-><init>(J)V

    iput-wide p3, p0, Lid9;->o:J

    iput-wide p5, p0, Lid9;->X:J

    iput-wide p7, p0, Lid9;->Y:J

    iput-wide p9, p0, Lid9;->Z:J

    iput-object p13, p0, Lid9;->o0:Lsw8;

    iput-object p14, p0, Lid9;->p0:Ljava/util/List;

    iput-object p15, p0, Lid9;->q0:Ljava/util/List;

    move/from16 p1, p16

    iput-boolean p1, p0, Lid9;->r0:Z
    ...
    :cond_0
    iput-object p11, p0, Lid9;->s0:Ljava/lang/String;
    ...
    :cond_1
    iput-object p12, p0, Lid9;->t0:Ljava/lang/String;
...
.method public final c()I
    ...
    :goto_2
    invoke-virtual {v8}, Lil;->e()Lhme;

    move-result-object v8

    sget-object v9, Lyra;->p0:Lyra;

    iget-wide v10, v0, Lhl;->a:J

    invoke-virtual {v8, v10, v11, v9}, Lhme;->h(JLyra;)Ljava/util/List;
    ...
    iget-object v9, v9, Lxle;->f:Lxra;

    check-cast v9, Lid9;

    iget-wide v14, v9, Lid9;->o:J

    cmp-long v14, v14, v6

    if-nez v14, :cond_3

    iget-wide v14, v9, Lid9;->X:J
    ...
    invoke-virtual {v5}, Ly42;->B()Z

    move-result v4

    if-nez v4, :cond_5

    invoke-virtual {v5}, Ly42;->Q()Z
    ...
    iget-boolean v14, v0, Lid9;->r0:Z

    if-eqz v14, :cond_f

    sget-object v15, Ls10;->c:Ls10;

    invoke-virtual {v1, v15}, Lzs8;->n(Ls10;)Z
    ...
    iget-object v15, v3, Lo9g;->a:Ljava/lang/Object;
    ...
    invoke-virtual {v1, v10, v11}, Lhme;->j(J)Lxle;
    ...
    iget-wide v3, v0, Lid9;->Y:J

    invoke-virtual {v1, v3, v4, v2}, La2a;->C(JLjava/util/List;)J
    ...
    :goto_7
    invoke-virtual {v2}, Lil;->e()Lhme;

    move-result-object v0

    invoke-virtual {v0, v10, v11}, Lhme;->c(J)V

    invoke-static {v13, v9}, Lg47;->p(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :cond_11
    invoke-static {v3}, Le20;->a(Lo9g;)Z
...
.method public final d()V
    ...
    invoke-virtual {v2, v0, v3}, Lxs8;->x(Lzs8;Lft8;)V
    ...
    iget-object v9, p0, Lid9;->p0:Ljava/util/List;

    iget-boolean v10, p0, Lid9;->r0:Z

    iget-wide v2, p0, Lid9;->X:J

    iget-wide v4, p0, Lid9;->o:J

    iget-object v6, p0, Lid9;->t0:Ljava/lang/String;

    iget-object v7, p0, Lid9;->q0:Ljava/util/List;

    iget-object v8, p0, Lid9;->o0:Lsw8;

    invoke-virtual/range {v1 .. v10}, Lxu4;->a(JJLjava/lang/String;Ljava/util/List;Lsw8;Ljava/util/List;Z)V
...
.method public final e(Llje;)V
    ...
    iget-object v0, v7, Lzs8;->r0:Lsw8;
    ...
    iget-object p0, v5, Lxs8;->a:Lr34;

    check-cast p0, Lz24;

    iget-object p0, p0, Lz24;->c:Lyjc;

    iget-object p0, p0, Lyjc;->a:Lljc;
    ...
    invoke-direct {p1, v0, v4}, Lfjc;-><init>(ILv56;)V
    ...
    iget-wide v4, v8, Lid9;->o:J

    invoke-virtual {p0, v4, v5}, Ln82;->C(J)Ly42;

    move-result-object p0

    iget-object p1, v7, Lzs8;->Q0:Ltg4;

    invoke-virtual {p1}, Ltg4;->b()Z
    ...
    invoke-virtual {p0, v4, v5}, Ln82;->w(J)V
...
.method public final f(Lvie;)V
    ...
    invoke-virtual {p1, v1}, Le20;->b(Lzs8;)V

    goto :goto_3

    :cond_3
    invoke-virtual {p0}, Lid9;->d()V
    ...
    invoke-direct {v3, v4, v5, p1}, Lji0;-><init>(JLvie;)V
...
.method public final g()[B
    ...
    invoke-static {v1}, Lru/ok/tamtam/nano/b;->f(Lo9g;)Lru/ok/tamtam/nano/Protos$Attaches;
    ...
    :cond_0
    iget-object p0, p0, Lid9;->q0:Ljava/util/List;
...
.method public final i()Lije;
    ...
    :cond_2
    iget-boolean v3, p0, Lid9;->r0:Z

    if-eqz v3, :cond_4

    iget-object v3, v2, Lzs8;->v0:Lo9g;

    invoke-static {v3}, Lfz7;->f(Lo9g;)Llz;
    ...
    :goto_2
    iget-object v3, v2, Lzs8;->N0:Ljava/util/List;

    if-eqz v3, :cond_5

    invoke-static {v3}, Lfz7;->v(Ljava/util/List;)Ljava/util/ArrayList;
    ...
    iget-object v9, p0, Lid9;->s0:Ljava/lang/String;

    iget-object v12, v2, Lzs8;->P0:Lug4;

    iget-wide v7, p0, Lid9;->Z:J

    invoke-direct/range {v4 .. v12}, Lnb2;-><init>(JJLjava/lang/String;Llz;Ljava/util/ArrayList;Lug4;)V
