...
.field public final p0:Ljava/util/concurrent/locks/Condition;
...
# direct methods
.method public constructor <init>(Lu24;Lp8d;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Thread;-><init>()V

    iput-object p2, p0, Lw24;->a:Lp8d;

    const/16 p2, 0x1e

    iput p2, p0, Lw24;->b:I

    iput-object p1, p0, Lw24;->c:Lu24;

    new-instance p1, Ljava/util/concurrent/ConcurrentLinkedQueue;

    invoke-direct {p1}, Ljava/util/concurrent/ConcurrentLinkedQueue;-><init>()V

    iput-object p1, p0, Lw24;->o:Ljava/util/concurrent/ConcurrentLinkedQueue;
    ...
    iput-object p1, p0, Lw24;->X:Ljava/util/concurrent/atomic/AtomicInteger;

    new-instance p1, Ljava/util/concurrent/locks/ReentrantLock;

    invoke-direct {p1}, Ljava/util/concurrent/locks/ReentrantLock;-><init>()V

    iput-object p1, p0, Lw24;->o0:Ljava/util/concurrent/locks/ReentrantLock;

    invoke-virtual {p1}, Ljava/util/concurrent/locks/ReentrantLock;->newCondition()Ljava/util/concurrent/locks/Condition;

    move-result-object p1

    iput-object p1, p0, Lw24;->p0:Ljava/util/concurrent/locks/Condition;

    new-instance p1, Ljava/util/concurrent/locks/ReentrantLock;

    invoke-direct {p1}, Ljava/util/concurrent/locks/ReentrantLock;-><init>()V

    iput-object p1, p0, Lw24;->q0:Ljava/util/concurrent/locks/ReentrantLock;
...
.method public final run()V
    ...
    :cond_0
    :goto_0
    iget-boolean v0, p0, Lw24;->r0:Z

    const/4 v1, 0x0

    if-nez v0, :cond_1b

    iget-object v0, p0, Lw24;->q0:Ljava/util/concurrent/locks/ReentrantLock;

    invoke-virtual {v0}, Ljava/util/concurrent/locks/ReentrantLock;->lock()V

    :try_start_0
    iget-object v2, p0, Lw24;->c:Lu24;
    ...
    iget-object v2, v2, Lu24;->a:Lorg/webrtc/DataChannel;
    ...
    iget-object v0, p0, Lw24;->Y:Lbj;

    if-nez v0, :cond_7

    iget-object v0, p0, Lw24;->o:Ljava/util/concurrent/ConcurrentLinkedQueue;
    ...
    :cond_4
    :try_start_1
    iget-object v0, p0, Lw24;->o0:Ljava/util/concurrent/locks/ReentrantLock;
    ...
    :try_start_2
    iget-object v2, p0, Lw24;->p0:Ljava/util/concurrent/locks/Condition;
    ...
    :cond_9
    iget-object v0, p0, Lw24;->X:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    :cond_15
    iget-object v2, p0, Lw24;->a:Lp8d;

    array-length v4, v8

    iget-object v2, v2, Lp8d;->a:Ljava/lang/Object;
    ...
    invoke-virtual {v2, v7, v8}, Lu24;->e(I[B)Z
    ...
    iget-object p0, p0, Lw24;->o:Ljava/util/concurrent/ConcurrentLinkedQueue;
