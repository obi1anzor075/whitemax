...
.method public synthetic constructor <init>(Ljava/lang/Object;ILjava/lang/Object;)V
    ...
    iput-object p1, p0, Lsla;->b:Ljava/lang/Object;

    iput-object p3, p0, Lsla;->c:Ljava/lang/Object;
...
.method public final accept(Ljava/lang/Object;)V
    ...
    iget-object v0, p0, Lsla;->c:Ljava/lang/Object;

    check-cast v0, Lnhd;

    check-cast p1, Lkn1;

    iget-object p0, p0, Lsla;->b:Ljava/lang/Object;

    check-cast p0, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;

    invoke-static {p0, v0, p1}, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->d(Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;Lnhd;Lkn1;)V
    ...
    iget-object p1, p0, Lsla;->b:Ljava/lang/Object;

    check-cast p1, Lxp0;

    invoke-virtual {p1}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iget-object p0, p0, Lsla;->c:Ljava/lang/Object;
    ...
    iget-object p1, p1, Lxp0;->b:Ljava/lang/Object;

    check-cast p1, Lzla;

    if-eqz p0, :cond_0

    iget-object p0, p1, Lzla;->k1:Ljl7;

    const/4 p1, 0x0

    invoke-virtual {p0, p1, p1}, Ljl7;->m(Ljava/lang/Float;Ljava/lang/Float;)V
    ...
    iget v0, p1, Lzla;->w1:F

    invoke-static {v0}, Ljava/lang/Float;->valueOf(F)Ljava/lang/Float;

    move-result-object v0

    iget p1, p1, Lzla;->x1:F

    invoke-static {p1}, Ljava/lang/Float;->valueOf(F)Ljava/lang/Float;

    move-result-object p1

    invoke-virtual {p0, v0, p1}, Ljl7;->m(Ljava/lang/Float;Ljava/lang/Float;)V
    ...
    iget-object v0, p0, Lsla;->b:Ljava/lang/Object;
    ...
    invoke-virtual {v0, p0}, Lzla;->g(Ljava/util/List;)Lorg/webrtc/PeerConnection$RTCConfiguration;
    ...
    iget-object v2, p1, Lzla;->O0:Lxwb;
    ...
    invoke-direct {v1, p1, v2, p0}, Lhg9;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V
    ...
    iget-object p1, v0, Lzla;->O0:Lxwb;
    ...
    invoke-virtual {v0, p1, v1}, Lzla;->u(Lorg/webrtc/PeerConnection;Z)V

    goto :goto_1

    :cond_2
    invoke-virtual {v0, p1, v1}, Lzla;->k(Lorg/webrtc/PeerConnection;Z)V
    ...
    invoke-virtual {p1}, Lzla;->toString()Ljava/lang/String;
    ...
    iget-object v0, p1, Lzla;->j1:Ljava/util/ArrayList;
    ...
    iget-object v1, p1, Lzla;->O0:Lxwb;

    const-string v2, "PCRTCClient"

    invoke-interface {v1, v2, p0}, Lxwb;->log(Ljava/lang/String;Ljava/lang/String;)V

    iget-boolean p0, p1, Lzla;->l1:Z

    if-eqz p0, :cond_7

    const/4 p0, 0x0

    iput-boolean p0, p1, Lzla;->l1:Z
    ...
    sget-object p0, Ltqd;->z0:Ltqd;

    const/4 v0, 0x0

    iget-object p1, p1, Lzla;->N0:Laxb;

    const-string v1, "rtc.no.stun.candidates"

    invoke-virtual {p1, p0, v1, v0}, Laxb;->log(Ltqd;Ljava/lang/String;Ljava/lang/String;)V
