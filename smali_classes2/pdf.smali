...
.field public final s0:Lodf;

.field public final t0:Lodf;

.field public final u0:Lodf;
...
.method static constructor <clinit>()V
    ...
    sput-object v3, Lpdf;->z0:[Lbc7;

    new-instance v0, Landroid/text/TextPaint;

    invoke-direct {v0}, Landroid/text/TextPaint;-><init>()V

    sput-object v0, Lpdf;->A0:Landroid/text/TextPaint;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v2, p0, Lpdf;->q0:Ljava/lang/Object;
    ...
    iget-object v2, v2, Ll73;->g:Lh83;

    iget v2, v2, Lh83;->a:I

    iput v2, p0, Lpdf;->r0:I

    new-instance v2, Lodf;

    const/4 v3, 0x1

    invoke-direct {v2, p0, v3}, Lodf;-><init>(Lpdf;I)V

    iput-object v2, p0, Lpdf;->s0:Lodf;
    ...
    iput-object v2, p0, Lpdf;->t0:Lodf;
    ...
    iput-object v2, p0, Lpdf;->u0:Lodf;
    ...
    iput-object v1, p0, Lpdf;->x0:Ljava/lang/Object;

    new-instance v1, Lodf;

    const/4 v3, 0x0

    invoke-direct {v1, p0, v3}, Lodf;-><init>(Lpdf;I)V

    iput-object v1, p0, Lpdf;->y0:Lodf;
    ...
    sget-object v3, Lpdf;->A0:Landroid/text/TextPaint;
    ...
    invoke-virtual {v1, v4}, Lnoe;->e(Lyt4;)J

    move-result-wide v4

    invoke-static {v4, v5, p1}, Ldk4;->c(JLandroid/content/Context;)F

    move-result v4

    invoke-virtual {v3, v4}, Landroid/graphics/Paint;->setTextSize(F)V

    iget-wide v4, v1, Lnoe;->e:J
    ...
    iget-object p1, v1, Lnoe;->f:Ljava/lang/String;
    ...
    invoke-direct {p0}, Lpdf;->getDrawableColor()I

    move-result v0

    invoke-virtual {p1, v0}, Landroid/graphics/drawable/Drawable;->setTint(I)V

    iput-object p1, p0, Lpdf;->v0:Landroid/graphics/drawable/Drawable;

    :cond_0
    return-void
.end method

.method public static final synthetic a(Lpdf;)I
    .locals 0
...
.method public static final synthetic b(Lpdf;)Landroid/text/BoringLayout$Metrics;
    .locals 0

    invoke-direct {p0}, Lpdf;->getMetrics()Landroid/text/BoringLayout$Metrics;
...
.method private final getBackgroundColor()I
    ...
    sget-object v0, Lpdf;->z0:[Lbc7;

    const/4 v1, 0x1

    aget-object v0, v0, v1

    iget-object v0, p0, Lpdf;->t0:Lodf;
...
.method private final getMetrics()Landroid/text/BoringLayout$Metrics;
    ...
    iget-object p0, p0, Lpdf;->x0:Ljava/lang/Object;
...
.method private final getText()Ljava/lang/CharSequence;
    ...
    iget-object p0, p0, Lpdf;->y0:Lodf;
...
.method private final setText(Ljava/lang/CharSequence;)V
    ...
    iget-object v1, p0, Lpdf;->y0:Lodf;
...
.method public final onDraw(Landroid/graphics/Canvas;)V
    ...
    iget-object v0, p0, Lpdf;->w0:Landroid/text/Layout;
    ...
    sget-object v3, Lpdf;->z0:[Lbc7;

    const/4 v4, 0x0

    aget-object v3, v3, v4

    iget-object v3, p0, Lpdf;->s0:Lodf;
    ...
    iget-object v3, p0, Lpdf;->q0:Ljava/lang/Object;
    ...
    invoke-direct {p0}, Lpdf;->getBackgroundColor()I
    ...
    iget-object p1, p0, Lpdf;->v0:Landroid/graphics/drawable/Drawable;
...
.method public final onMeasure(II)V
    ...
    iget-object p1, p0, Lpdf;->w0:Landroid/text/Layout;
    ...
    :goto_0
    iget-object v1, p0, Lpdf;->v0:Landroid/graphics/drawable/Drawable;
    ...
    :cond_1
    sget-object v1, Lpdf;->z0:[Lbc7;

    aget-object p2, v1, p2

    iget-object p2, p0, Lpdf;->s0:Lodf;
...
.method public final setBackgroundEnabled(Z)V
    ...
    iget-object v1, p0, Lpdf;->s0:Lodf;
...
.method public final setCapsuleInside(Z)V
    ...
    iget-object v1, p0, Lpdf;->t0:Lodf;
...
.method public final setContent(Ljava/lang/CharSequence;)V
    ...
    invoke-direct {p0, p1}, Lpdf;->setText(Ljava/lang/CharSequence;)V
...
.method public final setDrawableEnabled(Z)V
    ...
    iget-object v1, p0, Lpdf;->u0:Lodf;
