...
.field public volatile h:Lwd3;

.field public final i:Ljava/util/concurrent/CopyOnWriteArraySet;

.field public final j:Lid3;
...
# direct methods
.method public constructor <init>(Landroid/content/Context;Ljava/util/concurrent/Executor;Lnfc;Lr7e;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Ljd3;->a:Landroid/content/Context;

    iput-object p2, p0, Ljd3;->b:Ljava/util/concurrent/Executor;

    iput-object p3, p0, Ljd3;->c:Lnfc;

    iput-object p4, p0, Ljd3;->d:Lt97;
    ...
    iput-object p2, p0, Ljd3;->e:Ljava/util/concurrent/atomic/AtomicReference;

    new-instance p3, Lgd3;

    const/4 p4, 0x0

    invoke-direct {p3, p0, p4}, Lgd3;-><init>(Ljd3;I)V

    new-instance p4, Lr7e;

    invoke-direct {p4, p3}, Lr7e;-><init>(Ls16;)V

    iput-object p4, p0, Ljd3;->f:Lr7e;
    ...
    iput-object p4, p0, Ljd3;->g:Lr7e;

    sget-object p3, Lwd3;->b:Lwd3;

    iput-object p3, p0, Ljd3;->h:Lwd3;

    new-instance p3, Ljava/util/concurrent/CopyOnWriteArraySet;

    invoke-direct {p3}, Ljava/util/concurrent/CopyOnWriteArraySet;-><init>()V

    iput-object p3, p0, Ljd3;->i:Ljava/util/concurrent/CopyOnWriteArraySet;

    new-instance p3, Lid3;

    const/4 p4, 0x0

    invoke-direct {p3, p4, p0}, Lid3;-><init>(ILjava/lang/Object;)V

    iput-object p3, p0, Ljd3;->j:Lid3;

    new-instance p3, Ljava/util/concurrent/atomic/AtomicReference;

    sget-object p4, Lhd3;->f:Lhd3;

    invoke-direct {p3, p4}, Ljava/util/concurrent/atomic/AtomicReference;-><init>(Ljava/lang/Object;)V

    iput-object p3, p0, Ljd3;->k:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    iput-object p3, p0, Ljd3;->l:Ljava/lang/String;

    const/4 p3, 0x0

    invoke-virtual {p0, p3}, Ljd3;->m(Z)Z
    ...
    invoke-static {p1, p2, p0, p4, p3}, Ld8;->z(Landroid/content/Context;Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;Ljava/lang/String;I)Landroid/content/Intent;

    return-void
.end method

.method public static j(Landroid/net/NetworkCapabilities;)Lwd3;
    .locals 1
...
.method public final a()Z
    ...
    invoke-virtual {p0}, Ljd3;->k()Landroid/net/ConnectivityManager;
...
.method public final b()Lwd3;
    ...
    iget-object v0, p0, Ljd3;->h:Lwd3;

    sget-object v1, Lwd3;->b:Lwd3;

    if-eq v0, v1, :cond_0

    iget-object p0, p0, Ljd3;->h:Lwd3;
    ...
    invoke-static {v0}, Ljd3;->j(Landroid/net/NetworkCapabilities;)Lwd3;
    ...
    invoke-virtual {p0, v1, v0}, Ljd3;->l(Ljava/lang/String;Ljava/lang/Throwable;)V

    sget-object v1, Lwd3;->b:Lwd3;

    :goto_0
    iput-object v1, p0, Ljd3;->h:Lwd3;
...
.method public final d()Z
    ...
    iget-object v0, p0, Ljd3;->k:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    iget-object v1, p0, Ljd3;->e:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    iget-boolean p0, v0, Lhd3;->e:Z

    goto :goto_0

    :cond_0
    invoke-virtual {p0}, Ljd3;->h()Landroid/net/Network;

    move-result-object v0

    invoke-virtual {p0, v0}, Ljd3;->i(Landroid/net/Network;)Landroid/net/NetworkCapabilities;
...
.method public final f()Z
    ...
    iget-object v0, p0, Ljd3;->e:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    iget-object p0, p0, Ljd3;->k:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    iget-object v2, p0, Ljd3;->l:Ljava/lang/String;
    ...
    invoke-virtual {v2, v0, v3}, Lr4a;->c(Ljava/lang/Throwable;Z)V
    ...
    :cond_2
    iget-object p0, p0, Ljd3;->l:Ljava/lang/String;
    ...
    invoke-static {v3, v1}, Lus8;->k(Ljava/lang/String;Z)Ljava/lang/String;

    move-result-object v3

    const/4 v4, 0x0

    invoke-interface {v0, v2, p0, v3, v4}, Lfn6;->d(Ltn7;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public final h()Landroid/net/Network;
    ...
    iget-object v0, p0, Ljd3;->l:Ljava/lang/String;
...
.method public final invalidate()V
    ...
    invoke-virtual {p0, v1}, Ljd3;->m(Z)Z
    ...
    invoke-virtual {p0, v2, v2}, Ljd3;->o(Landroid/net/Network;Landroid/net/NetworkCapabilities;)V
...
.method public final l(Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-static {v0, p1, p2}, Ludd;->s(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    iget-object p0, p0, Ljd3;->c:Lnfc;
...
.method public final m(Z)Z
    ...
    iget-object p1, p0, Ljd3;->l:Ljava/lang/String;
    ...
    invoke-virtual {p0, v0, p1}, Ljd3;->l(Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public final n(Lhd3;)V
    ...
    invoke-static {v0, p1}, Ludd;->U(Ljava/lang/String;Ljava/lang/String;)V

    :cond_4
    :goto_1
    iget-object p1, p0, Ljd3;->b:Ljava/util/concurrent/Executor;
...
.method public final o(Landroid/net/Network;Landroid/net/NetworkCapabilities;)V
    ...
    invoke-virtual/range {p0 .. p0}, Ljd3;->h()Landroid/net/Network;
    ...
    :goto_0
    invoke-virtual {v1, v4}, Ljd3;->i(Landroid/net/Network;)Landroid/net/NetworkCapabilities;
    ...
    :try_start_0
    invoke-virtual/range {p0 .. p0}, Ljd3;->k()Landroid/net/ConnectivityManager;
    ...
    iget-object v0, v1, Ljd3;->l:Ljava/lang/String;

    const-string v7, "Unable to get active network info"

    invoke-static {v0, v7}, Ludd;->U(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    iget-object v7, v1, Ljd3;->l:Ljava/lang/String;
    ...
    :cond_9
    iget-object v9, v1, Ljd3;->l:Ljava/lang/String;
    ...
    sget-object v15, Ltn7;->Y:Ltn7;

    const-string v7, "retrieveInet, VPN detected"

    invoke-interface {v14, v15, v9, v7, v5}, Lfn6;->d(Ltn7;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-interface {v8, v14, v7, v0, v2}, Lfn6;->d(Ltn7;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-direct/range {v8 .. v13}, Lhd3;-><init>(ZZZZZ)V
    ...
    :cond_10
    invoke-virtual {v1, v5}, Ljd3;->n(Lhd3;)V
