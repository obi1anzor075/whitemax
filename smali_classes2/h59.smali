...
.method public constructor <init>(Lkotlin/coroutines/Continuation;Lone/me/messages/list/ui/MessagesListWidget;)V
    ...
    iput-object p2, p0, Lh59;->Y:Lone/me/messages/list/ui/MessagesListWidget;
...
.method public final invoke(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, p2}, Lh59;->m(Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Lkotlin/coroutines/Continuation;
...
.method public final m(Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Lkotlin/coroutines/Continuation;
    ...
    iget-object p0, p0, Lh59;->Y:Lone/me/messages/list/ui/MessagesListWidget;

    invoke-direct {v0, p2, p0}, Lh59;-><init>(Lkotlin/coroutines/Continuation;Lone/me/messages/list/ui/MessagesListWidget;)V

    iput-object p1, v0, Lh59;->X:Ljava/lang/Object;
...
.method public final o(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object p1, p0, Lh59;->X:Ljava/lang/Object;
    ...
    invoke-virtual {p1}, Lh49;->A()Lse9;

    move-result-object p1

    iget-object p1, p1, Lse9;->f:Lazd;
    ...
    iget-object p0, p0, Lone/me/messages/list/ui/MessagesListWidget;->F0:Ln4c;

    if-eqz p0, :cond_14

    invoke-virtual {p0}, Ln4c;->a()V
    ...
    iget-object v0, p0, Lse9;->f:Lazd;

    iget-object v2, p0, Lse9;->f:Lazd;
    ...
    iget-object v0, v0, Lme9;->a:Ljava/util/Set;
    ...
    invoke-direct {p0}, Lme9;-><init>()V

    invoke-virtual {v2, v3, p0}, Lazd;->m(Ljava/lang/Object;Ljava/lang/Object;)Z

    return-object v1

    :cond_2
    iget-object p0, p0, Lse9;->d:Ljw;
    ...
    iget-object p0, p0, Lone/me/messages/list/ui/MessagesListWidget;->T0:Lwz4;

    if-eqz p0, :cond_14

    iput-boolean v2, p0, Lwz4;->q:Z
    ...
    iget-wide v4, p1, Lu19;->a:J

    invoke-interface {v0, v4, v5}, Ll19;->e(J)Lone/me/messages/list/loader/MessageModel;
    ...
    :goto_0
    invoke-virtual {v4, v0, v2}, Lru/ok/onechat/reactions/ReactionsViewModel;->j(Lfw8;Z)Lkl7;
    ...
    iget-object p1, p0, Ln4c;->i:Ll15;

    iget-object v6, p0, Ln4c;->h:Landroid/graphics/Rect;

    iget-object v7, p0, Ln4c;->a:Landroidx/recyclerview/widget/RecyclerView;

    invoke-virtual {v7, v4, v5}, Landroidx/recyclerview/widget/RecyclerView;->N(J)Lccc;
    ...
    :cond_7
    iget-object v8, v8, Lccc;->a:Landroid/view/View;

    instance-of v10, v8, Lzr8;
    ...
    invoke-virtual {v10}, Lzr8;->getContentView$message_list_release()Landroid/view/View;
    ...
    :cond_b
    new-instance v10, Lw4c;

    invoke-virtual {v7}, Landroid/view/View;->getContext()Landroid/content/Context;

    move-result-object v9

    iget-object v11, p0, Ln4c;->f:Ljava/util/concurrent/ExecutorService;

    invoke-direct {v10, v9, v11}, Lw4c;-><init>(Landroid/content/Context;Ljava/util/concurrent/ExecutorService;)V

    invoke-static {v4, v5}, Ljava/lang/Long;->valueOf(J)Ljava/lang/Long;

    move-result-object v4

    iput-object v4, v10, Lw4c;->o0:Ljava/lang/Long;

    iput-object v8, v10, Lw4c;->X:Landroid/view/View;

    iget-object v4, v10, Lw4c;->Y:[I
    ...
    iput-object v4, v10, Lw4c;->o:Landroid/graphics/Rect;

    new-instance v4, Lm4c;

    iget-object v5, v10, Lw4c;->a:Landroid/content/Context;

    iget-object v6, v10, Lw4c;->b:Ljava/util/concurrent/ExecutorService;

    invoke-direct {v4, v5, v6}, Lm4c;-><init>(Landroid/content/Context;Ljava/util/concurrent/Executor;)V

    invoke-virtual {v4, v0, v3}, Lm4c;->a(Ljava/util/List;Ljava/lang/Integer;)V

    iput-object v10, v4, Lm4c;->b:Ll4c;

    iput-object v4, v10, Lw4c;->c:Lm4c;
    ...
    iget-object v5, v10, Lw4c;->c:Lm4c;

    if-eqz v5, :cond_c

    iget-object v3, v5, Lm4c;->d:Landroidx/recyclerview/widget/RecyclerView;
    ...
    iget-object v0, v10, Lw4c;->c:Lm4c;

    if-eqz v0, :cond_e

    iget-object v0, v0, Lm4c;->d:Landroidx/recyclerview/widget/RecyclerView;

    if-eqz v0, :cond_e

    iget-object v3, v10, Lw4c;->o:Landroid/graphics/Rect;
    ...
    iput-object v0, v10, Lw4c;->r0:Lie6;

    iget-object v11, v10, Lw4c;->c:Lm4c;

    iget-object v9, v10, Lw4c;->X:Landroid/view/View;

    iget-object v12, v10, Lw4c;->o:Landroid/graphics/Rect;
    ...
    invoke-direct {v0, v9, v8}, Lk1a;-><init>(Landroid/view/View;Lv56;)V
    ...
    :goto_7
    invoke-virtual {v7, p1}, Landroidx/recyclerview/widget/RecyclerView;->r0(Lsbc;)V

    invoke-virtual {v7, p1}, Landroidx/recyclerview/widget/RecyclerView;->m(Lsbc;)V

    iput-object v10, p0, Ln4c;->g:Lw4c;
