...
.method public constructor <init>()V
    ...
    .line 5
    iput-object v0, p0, Lcvc;->b:Ljava/lang/Object;
...
.method public static i(Lcvc;JZI)V
    .locals 10
    ...
    iget-object p0, p0, Lcvc;->b:Ljava/lang/Object;
    ...
    invoke-direct/range {v0 .. v9}, Lzuc;-><init>(JZZZZIJ)V
...
.method public final d(Lbn5;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    invoke-direct {v0, p0, p2}, Ldre;-><init>(Lcvc;Lkotlin/coroutines/Continuation;)V

    :goto_0
    iget-object p2, v0, Ldre;->Y:Ljava/lang/Object;
    ...
    iget-object p0, v0, Ldre;->X:Lbn5;

    iget-object p1, v0, Ldre;->o:Lcvc;
    ...
    invoke-static {p2}, Lk3c;->h(Lhx3;)V

    invoke-virtual {p0}, Lcvc;->f()Ljava/util/List;

    move-result-object p2

    iput-object p0, v0, Ldre;->o:Lcvc;

    iput-object p1, v0, Ldre;->X:Lbn5;

    iput v3, v0, Ldre;->o0:I
    ...
    :goto_2
    iput-object p1, v0, Ldre;->o:Lcvc;

    iput-object p0, v0, Ldre;->X:Lbn5;

    iput v2, v0, Ldre;->o0:I
...
.method public f()Ljava/util/List;
    ...
    iget-object v0, v0, Lcvc;->b:Ljava/lang/Object;
    ...
    sget v4, Lfyb;->oneme_settings_dump_threads:I
    ...
    filled-new-array {v1}, [Lo54;

    move-result-object v1

    invoke-static {v1}, Lq43;->f0([Ljava/lang/Object;)Ljava/util/ArrayList;
    ...
    invoke-static {v2}, Lsre;->i(Ljava/util/Map;)Ljava/util/Map;

    move-result-object v3

    sget-object v4, Lcre;->a:Ln25;
    ...
    iget-object v6, v0, Lfre;->e:Ljava/util/EnumMap;

    new-instance v8, Lv6c;

    const/16 v9, 0x18

    invoke-direct {v8, v9}, Lv6c;-><init>(I)V
    ...
    iget-wide v9, v6, Lji4;->a:J

    sget v6, Lfyb;->oneme_settings_thread_state_count:I
    ...
    invoke-direct {v11, v6, v5}, Ljoe;-><init>(ILjava/util/List;)V
    ...
    iget-wide v10, v0, Lfre;->b:J

    sget v4, Lfyb;->oneme_settings_thread_state_count:I
    ...
    invoke-direct {v12, v4, v3}, Ljoe;-><init>(ILjava/util/List;)V
    ...
    invoke-direct/range {v9 .. v16}, Lo54;-><init>(JLmoe;ILmoe;Lus;I)V
    ...
    invoke-static {v4, v5, v7}, Lr8e;->w0(Ljava/lang/String;Ljava/lang/String;Z)Z
    ...
    sget v2, Lfyb;->oneme_settings_thread_tracer:I
    ...
    invoke-direct {v11, v2, v3}, Ljoe;-><init>(ILjava/util/List;)V
    ...
    iget-wide v10, v0, Lfre;->d:J

    sget v0, Lfyb;->oneme_settings_thread_viewer_state:I
    ...
    invoke-direct {v12, v0, v2}, Ljoe;-><init>(ILjava/util/List;)V
