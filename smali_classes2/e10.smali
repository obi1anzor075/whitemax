...
.method public a()V
    ...
    iget-object v1, v0, Lc55;->a:Ljava/util/concurrent/ExecutorService;
    ...
    invoke-virtual {v0}, Lc55;->g()J

    move-result-wide v1

    iget-wide v3, p0, Le10;->a:J

    invoke-static {v1, v2, v3, v4}, Lc55;->c(JJ)J
    ...
    invoke-virtual {v0, p0}, Lc55;->execute(Ljava/lang/Runnable;)V
    :try_end_0
    ...
    sget-wide v4, Lat4;->b:J

    iput-wide v4, p0, Le10;->b:J

    iget-object p0, v0, Lc55;->b:Lz8a;

    iget-object v1, v0, Lc55;->Y:Lov7;

    iget-object v0, v0, Lc55;->Z:Ljava/util/concurrent/locks/ReentrantReadWriteLock;
    ...
    :cond_2
    iget-object v1, v1, Lov7;->d:[Ljava/lang/Object;
