...
# direct methods
.method public constructor <init>(Lcs9;Lorg/webrtc/CameraVideoCapturer;Libe;Ljava/util/ArrayList;Ljava/util/ArrayList;ZLxwb;)V
    .locals 4
    ...
    iput-object v0, p0, Lat1;->a:Ljava/util/ArrayList;

    new-instance v1, Ljava/util/ArrayList;

    invoke-direct {v1}, Ljava/util/ArrayList;-><init>()V

    iput-object v1, p0, Lat1;->b:Ljava/util/ArrayList;

    new-instance v2, Ljava/util/concurrent/CopyOnWriteArraySet;

    invoke-direct {v2}, Ljava/util/concurrent/CopyOnWriteArraySet;-><init>()V

    iput-object v2, p0, Lat1;->f:Ljava/util/concurrent/CopyOnWriteArraySet;

    new-instance v2, Ljava/lang/Object;

    invoke-direct {v2}, Ljava/lang/Object;-><init>()V

    iput-object v2, p0, Lat1;->g:Ljava/lang/Object;

    const/4 v2, 0x0

    iput-object v2, p0, Lat1;->h:Ljava/lang/String;

    iput-object p7, p0, Lat1;->e:Lxwb;

    check-cast p1, Ln54;

    new-instance p7, Lea6;

    new-instance v2, Lvka;

    new-instance v3, Lxu1;

    iget-object p1, p1, Ln54;->a:Lxwb;

    invoke-direct {v3, p1}, Lxu1;-><init>(Lxwb;)V

    invoke-direct {v2, p2, v3, p1}, Lvka;-><init>(Lorg/webrtc/CameraVideoCapturer;Lxu1;Lxwb;)V

    const/16 p1, 0x16

    invoke-direct {p7, p1, v2}, Lea6;-><init>(ILjava/lang/Object;)V

    iput-object p7, p0, Lat1;->c:Lea6;

    iput-object p3, p0, Lat1;->d:Libe;

    invoke-virtual {v0, p4}, Ljava/util/ArrayList;->addAll(Ljava/util/Collection;)Z

    invoke-virtual {v1, p5}, Ljava/util/ArrayList;->addAll(Ljava/util/Collection;)Z

    iput-boolean p6, p0, Lat1;->i:Z
...
.method public final a()V
    ...
    :try_start_0
    iget-boolean v1, p0, Lat1;->i:Z

    if-eqz v1, :cond_0

    iget-object v2, p0, Lat1;->a:Ljava/util/ArrayList;
    ...
    :cond_0
    iget-object v2, p0, Lat1;->b:Ljava/util/ArrayList;
    ...
    invoke-interface {v0, v3, v4}, Lxwb;->log(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v6, v7, v8, v2, v9}, Lth2;->l(Ljava/lang/StringBuilder;ILjava/lang/String;ILjava/lang/String;)V
    ...
    invoke-interface {v5, v6, v2}, Lxwb;->log(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v6, v4, v3, v7}, Lme4;->g(Ljava/lang/String;IILjava/lang/String;)Ljava/lang/String;

    move-result-object v4

    iget-object v6, p0, Lat1;->e:Lxwb;

    new-instance v7, Ljava/lang/IllegalArgumentException;

    invoke-direct {v7, v4}, Ljava/lang/IllegalArgumentException;-><init>(Ljava/lang/String;)V

    invoke-interface {v6, v5, v4, v7}, Lxwb;->reportException(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    :cond_b
    iget-object v4, p0, Lat1;->e:Lxwb;
    ...
    invoke-static {v6, v2, v7, v0, v8}, Lrf0;->i(Ljava/lang/String;ILjava/lang/String;ILjava/lang/String;)Ljava/lang/StringBuilder;
    ...
    invoke-interface {v4, v5, v6}, Lxwb;->log(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v4, p0, Lat1;->f:Ljava/util/concurrent/CopyOnWriteArraySet;
    ...
    iget-object v8, v6, Ljl7;->r:Lat1;

    if-eq p0, v8, :cond_d

    iget-object v8, v6, Ljl7;->n:Lxwb;
    ...
    invoke-interface {v8, v10, v11, v9}, Lxwb;->reportException(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    :cond_d
    iget-object v6, v6, Ljl7;->y:Lz7f;

    iget-object v8, v6, Lcf3;->c:Ljava/lang/Object;

    check-cast v8, Lxwb;

    const-string v9, "Camera capture dimensions were changed to "

    invoke-static {v9, v2, v0, v7}, Lme4;->g(Ljava/lang/String;IILjava/lang/String;)Ljava/lang/String;

    move-result-object v9

    const-string v10, "VideoRecord"

    invoke-interface {v8, v10, v9}, Lxwb;->log(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v8, v6, Lz7f;->z0:Lorg/webrtc/Size;
    ...
    invoke-virtual {v6}, Lz7f;->u()V

    goto :goto_6

    :cond_e
    iget-boolean v4, p0, Lat1;->k:Z
    ...
    invoke-interface {v0, v3, v2}, Lxwb;->log(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-interface {p0, v3, v0}, Lxwb;->log(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-interface {p0, v3, v1, v0}, Lxwb;->reportException(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public final b()V
    ...
    invoke-interface {p0, v2, v0}, Lxwb;->log(Ljava/lang/String;Ljava/lang/String;)V
