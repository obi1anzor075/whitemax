...
.method public constructor <init>(Lje7;Lje7;)V
    ...
    iput-object p1, p0, Lie0;->a:Lje7;

    iput-object p2, p0, Lie0;->b:Lje7;

    return-void
.end method

.method public static final a(Lie0;[BLhbf;)Lvee;
    .locals 2
    ...
    invoke-direct {p0, v0, p1, v1}, Lvee;-><init>(Ljava/lang/String;II)V

    iget p1, p2, Lhbf;->d:I

    invoke-virtual {p0, p1}, Lvee;->setAlpha(I)V

    new-instance p1, Landroid/graphics/PorterDuffXfermode;

    iget-boolean v0, p2, Lhbf;->e:Z
    ...
    iget-object v0, p0, Lvee;->a:Ltre;

    iget-object v0, v0, Ltre;->g:Landroid/graphics/Paint;

    invoke-virtual {v0, p1}, Landroid/graphics/Paint;->setXfermode(Landroid/graphics/Xfermode;)Landroid/graphics/Xfermode;

    iget p1, p2, Lhbf;->f:I

    sget-object p2, Lbp0;->a:Lbp0;

    invoke-static {p2}, Lcp0;->a(Lbp0;)Ljava/lang/Object;

    move-result-object p2

    if-eqz p2, :cond_1

    invoke-static {p1, p2}, Lap0;->a(ILjava/lang/Object;)Landroid/graphics/ColorFilter;
    ...
    :goto_1
    invoke-virtual {p0, p1}, Lvee;->setColorFilter(Landroid/graphics/ColorFilter;)V
...
.method public static b(Lorg/json/JSONArray;[I)Ljava/util/ArrayList;
    ...
    invoke-static {v9, v10}, Lp54;->i(II)V
    ...
    invoke-direct/range {v11 .. v18}, Lgbf;-><init>(FFFFF[F[I)V
...
# virtual methods
.method public final c(Landroid/content/Context;Lre0;)Ljava/util/LinkedHashMap;
    .locals 43
    ...
    :try_start_3
    sget-object v5, Lu42;->a:Ljava/nio/charset/Charset;
    ...
    sget-object v20, Lge0;->o:Ln25;

    invoke-virtual/range {v20 .. v20}, Ly1;->iterator()Ljava/util/Iterator;
    ...
    invoke-virtual/range {v21 .. v21}, Lv1;->hasNext()Z

    move-result v22

    if-eqz v22, :cond_f

    invoke-virtual/range {v21 .. v21}, Lv1;->next()Ljava/lang/Object;
    ...
    invoke-direct {v7, v1}, Lre0;-><init>(Ljava/lang/String;)V

    invoke-virtual {v14, v0}, Lap9;->g(Landroid/content/Context;)Lqp4;
    ...
    iget-object v1, v1, Lhjc;->o:Ljava/lang/Object;
    ...
    :goto_2
    invoke-static {v6, v5}, Lxq7;->d(Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    iget-boolean v1, v3, Lge0;->b:Z

    invoke-virtual {v4, v1}, Lk9a;->a(Z)Lyha;
    ...
    :try_start_7
    invoke-virtual {v2, v7}, Lre0;->equals(Ljava/lang/Object;)Z
    ...
    invoke-static {v15, v13}, Lvk9;->m(Lorg/json/JSONObject;Ljava/lang/String;)Ljava/lang/Boolean;
    ...
    invoke-direct/range {v29 .. v35}, Lhbf;-><init>(Ljava/lang/String;IIIZI)V
    ...
    invoke-direct {v15, v5, v6}, Lfbf;-><init>([IF)V
    ...
    invoke-static {v4, v5}, Lie0;->b(Lorg/json/JSONArray;[I)Ljava/util/ArrayList;
    ...
    invoke-static {v12, v1}, Lie0;->b(Lorg/json/JSONArray;[I)Ljava/util/ArrayList;
    ...
    invoke-static {v13, v1}, Lxq7;->d(Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    :goto_10
    :try_start_c
    new-instance v29, Libf;

    invoke-direct/range {v29 .. v34}, Libf;-><init>(Lhbf;Lfbf;Ljava/util/ArrayList;Ljava/util/ArrayList;Ljava/lang/Integer;)V
    :try_end_c
    ...
    sget-object v12, Lu42;->a:Ljava/nio/charset/Charset;
    ...
    invoke-direct {v13, v7}, Lre0;-><init>(Ljava/lang/String;)V

    if-eqz v2, :cond_15

    invoke-virtual {v2, v13}, Lre0;->equals(Ljava/lang/Object;)Z
    ...
    iget-object v7, v7, Lqp4;->X:Ljava/lang/Object;

    check-cast v7, Lhjc;

    iget-object v7, v7, Lhjc;->o:Ljava/lang/Object;
    ...
    iget-object v2, v13, Lre0;->a:Ljava/lang/String;
    ...
    invoke-static {v2, v7, v8}, Lj8e;->x0(Ljava/lang/CharSequence;Ljava/lang/CharSequence;Z)Z

    move-result v2

    invoke-virtual {v0, v2}, Lk9a;->a(Z)Lyha;
    ...
    invoke-direct/range {v26 .. v32}, Lhbf;-><init>(Ljava/lang/String;IIIZI)V
    ...
    invoke-static {v0}, Lp43;->V0(Ljava/util/List;)[I
    ...
    invoke-direct {v2, v0, v7}, Lfbf;-><init>([IF)V
    ...
    invoke-direct/range {v22 .. v27}, Libf;-><init>(Lhbf;Lfbf;Ljava/util/ArrayList;Ljava/util/ArrayList;Ljava/lang/Integer;)V
...
.method public final d(Landroid/content/Context;Lhbf;Lqde;)Ljava/lang/Object;
    .locals 3

    iget-object v0, p0, Lie0;->a:Lje7;
    ...
    invoke-direct {v1, p0, p1, p2, v2}, Lhe0;-><init>(Lie0;Landroid/content/Context;Lhbf;Lkotlin/coroutines/Continuation;)V
