...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lx41;->e:Ljava/util/List;

    return-void
.end method

.method public constructor <init>(Lru/ok/android/externcalls/analytics/CallAnalyticsSender;Lfje;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lx41;->a:Lru/ok/android/externcalls/analytics/CallAnalyticsSender;

    iput-object p2, p0, Lx41;->b:Leje;

    new-instance p1, Ljava/util/ArrayList;

    invoke-direct {p1}, Ljava/util/ArrayList;-><init>()V

    iput-object p1, p0, Lx41;->d:Ljava/util/ArrayList;
...
# virtual methods
.method public final b(Lswf;Lru/ok/android/externcalls/analytics/events/EventItemsMap;)V
    .locals 4

    iget-object v0, p1, Lswf;->c:Lru/ok/android/externcalls/analytics/events/EventItemsMap;
    ...
    iget-object p2, p1, Lswf;->d:Ljava/lang/Long;
    ...
    iget-object p1, p1, Lswf;->b:Lru/ok/android/externcalls/analytics/events/EventItemValue;
    ...
    iget-object p0, p0, Lx41;->a:Lru/ok/android/externcalls/analytics/CallAnalyticsSender;
...
.method public final c(Ljava/lang/String;Lru/ok/android/externcalls/analytics/events/EventItemValue;Lru/ok/android/externcalls/analytics/events/EventItemsMap;)V
    ...
    invoke-direct {v0, p1, p2, p3, v1}, Lswf;-><init>(Ljava/lang/String;Lru/ok/android/externcalls/analytics/events/EventItemValue;Lru/ok/android/externcalls/analytics/events/EventItemsMap;Ljava/lang/Long;)V

    iget-object p1, p0, Lx41;->c:Lru/ok/android/externcalls/analytics/events/EventItemsMap;

    if-nez p1, :cond_0

    iget-object p0, p0, Lx41;->d:Ljava/util/ArrayList;
    ...
    :cond_0
    invoke-virtual {p0, v0, p1}, Lx41;->b(Lswf;Lru/ok/android/externcalls/analytics/events/EventItemsMap;)V
