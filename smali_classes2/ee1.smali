...
# direct methods
.method public constructor <init>(Ls1c;Lorg/webrtc/EglBase$Context;[ILjava/lang/String;)V
    .locals 11

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lee1;->a:Ls1c;

    iput-object p2, p0, Lee1;->b:Lorg/webrtc/EglBase$Context;

    const-string v1, "CallOpenGL_renderer_"

    move-object v8, p4

    invoke-static {v1, p4}, Lpg0;->g(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v1

    iput-object v1, p0, Lee1;->d:Ljava/lang/String;
    ...
    invoke-direct/range {v1 .. v6}, Lce1;-><init>(Ls1c;Landroid/opengl/EGLContext;[ILtl8;Ljava/lang/String;)V

    iput-object v1, p0, Lee1;->e:Lce1;

    new-instance v0, Landroid/graphics/Matrix;

    invoke-direct {v0}, Landroid/graphics/Matrix;-><init>()V

    iput-object v0, p0, Lee1;->f:Landroid/graphics/Matrix;

    new-instance v0, Lorg/webrtc/VideoFrameDrawer;

    invoke-direct {v0}, Lorg/webrtc/VideoFrameDrawer;-><init>()V

    iput-object v0, p0, Lee1;->g:Lorg/webrtc/VideoFrameDrawer;

    new-instance v0, Lorg/webrtc/GlRectDrawer;

    invoke-direct {v0}, Lorg/webrtc/GlRectDrawer;-><init>()V

    iput-object v0, p0, Lee1;->h:Lorg/webrtc/GlRectDrawer;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lee1;->i:Ljava/util/ArrayList;

    new-instance v2, Lje;

    const/4 v0, 0x6

    invoke-direct {v2, v0, p0}, Lje;-><init>(ILjava/lang/Object;)V
    ...
    iget-object v1, v1, Lce1;->a:Ls1c;

    invoke-interface {v1, v3, v4, v0}, Ls1c;->reportException(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    :goto_0
    iput-object v2, p0, Lee1;->c:Lje;
...
.method public final a()V
    ...
    iget-object p0, p0, Lee1;->e:Lce1;

    iget-object v0, p0, Lce1;->a:Ls1c;

    iget-object v1, p0, Lce1;->j:Ljava/lang/String;
    ...
    iget-object v1, p0, Lce1;->h:Ljava/lang/Object;

    monitor-enter v1

    :try_start_0
    iget-boolean v2, p0, Lce1;->i:Z

    if-nez v2, :cond_0

    iget-object v2, p0, Lce1;->a:Ls1c;

    iget-object p0, p0, Lce1;->j:Ljava/lang/String;

    const-string v3, "Already released, ignore"

    invoke-interface {v2, p0, v3}, Ls1c;->log(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :try_start_1
    iput-boolean v2, p0, Lce1;->i:Z
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0

    monitor-exit v1

    iget-object v1, p0, Lce1;->k:Llcg;
    ...
    iget-object v1, p0, Lce1;->a:Ls1c;

    iget-object p0, p0, Lce1;->j:Ljava/lang/String;

    const-string v2, "Release action submitted"

    invoke-interface {v1, p0, v2}, Ls1c;->log(Ljava/lang/String;Ljava/lang/String;)V
...
.method public final b(Lce1;Lap1;Lorg/webrtc/VideoFrame;Lih1;)V
    .locals 16
    ...
    iget-object v4, v2, Lde1;->a:Landroid/opengl/EGLSurface;
    ...
    invoke-virtual {v1, v4}, Lce1;->b(Landroid/opengl/EGLSurface;)V

    const-string v7, "makeCurrent()"

    invoke-static {v7}, Lce1;->a(Ljava/lang/String;)V
    ...
    iget-object v11, v0, Lee1;->f:Landroid/graphics/Matrix;
    ...
    iget-object v3, v2, Lap1;->k:Lorg/webrtc/RendererCommon$GlDrawer;

    if-nez v3, :cond_3

    iget-object v3, v0, Lee1;->h:Lorg/webrtc/GlRectDrawer;

    :cond_3
    move-object v10, v3

    iget-object v3, v1, Lce1;->e:Landroid/opengl/EGLDisplay;
    ...
    iget-object v8, v0, Lee1;->g:Lorg/webrtc/VideoFrameDrawer;
    ...
    invoke-static {v0}, Lce1;->a(Ljava/lang/String;)V

    invoke-static {}, Ljava/lang/System;->nanoTime()J

    move-result-wide v7

    iget-object v0, v1, Lce1;->e:Landroid/opengl/EGLDisplay;
    ...
    iget-object v1, v2, Lap1;->l:Lbp1;

    sub-long v5, v3, v5

    sub-long/2addr v3, v7

    iget-wide v7, v1, Lbp1;->h:J

    add-long/2addr v7, v5

    iput-wide v7, v1, Lbp1;->h:J

    iget-wide v5, v1, Lbp1;->i:J

    add-long/2addr v5, v3

    iput-wide v5, v1, Lbp1;->i:J
