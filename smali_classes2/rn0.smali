...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lrn0;->x:Ljava/util/concurrent/ConcurrentHashMap;
...
.method public constructor <init>(Ljava/io/File;Lpn0;Lon0;IIZ)V
    .locals 14
    ...
    iput-object v3, v1, Lrn0;->d:Ljava/util/concurrent/atomic/AtomicInteger;

    new-instance v3, Ljava/util/ArrayList;

    invoke-direct {v3}, Ljava/util/ArrayList;-><init>()V

    iput-object v3, v1, Lrn0;->e:Ljava/util/ArrayList;

    new-instance v5, Ljava/lang/Object;

    invoke-direct {v5}, Ljava/lang/Object;-><init>()V

    iput-object v5, v1, Lrn0;->h:Ljava/lang/Object;

    new-instance v5, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {v5, v4}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>(Z)V

    iput-object v5, v1, Lrn0;->o:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iput-object v5, v1, Lrn0;->p:Lre;

    move-object/from16 v5, p2

    iput-object v5, v1, Lrn0;->a:Lpn0;
    ...
    sget-object v6, Lrn0;->A:Ljava/util/concurrent/ThreadPoolExecutor;
    ...
    sput-object v6, Lrn0;->A:Ljava/util/concurrent/ThreadPoolExecutor;

    :cond_0
    new-instance v6, Ljava/io/File;

    sget-object v7, Lez3;->e:Leg9;

    iget-object v7, v7, Leg9;->c:Lx3a;

    invoke-virtual {v7}, Lx3a;->v()Ljava/io/File;
    ...
    invoke-static {v9, v5, v10}, Lwn6;->l(Ljava/lang/StringBuilder;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v5

    invoke-direct {v7, v6, v5}, Ljava/io/File;-><init>(Ljava/io/File;Ljava/lang/String;)V

    iput-object v7, v1, Lrn0;->m:Ljava/io/File;

    const/high16 v5, 0x42700000    # 60.0f

    invoke-static {v5}, Lje;->a(F)I
    ...
    :goto_1
    iput-boolean v0, v1, Lrn0;->f:Z

    sget-object v0, Lez3;->e:Leg9;

    iget-object v0, v0, Leg9;->g:Ls16;
    ...
    iput-boolean v0, v1, Lrn0;->k:Z

    iget-boolean v0, v1, Lrn0;->k:Z
    ...
    iput-boolean v0, v1, Lrn0;->s:Z

    iget-boolean v0, v1, Lrn0;->s:Z
    ...
    :cond_4
    invoke-virtual {p0, v5, v0}, Lrn0;->d(Ljava/io/RandomAccessFile;I)V
    ...
    iput-boolean v4, v1, Lrn0;->s:Z

    iput-boolean v4, v1, Lrn0;->k:Z

    iput-boolean v8, v1, Lrn0;->q:Z
    ...
    :cond_5
    iget-object v0, v1, Lrn0;->u:Ljava/io/RandomAccessFile;

    if-eq v0, v5, :cond_6

    invoke-virtual {p0}, Lrn0;->a()V

    :cond_6
    iput-object v5, v1, Lrn0;->u:Ljava/io/RandomAccessFile;
    :try_end_1
    ...
    iget-object v0, v1, Lrn0;->m:Ljava/io/File;
...
.method public final a()V
    ...
    iget-object p0, p0, Lrn0;->u:Ljava/io/RandomAccessFile;
...
.method public final b()V
    ...
    :try_start_0
    iget-object v0, v11, Lrn0;->m:Ljava/io/File;
    ...
    iget-object v2, v11, Lrn0;->m:Ljava/io/File;
    ...
    iput-boolean v0, v11, Lrn0;->s:Z

    iget-boolean v0, v11, Lrn0;->s:Z

    if-eqz v0, :cond_4

    iget-object v0, v11, Lrn0;->e:Ljava/util/ArrayList;
    ...
    invoke-virtual {v11, v1, v0}, Lrn0;->d(Ljava/io/RandomAccessFile;I)V

    invoke-virtual {v1, v9, v10}, Ljava/io/RandomAccessFile;->seek(J)V

    iget-object v0, v11, Lrn0;->u:Ljava/io/RandomAccessFile;

    if-eq v0, v1, :cond_1

    invoke-virtual/range {p0 .. p0}, Lrn0;->a()V
    ...
    :cond_1
    :goto_0
    iput-object v1, v11, Lrn0;->u:Ljava/io/RandomAccessFile;

    iput-boolean v14, v11, Lrn0;->k:Z

    iput-boolean v14, v11, Lrn0;->q:Z
    :try_end_2
    ...
    :cond_2
    :goto_1
    iget-object v0, v11, Lrn0;->a:Lpn0;

    invoke-interface {v0}, Lpn0;->releaseForGenerateCache()V
    ...
    :cond_3
    :try_start_5
    iput-boolean v13, v11, Lrn0;->k:Z

    iput-boolean v13, v11, Lrn0;->s:Z
    ...
    :goto_2
    :try_start_8
    iget-object v1, v11, Lrn0;->m:Ljava/io/File;
    ...
    :catchall_4
    :try_start_9
    iget-object v1, v11, Lrn0;->u:Ljava/io/RandomAccessFile;
    :try_end_9
    ...
    sput-object v0, Lrn0;->C:Ljn;

    :cond_7
    sget-object v0, Lrn0;->C:Ljn;

    iget v1, v11, Lrn0;->c:I

    iget v2, v11, Lrn0;->b:I

    invoke-virtual {v0, v1, v2}, Ljn;->f(II)V
    ...
    invoke-interface {v0}, Lpn0;->prepareForGenerateCache()V
    ...
    :cond_8
    :goto_5
    iget-object v0, v11, Lrn0;->o:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    invoke-interface {v0, v1}, Lpn0;->getNextFrame(Landroid/graphics/Bitmap;)I
    ...
    invoke-virtual {v2, v1}, Lls6;->d(I)V
    ...
    invoke-virtual {v3, v4}, Lls6;->d(I)V
    ...
    iput-object v0, v11, Lrn0;->u:Ljava/io/RandomAccessFile;

    iput-boolean v14, v11, Lrn0;->s:Z
    ...
    sget-object v0, Lrn0;->A:Ljava/util/concurrent/ThreadPoolExecutor;
    ...
    invoke-direct/range {v1 .. v10}, Lnn0;-><init>(Lrn0;Ljava/util/concurrent/atomic/AtomicBoolean;[Landroid/graphics/Bitmap;I[Lls6;ILjava/io/RandomAccessFile;Ljava/util/ArrayList;[Ljava/util/concurrent/CountDownLatch;)V
    ...
    :goto_a
    iget-object v0, v11, Lrn0;->d:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    :goto_11
    iget-object v1, v11, Lrn0;->a:Lpn0;

    invoke-interface {v1}, Lpn0;->releaseForGenerateCache()V
...
.method public final d(Ljava/io/RandomAccessFile;I)V
    ...
    iget-object v2, p0, Lrn0;->e:Ljava/util/ArrayList;
...
.method public final e(Lqn0;)[B
    ...
    sget-object v2, Lrn0;->x:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    sget-object p1, Lrn0;->x:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    sget-boolean p1, Lrn0;->y:Z

    if-nez p1, :cond_4

    sput-boolean v1, Lrn0;->y:Z

    iget-object p0, p0, Lrn0;->p:Lre;

    const-wide/16 v0, 0x1388

    invoke-static {p0, v0, v1}, Lje;->e(Ljava/lang/Runnable;J)V

    goto :goto_2

    :cond_3
    iput-object v2, p0, Lrn0;->g:[B
...
.method public final f(Landroid/graphics/Bitmap;I)I
    ...
    :try_start_0
    iget-boolean v3, p0, Lrn0;->s:Z

    if-nez v3, :cond_1

    iget-boolean v3, p0, Lrn0;->k:Z
    ...
    iget-object v3, p0, Lrn0;->u:Ljava/io/RandomAccessFile;
    ...
    iget-object v5, p0, Lrn0;->m:Ljava/io/File;
    ...
    iput-boolean v5, p0, Lrn0;->s:Z

    iget-boolean v5, p0, Lrn0;->s:Z

    if-eqz v5, :cond_3

    iget-object v5, p0, Lrn0;->e:Ljava/util/ArrayList;
    ...
    invoke-virtual {p0, v3, v5}, Lrn0;->d(Ljava/io/RandomAccessFile;I)V
    ...
    iput-boolean v4, p0, Lrn0;->s:Z

    iput-boolean v2, p0, Lrn0;->q:Z
    ...
    invoke-virtual {p0, p2}, Lrn0;->e(Lqn0;)[B
    ...
    iget-boolean v6, p0, Lrn0;->t:Z

    if-nez v6, :cond_8

    iget-object v6, p0, Lrn0;->u:Ljava/io/RandomAccessFile;
    ...
    :cond_7
    iput-object v3, p0, Lrn0;->u:Ljava/io/RandomAccessFile;

    goto :goto_1

    :cond_8
    iput-object v0, p0, Lrn0;->u:Ljava/io/RandomAccessFile;

    invoke-virtual {v3}, Ljava/io/RandomAccessFile;->close()V

    :goto_1
    iget-object v6, p0, Lrn0;->v:Landroid/graphics/BitmapFactory$Options;
    ...
    iput-object v6, p0, Lrn0;->v:Landroid/graphics/BitmapFactory$Options;
    ...
    iget-object p1, p0, Lrn0;->v:Landroid/graphics/BitmapFactory$Options;
    ...
    iput-boolean v2, p0, Lrn0;->j:Z

    :catch_1
    :cond_a
    :goto_3
    iget-boolean p0, p0, Lrn0;->j:Z
...
.method public final g()Z
    ...
    iget-boolean v0, p0, Lrn0;->s:Z

    if-eqz v0, :cond_1

    iget-boolean p0, p0, Lrn0;->k:Z
