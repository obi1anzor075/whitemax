...
# direct methods
.method public constructor <init>(Landroid/content/Context;Lx56;)V
    .locals 1
    ...
    iput-object p1, p0, Los6;->b:Landroid/graphics/drawable/Drawable;

    new-instance p1, Landroid/graphics/Rect;

    invoke-direct {p1}, Landroid/graphics/Rect;-><init>()V

    iput-object p1, p0, Los6;->o:Landroid/graphics/Rect;

    const/4 p1, 0x3

    iput p1, p0, Los6;->o0:I

    const p1, 0x3f666666    # 0.9f

    iput p1, p0, Los6;->p0:F
    ...
    iput-object p1, p0, Los6;->q0:Landroid/graphics/Paint;

    new-instance p1, Landroid/graphics/Matrix;

    invoke-direct {p1}, Landroid/graphics/Matrix;-><init>()V

    iput-object p1, p0, Los6;->r0:Landroid/graphics/Matrix;

    const/4 p1, 0x0

    const/high16 p2, 0x3f400000    # 0.75f

    invoke-static {p1, p2}, Ln1c;->D(IF)I
...
# virtual methods
.method public final a(Landroid/graphics/Canvas;FFFILms6;)V
    .locals 13
    ...
    sget-object v9, Lms6;->o:Lms6;

    if-eq v2, v9, :cond_1

    iget-object v10, v2, Lms6;->a:Ljava/util/List;
    ...
    :goto_1
    invoke-interface {v8, v5}, Lx56;->invoke(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object v7, p0, Los6;->o:Landroid/graphics/Rect;

    invoke-virtual {v7, v6, v8, v9, v5}, Landroid/graphics/Rect;->set(IIII)V

    iget-object v5, p0, Los6;->b:Landroid/graphics/drawable/Drawable;
    ...
    :cond_7
    sget-object v4, Lns6;->$EnumSwitchMapping$0:[I
    ...
    invoke-virtual/range {v0 .. v6}, Los6;->a(Landroid/graphics/Canvas;FFFILms6;)V

    sget-object v6, Lms6;->c:Lms6;
...
.method public final onDraw(Landroid/graphics/Canvas;)V
    ...
    iget-object v6, p0, Los6;->s0:[I

    invoke-direct/range {v2 .. v8}, Landroid/graphics/RadialGradient;-><init>(FFF[I[FLandroid/graphics/Shader$TileMode;)V

    iget-object v0, p0, Los6;->r0:Landroid/graphics/Matrix;
    ...
    iget-object v11, p0, Los6;->q0:Landroid/graphics/Paint;
    ...
    sget-object v8, Lms6;->o:Lms6;

    move-object v2, p0

    invoke-virtual/range {v2 .. v8}, Los6;->a(Landroid/graphics/Canvas;FFFILms6;)V
