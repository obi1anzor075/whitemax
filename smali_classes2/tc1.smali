...
# direct methods
.method public constructor <init>(Lxwb;Lorg/webrtc/EglBase$Context;[ILjava/lang/String;)V
    .locals 15
    ...
    iput-object v10, v9, Ltc1;->a:Lxwb;

    iput-object v0, v9, Ltc1;->b:Lorg/webrtc/EglBase$Context;

    const-string v1, "CallOpenGL_renderer_"

    move-object/from16 v11, p4

    invoke-static {v1, v11}, Lrf0;->h(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v1

    iput-object v1, v9, Ltc1;->d:Ljava/lang/String;
    ...
    invoke-direct/range {v0 .. v5}, Lrc1;-><init>(Lxwb;Landroid/opengl/EGLContext;[ILh87;Ljava/lang/String;)V

    iput-object v12, v9, Ltc1;->e:Lrc1;

    new-instance v0, Landroid/graphics/Matrix;

    invoke-direct {v0}, Landroid/graphics/Matrix;-><init>()V

    iput-object v0, v9, Ltc1;->f:Landroid/graphics/Matrix;

    new-instance v0, Lorg/webrtc/VideoFrameDrawer;

    invoke-direct {v0}, Lorg/webrtc/VideoFrameDrawer;-><init>()V

    iput-object v0, v9, Ltc1;->g:Lorg/webrtc/VideoFrameDrawer;

    new-instance v0, Lorg/webrtc/GlRectDrawer;

    invoke-direct {v0}, Lorg/webrtc/GlRectDrawer;-><init>()V

    iput-object v0, v9, Ltc1;->h:Lorg/webrtc/GlRectDrawer;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, v9, Ltc1;->i:Ljava/util/ArrayList;
    ...
    :try_start_0
    iget-object v0, v12, Lrc1;->k:Lbxf;
    ...
    iget-object v2, v12, Lrc1;->j:Ljava/lang/String;

    const-string v3, "OpenGL tread died, is it fine?"

    iget-object v4, v12, Lrc1;->a:Lxwb;

    invoke-interface {v4, v2, v3, v0}, Lxwb;->reportException(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    :goto_0
    iput-object v1, v9, Ltc1;->c:Lre;
...
.method public final a()V
    ...
    iget-object p0, p0, Ltc1;->e:Lrc1;

    iget-object v0, p0, Lrc1;->a:Lxwb;

    iget-object v1, p0, Lrc1;->j:Ljava/lang/String;
    ...
    iget-object v1, p0, Lrc1;->h:Ljava/lang/Object;

    monitor-enter v1

    :try_start_0
    iget-boolean v2, p0, Lrc1;->i:Z

    if-nez v2, :cond_0

    iget-object v2, p0, Lrc1;->a:Lxwb;

    iget-object p0, p0, Lrc1;->j:Ljava/lang/String;

    const-string v3, "Already released, ignore"

    invoke-interface {v2, p0, v3}, Lxwb;->log(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :try_start_1
    iput-boolean v2, p0, Lrc1;->i:Z
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0

    monitor-exit v1

    iget-object v1, p0, Lrc1;->k:Lbxf;
    ...
    iget-object v1, p0, Lrc1;->a:Lxwb;

    iget-object p0, p0, Lrc1;->j:Ljava/lang/String;

    const-string v2, "Release action submitted"

    invoke-interface {v1, p0, v2}, Lxwb;->log(Ljava/lang/String;Ljava/lang/String;)V
...
.method public final b(Lrc1;Lum1;Lorg/webrtc/VideoFrame;Lxf1;)V
    .locals 16
    ...
    iget-object v4, v2, Lsc1;->a:Landroid/opengl/EGLSurface;
    ...
    invoke-virtual {v1, v4}, Lrc1;->b(Landroid/opengl/EGLSurface;)V

    const-string v7, "makeCurrent()"

    invoke-static {v7}, Lrc1;->a(Ljava/lang/String;)V
    ...
    iget-object v11, v0, Ltc1;->f:Landroid/graphics/Matrix;
    ...
    iget-object v3, v2, Lum1;->k:Lorg/webrtc/RendererCommon$GlDrawer;

    if-nez v3, :cond_3

    iget-object v3, v0, Ltc1;->h:Lorg/webrtc/GlRectDrawer;

    :cond_3
    move-object v10, v3

    iget-object v3, v1, Lrc1;->e:Landroid/opengl/EGLDisplay;
    ...
    iget-object v8, v0, Ltc1;->g:Lorg/webrtc/VideoFrameDrawer;
    ...
    invoke-static {v0}, Lrc1;->a(Ljava/lang/String;)V

    invoke-static {}, Ljava/lang/System;->nanoTime()J

    move-result-wide v7

    iget-object v0, v1, Lrc1;->e:Landroid/opengl/EGLDisplay;
    ...
    iget-object v1, v2, Lum1;->l:Lvm1;

    iget-wide v7, v1, Lvm1;->h:J

    add-long/2addr v7, v5

    iput-wide v7, v1, Lvm1;->h:J

    iget-wide v5, v1, Lvm1;->i:J

    add-long/2addr v5, v3

    iput-wide v5, v1, Lvm1;->i:J
