...
.method static constructor <clinit>()V
    ...
    sput-object v0, Llla;->b:Ljava/util/concurrent/ConcurrentHashMap;

    new-instance v0, Ljava/util/concurrent/ConcurrentHashMap;

    invoke-direct {v0}, Ljava/util/concurrent/ConcurrentHashMap;-><init>()V

    sput-object v0, Llla;->c:Ljava/util/concurrent/ConcurrentHashMap;
...
.method public static b(JJ)V
    ...
    iget-object v1, v0, Ljla;->a:Ljava/util/concurrent/LinkedBlockingDeque;
    ...
    :cond_2
    iget-object p2, v0, Ljla;->a:Ljava/util/concurrent/LinkedBlockingDeque;
    ...
    iget-object p2, v0, Ljla;->b:Ltd7;

    if-eqz p2, :cond_3

    invoke-virtual {p2}, Ltd7;->g()Z

    move-result p3

    if-nez p3, :cond_3

    invoke-static {p2}, Lem4;->a(Ljava/util/concurrent/atomic/AtomicReference;)Z

    :cond_3
    sget-object p2, Llla;->b:Ljava/util/concurrent/ConcurrentHashMap;
...
.method public static c(J)Ljla;
    ...
    sget-object v1, Llla;->b:Ljava/util/concurrent/ConcurrentHashMap;
...
.method public final d(JLq00;)V
    ...
    sget-object v3, Llla;->c:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iget-object v4, v2, Lkla;->b:Lq00;

    if-ne p3, v4, :cond_0

    iget-wide v4, v2, Lkla;->a:J
    ...
    invoke-direct {v2, v0, v1, p3}, Lkla;-><init>(JLq00;)V
...
.method public final declared-synchronized e(J)V
    ...
    :cond_0
    :try_start_0
    invoke-static {p1, p2}, Llla;->c(J)Ljla;

    move-result-object v0

    iget-object v1, v0, Ljla;->b:Ltd7;
    ...
    invoke-direct {v2, p0, p1, p2}, Lhla;-><init>(Llla;J)V

    const v3, 0x7fffffff

    invoke-virtual {v1, v2, v3}, Lvw9;->g(Lm66;I)Lvw9;
    ...
    invoke-direct {v3, p0, p1, p2}, Lhla;-><init>(Llla;J)V

    sget-object p1, Lkhg;->c:Lc76;

    new-instance p2, Ltd7;

    invoke-direct {p2, v2, v3, p1}, Ltd7;-><init>(Ljj3;Ljj3;Lc6;)V

    invoke-virtual {v1, p2}, Lvw9;->a(La0a;)V

    iput-object p2, v0, Ljla;->b:Ltd7;
    :try_end_0
...
.method public final f(JLq00;J)V
    ...
    sget-object p4, Llla;->b:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iget-object p5, p4, Ljla;->a:Ljava/util/concurrent/LinkedBlockingDeque;
    ...
    iget-object p5, p4, Ljla;->b:Ltd7;

    if-eqz p5, :cond_2

    iget-object p4, p4, Ljla;->b:Ltd7;

    invoke-virtual {p4}, Ltd7;->g()Z
    ...
    :cond_2
    :goto_1
    invoke-virtual {p0, p1, p2, p3}, Llla;->d(JLq00;)V
