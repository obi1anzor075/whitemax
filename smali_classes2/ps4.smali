...
.method private getCorrectionMatrix()Landroid/graphics/Matrix;
    ...
    iget-object v0, p0, Lps4;->o:Landroid/graphics/Matrix;

    iget-object v1, p0, Lps4;->z0:[F
...
.method public final draw(Landroid/graphics/Canvas;)V
    ...
    iget-object v0, p0, Lps4;->B0:Landroid/graphics/Rect;
    ...
    :cond_0
    iget-object p0, p0, Lps4;->a:Ljava/util/ArrayList;
    ...
    invoke-interface {v0, p1}, Lis4;->draw(Landroid/graphics/Canvas;)V
...
.method public getResultBounds()Landroid/graphics/Rect;
    ...
    :goto_0
    iget-boolean v1, p0, Lps4;->C0:Z

    if-eqz v1, :cond_2

    iget-object p0, p0, Lps4;->D0:Lns4;
...
.method public final onScale(Landroid/view/ScaleGestureDetector;)Z
    ...
    iget-object v2, p0, Lps4;->o:Landroid/graphics/Matrix;

    invoke-virtual {v2, v0, v0, v1, p1}, Landroid/graphics/Matrix;->postScale(FFFF)Z

    iget-object v0, p0, Lps4;->x0:Ljava/lang/Float;

    if-eqz v0, :cond_0

    iget-object v3, p0, Lps4;->y0:Ljava/lang/Float;
    ...
    :cond_0
    iget-object v0, p0, Lps4;->w0:Landroid/graphics/Matrix;
    ...
    iput-object v0, p0, Lps4;->x0:Ljava/lang/Float;

    invoke-static {p1}, Ljava/lang/Float;->valueOf(F)Ljava/lang/Float;

    move-result-object p1

    iput-object p1, p0, Lps4;->y0:Ljava/lang/Float;
...
.method public final onScaleBegin(Landroid/view/ScaleGestureDetector;)Z
    ...
    invoke-virtual {p1, v0}, Lw9;->a(Lks4;)V
...
.method public final onScaleEnd(Landroid/view/ScaleGestureDetector;)V
    ...
    iput-object p1, p0, Lps4;->x0:Ljava/lang/Float;

    iput-object p1, p0, Lps4;->y0:Ljava/lang/Float;

    invoke-direct {p0}, Lps4;->getCorrectionMatrix()Landroid/graphics/Matrix;
    ...
    invoke-direct/range {v1 .. v6}, Lms4;-><init>(Landroid/view/View;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;I)V
...
.method public final onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-boolean v0, p0, Lps4;->C0:Z

    const/4 v1, 0x1

    if-eqz v0, :cond_3

    iget-object v0, p0, Lps4;->D0:Lns4;
    ...
    invoke-virtual {p0, p1}, Lls4;->c(Landroid/view/MotionEvent;)V
    ...
    :cond_3
    :goto_0
    iget-object v0, p0, Lps4;->b:Landroid/view/ScaleGestureDetector;

    invoke-virtual {v0, p1}, Landroid/view/ScaleGestureDetector;->onTouchEvent(Landroid/view/MotionEvent;)Z

    iget-object v0, p0, Lps4;->c:Los4;
...
.method public setBoundingListener(Lns4;)V
    .locals 0

    iput-object p1, p0, Lps4;->D0:Lns4;
...
.method public setBounds(Landroid/graphics/Rect;)V
    ...
    iput-object p1, p0, Lps4;->B0:Landroid/graphics/Rect;
...
.method public setDrawStickerEnabled(Z)V
    ...
    :cond_0
    iput-boolean p1, p0, Lps4;->C0:Z

    iget-object p0, p0, Lps4;->D0:Lns4;

    if-eqz p0, :cond_1

    invoke-interface {p0, p1}, Lns4;->setDrawStickerEnabled(Z)V

    :cond_1
    return-void
.end method

.method public setListener(Los4;)V
    .locals 0

    iput-object p1, p0, Lps4;->c:Los4;
