...
.method public constructor <init>(JJJILjava/lang/String;ZLjava/lang/String;Ljava/util/Map;Ljava/lang/String;Ljava/lang/String;Ln10;Ljava/lang/Long;ZJ)V
    ...
    iput-wide p3, p0, Lgr2;->o:J

    iput-wide p5, p0, Lgr2;->X:J

    iput p7, p0, Lgr2;->Y:I

    iput-object p8, p0, Lgr2;->Z:Ljava/lang/String;

    iput-boolean p9, p0, Lgr2;->o0:Z

    iput-object p10, p0, Lgr2;->p0:Ljava/lang/String;

    iput-object p11, p0, Lgr2;->q0:Ljava/util/Map;

    iput-object p12, p0, Lgr2;->r0:Ljava/lang/String;

    iput-object p13, p0, Lgr2;->s0:Ljava/lang/String;

    iput-object p14, p0, Lgr2;->t0:Ln10;

    iput-object p15, p0, Lgr2;->u0:Ljava/lang/Long;

    move/from16 p1, p16

    iput-boolean p1, p0, Lgr2;->v0:Z

    move-wide/from16 p1, p17

    iput-wide p1, p0, Lgr2;->w0:J
...
.method public final e(Llje;)V
    ...
    iget-object v0, p1, Lhr2;->o:Lz42;

    if-eqz v0, :cond_0

    invoke-virtual {p0}, Lgr2;->u()V
...
.method public final f(Lvie;)V
    ...
    iget-object v0, p0, Lgr2;->r0:Ljava/lang/String;

    if-nez v0, :cond_0

    iget-object v0, p0, Lgr2;->s0:Ljava/lang/String;

    if-nez v0, :cond_0

    iget-object v0, p0, Lgr2;->u0:Ljava/lang/Long;

    if-eqz v0, :cond_1

    :cond_0
    invoke-virtual {p0}, Lgr2;->d()V
...
.method public final g()[B
    ...
    iget-object v2, p0, Lgr2;->r0:Ljava/lang/String;
    ...
    :goto_0
    iget-object v2, p0, Lgr2;->s0:Ljava/lang/String;
    ...
    :goto_1
    iget-object v2, p0, Lgr2;->t0:Ln10;
    ...
    :cond_2
    iget-object v2, p0, Lgr2;->u0:Ljava/lang/Long;
    ...
    :goto_2
    iget-boolean v2, p0, Lgr2;->v0:Z

    iput-boolean v2, v0, Lru/ok/tamtam/nano/Tasks$ChatUpdate;->notifyPin:Z

    iget-object p0, p0, Lgr2;->p0:Ljava/lang/String;
...
.method public final i()Lije;
    ...
    iget-object v1, v0, Lgr2;->u0:Ljava/lang/Long;
    ...
    :goto_1
    iget-boolean v14, v0, Lgr2;->v0:Z

    iget-wide v3, v0, Lgr2;->w0:J

    move-wide v15, v3

    iget-wide v3, v0, Lgr2;->X:J

    iget-object v6, v0, Lgr2;->Z:Ljava/lang/String;

    iget-boolean v7, v0, Lgr2;->o0:Z

    iget-object v8, v0, Lgr2;->p0:Ljava/lang/String;

    iget-object v9, v0, Lgr2;->q0:Ljava/util/Map;

    iget-object v10, v0, Lgr2;->r0:Ljava/lang/String;

    iget-object v11, v0, Lgr2;->s0:Ljava/lang/String;

    iget-object v12, v0, Lgr2;->t0:Ln10;
...
.method public final u()V
    ...
    invoke-virtual {v0, v1, v2, v3}, Ln82;->W(JLt82;)V
    ...
    invoke-virtual {p0, v1, v2, v0}, Ln82;->W(JLt82;)V
