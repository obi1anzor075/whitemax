...
# direct methods
.method public constructor <init>(Landroid/util/Size;Lzt4;)V
    .locals 5

    invoke-direct {p0}, Lbn4;-><init>()V

    iput-object p1, p0, Lmjf;->o:Landroid/util/Size;
    ...
    iput-object v0, p0, Lmjf;->p:Ljava/lang/String;

    const/16 v1, 0x10

    new-array v1, v1, [F

    iput-object v1, p0, Lmjf;->t:[F
    ...
    invoke-virtual {p0, p2}, Lbn4;->n(Lzt4;)Lfa0;
...
.method public final q()V
    ...
    iget-object v0, p0, Lmjf;->p:Ljava/lang/String;

    const-string v1, "release"

    invoke-static {v0, v1}, Lg47;->Q(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v0, p0, Lmjf;->s:Lone/me/sdk/gl/effects/objects/TrivialFragmentShader;
    ...
    iput-object v0, p0, Lmjf;->s:Lone/me/sdk/gl/effects/objects/TrivialFragmentShader;

    iget-object v2, p0, Lmjf;->r:Lone/me/sdk/gl/effects/objects/OesToImage2dRenderer;
    ...
    :cond_1
    iput-object v0, p0, Lmjf;->r:Lone/me/sdk/gl/effects/objects/OesToImage2dRenderer;

    iget-object v2, p0, Lmjf;->q:Lj0e;

    if-eqz v2, :cond_2

    iget-object v3, v2, Lj0e;->d:Ljava/io/Serializable;

    check-cast v3, Ljava/lang/String;

    invoke-static {v3, v1}, Lg47;->Q(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v1, v2, Lj0e;->e:Ljava/lang/Object;
    ...
    iget-object v1, v2, Lj0e;->f:Ljava/lang/Object;
    ...
    :cond_2
    iput-object v0, p0, Lmjf;->q:Lj0e;

    iput-object v0, p0, Lmjf;->w:Lafb;
...
.method public final w(Landroid/graphics/SurfaceTexture;Landroid/view/Surface;[FZ)V
    ...
    invoke-static {v3, v8}, Lz76;->d(Ljava/util/concurrent/atomic/AtomicBoolean;Z)V

    iget-object v3, v0, Lbn4;->e:Ljava/lang/Object;

    check-cast v3, Ljava/lang/Thread;

    invoke-static {v3}, Lz76;->c(Ljava/lang/Thread;)V
    ...
    iget-object v9, v2, Lva0;->a:Landroid/opengl/EGLSurface;
    ...
    iget-object v5, v0, Lmjf;->o:Landroid/util/Size;

    invoke-direct {v2, v5}, Lj0e;-><init>(Landroid/util/Size;)V
    ...
    iget-object v2, v10, Lj0e;->f:Ljava/lang/Object;

    move-object/from16 v17, v2

    check-cast v17, Lone/me/sdk/gl/effects/objects/FrameBuffer;

    iget-object v2, v0, Lmjf;->r:Lone/me/sdk/gl/effects/objects/OesToImage2dRenderer;
    ...
    iput-object v2, v0, Lmjf;->r:Lone/me/sdk/gl/effects/objects/OesToImage2dRenderer;

    :cond_3
    iget-object v5, v0, Lmjf;->s:Lone/me/sdk/gl/effects/objects/TrivialFragmentShader;
    ...
    iput-object v5, v0, Lmjf;->s:Lone/me/sdk/gl/effects/objects/TrivialFragmentShader;

    :cond_4
    iget-wide v6, v0, Lmjf;->u:J

    cmp-long v6, v13, v6

    iget-object v7, v0, Lmjf;->t:[F
    ...
    iget v6, v10, Lj0e;->a:I

    move/from16 v16, v8

    iget v8, v10, Lj0e;->b:I
    ...
    iget-object v3, v10, Lj0e;->e:Ljava/lang/Object;
    ...
    iget-object v4, v10, Lj0e;->c:Ljava/lang/Object;
    ...
    iget-object v4, v0, Lbn4;->k:Ljava/lang/Object;
    ...
    invoke-virtual {v0, v2}, Lbn4;->o(Landroid/opengl/EGLSurface;)V
    ...
    invoke-virtual {v4, v11}, Lafb;->invoke(Ljava/lang/Object;)Ljava/lang/Object;

    :cond_8
    iput-object v8, v0, Lmjf;->w:Lafb;
    ...
    invoke-static {v7, v4, v5}, Ln1c;->C(IJ)Ljava/lang/String;
    ...
    iget-object v4, v0, Lmjf;->p:Ljava/lang/String;

    invoke-static {v4, v2, v8}, Lg47;->r(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    invoke-virtual {v0, v1, v3}, Lbn4;->s(Landroid/view/Surface;Z)V
