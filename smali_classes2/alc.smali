...
.method public constructor <init>(Lorg/webrtc/VideoFrame$TextureBuffer;ILandroid/os/Handler;Lorg/webrtc/YuvConverter;)V
    ...
    iput-object p1, p0, Lalc;->a:Lorg/webrtc/VideoFrame$TextureBuffer;

    iput p2, p0, Lalc;->b:I

    iput-object p3, p0, Lalc;->c:Landroid/os/Handler;

    iput-object p4, p0, Lalc;->d:Lorg/webrtc/YuvConverter;
...
.method public final cropAndScale(IIIIII)Lorg/webrtc/VideoFrame$Buffer;
    ...
    iget-object v0, p0, Lalc;->a:Lorg/webrtc/VideoFrame$TextureBuffer;
    ...
    invoke-virtual {p0}, Lalc;->getWidth()I
    ...
    invoke-virtual {p0}, Lalc;->getHeight()I
    ...
    new-instance v8, Lq5b;

    const/16 p1, 0x8

    invoke-direct {v8, p1, p0}, Lq5b;-><init>(ILjava/lang/Object;)V

    iget-object v6, p0, Lalc;->c:Landroid/os/Handler;

    iget-object v7, p0, Lalc;->d:Lorg/webrtc/YuvConverter;
