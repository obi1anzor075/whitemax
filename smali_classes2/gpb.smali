...
.field public o0:Ljava/util/concurrent/ExecutorService;

.field public p0:Ly7a;

.field public final q0:Lru/ok/tamtam/android/widgets/quickcamera/CameraxCameraApiView;

.field public final r0:Landroidx/appcompat/widget/AppCompatImageView;

.field public final s0:Lzba;

.field public final t0:Landroid/widget/Chronometer;

.field public final u0:Landroid/widget/LinearLayout;

.field public final v0:Lzba;

.field public final w0:Lwv1;

.field public final x0:Lzba;

.field public final y0:Lzba;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v4, v0, Lgpb;->a:Landroid/animation/FloatEvaluator;
    ...
    iput-object v4, v0, Lgpb;->q0:Lru/ok/tamtam/android/widgets/quickcamera/CameraxCameraApiView;
    ...
    invoke-virtual {v7, v5}, Lap9;->h(Landroid/view/View;)Lyha;

    move-result-object v10

    invoke-interface {v10}, Lyha;->getIcon()Lds6;
    ...
    iput-object v5, v0, Lgpb;->r0:Landroidx/appcompat/widget/AppCompatImageView;

    new-instance v10, Lzba;

    invoke-direct {v10, v1}, Lzba;-><init>(Landroid/content/Context;)V
    ...
    sget-object v2, Lwba;->b:Lwba;

    invoke-virtual {v10, v2}, Lzba;->setMode(Lwba;)V
    ...
    invoke-virtual {v10, v11, v9, v13}, Lzba;->a(FILjava/lang/String;)V

    new-instance v9, Lbpb;

    const/4 v13, 0x0

    invoke-direct {v9, v0, v13}, Lbpb;-><init>(Lgpb;I)V

    invoke-static {v10, v9}, Lu7;->Q(Landroid/view/View;Landroid/view/View$OnClickListener;)V

    iput-object v10, v0, Lgpb;->s0:Lzba;
    ...
    invoke-interface {v13}, Lyha;->getText()Lane;

    invoke-virtual {v9, v6}, Landroid/widget/TextView;->setTextColor(I)V

    iput-object v9, v0, Lgpb;->t0:Landroid/widget/Chronometer;
    ...
    invoke-virtual {v7, v13}, Lap9;->h(Landroid/view/View;)Lyha;
    ...
    invoke-static {v3, v6}, Lgad;->j0(Landroid/graphics/drawable/Drawable;I)V
    ...
    invoke-interface {v7}, Lyha;->e()Lx3;

    move-result-object v7

    iget v7, v7, Lx3;->a:I

    invoke-static {v6, v7}, Lgad;->j0(Landroid/graphics/drawable/Drawable;I)V
    ...
    iput-object v13, v0, Lgpb;->u0:Landroid/widget/LinearLayout;

    new-instance v3, Lzba;

    invoke-direct {v3, v1}, Lzba;-><init>(Landroid/content/Context;)V
    ...
    invoke-virtual {v3, v2}, Lzba;->setMode(Lwba;)V

    new-instance v6, Lbpb;

    const/4 v7, 0x1

    invoke-direct {v6, v0, v7}, Lbpb;-><init>(Lgpb;I)V

    invoke-static {v3, v6}, Lu7;->Q(Landroid/view/View;Landroid/view/View$OnClickListener;)V

    iput-object v3, v0, Lgpb;->v0:Lzba;

    new-instance v6, Lwv1;

    invoke-direct {v6, v1}, Lwv1;-><init>(Landroid/content/Context;)V
    ...
    invoke-direct {v7, v0, v8}, Lbpb;-><init>(Lgpb;I)V

    invoke-static {v6, v7}, Lu7;->Q(Landroid/view/View;Landroid/view/View$OnClickListener;)V

    iput-object v6, v0, Lgpb;->w0:Lwv1;

    new-instance v7, Lzba;

    invoke-direct {v7, v1}, Lzba;-><init>(Landroid/content/Context;)V
    ...
    invoke-virtual {v7, v2}, Lzba;->setMode(Lwba;)V
    ...
    invoke-virtual {v7, v11, v8, v9}, Lzba;->a(FILjava/lang/String;)V

    new-instance v8, Lbpb;

    const/4 v9, 0x3

    invoke-direct {v8, v0, v9}, Lbpb;-><init>(Lgpb;I)V

    invoke-static {v7, v8}, Lu7;->Q(Landroid/view/View;Landroid/view/View$OnClickListener;)V

    iput-object v7, v0, Lgpb;->x0:Lzba;

    new-instance v8, Lzba;

    invoke-direct {v8, v1}, Lzba;-><init>(Landroid/content/Context;)V
    ...
    invoke-virtual {v8, v2}, Lzba;->setMode(Lwba;)V

    new-instance v2, Lbpb;

    const/4 v9, 0x4

    invoke-direct {v2, v0, v9}, Lbpb;-><init>(Lgpb;I)V

    invoke-static {v8, v2}, Lu7;->Q(Landroid/view/View;Landroid/view/View$OnClickListener;)V

    iput-object v8, v0, Lgpb;->y0:Lzba;
    ...
    invoke-direct {v2, v3, v3, v7}, Ltq0;-><init>(IIZ)V

    new-instance v7, Lp27;

    invoke-direct {v7, v3, v2}, Lp27;-><init>(ILtq0;)V

    const/4 v8, 0x0

    invoke-static {v6, v7, v8}, Lxqd;->d(Landroid/view/View;Lp27;Lx56;)V

    iput-object v6, v0, Lgpb;->z0:Landroid/widget/FrameLayout;

    new-instance v2, Ln6a;

    const/16 v7, 0xe

    invoke-direct {v2, v1, v7}, Ln6a;-><init>(Landroid/content/Context;I)V

    invoke-static {v3, v2}, Lkhg;->o(ILv56;)Lje7;

    move-result-object v2

    iput-object v2, v0, Lgpb;->A0:Ljava/lang/Object;
    ...
    iput-object v2, v0, Lgpb;->B0:Ljava/lang/Object;
    ...
    iput-object v1, v0, Lgpb;->C0:Ljava/lang/Object;
...
.method public static final a(Lgpb;Lgv1;)V
    .locals 6
    ...
    invoke-direct {p0}, Lgpb;->getFlashOnDrawable()Landroid/graphics/drawable/Drawable;
    ...
    :cond_1
    invoke-direct {p0}, Lgpb;->getFlashAutoDrawable()Landroid/graphics/drawable/Drawable;
    ...
    :cond_3
    invoke-direct {p0}, Lgpb;->getFlashOffDrawable()Landroid/graphics/drawable/Drawable;
    ...
    :cond_7
    :goto_1
    iget-object v1, p0, Lgpb;->v0:Lzba;

    iget-object v1, v1, Lzba;->c:Lffa;

    invoke-virtual {v1, v0}, Landroidx/appcompat/widget/AppCompatImageView;->setImageDrawable(Landroid/graphics/drawable/Drawable;)V

    invoke-static {v5}, Lvk9;->g(Ljava/lang/String;)Landroid/graphics/Path;

    move-result-object v0

    iput-object v0, v1, Lffa;->o0:Landroid/graphics/Path;
...
.method public static final b(Lgpb;FFFFF)V
    .locals 2

    iget-object v0, p0, Lgpb;->r0:Landroidx/appcompat/widget/AppCompatImageView;

    iget-object v1, p0, Lgpb;->a:Landroid/animation/FloatEvaluator;
    ...
    iget-object p0, p0, Lgpb;->z0:Landroid/widget/FrameLayout;
...
.method private final getFlashAutoDrawable()Landroid/graphics/drawable/Drawable;
    ...
    iget-object p0, p0, Lgpb;->A0:Ljava/lang/Object;
...
.method private final getFlashOffDrawable()Landroid/graphics/drawable/Drawable;
    ...
    iget-object p0, p0, Lgpb;->C0:Ljava/lang/Object;
...
.method private final getFlashOnDrawable()Landroid/graphics/drawable/Drawable;
    ...
    iget-object p0, p0, Lgpb;->B0:Ljava/lang/Object;
...
.method public final getCameraApi()Lhv1;
    ...
    iget-object p0, p0, Lgpb;->q0:Lru/ok/tamtam/android/widgets/quickcamera/CameraxCameraApiView;
