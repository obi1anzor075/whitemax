...
# direct methods
.method public constructor <init>(ILpda;)V
    .locals 2
    ...
    iput-object p1, p0, Loi8;->b:Landroid/graphics/Paint;

    new-instance p1, Landroid/graphics/Rect;

    invoke-direct {p1}, Landroid/graphics/Rect;-><init>()V

    iput-object p1, p0, Loi8;->c:Landroid/graphics/Rect;
    ...
    iput-object p1, p0, Loi8;->o:Ljava/lang/Object;

    invoke-virtual {p0, p2}, Loi8;->onThemeChanged(Lpda;)V
...
.method public static i(Landroidx/recyclerview/widget/RecyclerView;Landroid/view/View;)Z
    ...
    :cond_2
    invoke-virtual {p0, p1}, Ljgd;->l(I)I

    move-result v3

    invoke-virtual {p0, v2}, Ljgd;->l(I)I

    move-result v4

    iget-object p0, p0, Lig7;->o:Lmu;

    iget-object v5, p0, Lmu;->f:Ljava/util/List;

    invoke-static {p1, v5}, Lo23;->Y(ILjava/util/List;)Ljava/lang/Object;

    move-result-object p1

    instance-of v5, p1, Ldi8;
...
.method public final f(Landroid/graphics/Rect;Landroid/view/View;Landroidx/recyclerview/widget/RecyclerView;Lx6c;)V
    ...
    iget-object p2, p4, Lx6c;->b:Landroid/util/SparseArray;
    ...
    iput-object p2, p4, Lx6c;->b:Landroid/util/SparseArray;
    ...
    invoke-static {p3, p2}, Loi8;->i(Landroidx/recyclerview/widget/RecyclerView;Landroid/view/View;)Z
    ...
    :cond_5
    iget-object p0, p0, Loi8;->o:Ljava/lang/Object;
...
.method public g(Landroid/graphics/Canvas;Landroidx/recyclerview/widget/RecyclerView;Lx6c;)V
    ...
    :pswitch_0
    iget-object v0, p0, Loi8;->o:Ljava/lang/Object;
    ...
    invoke-virtual {p2, v4}, Landroidx/recyclerview/widget/RecyclerView;->T(Landroid/view/View;)Lb7c;

    move-result-object v6

    instance-of v6, v6, Lpp2;

    if-eqz v6, :cond_5

    iget-object v6, p3, Lx6c;->b:Landroid/util/SparseArray;
    ...
    iget-object v6, p0, Loi8;->c:Landroid/graphics/Rect;
    ...
    :cond_4
    iget-object v4, p0, Loi8;->b:Landroid/graphics/Paint;
...
.method public h(Landroid/graphics/Canvas;Landroidx/recyclerview/widget/RecyclerView;)V
    ...
    invoke-static {p2, v1}, Loi8;->i(Landroidx/recyclerview/widget/RecyclerView;Landroid/view/View;)Z
    ...
    iget-object v4, p0, Loi8;->o:Ljava/lang/Object;

    check-cast v4, Lx3a;

    iget-object v5, p0, Loi8;->c:Landroid/graphics/Rect;

    invoke-virtual {v4, v5, v1, v3}, Lx3a;->x(Landroid/graphics/Rect;Landroid/view/View;I)V
    ...
    iget-object v11, p0, Loi8;->b:Landroid/graphics/Paint;
...
.method public final onThemeChanged(Lpda;)V
    ...
    iget-object p0, p0, Loi8;->b:Landroid/graphics/Paint;
