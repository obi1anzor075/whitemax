...
.method public synthetic constructor <init>(Lru/ok/messages/media/crop/FrgTamCropImage;I)V
    ...
    iput-object p1, p0, Ln56;->b:Lru/ok/messages/media/crop/FrgTamCropImage;
...
.method public final run()V
    ...
    iget-object p0, p0, Ln56;->b:Lru/ok/messages/media/crop/FrgTamCropImage;
    ...
    iget-object v2, p0, Lru/ok/messages/media/crop/FrgTamCropImage;->x1:Lone/me/image/crop/view/ImageCropView;

    iget-object v2, v2, Lone/me/image/crop/view/ImageCropView;->a:Lfb6;

    invoke-virtual {v2}, Lm37;->getInitialMatrix()Landroid/graphics/Matrix;

    move-result-object v3

    iget-object v2, v2, Lfze;->q0:Landroid/graphics/Matrix;
    ...
    invoke-virtual {v2}, Lone/me/image/crop/view/ImageCropView;->getCropState()Ljz3;
    ...
    :goto_1
    iget-object v0, v0, Lone/me/image/crop/view/ImageCropView;->a:Lfb6;

    invoke-virtual {v0}, Lfze;->getViewBitmap()Landroid/graphics/Bitmap;

    move-result-object v1

    invoke-virtual {v0}, Lfze;->getImageOutputPath()Ljava/lang/String;

    move-result-object v2

    invoke-virtual {v0}, Lm37;->getCropState()Ljz3;
    ...
    iget-object v4, v0, Ljz3;->c:[F

    iget-object v0, v0, Ljz3;->a:Landroid/graphics/RectF;
    ...
    invoke-direct {v0, p0, v1}, Ln56;-><init>(Lru/ok/messages/media/crop/FrgTamCropImage;I)V

    new-instance v1, Lh93;

    const/4 v2, 0x1

    invoke-direct {v1, v2, v0}, Lh93;-><init>(ILjava/lang/Object;)V
    ...
    invoke-virtual {v0, v1}, Le93;->h(Lgsc;)Ln93;
    ...
    invoke-direct {v1, p0, v2}, Ln56;-><init>(Lru/ok/messages/media/crop/FrgTamCropImage;I)V

    new-instance v2, Lot5;

    const/4 v3, 0x6

    invoke-direct {v2, v3, p0}, Lot5;-><init>(ILjava/lang/Object;)V

    new-instance p0, Lfq1;

    const/4 v3, 0x0

    invoke-direct {p0, v2, v3, v1}, Lfq1;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V
    ...
    iget-object p0, p0, Lru/ok/messages/media/crop/FrgTamCropImage;->x1:Lone/me/image/crop/view/ImageCropView;
    ...
    iget-object v3, v0, Lfze;->q0:Landroid/graphics/Matrix;
    ...
    invoke-virtual {v0, v3}, Lfze;->setImageMatrix(Landroid/graphics/Matrix;)V
    ...
    iget-object v1, v0, Lm37;->z0:Landroid/graphics/Matrix;

    invoke-virtual {v1}, Landroid/graphics/Matrix;->reset()V

    invoke-virtual {v0}, Lfze;->getCurrentScale()F
    ...
    iget-object v2, v0, Lm37;->A0:Landroid/graphics/RectF;

    iget-object v0, v0, Lm37;->y0:Landroid/graphics/RectF;
    ...
    iget-object v1, p0, Lru/ok/messages/media/crop/FrgTamCropImage;->x1:Lone/me/image/crop/view/ImageCropView;

    iget-object v1, v1, Lone/me/image/crop/view/ImageCropView;->a:Lfb6;

    iget-object v2, v1, Lm37;->y0:Landroid/graphics/RectF;
    ...
    iget-object v5, v1, Lfze;->q0:Landroid/graphics/Matrix;

    const/high16 v6, 0x42b40000    # 90.0f

    invoke-virtual {v5, v6, v4, v2}, Landroid/graphics/Matrix;->postRotate(FFF)Z

    invoke-virtual {v1, v5}, Lfze;->setImageMatrix(Landroid/graphics/Matrix;)V

    iget-object v1, p0, Lru/ok/messages/media/crop/FrgTamCropImage;->x1:Lone/me/image/crop/view/ImageCropView;

    iget-object v1, v1, Lone/me/image/crop/view/ImageCropView;->b:Lyla;

    iget v2, v1, Lyla;->p0:F

    div-float v2, v3, v2

    iput v2, v1, Lyla;->p0:F

    iget-object v4, v1, Lyla;->a:Landroid/graphics/RectF;

    invoke-virtual {v1, v4, v2}, Lyla;->a(Landroid/graphics/RectF;F)V

    invoke-virtual {v1}, Lyla;->b()V

    iget-object v2, v1, Lyla;->I0:Lzla;
    ...
    invoke-virtual {v2, v4}, Lm37;->setCropRect(Landroid/graphics/RectF;)V
    ...
    iget-object v2, v1, Lm37;->z0:Landroid/graphics/Matrix;
    ...
    iget-object v3, v1, Lm37;->A0:Landroid/graphics/RectF;

    iget-object v1, v1, Lm37;->y0:Landroid/graphics/RectF;
    ...
    iget-object v0, v2, Lone/me/image/crop/view/ImageCropView;->a:Lfb6;

    iget-object v2, v0, Lm37;->y0:Landroid/graphics/RectF;
    ...
    iget-object v4, v0, Lfze;->q0:Landroid/graphics/Matrix;
    ...
    invoke-virtual {v0, v4}, Lfze;->setImageMatrix(Landroid/graphics/Matrix;)V
