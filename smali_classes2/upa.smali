...
.method public final run()V
    ...
    :cond_0
    iget-object v0, p0, Lfqa;->k:Lgi;

    if-eqz v0, :cond_2

    iget-object v1, v0, Lgi;->b:Lu24;

    if-eqz v1, :cond_1

    invoke-virtual {v1, v0}, Lu24;->c(Lymc;)V

    :cond_1
    const/4 v1, 0x0

    iput-object v1, v0, Lgi;->b:Lu24;
    ...
    invoke-interface {v0, p0}, Leqa;->r(Lfqa;)V
    ...
    invoke-interface {v0, p0}, Leqa;->b(Lfqa;)V

    :cond_4
    return-void

    :pswitch_4
    iget-object p0, p0, Lfqa;->N:Leqa;

    if-eqz p0, :cond_5

    invoke-interface {p0}, Leqa;->f()V
    ...
    invoke-interface {v0, p0}, Leqa;->c(Lfqa;)V
