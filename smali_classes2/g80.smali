...
# direct methods
.method public constructor <init>(Landroid/content/Context;Ly4;Lje7;Lje7;Lje7;)V
    .locals 0
    ...
    iput-object p2, p0, Lg80;->b:Ly4;

    iput-object p3, p0, Lg80;->c:Lje7;

    iput-object p4, p0, Lg80;->d:Lje7;

    iput-object p5, p0, Lg80;->e:Lje7;
...
.method public final addAccount(Landroid/accounts/AccountAuthenticatorResponse;Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Landroid/os/Bundle;)Landroid/os/Bundle;
    ...
    invoke-virtual {p2}, La5;->a()Landroid/accounts/Account;

    move-result-object p2

    if-eqz p2, :cond_0

    iget-object p2, p0, Lg80;->b:Ly4;
    ...
    iget-object p0, p0, Lg80;->a:Landroid/content/Context;

    sget p2, Lyyb;->account_already_exists:I
...
.method public final getAccountRemovalAllowed(Landroid/accounts/AccountAuthenticatorResponse;Landroid/accounts/Account;)Landroid/os/Bundle;
    ...
    invoke-virtual {p2}, Lw2a;->e()Z

    move-result p2

    sget v0, Ly6d;->o:I

    iget-object p0, p0, Lg80;->e:Lje7;
    ...
    invoke-direct {v0, p2}, Ly6d;-><init>(Z)V
