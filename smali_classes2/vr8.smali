...
# static fields
.field public static final x:Ldwc;
...
.field public final t:Lur8;

.field public final u:Lur8;
...
.method static constructor <clinit>()V
    ...
    sput-object v2, Lvr8;->y:[Lbc7;

    new-instance v1, Ldwc;

    invoke-direct {v1}, Ljava/lang/Object;-><init>()V

    sput-object v1, Lvr8;->x:Ldwc;

    new-instance v1, Landroid/graphics/Paint;

    invoke-direct {v1, v0}, Landroid/graphics/Paint;-><init>(I)V

    sput-object v1, Lvr8;->z:Landroid/graphics/Paint;
...
.method public constructor <init>([I[IZII)V
    ...
    iput-boolean p3, p0, Lvr8;->a:Z

    iput p4, p0, Lvr8;->w:I

    const/4 p3, 0x0

    iput-boolean p3, p0, Lvr8;->b:Z
    ...
    iput-object p4, p0, Lvr8;->g:Landroid/graphics/RectF;

    new-instance p4, Landroid/graphics/RectF;

    invoke-direct {p4}, Landroid/graphics/RectF;-><init>()V

    iput-object p4, p0, Lvr8;->h:Landroid/graphics/RectF;

    new-instance p4, Landroid/graphics/Path;

    invoke-direct {p4}, Landroid/graphics/Path;-><init>()V

    iput-object p4, p0, Lvr8;->i:Landroid/graphics/Path;
    ...
    iput-object p3, p0, Lvr8;->s:Landroid/graphics/Matrix;

    new-instance p3, Lur8;

    const/4 p4, 0x0

    invoke-direct {p3, p1, p0, p4}, Lur8;-><init>(Ljava/lang/Object;Lvr8;I)V

    iput-object p3, p0, Lvr8;->t:Lur8;

    new-instance p1, Lur8;

    const/4 p3, 0x1

    invoke-direct {p1, p2, p0, p3}, Lur8;-><init>(Ljava/lang/Object;Lvr8;I)V

    iput-object p1, p0, Lvr8;->u:Lur8;

    return-void
.end method

.method public static b(Lvr8;ZIZZIZ)Z
    .locals 2
    ...
    invoke-virtual {p0, p1}, Lvr8;->c(Landroid/graphics/Rect;)V
...
.method public final a()Landroid/graphics/Path;
    ...
    iget-object v0, p0, Lvr8;->j:Landroid/graphics/Path;

    if-nez v0, :cond_0

    iget-object p0, p0, Lvr8;->i:Landroid/graphics/Path;
...
.method public final c(Landroid/graphics/Rect;)V
    ...
    iget-boolean v3, p0, Lvr8;->e:Z

    iget-object v4, p0, Lvr8;->o:[F
    ...
    invoke-static {v4, v2}, Lns;->a0([FF)V
    ...
    :cond_1
    sget-object v7, Lwr8;->$EnumSwitchMapping$0:[I
    ...
    :cond_9
    :goto_1
    iget-object v0, p0, Lvr8;->i:Landroid/graphics/Path;

    invoke-virtual {v0}, Landroid/graphics/Path;->reset()V

    iget-boolean v1, p0, Lvr8;->b:Z
    ...
    iget-object v3, p0, Lvr8;->g:Landroid/graphics/RectF;
    ...
    iget-object v2, p0, Lvr8;->h:Landroid/graphics/RectF;
    ...
    :goto_4
    iput-object v0, p0, Lvr8;->j:Landroid/graphics/Path;

    sget-object v0, Lvr8;->y:[Lbc7;

    aget-object v1, v0, v6

    iget-object v1, p0, Lvr8;->t:Lur8;

    iget-object v1, v1, Lu2;->b:Ljava/lang/Object;

    check-cast v1, [I

    invoke-virtual {p0, v1, p1}, Lvr8;->d([ILandroid/graphics/Rect;)V

    aget-object v0, v0, v5

    iget-object v0, p0, Lvr8;->u:Lur8;

    iget-object v0, v0, Lu2;->b:Ljava/lang/Object;

    check-cast v0, [I

    invoke-virtual {p0, v0, p1}, Lvr8;->e([ILandroid/graphics/Rect;)V
...
.method public final d([ILandroid/graphics/Rect;)V
    ...
    iget-object p1, p0, Lvr8;->s:Landroid/graphics/Matrix;
    ...
    iput-object v0, p0, Lvr8;->q:Landroid/graphics/LinearGradient;
...
.method public final draw(Landroid/graphics/Canvas;)V
    ...
    sget-object v1, Lvr8;->z:Landroid/graphics/Paint;
    ...
    iget-object v0, p0, Lvr8;->q:Landroid/graphics/LinearGradient;

    goto :goto_0

    :cond_1
    iget-object v0, p0, Lvr8;->r:Landroid/graphics/LinearGradient;
    ...
    iget-object p0, p0, Lvr8;->j:Landroid/graphics/Path;
...
.method public final e([ILandroid/graphics/Rect;)V
    ...
    iput-object v0, p0, Lvr8;->r:Landroid/graphics/LinearGradient;
...
.method public final getOutline(Landroid/graphics/Outline;)V
    ...
    invoke-virtual {p0}, Lvr8;->a()Landroid/graphics/Path;
