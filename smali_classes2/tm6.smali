...
.method public constructor <init>(ILandroid/content/Context;Ljava/lang/String;)V
    ...
    iput-object p2, p0, Ltm6;->a:Landroid/content/Context;

    iput-object p3, p0, Ltm6;->b:Ljava/lang/String;
...
# virtual methods
.method public final b(Ljg8;)Lom6;
    .locals 12
    ...
    iget-object v2, p1, Ljg8;->b:Ljava/lang/Object;

    check-cast v2, Ljava/lang/String;

    new-instance v3, Ljava/net/URL;

    iget-object v4, p1, Ljg8;->c:Ljava/lang/Object;
    ...
    sget v7, Lusb;->rootca_ssl_rsa2022:I

    iget-object v9, p0, Ltm6;->a:Landroid/content/Context;
    ...
    invoke-static {v10, v5}, Lurd;->l(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    ...
    invoke-direct {v6, v8}, Lb93;-><init>([Ljavax/net/ssl/X509TrustManager;)V
    ...
    invoke-static {v10, p0}, Lurd;->l(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    ...
    iget-object v2, p0, Ltm6;->b:Ljava/lang/String;
    ...
    :try_start_3
    invoke-interface {p1}, Lnm6;->getContentType()Ljava/lang/String;
    ...
    invoke-interface {p1}, Lnm6;->getContentLength()J
    ...
    invoke-static {v3, v4, v6, p0}, Ltm6;->a(Ljava/net/HttpURLConnection;III)V
    ...
    :try_start_4
    invoke-interface {p1, p0}, Lnm6;->writeTo(Ljava/io/OutputStream;)V
    :try_end_4
    .catchall {:try_start_4 .. :try_end_4} :catchall_2

    :try_start_5
    invoke-static {p0, v5}, Lurd;->l(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    :try_end_5
    ...
    invoke-static {v4, v7}, Loyb;->q(Ljava/io/InputStream;Ljava/io/OutputStream;)V
    ...
    :try_start_b
    invoke-static {v4, v5}, Lurd;->l(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    :try_end_b
    ...
    invoke-direct {v5, v2, v0, v6}, Lbe5;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    invoke-direct {v4, p0, p1, v5, v1}, Lom6;-><init>(ILjava/lang/Object;Ljava/io/Closeable;I)V
    :try_end_f
