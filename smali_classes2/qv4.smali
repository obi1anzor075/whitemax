...
.method private getCorrectionMatrix()Landroid/graphics/Matrix;
    ...
    iget-object v0, p0, Lqv4;->o:Landroid/graphics/Matrix;

    iget-object v1, p0, Lqv4;->r0:[F
...
.method public final draw(Landroid/graphics/Canvas;)V
    ...
    iget-object v0, p0, Lqv4;->t0:Landroid/graphics/Rect;
    ...
    :cond_0
    iget-object p0, p0, Lqv4;->a:Ljava/util/ArrayList;
    ...
    invoke-interface {v0, p1}, Ljv4;->draw(Landroid/graphics/Canvas;)V
...
.method public getResultBounds()Landroid/graphics/Rect;
    ...
    :goto_0
    iget-boolean v1, p0, Lqv4;->u0:Z

    if-eqz v1, :cond_2

    iget-object p0, p0, Lqv4;->v0:Lov4;
...
.method public final onScale(Landroid/view/ScaleGestureDetector;)Z
    ...
    iget-object v2, p0, Lqv4;->o:Landroid/graphics/Matrix;

    invoke-virtual {v2, v0, v0, v1, p1}, Landroid/graphics/Matrix;->postScale(FFFF)Z

    iget-object v0, p0, Lqv4;->p0:Ljava/lang/Float;

    if-eqz v0, :cond_0

    iget-object v3, p0, Lqv4;->q0:Ljava/lang/Float;
    ...
    :cond_0
    iget-object v0, p0, Lqv4;->o0:Landroid/graphics/Matrix;
    ...
    iput-object v0, p0, Lqv4;->p0:Ljava/lang/Float;

    invoke-static {p1}, Ljava/lang/Float;->valueOf(F)Ljava/lang/Float;

    move-result-object p1

    iput-object p1, p0, Lqv4;->q0:Ljava/lang/Float;
...
.method public final onScaleBegin(Landroid/view/ScaleGestureDetector;)Z
    ...
    iget-object p0, p0, Lqv4;->c:Lpv4;

    if-eqz p0, :cond_1

    check-cast p0, Lmv4;

    iget-object p1, p0, Lmv4;->c:Lt4b;

    if-eqz p1, :cond_0

    invoke-virtual {p1}, Lt4b;->i()Ln9;

    move-result-object p1

    iget-object v0, p0, Lmv4;->a:Lqv4;

    invoke-virtual {p1, v0}, Ln9;->a(Llv4;)V

    :cond_0
    const/4 p1, 0x0

    iput-object p1, p0, Lmv4;->c:Lt4b;
...
.method public final onScaleEnd(Landroid/view/ScaleGestureDetector;)V
    ...
    iget-object v3, p0, Lqv4;->r0:[F

    const/4 p1, 0x0

    iput-object p1, p0, Lqv4;->p0:Ljava/lang/Float;

    iput-object p1, p0, Lqv4;->q0:Ljava/lang/Float;

    invoke-direct {p0}, Lqv4;->getCorrectionMatrix()Landroid/graphics/Matrix;
...
.method public final onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-boolean v0, p0, Lqv4;->u0:Z

    const/4 v1, 0x1

    if-eqz v0, :cond_3

    iget-object v0, p0, Lqv4;->v0:Lov4;
    ...
    iget-object v5, v0, Lru/ok/tamtam/photoeditor/view/EditorSurfaceViewContainer;->o0:Landroid/graphics/Rect;

    invoke-virtual {v4, v5}, Landroid/view/View;->getHitRect(Landroid/graphics/Rect;)V

    iget-object v4, v0, Lru/ok/tamtam/photoeditor/view/EditorSurfaceViewContainer;->b:Landroid/view/View;

    iget-object v0, v0, Lru/ok/tamtam/photoeditor/view/EditorSurfaceViewContainer;->p0:Landroid/graphics/Rect;
    ...
    invoke-virtual {p0, p1}, Lmv4;->c(Landroid/view/MotionEvent;)V
    ...
    :cond_3
    :goto_0
    iget-object v0, p0, Lqv4;->b:Landroid/view/ScaleGestureDetector;

    invoke-virtual {v0, p1}, Landroid/view/ScaleGestureDetector;->onTouchEvent(Landroid/view/MotionEvent;)Z

    iget-object v0, p0, Lqv4;->c:Lpv4;
...
.method public setBoundingListener(Lov4;)V
    .locals 0

    iput-object p1, p0, Lqv4;->v0:Lov4;
...
.method public setBounds(Landroid/graphics/Rect;)V
    ...
    iput-object p1, p0, Lqv4;->t0:Landroid/graphics/Rect;
...
.method public setDrawStickerEnabled(Z)V
    ...
    :cond_0
    iput-boolean p1, p0, Lqv4;->u0:Z

    iget-object p0, p0, Lqv4;->v0:Lov4;

    if-eqz p0, :cond_1

    invoke-interface {p0, p1}, Lov4;->setDrawStickerEnabled(Z)V
...
.method public setListener(Lpv4;)V
    .locals 0

    iput-object p1, p0, Lqv4;->c:Lpv4;
