...
.method static constructor <clinit>()V
    ...
    sput-object v3, Lone/me/sdk/bottomsheet/BaseBottomSheetWidget;->Y:[Lk77;

    new-instance v0, Lbqc;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lone/me/sdk/bottomsheet/BaseBottomSheetWidget;->X:Lbqc;
...
.method public constructor <init>()V
    ...
    invoke-direct {p0, v0, v1, v0}, Lone/me/sdk/bottomsheet/BaseBottomSheetWidget;-><init>(Landroid/os/Bundle;ILx54;)V
...
.method public constructor <init>(Landroid/os/Bundle;)V
    ...
    .line 5
    iput-object v0, p0, Lone/me/sdk/bottomsheet/BaseBottomSheetWidget;->b:Ljr;
    ...
    iput-object p1, p0, Lone/me/sdk/bottomsheet/BaseBottomSheetWidget;->c:Ln0c;
    ...
    .line 8
    invoke-direct {p1, v0, v0, v2}, Lup0;-><init>(IIZ)V
    ...
    invoke-direct {v0, v1, p1}, Lsy6;-><init>(ILup0;)V

    iput-object v0, p0, Lone/me/sdk/bottomsheet/BaseBottomSheetWidget;->o:Lsy6;
...
.method public l0(Landroid/view/LayoutInflater;Landroid/os/Bundle;)Landroid/widget/FrameLayout;
    .locals 4
    ...
    invoke-direct {v1, v3, v2}, Ltp0;-><init>(IF)V

    invoke-virtual {v0, v1}, Landroid/view/View;->setOutlineProvider(Landroid/view/ViewOutlineProvider;)V

    invoke-virtual {p0, v0, p1, p2}, Lone/me/sdk/bottomsheet/BaseBottomSheetWidget;->v0(Landroid/widget/FrameLayout;Landroid/view/LayoutInflater;Landroid/os/Bundle;)V
    ...
    invoke-direct {p1, p0, p2, v1}, Lz9;-><init>(Ljava/lang/Object;Lkotlin/coroutines/Continuation;I)V
...
.method public final o0()Landroid/view/View;
    ...
    sget-object v0, Lone/me/sdk/bottomsheet/BaseBottomSheetWidget;->Y:[Lk77;

    const/4 v1, 0x1

    aget-object v0, v0, v1

    iget-object v1, p0, Lone/me/sdk/bottomsheet/BaseBottomSheetWidget;->c:Ln0c;
...
.method public onAttach(Landroid/view/View;)V
    ...
    iget-object p0, p0, Lone/me/sdk/bottomsheet/BaseBottomSheetWidget;->a:Lz0b;
...
.method public final onCreateView(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    invoke-direct {p2, v0}, Lz0b;-><init>(Landroid/content/Context;)V

    sget v0, Lh9a;->a:I

    invoke-virtual {p2, v0}, Landroid/view/View;->setId(I)V

    invoke-virtual {p0, p1, p3}, Lone/me/sdk/bottomsheet/BaseBottomSheetWidget;->l0(Landroid/view/LayoutInflater;Landroid/os/Bundle;)Landroid/widget/FrameLayout;
    ...
    invoke-virtual {p0}, Lone/me/sdk/bottomsheet/BaseBottomSheetWidget;->m0()Lt0b;

    move-result-object p3

    invoke-virtual {p2, p3}, Lz0b;->setCallback(Lt0b;)V

    invoke-virtual {p0}, Lone/me/sdk/bottomsheet/BaseBottomSheetWidget;->n0()Lsy6;

    move-result-object p3

    const/4 v0, 0x0

    invoke-static {p1, p3, v0}, Lek8;->g(Landroid/view/View;Lsy6;Lu16;)V
    ...
    iput-object p2, p0, Lone/me/sdk/bottomsheet/BaseBottomSheetWidget;->a:Lz0b;
...
.method public onDestroyView(Landroid/view/View;)V
    ...
    iget-object v0, p0, Lone/me/sdk/bottomsheet/BaseBottomSheetWidget;->a:Lz0b;

    const/4 v1, 0x0

    if-eqz v0, :cond_0

    invoke-virtual {v0, v1}, Lz0b;->setCallback(Lt0b;)V
    ...
    iget-object v2, v0, Lz0b;->w0:Landroid/animation/ValueAnimator;

    if-eqz v2, :cond_1

    invoke-static {v2}, Lvx3;->f(Landroid/animation/Animator;)V

    :cond_1
    iput-object v1, v0, Lz0b;->w0:Landroid/animation/ValueAnimator;

    :cond_2
    iput-object v1, p0, Lone/me/sdk/bottomsheet/BaseBottomSheetWidget;->a:Lz0b;
...
.method public final r0(Z)V
    ...
    invoke-virtual {v0, p1}, Lz0b;->j(Z)V

    goto :goto_0

    :cond_1
    invoke-virtual {p0}, Lone/me/sdk/bottomsheet/BaseBottomSheetWidget;->s0()V
...
.method public final u0(Z)V
    ...
    iget-object v0, p0, Lone/me/sdk/bottomsheet/BaseBottomSheetWidget;->b:Ljr;
...
.method public abstract v0(Landroid/widget/FrameLayout;Landroid/view/LayoutInflater;Landroid/os/Bundle;)V
.end method
