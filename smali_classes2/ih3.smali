...
# direct methods
.method public constructor <init>(Landroid/content/Context;Ljava/util/concurrent/ExecutorService;Ltkg;Lwfe;)V
    .locals 0
    ...
    iput-object p2, p0, Lih3;->b:Ljava/util/concurrent/ExecutorService;

    iput-object p3, p0, Lih3;->c:Ltkg;

    iput-object p4, p0, Lih3;->d:Lwfe;
    ...
    iput-object p2, p0, Lih3;->e:Ljava/util/concurrent/atomic/AtomicReference;

    new-instance p3, Lfh3;

    const/4 p4, 0x0

    invoke-direct {p3, p0, p4}, Lfh3;-><init>(Lih3;I)V

    new-instance p4, Lwfe;

    invoke-direct {p4, p3}, Lwfe;-><init>(Lv56;)V

    iput-object p4, p0, Lih3;->f:Lwfe;
    ...
    iput-object p4, p0, Lih3;->g:Lwfe;

    sget-object p3, Lvh3;->a:Lvh3;

    iput-object p3, p0, Lih3;->h:Lvh3;

    new-instance p3, Ljava/util/concurrent/CopyOnWriteArraySet;

    invoke-direct {p3}, Ljava/util/concurrent/CopyOnWriteArraySet;-><init>()V

    iput-object p3, p0, Lih3;->i:Ljava/util/concurrent/CopyOnWriteArraySet;

    new-instance p3, Lhh3;

    const/4 p4, 0x0

    invoke-direct {p3, p4, p0}, Lhh3;-><init>(ILjava/lang/Object;)V

    iput-object p3, p0, Lih3;->j:Lhh3;

    new-instance p3, Ljava/util/concurrent/atomic/AtomicReference;

    sget-object p4, Lgh3;->f:Lgh3;

    invoke-direct {p3, p4}, Ljava/util/concurrent/atomic/AtomicReference;-><init>(Ljava/lang/Object;)V

    iput-object p3, p0, Lih3;->k:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    iput-object p3, p0, Lih3;->l:Ljava/lang/String;

    const/4 p3, 0x0

    invoke-virtual {p0, p3}, Lih3;->m(Z)Z
    ...
    invoke-static {p1, p2, p0, p4, p3}, Lu7;->L(Landroid/content/Context;Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;Ljava/lang/String;I)Landroid/content/Intent;

    return-void
.end method

.method public static j(Landroid/net/NetworkCapabilities;)Lvh3;
    .locals 1
    ...
    sget-object p0, Lvh3;->o:Lvh3;

    return-object p0

    :cond_3
    sget-object p0, Lvh3;->X:Lvh3;

    return-object p0

    :cond_4
    :goto_0
    sget-object p0, Lvh3;->a:Lvh3;
...
.method public final a()Z
    ...
    invoke-virtual {p0}, Lih3;->k()Landroid/net/ConnectivityManager;
...
.method public final b()Lvh3;
    ...
    iget-object v0, p0, Lih3;->h:Lvh3;

    sget-object v1, Lvh3;->a:Lvh3;

    if-eq v0, v1, :cond_0

    iget-object p0, p0, Lih3;->h:Lvh3;
    ...
    invoke-static {v0}, Lih3;->j(Landroid/net/NetworkCapabilities;)Lvh3;
    ...
    invoke-virtual {p0, v2, v0}, Lih3;->l(Ljava/lang/String;Ljava/lang/Throwable;)V

    :goto_0
    iput-object v1, p0, Lih3;->h:Lvh3;
...
.method public final d()Z
    ...
    iget-object v0, p0, Lih3;->k:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    iget-object v1, p0, Lih3;->e:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    iget-boolean p0, v0, Lgh3;->e:Z

    return p0

    :cond_0
    invoke-virtual {p0}, Lih3;->h()Landroid/net/Network;

    move-result-object v0

    invoke-virtual {p0, v0}, Lih3;->i(Landroid/net/Network;)Landroid/net/NetworkCapabilities;
...
.method public final f()Z
    ...
    iget-object v0, p0, Lih3;->e:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    iget-object p0, p0, Lih3;->k:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    iget-object v2, p0, Lih3;->l:Ljava/lang/String;

    const-string v3, "default network callback is not registered yet"

    invoke-static {v2, v3, v0}, Lg47;->O(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    iget-object v2, p0, Lih3;->d:Lwfe;
    ...
    invoke-virtual {v2, v0, v3}, Lu8a;->c(Ljava/lang/Throwable;Z)V
    ...
    :cond_2
    iget-object p0, p0, Lih3;->l:Ljava/lang/String;
    ...
    invoke-static {v3, v1}, Lu88;->l(Ljava/lang/String;Z)Ljava/lang/String;

    move-result-object v3

    const/4 v4, 0x0

    invoke-interface {v0, v2, p0, v3, v4}, Llr6;->d(Lqs7;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public final h()Landroid/net/Network;
    ...
    iget-object v0, p0, Lih3;->l:Ljava/lang/String;
    ...
    invoke-static {v0, v2, p0}, Lg47;->r(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public final invalidate()V
    ...
    invoke-virtual {p0, v1}, Lih3;->m(Z)Z
    ...
    invoke-virtual {p0, v2, v2}, Lih3;->o(Landroid/net/Network;Landroid/net/NetworkCapabilities;)V
...
.method public final l(Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-static {v0, p1, p2}, Lg47;->r(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    const-string v0, "ConnectionInfo"

    invoke-static {v0, p1, p2}, Lg47;->r(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    iget-object p0, p0, Lih3;->c:Ltkg;
    ...
    invoke-virtual {p0, p1, p2}, Lpy3;->a(Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public final m(Z)Z
    ...
    iget-object p1, p0, Lih3;->l:Ljava/lang/String;
    ...
    invoke-virtual {p0, v0, p1}, Lih3;->l(Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public final n(Lgh3;)V
    ...
    :cond_4
    :goto_1
    iget-object p1, p0, Lih3;->b:Ljava/util/concurrent/ExecutorService;
...
.method public final o(Landroid/net/Network;Landroid/net/NetworkCapabilities;)V
    ...
    invoke-virtual {v1}, Lih3;->h()Landroid/net/Network;
    ...
    :goto_0
    invoke-virtual {v1, v4}, Lih3;->i(Landroid/net/Network;)Landroid/net/NetworkCapabilities;
    ...
    :try_start_0
    invoke-virtual {v1}, Lih3;->k()Landroid/net/ConnectivityManager;
    ...
    iget-object v0, v1, Lih3;->l:Ljava/lang/String;
    ...
    iget-object v7, v1, Lih3;->l:Ljava/lang/String;

    const-string v8, "Failed to get active network info"

    invoke-static {v7, v8, v0}, Lg47;->r(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    :cond_9
    iget-object v9, v1, Lih3;->l:Ljava/lang/String;

    sget-object v14, Lg47;->m:Llr6;
    ...
    :cond_a
    invoke-interface {v14}, Llr6;->c()Z

    move-result v15

    if-eqz v15, :cond_b

    sget-object v15, Lqs7;->X:Lqs7;

    const-string v7, "retrieveInet, VPN detected"

    invoke-interface {v14, v15, v9, v7, v5}, Llr6;->d(Lqs7;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-interface {v8, v14, v7, v0, v2}, Llr6;->d(Lqs7;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    :cond_f
    :goto_7
    new-instance v8, Lgh3;

    invoke-direct/range {v8 .. v13}, Lgh3;-><init>(ZZZZZ)V
    ...
    :cond_10
    invoke-virtual {v1, v5}, Lih3;->n(Lgh3;)V
