...
# direct methods
.method public constructor <init>(Laz3;Lh2d;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Thread;-><init>()V

    iput-object p2, p0, Lcz3;->a:Lh2d;

    const/16 p2, 0x1e

    iput p2, p0, Lcz3;->b:I

    iput-object p1, p0, Lcz3;->c:Laz3;

    new-instance p1, Ljava/util/concurrent/ConcurrentLinkedQueue;

    invoke-direct {p1}, Ljava/util/concurrent/ConcurrentLinkedQueue;-><init>()V

    iput-object p1, p0, Lcz3;->o:Ljava/util/concurrent/ConcurrentLinkedQueue;
    ...
    iput-object p1, p0, Lcz3;->X:Ljava/util/concurrent/atomic/AtomicInteger;

    new-instance p1, Ljava/util/concurrent/locks/ReentrantLock;

    invoke-direct {p1}, Ljava/util/concurrent/locks/ReentrantLock;-><init>()V

    iput-object p1, p0, Lcz3;->w0:Ljava/util/concurrent/locks/ReentrantLock;

    invoke-virtual {p1}, Ljava/util/concurrent/locks/ReentrantLock;->newCondition()Ljava/util/concurrent/locks/Condition;

    move-result-object p1

    iput-object p1, p0, Lcz3;->x0:Ljava/util/concurrent/locks/Condition;

    new-instance p1, Ljava/util/concurrent/locks/ReentrantLock;

    invoke-direct {p1}, Ljava/util/concurrent/locks/ReentrantLock;-><init>()V

    iput-object p1, p0, Lcz3;->y0:Ljava/util/concurrent/locks/ReentrantLock;
...
.method public final run()V
    ...
    iget-object v0, p0, Lcz3;->y0:Ljava/util/concurrent/locks/ReentrantLock;

    invoke-virtual {v0}, Ljava/util/concurrent/locks/ReentrantLock;->lock()V

    :try_start_0
    iget-object v3, p0, Lcz3;->c:Laz3;
    ...
    iget-object v0, p0, Lcz3;->Y:Lij;

    if-nez v0, :cond_7

    iget-object v0, p0, Lcz3;->o:Ljava/util/concurrent/ConcurrentLinkedQueue;
    ...
    :cond_4
    :try_start_1
    iget-object v0, p0, Lcz3;->w0:Ljava/util/concurrent/locks/ReentrantLock;
    ...
    :try_start_2
    iget-object v3, p0, Lcz3;->x0:Ljava/util/concurrent/locks/Condition;
    ...
    :cond_9
    iget-object v0, p0, Lcz3;->X:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    invoke-virtual {v3, v7, v6}, Laz3;->e(I[B)Z
    ...
    iget-object v3, v3, Lh2d;->b:Ljava/lang/Object;

    check-cast v3, Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-virtual {v3}, Ljava/util/concurrent/atomic/AtomicInteger;->incrementAndGet()I

    iput-object v2, p0, Lcz3;->Y:Lij;
    :try_end_6
    ...
    iget-object p0, p0, Lcz3;->o:Ljava/util/concurrent/ConcurrentLinkedQueue;
