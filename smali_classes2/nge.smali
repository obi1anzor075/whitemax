...
.method public constructor <init>(ZJJZJLjava/lang/String;I)V
    ...
    .line 11
    invoke-static {p2, p3, v2, v1, v0}, Lc3d;->k(JLjava/util/EnumMap;Lyq4;Ljava/lang/Class;)Ljava/util/EnumMap;
    ...
    invoke-direct {v0, p4, p5}, Lah4;-><init>(J)V
    ...
    .line 14
    invoke-direct/range {v0 .. v8}, Lnge;-><init>(ZLjava/util/EnumMap;Ljava/util/EnumMap;ZJLjava/lang/String;I)V
...
.method public constructor <init>(ZLjava/util/EnumMap;Ljava/util/EnumMap;ZJLjava/lang/String;I)V
    ...
    .line 2
    iput-boolean p1, p0, Lnge;->a:Z

    .line 3
    iput-object p2, p0, Lnge;->b:Ljava/util/EnumMap;

    .line 4
    iput-object p3, p0, Lnge;->c:Ljava/util/EnumMap;

    .line 5
    iput-boolean p4, p0, Lnge;->d:Z

    .line 6
    iput-wide p5, p0, Lnge;->e:J

    .line 7
    iput-object p7, p0, Lnge;->f:Ljava/lang/String;
...
.method public static synthetic c(Lnge;Landroid/text/TextPaint;Landroid/util/DisplayMetrics;)V
    .locals 1

    sget-object v0, Lyq4;->b:Lyq4;

    invoke-virtual {p0, p1, p2, v0}, Lnge;->a(Landroid/text/TextPaint;Landroid/util/DisplayMetrics;Lyq4;)V

    return-void
.end method

.method public static synthetic d(Lnge;Landroid/widget/TextView;)V
    .locals 1

    sget-object v0, Lyq4;->b:Lyq4;

    invoke-virtual {p0, p1, v0}, Lnge;->b(Landroid/widget/TextView;Lyq4;)V
...
# virtual methods
.method public final a(Landroid/text/TextPaint;Landroid/util/DisplayMetrics;Lyq4;)V
    .locals 3
    ...
    iget-wide v0, p0, Lnge;->e:J

    invoke-static {v0, v1, p2}, Lah4;->d(JLandroid/util/DisplayMetrics;)F

    move-result v0

    invoke-virtual {p1, v0}, Landroid/graphics/Paint;->setLetterSpacing(F)V

    iget-object p0, p0, Lnge;->b:Ljava/util/EnumMap;
...
.method public final b(Landroid/widget/TextView;Lyq4;)V
    .locals 4
    ...
    iget-object v0, p0, Lnge;->b:Ljava/util/EnumMap;
    ...
    :cond_0
    iget-boolean v0, p0, Lnge;->a:Z

    invoke-virtual {p1, v0}, Landroid/widget/TextView;->setAllCaps(Z)V

    iget-wide v0, v1, Lah4;->a:J
    ...
    iget-object v0, p0, Lnge;->c:Ljava/util/EnumMap;
    ...
    iget-object p2, p0, Lnge;->f:Ljava/lang/String;
...
.method public final e()Ljava/util/EnumMap;
    ...
    iget-object p0, p0, Lnge;->c:Ljava/util/EnumMap;
...
.method public final equals(Ljava/lang/Object;)Z
    ...
    iget-boolean v1, p1, Lnge;->a:Z

    iget-boolean v3, p0, Lnge;->a:Z
    ...
    :cond_2
    iget-object v1, p0, Lnge;->b:Ljava/util/EnumMap;

    iget-object v3, p1, Lnge;->b:Ljava/util/EnumMap;
    ...
    :cond_3
    iget-object v1, p0, Lnge;->c:Ljava/util/EnumMap;

    iget-object v3, p1, Lnge;->c:Ljava/util/EnumMap;
    ...
    :cond_4
    iget-boolean v1, p0, Lnge;->d:Z

    iget-boolean v3, p1, Lnge;->d:Z
    ...
    :cond_5
    iget-wide v3, p0, Lnge;->e:J

    iget-wide v5, p1, Lnge;->e:J
...
.method public final hashCode()I
    ...
    iget-object v2, p0, Lnge;->b:Ljava/util/EnumMap;
    ...
    iget-boolean v2, p0, Lnge;->d:Z

    invoke-static {v0, v1, v2}, Lth2;->f(IIZ)I

    move-result v0

    iget-wide v2, p0, Lnge;->e:J
...
.method public final toString()Ljava/lang/String;
    ...
    iget-object v2, p0, Lnge;->c:Ljava/util/EnumMap;
