...
# direct methods
.method public constructor <init>(Landroid/content/Context;Lje7;Lje7;Lti4;I)V
    .locals 0
    ...
    iput-object p2, p0, Lgw8;->b:Lje7;

    iput-object p3, p0, Lgw8;->c:Lje7;

    invoke-virtual {p1}, Landroid/content/Context;->getApplicationContext()Landroid/content/Context;

    move-result-object p1

    iput-object p1, p0, Lgw8;->d:Landroid/content/Context;

    invoke-virtual {p4}, Lti4;->b()Lyi4;
...
.method public final a([B)Lfw8;
    ...
    invoke-virtual {p0, v3}, Lgw8;->b(Ljava/lang/String;)Ln3c;

    move-result-object v3

    invoke-direct {v7, v5, v3}, Lu3c;-><init>(Lv3c;Ln3c;)V
    ...
    invoke-direct {v3, v7, v4}, Lew8;-><init>(Lu3c;I)V
    ...
    invoke-static {v8, v3}, Lm26;->h(ILjava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p0, p1}, Lgw8;->b(Ljava/lang/String;)Ln3c;

    move-result-object p0

    invoke-direct {v7, v5, p0}, Lu3c;-><init>(Lv3c;Ln3c;)V

    move-object v5, v7

    :goto_1
    invoke-direct {v1, v0, v2, v5}, Lfw8;-><init>(Ljava/util/List;ILu3c;)V
    ...
    invoke-static {v6, v3}, Lm26;->h(ILjava/lang/String;)Ljava/lang/String;
...
.method public final b(Ljava/lang/String;)Ln3c;
    .locals 2

    iget-object v0, p0, Lgw8;->d:Landroid/content/Context;
    ...
    invoke-interface {p0, v0, p1}, Lox4;->b(ILjava/lang/CharSequence;)Ljava/lang/CharSequence;

    move-result-object p0

    invoke-direct {v1, p0}, Ln3c;-><init>(Ljava/lang/CharSequence;)V
...
.method public final c(Ljava/util/Map;)Ljava/util/LinkedHashMap;
    ...
    iget-object v4, v1, Lcw8;->a:Ljava/util/ArrayList;
    ...
    iget-object v8, v6, Lzv8;->a:Lyv8;

    invoke-virtual {p0, v8}, Lgw8;->d(Lyv8;)Lu3c;

    move-result-object v8

    iget v6, v6, Lzv8;->b:I

    invoke-direct {v7, v8, v6}, Lew8;-><init>(Lu3c;I)V
    ...
    iget-object v1, v1, Lcw8;->c:Lyv8;

    if-eqz v1, :cond_1

    invoke-virtual {p0, v1}, Lgw8;->d(Lyv8;)Lu3c;
    ...
    invoke-direct {v1, v5, v4, v3}, Lfw8;-><init>(Ljava/util/List;ILu3c;)V
...
.method public final d(Lyv8;)Lu3c;
    .locals 5

    new-instance v0, Lu3c;

    iget-object v1, p1, Lyv8;->a:Ldw8;
    ...
    invoke-direct {v2, v3, v4}, Lv1;-><init>(ILjava/lang/Object;)V
    ...
    invoke-direct {v0, v3, p0}, Lu3c;-><init>(Lv3c;Ln3c;)V
