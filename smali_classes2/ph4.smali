...
.method public final a(JLjava/lang/Long;Ljava/lang/Long;)V
    ...
    invoke-virtual {p4, v4, v5}, Lt52;->y(J)Li22;
    ...
    invoke-virtual {p3, v4, v5}, Lt52;->E(J)Li22;
    ...
    :cond_2
    iget-object p4, p3, Li22;->b:Lo62;

    iget-object p4, p4, Lo62;->f0:Lj4a;

    if-nez p4, :cond_3

    const-string p0, "draft is null, ignore"

    invoke-static {v1, p0, v0}, Ludd;->H(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    return-void

    :cond_3
    invoke-virtual {p4}, Lj4a;->b()Ljava/lang/Long;
    ...
    iget-wide p1, p3, Li22;->a:J

    invoke-virtual {p0, p1, p2}, Lt52;->p(J)V
