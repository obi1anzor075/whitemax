...
# direct methods
.method public constructor <init>(Lorg/webrtc/CameraVideoCapturer;Lpx1;Ls1c;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lapa;->a:Lorg/webrtc/CameraVideoCapturer;

    iput-object p2, p0, Lapa;->b:Lpx1;

    iput-object p3, p0, Lapa;->c:Ls1c;
...
.method public final changeCaptureFormat(III)V
    ...
    iget-object p0, p0, Lapa;->a:Lorg/webrtc/CameraVideoCapturer;
...
.method public final initialize(Lorg/webrtc/SurfaceTextureHelper;Landroid/content/Context;Lorg/webrtc/CapturerObserver;)V
    ...
    iget-object v2, p0, Lapa;->c:Ls1c;

    const-string v3, "PatchedVideoCapturer"

    invoke-interface {v2, v3, v1}, Ls1c;->log(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v1, p0, Lapa;->X:Lorg/webrtc/SurfaceTextureHelper;

    if-nez v1, :cond_0

    iput-object p1, p0, Lapa;->X:Lorg/webrtc/SurfaceTextureHelper;
    ...
    iput-object v1, p0, Lapa;->o:Lorg/webrtc/YuvConverter;
    :try_end_0
    ...
    :goto_0
    invoke-interface {v2, v3, v0, v1}, Ls1c;->logException(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-direct {v0, p0, p3}, Lnz7;-><init>(Lapa;Lorg/webrtc/CapturerObserver;)V
