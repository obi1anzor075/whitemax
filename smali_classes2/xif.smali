...
.method public constructor <init>(Landroid/util/Size;)V
    ...
    iput-object v1, p0, Lxif;->a:Ljava/lang/String;

    new-instance v2, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {v2}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>()V

    iput-object v2, p0, Lxif;->b:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance v2, Ljava/util/concurrent/CopyOnWriteArraySet;

    invoke-direct {v2}, Ljava/util/concurrent/CopyOnWriteArraySet;-><init>()V

    iput-object v2, p0, Lxif;->Y:Ljava/util/concurrent/CopyOnWriteArraySet;

    new-instance v2, Ljava/util/LinkedHashMap;

    invoke-direct {v2}, Ljava/util/LinkedHashMap;-><init>()V

    iput-object v2, p0, Lxif;->Z:Ljava/util/LinkedHashMap;

    const/16 v2, 0x10

    new-array v3, v2, [F

    iput-object v3, p0, Lxif;->o0:[F

    new-array v2, v2, [F

    iput-object v2, p0, Lxif;->p0:[F
    ...
    :cond_1
    :goto_0
    invoke-static {v0}, Lgr0;->i(Lzt4;)V

    new-instance v1, Luif;

    invoke-direct {v1, p0, p1, v0}, Luif;-><init>(Lxif;Landroid/util/Size;Lzt4;)V

    iput-object v1, p0, Lxif;->c:Luif;
    ...
    iput-object p1, p0, Lxif;->o:Landroid/os/Handler;

    iget-object v0, v1, Luif;->o:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    invoke-virtual {p0}, Lxif;->release()V
    ...
    invoke-direct {v0, p1}, Lmi6;-><init>(Landroid/os/Handler;)V

    iput-object v0, p0, Lxif;->X:Lmi6;

    return-void
.end method

.method public static final a(Lxif;Landroid/util/Size;Lzt4;)V
    .locals 5

    iget-object v0, p0, Lxif;->a:Ljava/lang/String;
    ...
    :cond_1
    :goto_0
    invoke-virtual {p0}, Lxif;->e()V

    iget-boolean v0, p0, Lxif;->r0:Z

    if-nez v0, :cond_3

    iget-object v0, p0, Lxif;->q0:Lmjf;

    if-nez v0, :cond_2

    new-instance v0, Lmjf;

    invoke-direct {v0, p1, p2}, Lmjf;-><init>(Landroid/util/Size;Lzt4;)V

    iput-object v0, p0, Lxif;->q0:Lmjf;
...
.method public static g(Lxif;Lv56;Lv56;I)V
    .locals 3
    ...
    :cond_0
    iget-object p3, p0, Lxif;->o:Landroid/os/Handler;
...
.method public final b(Lede;)V
    ...
    :cond_1
    :goto_0
    iget-object v0, p0, Lxif;->b:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    invoke-direct {v1, p1, p0, v0, v3}, Lt71;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;I)V

    iget-object v0, p0, Lxif;->o:Landroid/os/Handler;

    new-instance v3, Ljff;

    const/4 v4, 0x4

    invoke-direct {v3, p0, v4, v1}, Ljff;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V
...
.method public final d(Lxce;)V
    ...
    iget-object v4, p1, Lxce;->o:Landroid/util/Size;
    ...
    invoke-direct {v0, p1, v1, p0}, Lmhf;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V
    ...
    invoke-direct/range {v3 .. v10}, Lbz8;-><init>(ILjava/lang/Object;Ljava/lang/Class;Ljava/lang/String;Ljava/lang/String;II)V

    iget-object p1, p0, Lxif;->o:Landroid/os/Handler;

    new-instance v1, Ljff;

    const/4 v4, 0x4

    invoke-direct {v1, p0, v4, v0}, Ljff;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V
    ...
    invoke-virtual {v3}, Lbz8;->invoke()Ljava/lang/Object;
...
.method public final f()V
    ...
    iget-boolean v1, p0, Lxif;->r0:Z

    if-eqz v1, :cond_2

    iget v1, p0, Lxif;->s0:I

    if-nez v1, :cond_2

    iget-object v1, p0, Lxif;->Z:Ljava/util/LinkedHashMap;
    ...
    invoke-virtual {v4}, Lxce;->close()V
...
.method public final release()V
    ...
    iget-object v0, p0, Lxif;->Y:Ljava/util/concurrent/CopyOnWriteArraySet;
