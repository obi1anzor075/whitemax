...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lg61;->e:Ljava/util/List;

    return-void
.end method

.method public constructor <init>(Lru/ok/android/externcalls/analytics/CallAnalyticsSender;Lase;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lg61;->a:Lru/ok/android/externcalls/analytics/CallAnalyticsSender;

    iput-object p2, p0, Lg61;->b:Lase;

    new-instance p1, Ljava/util/ArrayList;

    invoke-direct {p1}, Ljava/util/ArrayList;-><init>()V

    iput-object p1, p0, Lg61;->d:Ljava/util/ArrayList;
...
# virtual methods
.method public final b(Lccg;Lru/ok/android/externcalls/analytics/events/EventItemsMap;)V
    .locals 4

    iget-object v0, p1, Lccg;->c:Lru/ok/android/externcalls/analytics/events/EventItemsMap;
    ...
    iget-object p2, p1, Lccg;->d:Ljava/lang/Long;
    ...
    :cond_0
    iget-object p2, p0, Lg61;->b:Lase;

    invoke-virtual {p2}, Lase;->a()Ljava/lang/Long;
    ...
    iget-object p1, p1, Lccg;->b:Lru/ok/android/externcalls/analytics/events/EventItemValue;
    ...
    iget-object p0, p0, Lg61;->a:Lru/ok/android/externcalls/analytics/CallAnalyticsSender;
...
.method public final c(Ljava/lang/String;Lru/ok/android/externcalls/analytics/events/EventItemValue;Lru/ok/android/externcalls/analytics/events/EventItemsMap;)V
    ...
    iget-object v1, p0, Lg61;->b:Lase;

    invoke-virtual {v1}, Lase;->a()Ljava/lang/Long;

    move-result-object v1

    invoke-direct {v0, p1, p2, p3, v1}, Lccg;-><init>(Ljava/lang/String;Lru/ok/android/externcalls/analytics/events/EventItemValue;Lru/ok/android/externcalls/analytics/events/EventItemsMap;Ljava/lang/Long;)V

    iget-object p1, p0, Lg61;->c:Lru/ok/android/externcalls/analytics/events/EventItemsMap;

    if-nez p1, :cond_0

    iget-object p0, p0, Lg61;->d:Ljava/util/ArrayList;
    ...
    :cond_0
    invoke-virtual {p0, v0, p1}, Lg61;->b(Lccg;Lru/ok/android/externcalls/analytics/events/EventItemsMap;)V
