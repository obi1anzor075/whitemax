...
.method public a(Lahc;Lkhc;)V
    ...
    :pswitch_0
    iget-object p1, p2, Live;->a:Ljava/util/Map;
    ...
    iget-object p1, p0, Lsg4;->a:Lxwb;

    const-string p2, "DisplayLayouts"

    const-string v0, "Resend next time after response with errors"

    invoke-interface {p1, p2, v0}, Lxwb;->log(Ljava/lang/String;Ljava/lang/String;)V

    const/4 p1, 0x1

    iput-boolean p1, p0, Lsg4;->e:Z
...
.method public b(Lahc;Ljava/lang/Throwable;)V
    .locals 1
