...
.field public V0:Lle1;

.field public W0:Lize;

.field public X0:Lns3;

.field public Y0:Lbk1;

.field public Z0:Ldwa;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-direct {p2, v0}, Ldi1;-><init>(I)V
    ...
    iput-object p2, p0, Lzj1;->K0:Lt97;
    ...
    iput-object p2, p0, Lzj1;->L0:Lt97;

    new-instance p2, Lc6;

    const/16 v1, 0x1c

    invoke-direct {p2, v1, p0}, Lc6;-><init>(ILjava/lang/Object;)V

    invoke-static {v0, p2}, Lez3;->O(ILs16;)Lt97;

    move-result-object p2

    iput-object p2, p0, Lzj1;->M0:Lt97;

    sget-object p2, Lle1;->c:Lle1;

    iput-object p2, p0, Lzj1;->V0:Lle1;
    ...
    invoke-direct {p2, v1, v2}, Lre3;-><init>(II)V
    ...
    sget v4, Luob;->call_video_rotation:I

    invoke-virtual {p2, v4}, Landroid/view/View;->setId(I)V

    invoke-direct {p0}, Lzj1;->getBackgroundView()Landroid/graphics/drawable/Drawable;

    move-result-object v4

    invoke-virtual {p2, v4}, Landroid/view/View;->setBackground(Landroid/graphics/drawable/Drawable;)V

    sget v4, Lcnb;->ic_rotation_view_16:I
    ...
    iput-object p2, p0, Lzj1;->O0:Landroidx/appcompat/widget/AppCompatImageView;
    ...
    sget v8, Luob;->call_pin:I

    invoke-virtual {v7, v8}, Landroid/view/View;->setId(I)V

    sget v8, Lcnb;->ic_pin_13:I
    ...
    invoke-direct {v4, p0, v8}, Lxj1;-><init>(Lzj1;I)V

    invoke-static {v7, v4}, La24;->a0(Landroid/view/View;Landroid/view/View$OnClickListener;)V

    iput-object v7, p0, Lzj1;->P0:Landroidx/appcompat/widget/AppCompatImageView;
    ...
    sget p1, Luob;->call_user_full_name:I
    ...
    invoke-static {v1, v4}, Lnge;->d(Lnge;Landroid/widget/TextView;)V
    ...
    iput-object v4, p0, Lzj1;->N0:Landroidx/appcompat/widget/AppCompatTextView;
    ...
    iget-object v1, p0, Lzj1;->U0:Ljava/lang/CharSequence;

    invoke-virtual {p0, v1}, Lzj1;->A(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {v1, v2, v0, v3, v0}, Lbf3;->d(IIII)V

    const/4 v5, 0x4

    invoke-virtual {v1, v2, v5, v3, v5}, Lbf3;->d(IIII)V
    ...
    invoke-virtual {v1, v2, v8, v6, v9}, Lbf3;->d(IIII)V

    invoke-virtual {v1, v2, v9, v3, v9}, Lbf3;->d(IIII)V

    invoke-virtual {v1, v2}, Lbf3;->g(I)Lwe3;
    ...
    invoke-virtual {v1, v2, v9, v6, v8}, Lbf3;->d(IIII)V

    new-instance v6, Lhw9;

    const/4 v7, 0x4

    invoke-direct {v6, v1, v9, v2, v7}, Lhw9;-><init>(Ljava/lang/Object;III)V
    ...
    invoke-virtual {v6, v10}, Lhw9;->e(I)V
    ...
    invoke-direct {v6, v1, v8, v2, v10}, Lhw9;-><init>(Ljava/lang/Object;III)V
    ...
    invoke-virtual {v6, v7}, Lhw9;->e(I)V
    ...
    iput-boolean p1, v2, Lxe3;->l0:Z

    invoke-virtual {p2}, Landroid/view/View;->getId()I

    move-result p1

    invoke-virtual {v1, p1, v0, v3, v0}, Lbf3;->d(IIII)V

    invoke-virtual {v1, p1, v5, v3, v5}, Lbf3;->d(IIII)V

    invoke-virtual {v4}, Landroid/view/View;->getId()I

    move-result p2

    invoke-virtual {v1, p1, v9, p2, v8}, Lbf3;->d(IIII)V

    invoke-virtual {v1, p1, v8, v3, v8}, Lbf3;->d(IIII)V

    invoke-virtual {v1, p0}, Lbf3;->a(Landroidx/constraintlayout/widget/ConstraintLayout;)V
...
.method private final getBG_RADIUS()[F
    ...
    iget-object p0, p0, Lzj1;->K0:Lt97;
...
.method private final getBackgroundView()Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {p0}, Lzj1;->getBG_RADIUS()[F
...
.method private final getCallScreen()Lync;
    .locals 0

    iget-object p0, p0, Lzj1;->L0:Lt97;
...
.method private final getTargetWidth()I
    ...
    iget-object p0, p0, Lzj1;->M0:Lt97;
...
.method public static w(Lzj1;)I
    .locals 3

    invoke-direct {p0}, Lzj1;->getCallScreen()Lync;
...
.method public final A(Ljava/lang/CharSequence;)V
    ...
    invoke-direct {p0}, Lzj1;->getTargetWidth()I

    move-result v0

    iget-object v1, p0, Lzj1;->N0:Landroidx/appcompat/widget/AppCompatTextView;

    invoke-static {p1, v1, v0}, Lkjd;->h(Ljava/lang/CharSequence;Landroid/widget/TextView;I)Ljava/lang/CharSequence;
    ...
    invoke-direct {v0, v1, p1, p0, v2}, Lg5;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;I)V
...
.method public final H(Lks3;Lks3;)Ljava/util/List;
    ...
    invoke-static {p0, v1}, Lct0;->r(Landroid/view/View;F)Landroid/animation/ObjectAnimator;

    move-result-object p1

    invoke-virtual {v0, p1}, Llg7;->add(Ljava/lang/Object;)Z

    iget-object p1, p0, Lzj1;->T0:Ljava/lang/Boolean;
    ...
    iget-boolean p1, p2, Lks3;->a:Z

    invoke-static {p0, p1}, Lct0;->n(Landroid/view/View;Z)Landroid/animation/ObjectAnimator;
...
.method public final onAttachedToWindow()V
    ...
    iget-object v0, p0, Lzj1;->Y0:Lbk1;
...
.method public final setActive(Z)V
    ...
    iget-object v0, p0, Lzj1;->T0:Ljava/lang/Boolean;
    ...
    iput-object p1, p0, Lzj1;->T0:Ljava/lang/Boolean;
...
.method public final setCallSpeakerMediator(Lbk1;)V
    ...
    iput-object p1, p0, Lzj1;->Y0:Lbk1;
...
.method public final setControlsMediator(Lns3;)V
    ...
    iput-object p1, p0, Lzj1;->X0:Lns3;
...
.method public final setLabel(Ljava/lang/CharSequence;)V
    ...
    iget-object v0, p0, Lzj1;->U0:Ljava/lang/CharSequence;
    ...
    :cond_0
    iput-object p1, p0, Lzj1;->U0:Ljava/lang/CharSequence;
...
.method public final setListener(Lyj1;)V
    .locals 0

    iput-object p1, p0, Lzj1;->Q0:Lyj1;
...
.method public final setParticipantId(Lle1;)V
    ...
    iput-object p1, p0, Lzj1;->V0:Lle1;

    return-void
.end method

.method public final setPipBoundariesController(Ldwa;)V
    .locals 0

    iput-object p1, p0, Lzj1;->Z0:Ldwa;
...
.method public final x()V
    ...
    iget-object v0, p0, Lzj1;->S0:Ljava/lang/Boolean;
    ...
    :cond_1
    iget-object v2, p0, Lzj1;->N0:Landroidx/appcompat/widget/AppCompatTextView;
...
.method public final y()V
    ...
    iget-object v0, p0, Lzj1;->X0:Lns3;

    if-eqz v0, :cond_0

    check-cast v0, Lrs3;

    iget-object v0, v0, Lrs3;->j:Lls3;
