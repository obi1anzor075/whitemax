...
.method public constructor <init>(Ljava/lang/String;)V
    ...
    iput v0, p0, Lbyf;->alpha:F

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Lbyf;->customParams:Ljava/util/HashMap;

    const-string v0, "precision mediump float;\nuniform mat4 mvpMatrix;\nuniform mat4 texMatrix;\nattribute vec4 aVertexCoord;\nattribute vec4 aTextureCoord;\nvarying vec2 vTextureCoord;\nvoid main() {\n    gl_Position = mvpMatrix * aVertexCoord;\n   vTextureCoord = (texMatrix * aTextureCoord).xy;\n}\n"

    const v1, 0x8b31

    invoke-static {v1, v0}, Lek8;->j(ILjava/lang/String;)I
    ...
    invoke-static {v1, p1}, Lek8;->j(ILjava/lang/String;)I
    ...
    iput v1, p0, Lbyf;->programId:I

    const-string v2, "glCreateProgram"

    invoke-static {v2}, Lek8;->c(Ljava/lang/String;)V
    ...
    invoke-static {v0}, Lek8;->c(Ljava/lang/String;)V
    ...
    iput v0, p0, Lbyf;->aVertexCoordLoc:I

    invoke-static {v0, p1}, Lek8;->b(ILjava/lang/String;)V
    ...
    iput v2, p0, Lbyf;->aTextureCoordLoc:I

    invoke-static {v2, p1}, Lek8;->b(ILjava/lang/String;)V
    ...
    iput v3, p0, Lbyf;->mvpMatrixLoc:I

    invoke-static {v3, p1}, Lek8;->b(ILjava/lang/String;)V
    ...
    iput v3, p0, Lbyf;->texMatrixLoc:I
    ...
    iput v3, p0, Lbyf;->textureLocation:I
    ...
    iput v1, p0, Lbyf;->alphaLocation:I

    invoke-static {v3, p1}, Lek8;->b(ILjava/lang/String;)V

    new-instance p1, Lqxf;

    invoke-direct {p1, v0, v2}, Lqxf;-><init>(II)V

    iput-object p1, p0, Lbyf;->frame:Lqxf;
...
.method public getTextureCoordLoc()I
    ...
    iget p0, p0, Lbyf;->aTextureCoordLoc:I
...
.method public getVertexCoordLoc()I
    ...
    iget p0, p0, Lbyf;->aVertexCoordLoc:I
...
.method public registerTexture(IILjava/lang/String;)I
    ...
    iget v0, p0, Lbyf;->firstFreeTexture:I
    ...
    iget p1, p0, Lbyf;->firstFreeTexture:I

    add-int/lit8 p2, p1, 0x1

    iput p2, p0, Lbyf;->firstFreeTexture:I
...
.method public release()V
    ...
    iget-object v0, p0, Lbyf;->frame:Lqxf;

    iget-object v0, v0, Lqxf;->a:Lyxf;

    invoke-interface {v0}, Lyxf;->b()V

    iget p0, p0, Lbyf;->programId:I
...
.method public render()V
    ...
    invoke-virtual {p0}, Lbyf;->use()V

    iget-object v0, p0, Lbyf;->frame:Lqxf;

    iget-object v0, v0, Lqxf;->a:Lyxf;

    invoke-interface {v0}, Lyxf;->a()V

    invoke-virtual {p0}, Lbyf;->unUse()V
...
.method public setCustomParameter(Ljava/lang/String;F)V
    ...
    .line 2
    iget-object p0, p0, Lbyf;->customParams:Ljava/util/HashMap;
...
.method public setMVPMat([F)V
    ...
    iput-object p1, p0, Lbyf;->mvpMat:[F
...
.method public setTexMat([F)V
    ...
    iput-object p1, p0, Lbyf;->texMat:[F
...
.method public unUse()V
    ...
    invoke-static {p0}, Lek8;->c(Ljava/lang/String;)V
...
.method public use()V
    ...
    iput v0, p0, Lbyf;->firstFreeTexture:I

    iget-object v1, p0, Lbyf;->mvpMat:[F
    ...
    iput-object v1, p0, Lbyf;->mvpMat:[F

    invoke-static {v1, v0}, Landroid/opengl/Matrix;->setIdentityM([FI)V

    :cond_0
    iget-object v1, p0, Lbyf;->texMat:[F

    if-nez v1, :cond_1

    new-array v1, v2, [F

    iput-object v1, p0, Lbyf;->texMat:[F

    invoke-static {v1, v0}, Landroid/opengl/Matrix;->setIdentityM([FI)V

    :cond_1
    iget v1, p0, Lbyf;->programId:I
    ...
    iget v1, p0, Lbyf;->mvpMatrixLoc:I

    iget-object v2, p0, Lbyf;->mvpMat:[F
    ...
    iget v2, p0, Lbyf;->texMatrixLoc:I

    iget-object v4, p0, Lbyf;->texMat:[F

    invoke-static {v2, v3, v0, v4, v0}, Landroid/opengl/GLES20;->glUniformMatrix4fv(IIZ[FI)V

    invoke-static {v1}, Lek8;->c(Ljava/lang/String;)V

    iget v0, p0, Lbyf;->textureLocation:I

    invoke-virtual {p0}, Lbyf;->getTarget()I

    move-result v1

    iget v2, p0, Lbyf;->textureId:I

    const-string v3, "textureId"

    invoke-virtual {p0, v1, v2, v3}, Lbyf;->registerTexture(IILjava/lang/String;)I
    ...
    iget v0, p0, Lbyf;->alphaLocation:I

    iget v1, p0, Lbyf;->alpha:F
    ...
    iget-object v0, p0, Lbyf;->customParams:Ljava/util/HashMap;
    ...
    iget-object v3, p0, Lbyf;->customParams:Ljava/util/HashMap;
