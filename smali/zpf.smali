...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v1, p0, Lzpf;->c:Ljava/util/List;

    sget-object v1, Lmw1;->g:Lmw1;

    iput-object v1, p0, Lzpf;->o:Lmw1;

    const v1, 0x3d5a511a    # 0.0533f

    iput v1, p0, Lzpf;->w0:F

    const/4 v1, 0x0

    iput v1, p0, Lzpf;->x0:I

    const v2, 0x3da3d70a    # 0.08f

    iput v2, p0, Lzpf;->y0:F

    new-instance v2, Ljw1;

    invoke-direct {v2, p1}, Ljw1;-><init>(Landroid/content/Context;)V

    iput-object v2, p0, Lzpf;->a:Ljw1;
...
.method public final a(Ljava/util/List;Lmw1;FIF)V
    ...
    iput-object p2, p0, Lzpf;->o:Lmw1;

    iput p3, p0, Lzpf;->w0:F

    iput p4, p0, Lzpf;->x0:I

    iput p5, p0, Lzpf;->y0:F
    ...
    iget-object v4, v3, Ltw3;->o:Landroid/graphics/Bitmap;
    ...
    :cond_1
    iget-object p1, p0, Lzpf;->c:Ljava/util/List;
    ...
    :cond_2
    iput-object v0, p0, Lzpf;->c:Ljava/util/List;

    invoke-virtual {p0}, Lzpf;->c()V

    :cond_3
    iget-object v0, p0, Lzpf;->a:Ljw1;
    ...
    invoke-virtual/range {v0 .. v5}, Ljw1;->a(Ljava/util/List;Lmw1;FIF)V
...
.method public final b(IF)Ljava/lang/String;
    ...
    invoke-static {p2, p1, v0, v1}, Le07;->K(FIII)F
...
.method public final c()V
    ...
    iget-object v3, v0, Lzpf;->o:Lmw1;

    iget v3, v3, Lmw1;->a:I

    invoke-static {v3}, Lvx3;->N(I)Ljava/lang/String;

    move-result-object v3

    iget v4, v0, Lzpf;->x0:I

    iget v5, v0, Lzpf;->w0:F

    invoke-virtual {v0, v4, v5}, Lzpf;->b(IF)Ljava/lang/String;
    ...
    :cond_0
    invoke-static {v7}, Lvx3;->N(I)Ljava/lang/String;
    ...
    invoke-static {v4}, Lvx3;->l(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v4

    iget-object v6, v0, Lzpf;->o:Lmw1;

    iget v6, v6, Lmw1;->b:I

    invoke-static {v6}, Lvx3;->N(I)Ljava/lang/String;
    ...
    :goto_1
    iget-object v12, v0, Lzpf;->c:Ljava/util/List;
    ...
    iget v14, v12, Ltw3;->E0:I

    if-eqz v18, :cond_e

    iget v5, v12, Ltw3;->Y:I
    ...
    iget-object v5, v12, Ltw3;->b:Landroid/text/Layout$Alignment;
    ...
    :goto_d
    iget v4, v12, Ltw3;->C0:I

    iget v5, v12, Ltw3;->D0:F

    invoke-virtual {v0, v4, v5}, Lzpf;->b(IF)Ljava/lang/String;

    move-result-object v31

    iget-boolean v4, v12, Ltw3;->A0:Z

    if-eqz v4, :cond_15

    iget v4, v12, Ltw3;->B0:I

    goto :goto_e

    :cond_15
    iget-object v4, v0, Lzpf;->o:Lmw1;

    iget v4, v4, Lmw1;->c:I

    :goto_e
    invoke-static {v4}, Lvx3;->N(I)Ljava/lang/String;
    ...
    sget-object v4, Lemd;->a:Ljava/util/regex/Pattern;
    ...
    iget-object v11, v12, Ltw3;->a:Ljava/lang/CharSequence;

    if-nez v11, :cond_1d

    new-instance v1, Lsu4;

    invoke-direct {v1, v9}, Lsu4;-><init>(Ljava/lang/String;)V
    ...
    invoke-static {v11}, Lemd;->a(Ljava/lang/CharSequence;)Ljava/lang/String;
    ...
    invoke-static {v2}, Lvx3;->l(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v8, v6, v5}, Lwn6;->i(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v6, v8, v5}, Lrf0;->f(ILjava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v6, v5, v8}, Lwn6;->i(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v2, v2, Lfic;->a:Ljava/lang/String;

    invoke-static {v2}, Lemd;->a(Ljava/lang/CharSequence;)Ljava/lang/String;

    move-result-object v2

    const/16 v6, 0x10

    invoke-static {v6, v2}, Lme4;->e(ILjava/lang/String;)I
    ...
    invoke-direct {v8, v1, v6, v4, v2}, Lcmd;-><init>(Ljava/lang/String;IILjava/lang/String;)V
    ...
    :cond_45
    iget-object v1, v1, Ldmd;->a:Ljava/util/ArrayList;
    ...
    :cond_46
    iget-object v1, v1, Ldmd;->b:Ljava/util/ArrayList;
    ...
    invoke-static {v4}, Lemd;->a(Ljava/lang/CharSequence;)Ljava/lang/String;
    ...
    iget-object v8, v4, Ldmd;->b:Ljava/util/ArrayList;

    sget-object v9, Lcmd;->f:Lxb4;
    ...
    iget-object v9, v9, Lcmd;->d:Ljava/lang/String;
    ...
    :cond_49
    iget-object v4, v4, Ldmd;->a:Ljava/util/ArrayList;

    sget-object v8, Lcmd;->e:Lxb4;
    ...
    iget-object v8, v8, Lcmd;->c:Ljava/lang/String;
    ...
    invoke-static {v0}, Lemd;->a(Ljava/lang/CharSequence;)Ljava/lang/String;
    ...
    invoke-direct {v0, v1}, Lsu4;-><init>(Ljava/lang/String;)V
    ...
    iget-object v0, v1, Lsu4;->a:Ljava/lang/String;

    iget-object v1, v12, Ltw3;->c:Landroid/text/Layout$Alignment;

    if-eqz v1, :cond_54

    sget-object v4, Lypf;->a:[I
