...
# static fields
.field public static final d:Lxb3;

.field public static final e:Lboc;

.field public static final f:I

.field public static final g:Lyb3;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v1, v3}, Lboc;-><init>(Ljava/lang/String;)V

    invoke-direct {v0, v1}, Lio9;-><init>(Ljava/util/concurrent/ThreadFactory;)V

    sput-object v0, Lzb3;->g:Lyb3;
    ...
    invoke-direct {v3, v4, v0, v1}, Lboc;-><init>(Ljava/lang/String;IZ)V

    sput-object v3, Lzb3;->e:Lboc;

    new-instance v0, Lxb3;

    invoke-direct {v0, v2, v3}, Lxb3;-><init>(ILjava/util/concurrent/ThreadFactory;)V

    sput-object v0, Lzb3;->d:Lxb3;

    iget-object v0, v0, Lxb3;->b:[Lyb3;
...
.method public constructor <init>()V
    ...
    sget-object v1, Lzb3;->d:Lxb3;

    invoke-direct {v0, v1}, Ljava/util/concurrent/atomic/AtomicReference;-><init>(Ljava/lang/Object;)V

    iput-object v0, p0, Lzb3;->c:Ljava/util/concurrent/atomic/AtomicReference;

    new-instance p0, Lxb3;

    sget v2, Lzb3;->f:I

    sget-object v3, Lzb3;->e:Lboc;

    invoke-direct {p0, v2, v3}, Lxb3;-><init>(ILjava/util/concurrent/ThreadFactory;)V
...
.method public final a()Lesc;
    ...
    iget-object p0, p0, Lzb3;->c:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    invoke-virtual {p0}, Lxb3;->a()Lyb3;

    move-result-object p0

    invoke-direct {v0, p0}, Lwb3;-><init>(Lyb3;)V
...
.method public final d(Ljava/lang/Runnable;JJLjava/util/concurrent/TimeUnit;)Lam4;
    .locals 7
    ...
    iget-object v0, p0, Lio9;->a:Ljava/util/concurrent/ScheduledThreadPoolExecutor;
    ...
    invoke-direct {p0, p1, v0}, Lv27;-><init>(Ljava/lang/Runnable;Ljava/util/concurrent/ScheduledExecutorService;)V
    ...
    :goto_0
    invoke-virtual {p0, p1}, Lv27;->a(Ljava/util/concurrent/Future;)V
    :try_end_0
    .catch Ljava/util/concurrent/RejectedExecutionException; {:try_start_0 .. :try_end_0} :catch_0
