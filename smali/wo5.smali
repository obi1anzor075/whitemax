...
.method public synthetic constructor <init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;JI)V
    ...
    iput-object p2, p0, Lwo5;->o:Ljava/lang/Object;

    iput-object p3, p0, Lwo5;->X:Ljava/lang/Object;

    iput-wide p4, p0, Lwo5;->b:J
...
.method public final run()V
    ...
    iget-object v0, p0, Lwo5;->X:Ljava/lang/Object;

    check-cast v0, Ljava/lang/String;

    iget-wide v1, p0, Lwo5;->b:J

    iget-object v3, p0, Lwo5;->c:Ljava/lang/Object;

    check-cast v3, Lcom/my/tracker/obfuscated/t;

    iget-object p0, p0, Lwo5;->o:Ljava/lang/Object;
    ...
    iget-object v1, p0, Lwo5;->o:Ljava/lang/Object;

    move-object v7, v1

    check-cast v7, Lge1;

    iget-object v1, p0, Lwo5;->X:Ljava/lang/Object;

    check-cast v1, Landroid/util/Size;

    iget-wide v2, p0, Lwo5;->b:J

    monitor-enter v0

    :try_start_0
    iget-object p0, v0, Lstf;->o:Ljava/lang/Object;
    ...
    :cond_0
    :try_start_1
    iget-object p0, v0, Lstf;->c:Ljava/lang/Object;
    ...
    invoke-direct {v5, p0, v2}, Lwia;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, v8}, Lqmc;->b(Ljava/lang/Runnable;)Lxi4;
    ...
    iget-wide v9, p0, Lwo5;->b:J

    iget-boolean p0, v0, Lbp5;->d:Z
    ...
    invoke-virtual {v7, p0}, Lsn1;->d(Ljava/lang/Throwable;)Z
    ...
    invoke-interface {p0}, Luvf;->f()Landroid/graphics/Rect;

    move-result-object p0

    iget-object v1, v0, Lbp5;->e:Landroid/util/Rational;
    ...
    iget-object v1, v1, Lzq1;->i:Lpd;

    iget-object v1, v1, Lpd;->Y:Ljava/lang/Object;

    check-cast v1, Luvf;

    invoke-interface {v1}, Luvf;->f()Landroid/graphics/Rect;
    ...
    :goto_3
    iget-object v1, v8, Lws4;->b:Ljava/lang/Object;
    ...
    invoke-virtual {v1, v3}, Let1;->a(Landroid/hardware/camera2/CameraCharacteristics$Key;)Ljava/lang/Object;
    ...
    invoke-virtual/range {v1 .. v6}, Lbp5;->c(Ljava/util/List;ILandroid/util/Rational;Landroid/graphics/Rect;I)Ljava/util/List;

    move-result-object v13

    iget-object v1, v8, Lws4;->c:Ljava/lang/Object;
    ...
    iget-object v1, v8, Lws4;->o:Ljava/lang/Object;
    ...
    iput-object v2, v0, Lbp5;->t:Lsn1;

    :cond_8
    iget-object v1, v0, Lbp5;->p:Lxo5;

    iget-object v4, v0, Lbp5;->a:Lzq1;

    iget-object v4, v4, Lzq1;->b:Lxq1;

    iget-object v4, v4, Lxq1;->b:Ljava/lang/Object;

    check-cast v4, Ljava/util/HashSet;

    invoke-virtual {v4, v1}, Ljava/util/HashSet;->remove(Ljava/lang/Object;)Z

    iget-object v1, v0, Lbp5;->u:Lsn1;
    ...
    iput-object v2, v0, Lbp5;->u:Lsn1;

    :cond_9
    iget-object v1, v0, Lbp5;->i:Ljava/util/concurrent/ScheduledFuture;
    ...
    iput-object v2, v0, Lbp5;->i:Ljava/util/concurrent/ScheduledFuture;

    :cond_a
    iput-object v7, v0, Lbp5;->t:Lsn1;

    sget-object v1, Lbp5;->x:[Landroid/hardware/camera2/params/MeteringRectangle;
    ...
    iget-object v6, v0, Lbp5;->a:Lzq1;

    iget-object v7, v6, Lzq1;->b:Lxq1;

    iget-object v7, v7, Lxq1;->b:Ljava/lang/Object;
    ...
    :cond_b
    iget-object v1, v0, Lbp5;->j:Ljava/util/concurrent/ScheduledFuture;

    if-eqz v1, :cond_c

    invoke-interface {v1, v3}, Ljava/util/concurrent/Future;->cancel(Z)Z

    iput-object v2, v0, Lbp5;->j:Ljava/util/concurrent/ScheduledFuture;

    :cond_c
    iput-object v4, v0, Lbp5;->q:[Landroid/hardware/camera2/params/MeteringRectangle;

    iput-object v5, v0, Lbp5;->r:[Landroid/hardware/camera2/params/MeteringRectangle;

    iput-object p0, v0, Lbp5;->s:[Landroid/hardware/camera2/params/MeteringRectangle;
    ...
    iput-boolean v3, v0, Lbp5;->g:Z

    iput-boolean v12, v0, Lbp5;->l:Z

    iput-boolean v12, v0, Lbp5;->m:Z

    invoke-virtual {v6}, Lzq1;->A()J

    move-result-wide v1

    invoke-virtual {v0, v3}, Lbp5;->e(Z)V

    goto :goto_8

    :cond_e
    iput-boolean v12, v0, Lbp5;->g:Z

    iput-boolean v3, v0, Lbp5;->l:Z
    ...
    iput-object p0, v0, Lbp5;->h:Ljava/lang/Integer;

    invoke-virtual {v6, v3}, Lzq1;->u(I)I
    ...
    invoke-direct {p0, v0, v12, v1, v2}, Lvo5;-><init>(Lbp5;ZJ)V

    iput-object p0, v0, Lbp5;->o:Lvo5;

    invoke-virtual {v6, p0}, Lzq1;->p(Lyq1;)V

    iget-wide v1, v0, Lbp5;->k:J

    const-wide/16 v3, 0x1

    add-long/2addr v1, v3

    iput-wide v1, v0, Lbp5;->k:J

    new-instance p0, Lyo5;

    const/4 v3, 0x0

    invoke-direct {p0, v3, v1, v2, v0}, Lyo5;-><init>(IJLbp5;)V

    sget-object v3, Ljava/util/concurrent/TimeUnit;->MILLISECONDS:Ljava/util/concurrent/TimeUnit;

    iget-object v4, v0, Lbp5;->c:Ljava/util/concurrent/ScheduledExecutorService;
    ...
    iput-object p0, v0, Lbp5;->j:Ljava/util/concurrent/ScheduledFuture;

    iget-wide v5, v8, Lws4;->a:J
    ...
    invoke-direct {p0, v7, v1, v2, v0}, Lyo5;-><init>(IJLbp5;)V
    ...
    iput-object p0, v0, Lbp5;->i:Ljava/util/concurrent/ScheduledFuture;
