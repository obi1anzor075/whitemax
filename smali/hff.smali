...
.method public constructor <init>(Lfff;)V
    ...
    iput-object v0, p0, Lhff;->o:Ljava/util/HashSet;

    iput-object p1, p0, Lhff;->a:Lfff;

    invoke-interface {p1}, Lfff;->T()I
    ...
    iput-object v1, p0, Lhff;->b:Landroid/util/Range;

    invoke-interface {p1}, Lfff;->n0()I
    ...
    iput-object p1, p0, Lhff;->c:Landroid/util/Range;
...
.method public static a(Lfff;Landroid/util/Size;)Lfff;
    .locals 2

    instance-of v0, p0, Lhff;
    ...
    invoke-interface {p0, v0, v1}, Lfff;->K(II)Z
    ...
    invoke-direct {v0, p0}, Lhff;-><init>(Lfff;)V
    ...
    iget-object v0, v0, Lhff;->o:Ljava/util/HashSet;
...
.method public final i0(I)Landroid/util/Range;
    ...
    iget-object v1, p0, Lhff;->c:Landroid/util/Range;

    invoke-virtual {v1, v0}, Landroid/util/Range;->contains(Ljava/lang/Comparable;)Z

    move-result v0

    iget-object v2, p0, Lhff;->a:Lfff;
    ...
    invoke-static {p1, v0}, Lfq0;->k(Ljava/lang/String;Z)V

    iget-object p0, p0, Lhff;->b:Landroid/util/Range;
...
.method public final m0(I)Landroid/util/Range;
    ...
    iget-object v1, p0, Lhff;->b:Landroid/util/Range;
    ...
    iget-object p0, p0, Lhff;->c:Landroid/util/Range;
...
.method public final p0(II)Z
    ...
    iget-object v0, p0, Lhff;->a:Lfff;

    invoke-interface {v0, p1, p2}, Lfff;->p0(II)Z
    ...
    :cond_0
    iget-object v1, p0, Lhff;->o:Ljava/util/HashSet;
