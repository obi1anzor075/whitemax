...
.method public final dispatch(Lhx3;Ljava/lang/Runnable;)V
    ...
    invoke-virtual {v0, p1}, Ljx3;->isDispatchNeeded(Lhx3;)Z
    ...
    :cond_0
    iget-object p1, p0, Lkl4;->d:Ljava/util/ArrayDeque;
    ...
    invoke-direct {v1, p0, v2, p2}, Lut1;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    invoke-virtual {v0, p1, v1}, Ljx3;->dispatch(Lhx3;Ljava/lang/Runnable;)V
...
.method public final isDispatchNeeded(Lhx3;)Z
    ...
    iget-boolean p1, p0, Lkl4;->b:Z

    if-nez p1, :cond_2

    iget-boolean p0, p0, Lkl4;->a:Z
