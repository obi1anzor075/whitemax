...
.method public final b(Landroid/graphics/Canvas;Landroid/graphics/Paint;II)V
    ...
    invoke-static {p3, p4}, Lsbg;->g(II)I

    move-result p3

    iget-object p4, p0, Lwq4;->a:Loj0;
    ...
    invoke-virtual/range {v1 .. v7}, Lmh7;->h(Landroid/graphics/Canvas;Landroid/graphics/Paint;Landroid/graphics/PointF;Landroid/graphics/PointF;FF)V
...
.method public final c(Landroid/graphics/Canvas;Landroid/graphics/Paint;Lvq4;I)V
    ...
    invoke-static {v0, p4}, Lsbg;->g(II)I
    ...
    invoke-virtual/range {v1 .. v8}, Lmh7;->g(Landroid/graphics/Canvas;Landroid/graphics/Paint;FFIII)V
...
.method public final d(Landroid/graphics/Canvas;Landroid/graphics/Paint;FFIII)V
    ...
    invoke-static {p5, p6}, Lsbg;->g(II)I

    move-result p5

    move p6, p7

    invoke-virtual/range {p0 .. p7}, Lmh7;->g(Landroid/graphics/Canvas;Landroid/graphics/Paint;FFIII)V
...
.method public final g(Landroid/graphics/Canvas;Landroid/graphics/Paint;FFIII)V
    ...
    invoke-static {p3, v0, v1}, Lus;->i(FFF)F

    move-result p3

    move/from16 v2, p4

    invoke-static {v2, v0, v1}, Lus;->i(FFF)F
    ...
    invoke-static {v3, v1, p3}, Lap;->R(FFF)F
    ...
    invoke-static {v3, v1, v2}, Lap;->R(FFF)F
    ...
    invoke-static {p3, v0, v4}, Lus;->i(FFF)F
    ...
    invoke-static {v2, v6, v1}, Lus;->i(FFF)F
    ...
    invoke-virtual/range {v5 .. v11}, Lmh7;->h(Landroid/graphics/Canvas;Landroid/graphics/Paint;Landroid/graphics/PointF;Landroid/graphics/PointF;FF)V
