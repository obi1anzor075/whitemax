...
.method public static J(Ljava/io/File;)Z
    ...
    invoke-direct {v0, p0}, Lnf5;-><init>(Ljava/io/File;)V

    new-instance p0, Llf5;

    invoke-direct {p0, v0}, Llf5;-><init>(Lnf5;)V
...
.method public static K(Ljava/io/File;)[B
    ...
    invoke-static {v0, v6}, Loyb;->q(Ljava/io/InputStream;Ljava/io/OutputStream;)V
...
.method public static L(Ljava/io/File;)Ljava/util/ArrayList;
    ...
    invoke-direct {p0, v0, v3}, Les;-><init>(ILjava/lang/Object;)V

    new-instance v0, Lle3;

    invoke-direct {v0, p0}, Lle3;-><init>(Ldyc;)V

    invoke-virtual {v0}, Lle3;->iterator()Ljava/util/Iterator;
...
.method public static N(Ljava/io/File;Ljava/lang/String;)Ljava/io/File;
    ...
    invoke-static {p1, v1, v2, v2, v3}, Lh0e;->Z(Ljava/lang/CharSequence;CIZI)I
    ...
    invoke-static {p1, v1, v4, v2, v3}, Lh0e;->Z(Ljava/lang/CharSequence;CIZI)I
    ...
    invoke-static {p1, v3}, Lh0e;->T(Ljava/lang/CharSequence;C)Z
    ...
    invoke-static {p0, v1}, Lh0e;->T(Ljava/lang/CharSequence;C)Z
...
.method public static O(Ljava/io/File;Ljava/lang/String;)V
    ...
    :try_start_0
    invoke-static {v1, p1, v0}, Lng5;->P(Ljava/io/FileOutputStream;Ljava/lang/String;Ljava/nio/charset/Charset;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
