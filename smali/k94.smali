...
# direct methods
.method public constructor <init>(Landroid/content/Context;Lfz5;Landroid/media/MediaFormat;Ljava/lang/String;ZLandroid/view/Surface;)V
    .locals 9

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p2, p0, Lk94;->c:Lfz5;

    iput-object p3, p0, Lk94;->b:Landroid/media/MediaFormat;

    iput-boolean p5, p0, Lk94;->g:Z
    ...
    iput-boolean p2, p0, Lk94;->h:Z

    new-instance v0, Landroid/media/MediaCodec$BufferInfo;

    invoke-direct {v0}, Landroid/media/MediaCodec$BufferInfo;-><init>()V

    iput-object v0, p0, Lk94;->a:Landroid/media/MediaCodec$BufferInfo;
    ...
    iput-object v0, p0, Lk94;->i:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    invoke-static {p6, v3}, Lu27;->e(Ljava/lang/Object;Z)V
    ...
    iput-object v7, p0, Lk94;->d:Landroid/media/MediaCodec;

    iput-object v6, p0, Lk94;->e:Landroid/view/Surface;

    invoke-static {p1}, Lpaf;->K(Landroid/content/Context;)Z
    ...
    invoke-static {p1, p2}, Lou0;->i(Ljava/lang/Exception;Ljava/lang/String;)V
    ...
    :goto_7
    iget-boolean p0, p0, Lk94;->h:Z

    new-instance p6, Lnh3;

    invoke-virtual {p3}, Landroid/media/MediaFormat;->toString()Ljava/lang/String;

    move-result-object p3

    invoke-direct {p6, p3, p4, p0, p5}, Lnh3;-><init>(Ljava/lang/String;Ljava/lang/String;ZZ)V

    invoke-static {p1, p2, p6}, Landroidx/media3/transformer/ExportException;->c(Ljava/lang/Exception;ILnh3;)Landroidx/media3/transformer/ExportException;
...
.method public final a(Ljava/lang/RuntimeException;)Landroidx/media3/transformer/ExportException;
    ...
    :goto_0
    invoke-virtual {p0}, Lk94;->b()Ljava/lang/String;

    move-result-object v2

    new-instance v3, Lnh3;

    iget-object v4, p0, Lk94;->b:Landroid/media/MediaFormat;
    ...
    invoke-direct {v3, v4, v2, p0, v0}, Lnh3;-><init>(Ljava/lang/String;Ljava/lang/String;ZZ)V

    invoke-static {p1, v1, v3}, Landroidx/media3/transformer/ExportException;->c(Ljava/lang/Exception;ILnh3;)Landroidx/media3/transformer/ExportException;
...
.method public final b()Ljava/lang/String;
    ...
    iget-object p0, p0, Lk94;->d:Landroid/media/MediaCodec;

    if-lt v0, v1, :cond_0

    invoke-static {p0}, Lj94;->a(Landroid/media/MediaCodec;)Ljava/lang/String;
...
.method public final c()Ljava/nio/ByteBuffer;
    ...
    :cond_0
    iget-object v0, p0, Lk94;->a:Landroid/media/MediaCodec$BufferInfo;
    ...
    iget-object p0, p0, Lk94;->k:Ljava/nio/ByteBuffer;
...
.method public final e(Lc64;)Z
    .locals 4

    const-string v0, "MediaCodec error"

    iget-object v1, p0, Lk94;->d:Landroid/media/MediaCodec;

    iget-boolean v2, p0, Lk94;->n:Z
    ...
    iput-object v1, p1, Lc64;->X:Ljava/nio/ByteBuffer;
    :try_end_1
    ...
    invoke-static {p1, v0}, Lou0;->i(Ljava/lang/Exception;Ljava/lang/String;)V

    invoke-virtual {p0, p1}, Lk94;->a(Ljava/lang/RuntimeException;)Landroidx/media3/transformer/ExportException;
    ...
    :cond_2
    :goto_1
    iget-object p0, p1, Lc64;->X:Ljava/nio/ByteBuffer;
...
.method public final f(Z)Z
    ...
    iget-object v2, p0, Lk94;->c:Lfz5;

    iget-boolean v3, p0, Lk94;->g:Z

    iget-object v4, p0, Lk94;->d:Landroid/media/MediaCodec;

    iget-object v5, p0, Lk94;->a:Landroid/media/MediaCodec$BufferInfo;
    ...
    iget-object v0, v2, Lfz5;->k:Lx79;

    invoke-static {p1}, Lzo3;->m(Landroid/media/MediaFormat;)Lfz5;
    ...
    invoke-direct {p1, v4}, Lfz5;-><init>(Lcz5;)V

    iput-object p1, p0, Lk94;->j:Lfz5;

    if-eqz v3, :cond_3

    iget-object p1, v2, Lfz5;->m:Ljava/lang/String;
    ...
    iput-object v0, p0, Lk94;->j:Lfz5;

    :cond_3
    if-nez v3, :cond_4

    iget-boolean p1, p0, Lk94;->h:Z

    if-eqz p1, :cond_4

    iget-object p0, p0, Lk94;->i:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iput-object p1, p0, Lk94;->k:Ljava/nio/ByteBuffer;
    :try_end_5
...
.method public final g(Lc64;)V
    .locals 9

    iget-boolean v0, p0, Lk94;->n:Z
    ...
    iget-object v3, p1, Lc64;->X:Ljava/nio/ByteBuffer;
    ...
    iput-object p0, p1, Lc64;->X:Ljava/nio/ByteBuffer;
...
.method public final h()V
    ...
    iput-object v0, p0, Lk94;->k:Ljava/nio/ByteBuffer;

    iget-object v0, p0, Lk94;->e:Landroid/view/Surface;
...
.method public final i()V
    ...
    invoke-virtual {p0, v0, v1, v2}, Lk94;->j(JZ)V
...
.method public final j(JZ)V
    ...
    iput-object v1, p0, Lk94;->k:Ljava/nio/ByteBuffer;
    ...
    sget-object p1, Lq54;->a:Ljava/util/LinkedHashMap;
