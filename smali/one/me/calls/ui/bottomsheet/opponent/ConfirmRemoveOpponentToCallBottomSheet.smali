...
.method public constructor <init>(Landroid/os/Bundle;)V
    ...
    .line 4
    iput-object v0, p0, Lone/me/calls/ui/bottomsheet/opponent/ConfirmRemoveOpponentToCallBottomSheet;->u0:Lje7;
    ...
    .line 7
    iput-object v0, p0, Lone/me/calls/ui/bottomsheet/opponent/ConfirmRemoveOpponentToCallBottomSheet;->v0:Ljava/lang/Object;

    .line 8
    new-instance v0, Lvf2;

    invoke-direct {v0, p1, v2}, Lvf2;-><init>(Landroid/os/Bundle;I)V
    ...
    .line 10
    iput-object p1, p0, Lone/me/calls/ui/bottomsheet/opponent/ConfirmRemoveOpponentToCallBottomSheet;->w0:Ljava/lang/Object;

    return-void
.end method

.method public constructor <init>(Lwf1;I)V
    .locals 2
...
.method public synthetic constructor <init>(Lwf1;IILl94;)V
    .locals 0
    ...
    .line 17
    :cond_0
    invoke-direct {p0, p1, p2}, Lone/me/calls/ui/bottomsheet/opponent/ConfirmRemoveOpponentToCallBottomSheet;-><init>(Lwf1;I)V
...
.method public final A0(Landroid/view/LayoutInflater;Landroid/widget/FrameLayout;)Landroid/view/View;
    ...
    iget-object v6, p0, Lone/me/calls/ui/bottomsheet/opponent/ConfirmRemoveOpponentToCallBottomSheet;->u0:Lje7;
    ...
    iget-object v7, v6, Lwf3;->c:Lfr1;

    invoke-virtual {v7}, Lfr1;->e()Ltyd;
    ...
    iget-object v7, v7, Lhoa;->c:Ljava/util/Map;

    iget-object v6, v6, Lwf3;->b:Lwf1;
    ...
    invoke-virtual {v1, v6}, Lone/me/sdk/uikit/common/button/OneMeButton;->setSize(Lt4a;)V
    ...
    invoke-direct {v8, p0, v9}, Lsf3;-><init>(Lone/me/calls/ui/bottomsheet/opponent/ConfirmRemoveOpponentToCallBottomSheet;I)V
    ...
    invoke-virtual {v8, v3}, Lone/me/sdk/uikit/common/button/OneMeButton;->setAppearance(Lq4a;)V

    invoke-virtual {v8, v6}, Lone/me/sdk/uikit/common/button/OneMeButton;->setSize(Lt4a;)V

    sget-object v2, Ls4a;->b:Ls4a;

    invoke-virtual {v8, v2}, Lone/me/sdk/uikit/common/button/OneMeButton;->setMode(Ls4a;)V
    ...
    invoke-direct {v0, p0, v2}, Lsf3;-><init>(Lone/me/calls/ui/bottomsheet/opponent/ConfirmRemoveOpponentToCallBottomSheet;I)V
    ...
    invoke-virtual {p0, v0, v2, v5, v2}, Lxi3;->d(IIII)V

    const/4 v3, 0x7

    invoke-virtual {p0, v0, v3, v5, v3}, Lxi3;->d(IIII)V
    ...
    invoke-virtual {p0, v0, v9, v7, v2}, Lxi3;->d(IIII)V

    new-instance v7, Lg0a;

    const/4 v10, 0x5

    invoke-direct {v7, p0, v9, v0, v10}, Lg0a;-><init>(Ljava/lang/Object;III)V
    ...
    invoke-virtual {v7, v10}, Lg0a;->e(I)V
    ...
    invoke-virtual {p0, v0, v2, p1, v9}, Lxi3;->d(IIII)V
    ...
    invoke-virtual {p0, v0, v9, p1, v2}, Lxi3;->d(IIII)V

    new-instance p1, Lg0a;

    const/4 v7, 0x5

    invoke-direct {p1, p0, v9, v0, v7}, Lg0a;-><init>(Ljava/lang/Object;III)V
    ...
    invoke-virtual {p1, v0}, Lg0a;->e(I)V
    ...
    invoke-virtual {p0, p1, v2, v0, v9}, Lxi3;->d(IIII)V

    invoke-virtual {v8}, Landroid/view/View;->getId()I

    move-result v0

    invoke-virtual {p0, p1, v3, v0, v6}, Lxi3;->d(IIII)V

    new-instance v0, Lg0a;

    const/4 v4, 0x5

    invoke-direct {v0, p0, v3, p1, v4}, Lg0a;-><init>(Ljava/lang/Object;III)V
    ...
    invoke-static {v4, v7, v0}, Lzt1;->p(FFLg0a;)V

    invoke-virtual {p0, p1, v6, v5, v6}, Lxi3;->d(IIII)V

    invoke-virtual {p0, p1, v9, v5, v2}, Lxi3;->d(IIII)V
    ...
    invoke-virtual {p0, p1, v2, v0, v2}, Lxi3;->d(IIII)V

    invoke-virtual {p0, p1, v3, v5, v3}, Lxi3;->d(IIII)V

    invoke-virtual {v1}, Landroid/view/View;->getId()I

    move-result v0

    invoke-virtual {p0, p1, v6, v0, v3}, Lxi3;->d(IIII)V
    ...
    invoke-virtual {p0, p1, v9, v0, v9}, Lxi3;->d(IIII)V
...
.method public final onViewCreated(Landroid/view/View;)V
    ...
    iget-object p1, p0, Lone/me/calls/ui/bottomsheet/opponent/ConfirmRemoveOpponentToCallBottomSheet;->u0:Lje7;
    ...
    invoke-direct {v0, v1, p0}, Luf3;-><init>(Lkotlin/coroutines/Continuation;Lone/me/calls/ui/bottomsheet/opponent/ConfirmRemoveOpponentToCallBottomSheet;)V
