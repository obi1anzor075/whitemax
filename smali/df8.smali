...
.method public constructor <init>(Landroidx/mediarouter/app/d;Z)V
    ...
    iput-object p1, p0, Ldf8;->b:Landroidx/mediarouter/app/d;

    iput-boolean p2, p0, Ldf8;->a:Z
...
.method public final onGlobalLayout()V
    ...
    iget-object v1, v0, Ldf8;->b:Landroidx/mediarouter/app/d;

    iget-object v2, v1, Landroidx/mediarouter/app/d;->z0:Landroid/widget/FrameLayout;
    ...
    iget-boolean v2, v1, Landroidx/mediarouter/app/d;->l1:Z

    const/4 v3, 0x1

    if-eqz v2, :cond_0

    iput-boolean v3, v1, Landroidx/mediarouter/app/d;->m1:Z

    return-void

    :cond_0
    iget-object v2, v1, Landroidx/mediarouter/app/d;->p0:Lmg8;

    iget-object v4, v1, Landroidx/mediarouter/app/d;->G0:Landroid/widget/LinearLayout;
    ...
    iget-object v6, v1, Landroidx/mediarouter/app/d;->G0:Landroid/widget/LinearLayout;

    invoke-static {v6, v4}, Landroidx/mediarouter/app/d;->m(Landroid/view/View;I)V

    iget-object v4, v1, Landroidx/mediarouter/app/d;->A0:Landroid/widget/ImageView;
    ...
    iget-object v8, v1, Landroidx/mediarouter/app/d;->A0:Landroid/widget/ImageView;
    ...
    iget-object v8, v1, Landroidx/mediarouter/app/d;->M0:Ljava/util/ArrayList;
    ...
    iget v9, v1, Landroidx/mediarouter/app/d;->U0:I

    iget-object v10, v2, Lmg8;->u:Ljava/util/ArrayList;
    ...
    iget-boolean v9, v1, Landroidx/mediarouter/app/d;->k1:Z
    ...
    iget-object v5, v1, Landroidx/mediarouter/app/d;->y0:Landroid/widget/LinearLayout;

    invoke-virtual {v5}, Landroid/view/View;->getMeasuredHeight()I

    move-result v5

    iget-object v11, v1, Landroidx/mediarouter/app/d;->z0:Landroid/widget/FrameLayout;
    ...
    :cond_6
    iget-object v6, v1, Landroidx/mediarouter/app/d;->K0:Landroidx/mediarouter/app/OverlayListView;
    ...
    iget-object v9, v1, Landroidx/mediarouter/app/d;->G0:Landroid/widget/LinearLayout;
    ...
    iget-object v6, v1, Landroidx/mediarouter/app/d;->z0:Landroid/widget/FrameLayout;
    ...
    iget-object v6, v1, Landroidx/mediarouter/app/d;->A0:Landroid/widget/ImageView;
    ...
    iget-object v4, v1, Landroidx/mediarouter/app/d;->H0:Landroid/widget/RelativeLayout;
    ...
    iget-object v5, v1, Landroidx/mediarouter/app/d;->K0:Landroidx/mediarouter/app/OverlayListView;

    invoke-virtual {v5}, Landroid/view/View;->clearAnimation()V

    iget-object v5, v1, Landroidx/mediarouter/app/d;->z0:Landroid/widget/FrameLayout;

    invoke-virtual {v5}, Landroid/view/View;->clearAnimation()V

    iget-boolean v0, v0, Ldf8;->a:Z
    ...
    iget-object v4, v1, Landroidx/mediarouter/app/d;->K0:Landroidx/mediarouter/app/OverlayListView;

    invoke-virtual {v1, v4, v8}, Landroidx/mediarouter/app/d;->f(Landroid/view/View;I)V

    iget-object v4, v1, Landroidx/mediarouter/app/d;->z0:Landroid/widget/FrameLayout;
    ...
    :goto_9
    iget-object v4, v1, Landroidx/mediarouter/app/d;->x0:Landroid/widget/FrameLayout;
    ...
    iget-object v0, v1, Landroidx/mediarouter/app/d;->M0:Ljava/util/ArrayList;

    invoke-virtual {v0}, Ljava/util/ArrayList;->clear()V

    iget-object v0, v1, Landroidx/mediarouter/app/d;->L0:Landroidx/mediarouter/app/c;
    ...
    :cond_d
    iget-object v4, v1, Landroidx/mediarouter/app/d;->M0:Ljava/util/ArrayList;
    ...
    iget-object v6, v1, Landroidx/mediarouter/app/d;->L0:Landroidx/mediarouter/app/c;
    ...
    iget-object v4, v1, Landroidx/mediarouter/app/d;->q0:Landroid/content/Context;
    ...
    :cond_12
    iget-object v3, v1, Landroidx/mediarouter/app/d;->M0:Ljava/util/ArrayList;
    ...
    iput-object v4, v1, Landroidx/mediarouter/app/d;->O0:Ljava/util/HashSet;

    iget-object v2, v1, Landroidx/mediarouter/app/d;->M0:Ljava/util/ArrayList;
    ...
    iget-object v2, v1, Landroidx/mediarouter/app/d;->L0:Landroidx/mediarouter/app/c;

    invoke-virtual {v2}, Landroid/widget/BaseAdapter;->notifyDataSetChanged()V

    if-eqz v0, :cond_13

    iget-boolean v0, v1, Landroidx/mediarouter/app/d;->k1:Z

    if-eqz v0, :cond_13

    iget-object v0, v1, Landroidx/mediarouter/app/d;->N0:Ljava/util/HashSet;
    ...
    iget-object v0, v1, Landroidx/mediarouter/app/d;->K0:Landroidx/mediarouter/app/OverlayListView;
    ...
    iput-boolean v0, v1, Landroidx/mediarouter/app/d;->l1:Z
    ...
    iput-object v0, v1, Landroidx/mediarouter/app/d;->O0:Ljava/util/HashSet;
