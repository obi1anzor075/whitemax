...
.method public constructor <init>(Lgz1;)V
    ...
    .line 36
    iget-object v0, p1, Lgz1;->b:Lqka;

    invoke-static {v0}, Lzg9;->d(Lrc3;)Lzg9;
    ...
    .line 38
    iget-object v0, p1, Lgz1;->e:Ljava/util/List;

    .line 39
    invoke-virtual {v2, v0}, Ljava/util/ArrayList;->addAll(Ljava/util/Collection;)Z

    .line 40
    iget-boolean v0, p1, Lgz1;->f:Z

    .line 41
    iput-boolean v0, p0, Lg40;->b:Z

    .line 42
    iget-object v0, p1, Lgz1;->g:Lxhe;
    ...
    .line 44
    iget-object v2, v0, Lxhe;->a:Landroid/util/ArrayMap;
    ...
    .line 47
    iget-object v4, v0, Lxhe;->a:Landroid/util/ArrayMap;
    ...
    .line 50
    invoke-direct {v0, v1}, Lxhe;-><init>(Landroid/util/ArrayMap;)V
...
.method public constructor <init>(Lqt1;Lxv1;Lly4;Lw4d;Lmi6;)V
    .locals 2
    ...
    invoke-direct {p1, p3, p4}, Lpc3;-><init>(Lly4;I)V
    ...
    invoke-direct {p1, p3, p2}, Lbmc;-><init>(ILjava/lang/Object;)V

    invoke-static {p1}, La4f;->t(Lbmc;)Z
...
.method public constructor <init>(Luo9;Lxw6;)V
    .locals 1
    ...
    invoke-direct {p1, p2}, Lt50;-><init>(Lxw6;)V
...
.method public static g(Landroid/hardware/camera2/TotalCaptureResult;Z)Z
    ...
    sget-object p0, Lqv3;->a:Ljava/util/Set;

    invoke-virtual {v1}, Lkkc;->W()I
    ...
    :goto_1
    iget-object v5, v1, Lkkc;->c:Ljava/lang/Object;
    ...
    sget-object p1, Lqv3;->d:Ljava/util/Set;

    invoke-virtual {v1}, Lkkc;->n()Llv1;
    ...
    sget-object p1, Lqv3;->c:Ljava/util/Set;
    ...
    :cond_f
    sget-object v3, Lqv3;->b:Ljava/util/Set;

    invoke-virtual {v1}, Lkkc;->j()Lnv1;
...
.method public c(Lrc3;)V
    ...
    :catch_0
    invoke-interface {p1, v1}, Lrc3;->i(Ls90;)Ljava/lang/Object;
    ...
    invoke-interface {p1, v1}, Lrc3;->n(Ls90;)Lqc3;

    move-result-object v4

    invoke-virtual {v3, v1, v4, v2}, Lzg9;->e(Ls90;Lqc3;Ljava/lang/Object;)V
...
.method public d()Lgz1;
    ...
    iget-object v9, v7, Lxhe;->a:Landroid/util/ArrayMap;
    ...
    iget-object v11, v7, Lxhe;->a:Landroid/util/ArrayMap;
    ...
    invoke-direct {v7, v8}, Lxhe;-><init>(Landroid/util/ArrayMap;)V
    ...
    invoke-direct/range {v0 .. v8}, Lgz1;-><init>(Ljava/util/ArrayList;Lqka;IZLjava/util/ArrayList;ZLxhe;Lpv1;)V

    return-object v0
.end method

.method public e()Lvr9;
    .locals 17
    ...
    iget-boolean v5, v4, Lsdc;->d:Z

    if-nez v5, :cond_1

    iget-object v5, v4, Lsdc;->c:[Ljava/lang/CharSequence;
    ...
    :cond_0
    iget-object v5, v4, Lsdc;->g:Ljava/util/Set;
    ...
    invoke-direct/range {v5 .. v16}, Lvr9;-><init>(Landroidx/core/graphics/drawable/IconCompat;Ljava/lang/CharSequence;Landroid/app/PendingIntent;Landroid/os/Bundle;[Lsdc;[Lsdc;ZIZZZ)V

    return-object v5
.end method

.method public f(III)Lqu1;
    .locals 10
    ...
    invoke-direct {v7, v0, v1}, Ljq0;-><init>(Lly4;I)V
    ...
    invoke-direct/range {v1 .. v7}, Lqu1;-><init>(ILw4d;Lmi6;Lqt1;ZLjq0;)V

    move-object v8, v1

    iget-object v9, v8, Lqu1;->h:Ljava/util/ArrayList;

    if-nez p1, :cond_0

    new-instance p1, Lmu1;

    invoke-direct {p1, v5}, Lmu1;-><init>(Lqt1;)V
    ...
    invoke-virtual {v0, v1}, Lly4;->g(Ljava/lang/Class;)Lkpb;

    move-result-object v0

    check-cast v0, Landroidx/camera/camera2/internal/compat/quirk/TorchFlashRequiredFor3aUpdateQuirk;

    iput-object v0, p3, Lzsd;->a:Ljava/lang/Object;

    invoke-direct {p1, v5, p2, p0, p3}, Lvu1;-><init>(Lqt1;Lw4d;Lmi6;Lzsd;)V
    ...
    invoke-direct {p0, v5, p2, v7}, Llu1;-><init>(Lqt1;ILjq0;)V
    ...
    invoke-direct/range {v1 .. v6}, Lxu1;-><init>(Lqt1;ILw4d;Lmi6;Z)V
...
.method public j(Lhv4;Lfz5;)Li40;
    .locals 2
    ...
    invoke-direct {v0, v1, p1, p2}, Li40;-><init>(Lv50;Lhv4;Lfz5;)V
