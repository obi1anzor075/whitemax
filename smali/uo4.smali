...
# static fields
.field public static final n:Ltfc;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Ltfc;-><init>(I)V

    sput-object v0, Luo4;->n:Ltfc;

    return-void
.end method

.method public constructor <init>(Landroid/content/Context;Lt34;Law0;Lf34;Ljava/util/concurrent/ExecutorService;)V
    .locals 6

    new-instance v2, Lda4;

    invoke-direct {v2, p2}, Lda4;-><init>(Lt34;)V

    new-instance v3, Lea4;

    new-instance p2, Lgw0;

    invoke-direct {p2}, Lgw0;-><init>()V

    iput-object p3, p2, Lgw0;->a:Law0;

    iput-object p4, p2, Lgw0;->d:Lf34;

    invoke-direct {v3, p2, p5}, Lea4;-><init>(Lgw0;Ljava/util/concurrent/ExecutorService;)V
    ...
    invoke-static {p3}, Lpaf;->o(Lil4;)Landroid/os/Handler;
    ...
    invoke-direct/range {v0 .. v5}, Lro4;-><init>(Landroid/os/HandlerThread;Lda4;Lea4;Landroid/os/Handler;Z)V

    iput-object v0, p0, Luo4;->c:Lro4;

    new-instance p3, Ld74;

    const/16 p4, 0x8

    invoke-direct {p3, p4, p0}, Ld74;-><init>(ILjava/lang/Object;)V

    iput-object p3, p0, Luo4;->d:Ld74;

    new-instance p4, Lya0;

    sget-object p5, Luo4;->n:Ltfc;

    invoke-direct {p4, p1, p3, p5}, Lya0;-><init>(Landroid/content/Context;Ld74;Ltfc;)V

    iput-object p4, p0, Luo4;->m:Lya0;

    invoke-virtual {p4}, Lya0;->c()I
...
.method public final b(Lya0;I)V
    .locals 2

    iget-object p1, p1, Lya0;->d:Ljava/lang/Object;
