...
.method public a(Lage;Lage;Landroid/view/Window;Landroid/view/View;ZZ)V
    ...
    invoke-direct {p1, p4}, Lef6;-><init>(Landroid/view/View;)V
    ...
    invoke-direct {p2, p4, p1}, Ld8g;-><init>(Landroid/view/WindowInsetsController;Lef6;)V

    iput-object p3, p2, Ld8g;->p0:Landroid/view/Window;
    ...
    invoke-direct {p2, p3, p1}, Lc8g;-><init>(Landroid/view/Window;Lef6;)V

    :goto_0
    xor-int/lit8 p1, p5, 0x1

    invoke-virtual {p2, p1}, Lp6g;->y(Z)V

    xor-int/2addr p0, p6

    invoke-virtual {p2, p0}, Lp6g;->x(Z)V
