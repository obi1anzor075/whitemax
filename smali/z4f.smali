...
.method public constructor <init>(Lhx3;Lkotlin/coroutines/Continuation;)V
    ...
    :goto_0
    invoke-direct {p0, v0, p2}, Lkotlinx/coroutines/internal/ScopeCoroutine;-><init>(Lhx3;Lkotlin/coroutines/Continuation;)V
    ...
    instance-of p2, p2, Ljx3;

    if-nez p2, :cond_1

    const/4 p2, 0x0

    invoke-static {p1, p2}, Lkotlinx/coroutines/internal/ThreadContextKt;->updateThreadContext(Lhx3;Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object p2

    invoke-static {p1, p2}, Lkotlinx/coroutines/internal/ThreadContextKt;->restoreThreadContext(Lhx3;Ljava/lang/Object;)V

    invoke-virtual {p0, p1, p2}, Lz4f;->E(Lhx3;Ljava/lang/Object;)V
...
.method public final E(Lhx3;Ljava/lang/Object;)V
    .locals 1
...
.method public final afterResume(Ljava/lang/Object;)V
    ...
    invoke-static {v1, v2}, Lkotlinx/coroutines/internal/ThreadContextKt;->updateThreadContext(Lhx3;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-static {v0, v1, v3}, Lzx7;->n0(Lkotlin/coroutines/Continuation;Lhx3;Ljava/lang/Object;)Lz4f;
    ...
    :cond_4
    :goto_0
    invoke-static {v1, v3}, Lkotlinx/coroutines/internal/ThreadContextKt;->restoreThreadContext(Lhx3;Ljava/lang/Object;)V
