...
.method public synthetic constructor <init>(Lone/me/chatscreen/ChatScreen;I)V
    ...
    iput-object p1, p0, Lvl2;->b:Lone/me/chatscreen/ChatScreen;
...
.method public final invoke(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object v0, v0, Lvl2;->b:Lone/me/chatscreen/ChatScreen;
    ...
    invoke-virtual {v1}, Luy8;->v()Lwx8;

    move-result-object v1

    if-eqz v1, :cond_0

    invoke-virtual {v0, v12}, Lone/me/chatscreen/ChatScreen;->V0(Z)V
    ...
    :cond_1
    invoke-virtual {v0, v10}, Lone/me/chatscreen/ChatScreen;->U0(Ljava/lang/CharSequence;)V

    invoke-virtual {v0}, Lone/me/chatscreen/ChatScreen;->S0()Lhp2;

    move-result-object v1

    iget-object v1, v1, Lhp2;->c:Lk95;

    iget-object v2, v1, Lk95;->a:Lvu0;

    invoke-virtual {v2, v1}, Lvu0;->f(Ljava/lang/Object;)V

    iget-object v0, v0, Lone/me/chatscreen/ChatScreen;->G0:Lje7;
    ...
    iget-object v0, v0, Lh8c;->c:Lj35;

    sget-object v1, Lz7c;->a:Lz7c;
    ...
    invoke-virtual {v2, v3}, Lvia;->setSubtitle(Ljava/lang/CharSequence;)V

    new-instance v3, Ldia;

    new-instance v4, Lvl2;

    invoke-direct {v4, v0, v5}, Lvl2;-><init>(Lone/me/chatscreen/ChatScreen;I)V
    ...
    invoke-direct {v3, v0, v4}, Lul2;-><init>(Lone/me/chatscreen/ChatScreen;I)V

    invoke-virtual {v2, v3}, Lvia;->setTitleClickListener(Lv56;)V
    ...
    invoke-direct {v2, v3}, Luea;-><init>(Landroid/content/Context;)V
    ...
    invoke-virtual {v2, v12}, Luea;->setShouldShowSearchIcon(Z)V

    new-instance v3, Lgn2;

    invoke-direct {v3, v0}, Lgn2;-><init>(Lone/me/chatscreen/ChatScreen;)V

    invoke-virtual {v2, v3}, Luea;->setListener(Lrea;)V

    invoke-virtual {v0}, Lone/me/chatscreen/ChatScreen;->S0()Lhp2;

    move-result-object v3

    invoke-virtual {v3}, Lhp2;->u()Z
    ...
    invoke-static {v0, v3}, Lu7;->x(Landroid/content/Context;I)Ljava/lang/String;

    move-result-object v0

    invoke-virtual {v2, v0}, Luea;->setSearchHint(Ljava/lang/String;)V
    ...
    iget-object v0, v0, Lone/me/chatscreen/ChatScreen;->Q0:Lsb8;

    if-eqz v0, :cond_9

    iget-object v1, v0, Lsb8;->c:Landroid/view/View;

    iget-object v2, v0, Lsb8;->b:Landroid/view/View;

    iget-boolean v3, v0, Lsb8;->l:Z

    if-eqz v3, :cond_9

    iget-boolean v3, v0, Lsb8;->g:Z
    ...
    iput-boolean v12, v0, Lsb8;->g:Z

    iget-object v0, v0, Lsb8;->i:Landroid/animation/AnimatorSet;
    ...
    invoke-direct {v2, v0, v4}, Lvl2;-><init>(Lone/me/chatscreen/ChatScreen;I)V
    ...
    invoke-static {v4}, Lxqd;->e(Landroid/view/View;)V
    ...
    invoke-direct {v13, v3, v10, v12}, Lhn2;-><init>(ILkotlin/coroutines/Continuation;I)V

    invoke-static {v13, v4}, Lxq7;->J(Ln66;Landroid/view/View;)V

    invoke-virtual {v2, v4}, Lvl2;->invoke(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-static {v2}, Lou0;->a(Landroid/content/Context;)Ls12;
    ...
    invoke-direct {v4, v3, v10, v12}, Lcn2;-><init>(ILkotlin/coroutines/Continuation;I)V
    ...
    invoke-virtual {v0}, Lone/me/chatscreen/ChatScreen;->T0()Z
    ...
    invoke-direct {v3, v8, v7, v8}, Ltq0;-><init>(IIZ)V

    invoke-direct {v0, v12, v3, v8}, Lp27;-><init>(ILtq0;I)V

    invoke-static {v2, v0, v10}, Lxqd;->d(Landroid/view/View;Lp27;Lx56;)V
    ...
    sget-object v13, Lone/me/chatscreen/ChatScreen;->g1:[Lbc7;

    new-instance v13, Lvl2;

    invoke-direct {v13, v0, v7}, Lvl2;-><init>(Lone/me/chatscreen/ChatScreen;I)V
    ...
    invoke-virtual {v13, v14}, Lvl2;->invoke(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-direct {v14, v4, v7, v8}, Ltq0;-><init>(IIZ)V

    invoke-direct {v2, v12, v14, v8}, Lp27;-><init>(ILtq0;I)V

    invoke-static {v13, v2, v10}, Lxqd;->d(Landroid/view/View;Lp27;Lx56;)V
    ...
    invoke-direct {v13, v9, v6}, Landroid/widget/FrameLayout$LayoutParams;-><init>(II)V
    ...
    invoke-direct {v15, v4, v7, v8}, Ltq0;-><init>(IIZ)V

    invoke-direct {v13, v12, v15, v8}, Lp27;-><init>(ILtq0;I)V

    invoke-static {v2, v13, v10}, Lxqd;->d(Landroid/view/View;Lp27;Lx56;)V

    :goto_6
    new-instance v13, Lc61;

    invoke-direct {v13, v7, v0}, Lc61;-><init>(ILjava/lang/Object;)V
    ...
    invoke-direct {v13, v3, v10, v4}, Lqq;-><init>(ILkotlin/coroutines/Continuation;I)V

    invoke-static {v13, v2}, Lxq7;->J(Ln66;Landroid/view/View;)V
    ...
    new-instance v13, Ltq0;

    invoke-direct {v13, v4, v7, v8}, Ltq0;-><init>(IIZ)V

    invoke-direct {v3, v12, v13, v8}, Lp27;-><init>(ILtq0;I)V

    invoke-static {v2, v3, v10}, Lxqd;->d(Landroid/view/View;Lp27;Lx56;)V
    ...
    invoke-static {v3}, Lwc7;->a(Landroid/content/Context;)I
    ...
    invoke-direct {v4, v5, v8, v8}, Ltq0;-><init>(IIZ)V

    invoke-direct {v3, v12, v4, v8}, Lp27;-><init>(ILtq0;I)V
    ...
    invoke-static {v2, v3, v4}, Lxqd;->d(Landroid/view/View;Lp27;Lx56;)V
    ...
    invoke-direct {v2, v12, v0}, Lp27;-><init>(ILtq0;)V

    move-object v0, v2

    :goto_9
    invoke-static {v1, v0, v10}, Lxqd;->d(Landroid/view/View;Lp27;Lx56;)V
    ...
    sget v3, Lmtb;->chat__root_container:I
    ...
    invoke-direct {v6, v5, v8, v8}, Ltq0;-><init>(IIZ)V

    invoke-direct {v4, v5, v6}, Lp27;-><init>(ILtq0;)V

    invoke-static {v3, v4, v10}, Lxqd;->d(Landroid/view/View;Lp27;Lx56;)V

    invoke-virtual {v1, v3}, Landroid/view/ViewGroup;->addView(Landroid/view/View;)V

    new-instance v3, Lvl2;

    invoke-direct {v3, v0, v8}, Lvl2;-><init>(Lone/me/chatscreen/ChatScreen;I)V
    ...
    invoke-virtual {v3, v0}, Lvl2;->invoke(Ljava/lang/Object;)Ljava/lang/Object;
