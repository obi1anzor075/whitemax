...
# direct methods
.method public static final a()Lme1;
    .locals 25
    ...
    invoke-direct {v5, v9, v6, v9}, Lt8f;-><init>(ZLru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;Z)V
    ...
    invoke-virtual {v0, v6}, Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey$Builder;->setType(Lw8f;)Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey$Builder;
    ...
    invoke-direct {v5, v9, v0, v9}, Lt8f;-><init>(ZLru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;Z)V

    new-instance v24, Lme1;
...
.method public static final b(Lru/ok/android/externcalls/sdk/id/ParticipantId;)Lle1;
    .locals 4
    ...
    invoke-static {p0, v0, v1, v2}, Lh0e;->q0(Ljava/lang/CharSequence;[Ljava/lang/String;ZI)Ljava/util/List;
    ...
    invoke-static {v0}, Lo0e;->G(Ljava/lang/String;)Ljava/lang/Integer;
    ...
    invoke-direct {v0, v2, v3, v1}, Lle1;-><init>(JI)V
...
.method public static final d(Lle1;)Lru/ok/android/externcalls/sdk/id/ParticipantId;
    .locals 3

    new-instance v0, Lru/ok/android/externcalls/sdk/id/ParticipantId;

    iget-wide v1, p0, Lle1;->a:J
