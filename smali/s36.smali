...
# static fields
.field public static final o0:Lddc;

.field public static final p0:Lddc;
...
.method static constructor <clinit>()V
    ...
    invoke-static {v1, v0}, Lfq0;->o(I[Ljava/lang/Object;)V

    invoke-static {v1, v0}, Lxw6;->h(I[Ljava/lang/Object;)Lddc;

    move-result-object v0

    sput-object v0, Ls36;->p0:Lddc;
...
.method public constructor <init>(Landroid/media/MediaMuxer;)V
    ...
    iput-object p1, p0, Ls36;->a:Landroid/media/MediaMuxer;
    ...
    iput-object p1, p0, Ls36;->c:Ljava/util/HashMap;

    new-instance p1, Ljava/util/HashMap;

    invoke-direct {p1}, Ljava/util/HashMap;-><init>()V

    iput-object p1, p0, Ls36;->o:Ljava/util/HashMap;
...
# virtual methods
.method public final b(Lql5;Ljava/nio/ByteBuffer;Landroid/media/MediaCodec$BufferInfo;)V
    .locals 18
    ...
    iget-wide v7, v0, Ls36;->b:J

    cmp-long v5, v7, v5

    if-eqz v5, :cond_0

    iget-object v5, v0, Ls36;->X:Lql5;
    ...
    :cond_0
    iget-boolean v5, v0, Ls36;->Y:Z

    iget-object v8, v0, Ls36;->a:Landroid/media/MediaMuxer;

    const/4 v6, 0x1

    iget-object v7, v0, Ls36;->o:Ljava/util/HashMap;
    ...
    iget-object v0, v0, Ls36;->c:Ljava/util/HashMap;
    ...
    invoke-static {v3, v4, v7, v6}, Lzt1;->k(JLjava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    invoke-static {v9, v5}, Lu27;->i(Ljava/lang/Object;Z)V
    ...
    invoke-static {v0, v15}, Lu27;->i(Ljava/lang/Object;Z)V
    ...
    invoke-static {v5, v6, v3, v4}, Lzt1;->k(JLjava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
...
.method public final close()V
    ...
    :cond_0
    iget-boolean v0, p0, Ls36;->Y:Z

    const/4 v1, 0x1

    iget-object v2, p0, Ls36;->a:Landroid/media/MediaMuxer;
    ...
    invoke-virtual {p0, v0, v5, v4}, Ls36;->b(Lql5;Ljava/nio/ByteBuffer;Landroid/media/MediaCodec$BufferInfo;)V

    :cond_2
    iput-boolean v3, p0, Ls36;->Y:Z

    :try_start_1
    invoke-static {v2}, Ls36;->a(Landroid/media/MediaMuxer;)V
    :try_end_1
    .catch Ljava/lang/RuntimeException; {:try_start_1 .. :try_end_1} :catch_1
...
.method public final h(Lv79;)V
    ...
    iget-object p0, p0, Ls36;->a:Landroid/media/MediaMuxer;
...
.method public final n(Lfz5;)Lql5;
    .locals 6
    ...
    iget-object v3, p0, Ls36;->a:Landroid/media/MediaMuxer;
    ...
    iget-object v4, p1, Lfz5;->z:La53;

    invoke-static {v0, v4}, Lzo3;->F(Landroid/media/MediaFormat;La53;)V
    ...
    invoke-direct {v0, p1, v1}, Lql5;-><init>(II)V

    if-eqz v2, :cond_2

    iput-object v0, p0, Ls36;->X:Lql5;
