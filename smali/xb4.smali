...
.field public final Z:Lnz7;

.field public final o0:Lnz7;

.field public p0:Ljava/net/HttpURLConnection;
...
# direct methods
.method public constructor <init>(IILnz7;)V
    .locals 1

    const/4 v0, 0x1

    invoke-direct {p0, v0}, Lfi0;-><init>(Z)V

    iput p1, p0, Lxb4;->X:I

    iput p2, p0, Lxb4;->Y:I

    iput-object p3, p0, Lxb4;->Z:Lnz7;

    new-instance p1, Lnz7;

    const/16 p2, 0x15

    invoke-direct {p1, p2}, Lnz7;-><init>(I)V

    iput-object p1, p0, Lxb4;->o0:Lnz7;
...
.method public final F(Lp34;)J
    ...
    iput-wide v12, v1, Lxb4;->u0:J

    iput-wide v12, v1, Lxb4;->t0:J

    invoke-virtual {v1}, Lfi0;->c()V
    ...
    iget-object v3, v0, Lp34;->a:Landroid/net/Uri;
    ...
    :goto_0
    iget-object v11, v0, Lp34;->e:Ljava/util/Map;

    const/4 v10, 0x1

    invoke-virtual/range {v1 .. v11}, Lxb4;->g(Ljava/net/URL;I[BJJZZLjava/util/Map;)Ljava/net/HttpURLConnection;

    move-result-object v2

    iget-wide v3, v0, Lp34;->f:J

    iget-wide v5, v0, Lp34;->g:J

    iput-object v2, v1, Lxb4;->p0:Ljava/net/HttpURLConnection;

    invoke-virtual {v2}, Ljava/net/HttpURLConnection;->getResponseCode()I

    move-result v7

    iput v7, v1, Lxb4;->s0:I

    invoke-virtual {v2}, Ljava/net/HttpURLConnection;->getResponseMessage()Ljava/lang/String;
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_5

    iget v7, v1, Lxb4;->s0:I
    ...
    sget-object v8, Ler6;->a:Ljava/util/regex/Pattern;
    ...
    invoke-static {v9}, Lou0;->m(Ljava/lang/String;)V
    ...
    sget-object v11, Ler6;->a:Ljava/util/regex/Pattern;
    ...
    invoke-static {v5}, Lou0;->m(Ljava/lang/String;)V
    ...
    iput-object v2, v1, Lxb4;->q0:Ljava/io/InputStream;

    if-eqz v7, :cond_a

    new-instance v2, Ljava/util/zip/GZIPInputStream;

    iget-object v6, v1, Lxb4;->q0:Ljava/io/InputStream;
    ...
    :cond_a
    :goto_7
    iput-boolean v14, v1, Lxb4;->r0:Z

    invoke-virtual/range {p0 .. p1}, Lfi0;->d(Lp34;)V

    :try_start_4
    invoke-virtual {v1, v3, v4}, Lxb4;->j(J)V
    :try_end_4
    .catch Ljava/io/IOException; {:try_start_4 .. :try_end_4} :catch_3

    iget-wide v0, v1, Lxb4;->t0:J
    ...
    sget-object v9, Ler6;->a:Ljava/util/regex/Pattern;
    ...
    :cond_d
    sget-object v9, Ler6;->b:Ljava/util/regex/Pattern;
...
.method public final close()V
    ...
    :try_start_0
    iget-object v2, p0, Lxb4;->q0:Ljava/io/InputStream;

    if-eqz v2, :cond_1

    iget-wide v3, p0, Lxb4;->t0:J
    ...
    :cond_0
    iget-wide v5, p0, Lxb4;->u0:J

    sub-long v5, v3, v5

    :goto_0
    iget-object v3, p0, Lxb4;->p0:Ljava/net/HttpURLConnection;

    invoke-static {v3, v5, v6}, Lxb4;->h(Ljava/net/HttpURLConnection;J)V
    :try_end_0
    ...
    :cond_1
    :goto_1
    iput-object v1, p0, Lxb4;->q0:Ljava/io/InputStream;

    invoke-virtual {p0}, Lxb4;->e()V

    iget-boolean v1, p0, Lxb4;->r0:Z

    if-eqz v1, :cond_2

    iput-boolean v0, p0, Lxb4;->r0:Z

    invoke-virtual {p0}, Lfi0;->b()V
...
.method public final e()V
    ...
    iget-object v0, p0, Lxb4;->p0:Ljava/net/HttpURLConnection;
    ...
    iput-object v0, p0, Lxb4;->p0:Ljava/net/HttpURLConnection;
...
.method public final g(Ljava/net/URL;I[BJJZZLjava/util/Map;)Ljava/net/HttpURLConnection;
    ...
    iget-object v1, p0, Lxb4;->Z:Lnz7;

    if-eqz v1, :cond_0

    invoke-virtual {v1}, Lnz7;->B()Ljava/util/Map;
    ...
    :cond_0
    iget-object p0, p0, Lxb4;->o0:Lnz7;

    invoke-virtual {p0}, Lnz7;->B()Ljava/util/Map;
    ...
    :cond_1
    sget-object p0, Ler6;->a:Ljava/util/regex/Pattern;
    ...
    invoke-static {p4, p5, p0, p10}, Lzt1;->k(JLjava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
...
.method public final getUri()Landroid/net/Uri;
    ...
    iget-object p0, p0, Lxb4;->p0:Ljava/net/HttpURLConnection;
...
.method public final j(J)V
    ...
    iget-object v5, p0, Lxb4;->q0:Ljava/io/InputStream;
    ...
    invoke-virtual {p0, v4}, Lfi0;->a(I)V
...
.method public final read([BII)I
    ...
    :cond_2
    iget-object v0, p0, Lxb4;->q0:Ljava/io/InputStream;
    ...
    :cond_3
    iget-wide p2, p0, Lxb4;->u0:J

    int-to-long v0, p1

    add-long/2addr p2, v0

    iput-wide p2, p0, Lxb4;->u0:J
