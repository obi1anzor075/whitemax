...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lzud;->r:Ljava/util/regex/Pattern;
...
.method public constructor <init>(Ljava/util/List;)V
    ...
    invoke-static {v0}, Lnaf;->m([B)Ljava/lang/String;
    ...
    invoke-static {v0}, Loe;->b(Ljava/lang/String;)Loe;

    move-result-object v0

    invoke-virtual {v0}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iput-object v0, p0, Lzud;->n:Loe;
    ...
    invoke-virtual {p0, v0}, Lzud;->i(Labf;)V

    return-void

    :cond_0
    iput-boolean v0, p0, Lzud;->m:Z

    const/4 p1, 0x0

    iput-object p1, p0, Lzud;->n:Loe;
...
.method public static j(Ljava/lang/String;)J
    ...
    sget-object v0, Lzud;->r:Ljava/util/regex/Pattern;
...
.method public final e(I[BZ)Lo9e;
    ...
    invoke-direct {v3, v4, v5}, Labf;-><init>(I[B)V

    iget-boolean v4, v0, Lzud;->m:Z

    if-nez v4, :cond_0

    invoke-virtual {v0, v3}, Lzud;->i(Labf;)V

    :cond_0
    if-eqz v4, :cond_1

    iget-object v4, v0, Lzud;->n:Loe;
    ...
    :goto_0
    invoke-virtual {v3}, Labf;->g()Ljava/lang/String;
    ...
    invoke-static {v6}, Loe;->b(Ljava/lang/String;)Loe;
    ...
    invoke-static {v8}, Lzud;->j(Ljava/lang/String;)J
    ...
    invoke-static {v12}, Lzud;->j(Ljava/lang/String;)J
    ...
    :cond_7
    iget-object v6, v0, Lzud;->o:Ljava/util/LinkedHashMap;
    ...
    sget-object v11, Ldvd;->a:Ljava/util/regex/Pattern;
    ...
    :try_start_0
    invoke-static {v10}, Ldvd;->a(Ljava/lang/String;)Landroid/graphics/PointF;
    ...
    :cond_9
    :try_start_1
    sget-object v5, Ldvd;->d:Ljava/util/regex/Pattern;
    ...
    invoke-static {v5}, Lfvd;->a(Ljava/lang/String;)I
    ...
    sget-object v5, Ldvd;->a:Ljava/util/regex/Pattern;
    ...
    iget-boolean v5, v6, Lfvd;->f:Z

    iget-object v0, v6, Lfvd;->c:Ljava/lang/Integer;
    ...
    invoke-direct/range {v16 .. v33}, Lp04;-><init>(Ljava/lang/CharSequence;Landroid/text/Layout$Alignment;Landroid/text/Layout$Alignment;Landroid/graphics/Bitmap;FIIFIIFFFZIIF)V

    move-object/from16 v0, v16

    invoke-static {v8, v9, v2, v1}, Lzud;->h(JLjava/util/ArrayList;Ljava/util/ArrayList;)I

    move-result v3

    invoke-static {v14, v15, v2, v1}, Lzud;->h(JLjava/util/ArrayList;Ljava/util/ArrayList;)I
    ...
    invoke-direct {v0, v1, v3, v2}, Lj7b;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V
...
.method public final i(Labf;)V
    ...
    :cond_0
    :goto_0
    invoke-virtual {v2}, Labf;->g()Ljava/lang/String;
    ...
    invoke-direct/range {v13 .. v22}, Lbvd;-><init>(IIIIIIIII)V
    ...
    invoke-static {v0}, Lfvd;->a(Ljava/lang/String;)I
    ...
    invoke-static {v0}, Lfvd;->c(Ljava/lang/String;)Ljava/lang/Integer;
    ...
    invoke-static {v4, v0}, Lu27;->d(Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-static {v0}, Lfvd;->b(Ljava/lang/String;)Z
    ...
    :goto_e
    invoke-direct/range {v15 .. v23}, Lfvd;-><init>(Ljava/lang/String;ILjava/lang/Integer;FZZZZ)V
    :try_end_3
    ...
    iget-object v0, v15, Lfvd;->a:Ljava/lang/String;
    ...
    :cond_1c
    iput-object v3, v1, Lzud;->o:Ljava/util/LinkedHashMap;
