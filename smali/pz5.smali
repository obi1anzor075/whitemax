...
# static fields
.field public static final w0:Le8c;

.field public static final x0:Le8c;
...
.method static constructor <clinit>()V
    ...
    invoke-virtual {v0, v1}, Lms6;->b([Ljava/lang/Object;)V
...
.method public constructor <init>(Landroid/media/MediaMuxer;J)V
    ...
    iput-object p1, p0, Lpz5;->a:Landroid/media/MediaMuxer;

    invoke-static {p2, p3}, Loze;->S(J)J

    move-result-wide p1

    iput-wide p1, p0, Lpz5;->b:J

    new-instance p1, Ljava/util/HashMap;

    invoke-direct {p1}, Ljava/util/HashMap;-><init>()V

    iput-object p1, p0, Lpz5;->c:Ljava/util/HashMap;

    new-instance p1, Ljava/util/HashMap;

    invoke-direct {p1}, Ljava/util/HashMap;-><init>()V

    iput-object p1, p0, Lpz5;->o:Ljava/util/HashMap;
...
.method public final close()V
    ...
    :cond_0
    iget-boolean v0, p0, Lpz5;->Y:Z

    const/4 v1, 0x1

    iget-object v2, p0, Lpz5;->a:Landroid/media/MediaMuxer;
    ...
    invoke-virtual {p0, v4, v5, v0}, Lpz5;->j(Loz5;Ljava/nio/ByteBuffer;Landroid/media/MediaCodec$BufferInfo;)V

    :cond_2
    iput-boolean v3, p0, Lpz5;->Y:Z

    :try_start_1
    invoke-static {v2}, Lpz5;->a(Landroid/media/MediaMuxer;)V
    :try_end_1
...
.method public final h(Lx29;)V
    ...
    iget-object p0, p0, Lpz5;->a:Landroid/media/MediaMuxer;
...
.method public final j(Loz5;Ljava/nio/ByteBuffer;Landroid/media/MediaCodec$BufferInfo;)V
    .locals 16
    ...
    :cond_0
    iget-boolean v4, v0, Lpz5;->Y:Z

    iget-object v5, v0, Lpz5;->o:Ljava/util/HashMap;

    const/4 v6, 0x1

    iget-object v9, v0, Lpz5;->a:Landroid/media/MediaMuxer;
    ...
    iget-object v0, v0, Lpz5;->c:Ljava/util/HashMap;
    ...
    invoke-static {v12, v13, v14, v6}, Lhr1;->k(JLjava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    invoke-static {v10, v7}, Loyb;->j(Ljava/lang/Object;Z)V
    ...
    invoke-static {v12, v13, v2, v3}, Lhr1;->k(JLjava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
...
.method public final s(Lxu5;)Loz5;
    .locals 6
    ...
    iget-object v3, p0, Lpz5;->a:Landroid/media/MediaMuxer;
    ...
    iget-object v4, p1, Lxu5;->A:Lz23;

    invoke-static {v1, v4}, Liu7;->H(Landroid/media/MediaFormat;Lz23;)V
    ...
    iget-object v0, p1, Lxu5;->d:Ljava/lang/String;
    ...
    :cond_1
    :goto_0
    iget-object v0, p1, Lxu5;->q:Ljava/util/List;

    invoke-static {v1, v0}, Liu7;->X(Landroid/media/MediaFormat;Ljava/util/List;)V
    ...
    invoke-direct {v0, p1}, Loz5;-><init>(I)V

    if-eqz v2, :cond_2

    iput-object v0, p0, Lpz5;->X:Loz5;
