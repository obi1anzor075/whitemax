...
.method static constructor <clinit>()V
    ...
    sput-wide v0, Ls60;->m:J

    return-void
.end method

.method public constructor <init>(Lf90;Landroid/content/Context;)V
    .locals 9
    ...
    iput-object v0, p0, Ls60;->d:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iput-object v0, p0, Ls60;->e:Ljava/util/concurrent/atomic/AtomicReference;

    iput-boolean v1, p0, Ls60;->l:Z
    ...
    invoke-static {v0, p1, p2}, Ls60;->b(ILf90;Landroid/content/Context;)Landroid/media/AudioRecord;

    move-result-object p1

    iput-object p1, p0, Ls60;->a:Landroid/media/AudioRecord;
...
.method public static b(ILf90;Landroid/content/Context;)Landroid/media/AudioRecord;
    .locals 4
...
.method public final a()V
    ...
    iget-object p0, p0, Ls60;->c:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public final c(Z)V
    ...
    iget-object v0, p0, Ls60;->i:Lw4d;

    iget-object v1, p0, Ls60;->h:Lly4;

    if-eqz v0, :cond_0

    if-eqz v1, :cond_0

    iget-object p0, p0, Ls60;->e:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    invoke-direct {p0, v1, p1, v2}, Lh60;-><init>(Ljava/lang/Object;ZI)V

    invoke-virtual {v0, p0}, Lw4d;->execute(Ljava/lang/Runnable;)V
...
.method public final d()V
    ...
    iget-object v0, p0, Ls60;->d:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iget-object v2, p0, Ls60;->a:Landroid/media/AudioRecord;
    ...
    iput-wide v2, p0, Ls60;->j:J

    iput-boolean v4, p0, Ls60;->l:Z

    iget-object v0, p0, Ls60;->e:Ljava/util/concurrent/atomic/AtomicReference;

    const/4 v2, 0x0

    invoke-virtual {v0, v2}, Ljava/util/concurrent/atomic/AtomicReference;->set(Ljava/lang/Object;)V

    iget-object v0, p0, Ls60;->a:Landroid/media/AudioRecord;
    ...
    :goto_1
    invoke-virtual {p0, v1}, Ls60;->c(Z)V
    ...
    iget-object p0, p0, Ls60;->a:Landroid/media/AudioRecord;
...
.method public final read(Ljava/nio/ByteBuffer;)Li90;
    ...
    iget-object v5, p0, Ls60;->a:Landroid/media/AudioRecord;
    ...
    iget-object v5, p0, Ls60;->b:Lf90;

    iget v5, v5, Lf90;->b:I

    iget-wide v7, p0, Ls60;->j:J
    ...
    invoke-static {v11, v9}, Lfq0;->k(Ljava/lang/String;Z)V
    ...
    invoke-static {v5, v7, v8}, Lvk9;->l(IJ)J
    ...
    sget-wide v7, Ls60;->m:J

    cmp-long p1, v5, v7

    if-lez p1, :cond_4

    iput-boolean v10, p0, Ls60;->l:Z
    ...
    :cond_5
    iget-wide v3, p0, Ls60;->j:J

    int-to-long v5, v0

    iget p1, p0, Ls60;->g:I

    invoke-static {p1, v5, v6}, Lvk9;->I(IJ)J

    move-result-wide v5

    add-long/2addr v5, v3

    iput-wide v5, p0, Ls60;->j:J

    :cond_6
    new-instance p0, Li90;

    invoke-direct {p0, v0, v1, v2}, Li90;-><init>(IJ)V
