...
.method public constructor <init>(Lq3f;)V
    ...
    iput-object v0, p0, Ls3f;->o:Ljava/util/HashSet;

    iput-object p1, p0, Ls3f;->a:Lq3f;

    invoke-interface {p1}, Lq3f;->a1()I
    ...
    iput-object v1, p0, Ls3f;->b:Landroid/util/Range;

    invoke-interface {p1}, Lq3f;->w1()I
    ...
    iput-object p1, p0, Ls3f;->c:Landroid/util/Range;
...
.method public static a(Lq3f;Landroid/util/Size;)Lq3f;
    .locals 2

    instance-of v0, p0, Ls3f;
    ...
    invoke-interface {p0, v0, v1}, Lq3f;->Q0(II)Z
    ...
    invoke-direct {v0, p0}, Ls3f;-><init>(Lq3f;)V
    ...
    iget-object v0, v0, Ls3f;->o:Ljava/util/HashSet;
...
.method public final A1(II)Z
    ...
    iget-object v0, p0, Ls3f;->a:Lq3f;

    invoke-interface {v0, p1, p2}, Lq3f;->A1(II)Z
    ...
    :cond_0
    iget-object v1, p0, Ls3f;->o:Ljava/util/HashSet;
    ...
    iget-object v3, p0, Ls3f;->b:Landroid/util/Range;
    ...
    iget-object p0, p0, Ls3f;->c:Landroid/util/Range;
...
.method public final r1(I)Landroid/util/Range;
    ...
    iget-object v1, p0, Ls3f;->c:Landroid/util/Range;

    invoke-virtual {v1, v0}, Landroid/util/Range;->contains(Ljava/lang/Comparable;)Z

    move-result v0

    iget-object v2, p0, Ls3f;->a:Lq3f;

    if-eqz v0, :cond_0

    invoke-interface {v2}, Lq3f;->w1()I
    ...
    invoke-static {p1, v0}, Le07;->j(Ljava/lang/String;Z)V

    iget-object p0, p0, Ls3f;->b:Landroid/util/Range;
...
.method public final v1(I)Landroid/util/Range;
    ...
    iget-object v1, p0, Ls3f;->b:Landroid/util/Range;
