...
.method public static e(Ljava/util/ArrayList;I)Lgn9;
    .locals 19
    ...
    invoke-static {v2}, Lhn9;->g(Landroid/app/Notification$Action;)[Landroid/app/RemoteInput;
    ...
    new-instance v16, Lu8c;

    invoke-static {v7}, Lhn9;->h(Landroid/app/RemoteInput;)Ljava/lang/String;

    move-result-object v9

    invoke-static {v7}, Lhn9;->f(Landroid/app/RemoteInput;)Ljava/lang/CharSequence;

    move-result-object v10

    invoke-static {v7}, Lhn9;->b(Landroid/app/RemoteInput;)[Ljava/lang/CharSequence;

    move-result-object v11

    invoke-static {v7}, Lhn9;->a(Landroid/app/RemoteInput;)Z

    move-result v12

    invoke-static {v7}, Lmn9;->c(Landroid/app/RemoteInput;)I

    move-result v13

    invoke-static {v7}, Lhn9;->d(Landroid/app/RemoteInput;)Landroid/os/Bundle;
    ...
    invoke-direct/range {v8 .. v15}, Lu8c;-><init>(Ljava/lang/String;Ljava/lang/CharSequence;[Ljava/lang/CharSequence;ZILandroid/os/Bundle;Ljava/util/HashSet;)V
    ...
    invoke-static {v2}, Lhn9;->c(Landroid/app/Notification$Action;)Landroid/os/Bundle;
    ...
    invoke-static {v2}, Lkn9;->a(Landroid/app/Notification$Action;)Z
    ...
    invoke-static {v2}, Lln9;->a(Landroid/app/Notification$Action;)I

    move-result v15

    invoke-static {v2}, Lmn9;->e(Landroid/app/Notification$Action;)Z
    ...
    invoke-static {v2}, Lnn9;->a(Landroid/app/Notification$Action;)Z
    ...
    invoke-static {v2}, Ljn9;->a(Landroid/app/Notification$Action;)Landroid/graphics/drawable/Icon;
    ...
    invoke-direct/range {v7 .. v18}, Lgn9;-><init>(Landroidx/core/graphics/drawable/IconCompat;Ljava/lang/CharSequence;Landroid/app/PendingIntent;Landroid/os/Bundle;[Lu8c;[Lu8c;ZIZZZ)V
    ...
    invoke-static {v0}, Lbo6;->c(Ljava/lang/Object;)I
    ...
    invoke-static {v0}, Lbo6;->a(Ljava/lang/Object;)I
    ...
    :cond_8
    invoke-static {v0}, Lzn6;->a(Landroid/graphics/drawable/Icon;)Landroidx/core/graphics/drawable/IconCompat;
