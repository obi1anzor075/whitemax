...
.method static constructor <clinit>()V
    ...
    sget-object v2, Lya7;->o:Lya7;

    const-string v3, "ALLOW_JAVA_COMMENTS"

    invoke-direct {v0, v3, v1, v2}, Lcb7;-><init>(Ljava/lang/String;ILya7;)V

    new-instance v1, Lcb7;

    const/4 v2, 0x1

    sget-object v3, Lya7;->X:Lya7;

    const-string v4, "ALLOW_YAML_COMMENTS"

    invoke-direct {v1, v4, v2, v3}, Lcb7;-><init>(Ljava/lang/String;ILya7;)V

    new-instance v2, Lcb7;

    const/4 v3, 0x2

    sget-object v4, Lya7;->Z:Lya7;

    const-string v5, "ALLOW_SINGLE_QUOTES"

    invoke-direct {v2, v5, v3, v4}, Lcb7;-><init>(Ljava/lang/String;ILya7;)V

    new-instance v3, Lcb7;

    const/4 v4, 0x3

    sget-object v5, Lya7;->Y:Lya7;

    const-string v6, "ALLOW_UNQUOTED_FIELD_NAMES"

    invoke-direct {v3, v6, v4, v5}, Lcb7;-><init>(Ljava/lang/String;ILya7;)V

    new-instance v4, Lcb7;

    const/4 v5, 0x4

    sget-object v6, Lya7;->o0:Lya7;

    const-string v7, "ALLOW_UNESCAPED_CONTROL_CHARS"

    invoke-direct {v4, v7, v5, v6}, Lcb7;-><init>(Ljava/lang/String;ILya7;)V

    new-instance v5, Lcb7;

    const/4 v6, 0x5

    sget-object v7, Lya7;->p0:Lya7;

    const-string v8, "ALLOW_BACKSLASH_ESCAPING_ANY_CHARACTER"

    invoke-direct {v5, v8, v6, v7}, Lcb7;-><init>(Ljava/lang/String;ILya7;)V

    new-instance v6, Lcb7;

    const/4 v7, 0x6

    sget-object v8, Lya7;->q0:Lya7;

    const-string v9, "ALLOW_LEADING_ZEROS_FOR_NUMBERS"

    invoke-direct {v6, v9, v7, v8}, Lcb7;-><init>(Ljava/lang/String;ILya7;)V

    new-instance v7, Lcb7;

    const/4 v8, 0x7

    sget-object v9, Lya7;->r0:Lya7;

    const-string v10, "ALLOW_LEADING_DECIMAL_POINT_FOR_NUMBERS"

    invoke-direct {v7, v10, v8, v9}, Lcb7;-><init>(Ljava/lang/String;ILya7;)V
    ...
    sget-object v10, Lya7;->s0:Lya7;

    const-string v11, "ALLOW_NON_NUMERIC_NUMBERS"

    invoke-direct {v8, v11, v9, v10}, Lcb7;-><init>(Ljava/lang/String;ILya7;)V

    new-instance v9, Lcb7;

    const/16 v10, 0x9

    sget-object v11, Lya7;->t0:Lya7;

    const-string v12, "ALLOW_MISSING_VALUES"

    invoke-direct {v9, v12, v10, v11}, Lcb7;-><init>(Ljava/lang/String;ILya7;)V

    new-instance v10, Lcb7;

    const/16 v11, 0xa

    sget-object v12, Lya7;->u0:Lya7;

    const-string v13, "ALLOW_TRAILING_COMMA"

    invoke-direct {v10, v13, v11, v12}, Lcb7;-><init>(Ljava/lang/String;ILya7;)V
