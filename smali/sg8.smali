...
.method public final onRouteAdded(Landroid/media/MediaRouter;Landroid/media/MediaRouter$RouteInfo;)V
    ...
    iget-object p0, p0, Lsg8;->a:Lwge;

    invoke-virtual {p0, p2}, Lwge;->i(Ljava/lang/Object;)Z
...
.method public final onRouteChanged(Landroid/media/MediaRouter;Landroid/media/MediaRouter$RouteInfo;)V
    ...
    invoke-static {p2}, Lwge;->n(Ljava/lang/Object;)Lvge;

    move-result-object p1

    if-nez p1, :cond_1

    invoke-virtual {p0, p2}, Lwge;->j(Ljava/lang/Object;)I

    move-result p1

    if-ltz p1, :cond_1

    iget-object p2, p0, Lwge;->x0:Ljava/util/ArrayList;
    ...
    iget-object v1, p1, Luge;->a:Ljava/lang/Object;
    ...
    :goto_0
    invoke-direct {p2, v0, v1}, Ljab;-><init>(Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual {p0, p1, p2}, Lwge;->o(Luge;Ljab;)V

    invoke-virtual {p2}, Ljab;->d()Lif8;

    move-result-object p2

    iput-object p2, p1, Luge;->c:Lif8;
...
.method public final onRoutePresentationDisplayChanged(Landroid/media/MediaRouter;Landroid/media/MediaRouter$RouteInfo;)V
    ...
    :goto_1
    iget-object v2, p1, Luge;->c:Lif8;

    iget-object v2, v2, Lif8;->a:Landroid/os/Bundle;
    ...
    iget-object v1, p1, Luge;->c:Lif8;

    if-eqz v1, :cond_5

    new-instance v2, Landroid/os/Bundle;

    iget-object v4, v1, Lif8;->a:Landroid/os/Bundle;

    invoke-direct {v2, v4}, Landroid/os/Bundle;-><init>(Landroid/os/Bundle;)V

    invoke-virtual {v1}, Lif8;->b()Ljava/util/List;
    ...
    iget-object v5, v1, Lif8;->c:Ljava/util/List;
    ...
    invoke-direct {p2, v2}, Lif8;-><init>(Landroid/os/Bundle;)V
...
.method public final onRouteSelected(Landroid/media/MediaRouter;ILandroid/media/MediaRouter$RouteInfo;)V
    ...
    iget-object p1, p0, Lwge;->q0:Ljava/lang/Object;
    ...
    :cond_0
    invoke-static {p3}, Lwge;->n(Ljava/lang/Object;)Lvge;

    move-result-object p1

    if-eqz p1, :cond_1

    iget-object p0, p1, Lvge;->a:Lmg8;
    ...
    :cond_1
    invoke-virtual {p0, p3}, Lwge;->j(Ljava/lang/Object;)I
    ...
    iget-object p0, p0, Lwge;->p0:Lxge;

    iget-object p1, p1, Luge;->b:Ljava/lang/String;

    check-cast p0, Ljg8;

    iget-object p2, p0, Ljg8;->m:Lhg8;

    const/16 p3, 0x106

    invoke-virtual {p2, p3}, Landroid/os/Handler;->removeMessages(I)V

    iget-object p2, p0, Ljg8;->c:Lsge;

    invoke-virtual {p0, p2}, Ljg8;->d(Lcg8;)Llg8;

    move-result-object p0

    if-eqz p0, :cond_2

    invoke-virtual {p0, p1}, Llg8;->a(Ljava/lang/String;)Lmg8;
...
.method public final onRouteVolumeChanged(Landroid/media/MediaRouter;Landroid/media/MediaRouter$RouteInfo;)V
    ...
    iget-object v0, p1, Luge;->c:Lif8;

    iget-object v0, v0, Lif8;->a:Landroid/os/Bundle;
    ...
    iget-object v3, v0, Lif8;->a:Landroid/os/Bundle;

    invoke-direct {v2, v3}, Landroid/os/Bundle;-><init>(Landroid/os/Bundle;)V

    invoke-virtual {v0}, Lif8;->b()Ljava/util/List;
    ...
    iget-object v0, v0, Lif8;->c:Ljava/util/List;
