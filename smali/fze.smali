...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Lfze;->o:[F

    const/4 p1, 0x2

    new-array p1, p1, [F

    iput-object p1, p0, Lfze;->o0:[F

    const/16 p1, 0x9

    new-array p1, p1, [F

    iput-object p1, p0, Lfze;->p0:[F

    new-instance p1, Landroid/graphics/Matrix;

    invoke-direct {p1}, Landroid/graphics/Matrix;-><init>()V

    iput-object p1, p0, Lfze;->q0:Landroid/graphics/Matrix;

    iput-boolean v1, p0, Lfze;->t0:Z

    iput-boolean v1, p0, Lfze;->u0:Z

    iput v1, p0, Lfze;->v0:I

    check-cast p0, Lfb6;

    sget-object p1, Landroid/widget/ImageView$ScaleType;->MATRIX:Landroid/widget/ImageView$ScaleType;

    invoke-virtual {p0, p1}, Lfze;->setScaleType(Landroid/widget/ImageView$ScaleType;)V
    ...
    iput-object p1, p0, Lfb6;->L0:Landroid/view/GestureDetector;
    ...
    invoke-direct {v1, p0}, Leb6;-><init>(Lfb6;)V

    invoke-direct {p1, v0, v1}, Landroid/view/ScaleGestureDetector;-><init>(Landroid/content/Context;Landroid/view/ScaleGestureDetector$OnScaleGestureListener;)V

    iput-object p1, p0, Lfb6;->J0:Landroid/view/ScaleGestureDetector;
    ...
    iput-object p1, p0, Lfb6;->K0:Lblc;
...
.method public getCurrentAngle()F
    ...
    iget-object p0, p0, Lfze;->q0:Landroid/graphics/Matrix;
...
.method public getCurrentScale()F
    ...
    invoke-static {p0}, Lxqd;->n(Landroid/graphics/Matrix;)F
...
.method public getImageOutputPath()Ljava/lang/String;
    ...
    iget-object p0, p0, Lfze;->w0:Ljava/lang/String;
...
.method public getMaxBitmapSize()I
    ...
    invoke-static {v0}, Lfq0;->j(Landroid/content/Context;)I

    move-result v0

    iput v0, p0, Lfze;->v0:I

    :cond_0
    iget p0, p0, Lfze;->v0:I
...
.method public getViewBitmap()Landroid/graphics/Bitmap;
    ...
    iget-object p0, p0, Lfb5;->b:Landroid/graphics/Bitmap;
...
.method public final onLayout(ZIIII)V
    ...
    iget-boolean p1, p0, Lfze;->t0:Z

    if-eqz p1, :cond_0

    iget-boolean p1, p0, Lfze;->u0:Z
...
.method public setImageBitmap(Landroid/graphics/Bitmap;)V
    ...
    invoke-direct {v0, p1}, Lfb5;-><init>(Landroid/graphics/Bitmap;)V
...
.method public setImageMatrix(Landroid/graphics/Matrix;)V
    ...
    :try_start_0
    iget-object p1, p0, Lfze;->o:[F

    iget-object v1, p0, Lfze;->r0:[F

    invoke-virtual {v0, p1, v1}, Landroid/graphics/Matrix;->mapPoints([F[F)V

    iget-object p1, p0, Lfze;->o0:[F

    iget-object p0, p0, Lfze;->s0:[F
...
.method public setTransformImageListener(Leze;)V
    .locals 0
