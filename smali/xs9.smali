...
.method public constructor <init>(Landroid/widget/FrameLayout;Lx5b;)V
    ...
    .line 4
    iput-object p2, p0, Lxs9;->d:Ljava/lang/Object;
...
.method public a(Landroid/os/Bundle;)V
    ...
    iget-boolean v0, p0, Lxs9;->a:Z

    if-eqz v0, :cond_0

    iget-object v0, p0, Lxs9;->d:Ljava/lang/Object;
    ...
    :cond_1
    invoke-virtual {p0}, Lxs9;->d()Ljava/lang/String;
...
.method public abstract b(Lku5;)V
.end method
...
.method public c(I)Landroid/widget/RemoteViews;
    ...
    iget-object v2, v2, Ljs9;->a:Landroid/content/Context;
    ...
    iget-object p1, p1, Ljs9;->i:Landroidx/core/graphics/drawable/IconCompat;
    ...
    iget-object v3, v3, Ljs9;->i:Landroidx/core/graphics/drawable/IconCompat;

    iget-object v4, p0, Lxs9;->b:Ljava/lang/Object;

    check-cast v4, Ljs9;

    iget-object v4, v4, Ljs9;->a:Landroid/content/Context;
    ...
    :cond_4
    :goto_1
    invoke-static {v3, v4}, Les6;->d(Landroidx/core/graphics/drawable/IconCompat;Landroid/content/Context;)Landroid/graphics/drawable/Icon;

    move-result-object v3

    invoke-static {v3, v4}, Les6;->c(Landroid/graphics/drawable/Icon;Landroid/content/Context;)Landroid/graphics/drawable/Drawable;
    ...
    iget-object p1, p1, Ljs9;->e:Ljava/lang/CharSequence;

    if-eqz p1, :cond_6

    sget v3, Lkub;->title:I
    ...
    iget-object p1, p1, Ljs9;->f:Ljava/lang/CharSequence;
    ...
    sget p1, Lzvb;->status_bar_notification_info_maxnum:I
    ...
    sget v4, Lkyb;->status_bar_notification_info_overflow:I
    ...
    iget-boolean v0, v4, Ljs9;->m:Z

    if-eqz v0, :cond_c

    sget v0, Lkub;->chronometer:I
    ...
    iget-object v4, v4, Ljs9;->F:Landroid/app/Notification;
...
.method public abstract k(Lede;Lj00;)V
.end method
...
.method public l()V
    ...
    invoke-virtual {p0}, Lxs9;->e()Landroid/view/View;

    move-result-object v1

    if-eqz v1, :cond_8

    iget-boolean v2, p0, Lxs9;->a:Z
    ...
    iget-object v3, p0, Lx5b;->a:Landroid/util/Size;
