...
.field public static final V0:Lnsf;
...
.field public J0:Lnsf;

.field public K0:Lnsf;

.field public L0:Lnsf;
...
.field public final Q0:Lm6;

.field public final R0:Lm6;

.field public final S0:Lms;

.field public final T0:Lp6;
...
.method static constructor <clinit>()V
    ...
    invoke-static {v1, v2, v1, v2}, Lqy6;->b(IIII)Lqy6;

    move-result-object v1

    invoke-virtual {v0, v1}, Lesf;->f(Lqy6;)V

    invoke-virtual {v0}, Lesf;->b()Lnsf;

    move-result-object v0

    sput-object v0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->V0:Lnsf;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget-object p2, Lnsf;->b:Lnsf;

    iput-object p2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->I0:Lnsf;

    iput-object p2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->J0:Lnsf;

    iput-object p2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->K0:Lnsf;

    iput-object p2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->L0:Lnsf;
    ...
    iput-object p2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->Q0:Lm6;
    ...
    iput-object p2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->R0:Lm6;
    ...
    iput-object p2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->S0:Lms;
    ...
    iput-object p2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->T0:Lp6;
...
.method public final b()V
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->Q0:Lm6;

    invoke-virtual {p0, v0}, Landroid/view/View;->removeCallbacks(Ljava/lang/Runnable;)Z

    iget-object v0, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->R0:Lm6;

    invoke-virtual {p0, v0}, Landroid/view/View;->removeCallbacks(Ljava/lang/Runnable;)Z

    iget-object p0, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->O0:Landroid/view/ViewPropertyAnimator;
...
.method public final draw(Landroid/graphics/Canvas;)V
    ...
    iget-object p0, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->x0:Landroid/graphics/drawable/Drawable;
...
.method public final e()V
    ...
    :goto_0
    iput-object v0, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->w0:Lt24;
...
.method public final f(Landroid/view/Menu;Lgm8;)V
    .locals 3
    ...
    iget-object v0, p0, Lcme;->m:Li7;

    iget-object v1, p0, Lcme;->a:Landroidx/appcompat/widget/Toolbar;
    ...
    invoke-direct {v0, v2}, Li7;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lcme;->m:Li7;

    :cond_0
    iget-object p0, p0, Lcme;->m:Li7;

    iput-object p2, p0, Li7;->X:Lgm8;
    ...
    iget-object p2, p2, Landroidx/appcompat/widget/ActionMenuView;->a:Lpl8;
    ...
    iget-object v0, v1, Landroidx/appcompat/widget/Toolbar;->d1:Li7;

    invoke-virtual {p2, v0}, Lpl8;->r(Lhm8;)V

    iget-object v0, v1, Landroidx/appcompat/widget/Toolbar;->e1:Lrle;

    invoke-virtual {p2, v0}, Lpl8;->r(Lhm8;)V

    :cond_3
    iget-object p2, v1, Landroidx/appcompat/widget/Toolbar;->e1:Lrle;

    if-nez p2, :cond_4

    new-instance p2, Lrle;

    invoke-direct {p2, v1}, Lrle;-><init>(Landroidx/appcompat/widget/Toolbar;)V

    iput-object p2, v1, Landroidx/appcompat/widget/Toolbar;->e1:Lrle;

    :cond_4
    const/4 p2, 0x1

    iput-boolean p2, p0, Li7;->F0:Z

    if-eqz p1, :cond_5

    iget-object p2, v1, Landroidx/appcompat/widget/Toolbar;->B0:Landroid/content/Context;

    invoke-virtual {p1, p0, p2}, Lpl8;->b(Lhm8;Landroid/content/Context;)V

    iget-object p2, v1, Landroidx/appcompat/widget/Toolbar;->e1:Lrle;

    iget-object v0, v1, Landroidx/appcompat/widget/Toolbar;->B0:Landroid/content/Context;

    invoke-virtual {p1, p2, v0}, Lpl8;->b(Lhm8;Landroid/content/Context;)V
    ...
    invoke-virtual {p0, p1, p2}, Li7;->k(Landroid/content/Context;Lpl8;)V

    iget-object p1, v1, Landroidx/appcompat/widget/Toolbar;->e1:Lrle;

    iget-object v0, v1, Landroidx/appcompat/widget/Toolbar;->B0:Landroid/content/Context;

    invoke-virtual {p1, v0, p2}, Lrle;->k(Landroid/content/Context;Lpl8;)V

    invoke-virtual {p0}, Li7;->i()V

    iget-object p1, v1, Landroidx/appcompat/widget/Toolbar;->e1:Lrle;

    invoke-virtual {p1}, Lrle;->i()V
    ...
    invoke-virtual {p1, p0}, Landroidx/appcompat/widget/ActionMenuView;->setPresenter(Li7;)V

    iput-object p0, v1, Landroidx/appcompat/widget/Toolbar;->d1:Li7;
...
.method public getNestedScrollAxes()I
    ...
    iget-object p0, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->S0:Lms;
...
.method public final onApplyWindowInsets(Landroid/view/WindowInsets;)Landroid/view/WindowInsets;
    ...
    invoke-static {p0, p1}, Lnsf;->f(Landroid/view/View;Landroid/view/WindowInsets;)Lnsf;
    ...
    invoke-static {p0, p1, v1}, Lt9f;->b(Landroid/view/View;Lnsf;Landroid/graphics/Rect;)Lnsf;
    ...
    invoke-virtual {p1, v2, v3, v4, v5}, Llsf;->l(IIII)Lnsf;

    move-result-object v2

    iput-object v2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->I0:Lnsf;

    iget-object v3, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->J0:Lnsf;

    invoke-virtual {v3, v2}, Lnsf;->equals(Ljava/lang/Object;)Z
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->I0:Lnsf;

    iput-object v0, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->J0:Lnsf;
...
.method public final onMeasure(II)V
    ...
    iget-boolean v7, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->z0:Z
    ...
    iget-object v7, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->I0:Lnsf;

    iput-object v7, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->K0:Lnsf;

    iget-boolean v7, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->y0:Z

    if-nez v7, :cond_4

    if-nez v4, :cond_4

    iget-object v4, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->T0:Lp6;

    sget-object v7, Landroidx/appcompat/widget/ActionBarOverlayLayout;->V0:Lnsf;

    iget-object v9, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->H0:Landroid/graphics/Rect;

    invoke-static {v4, v7, v9}, Lt9f;->b(Landroid/view/View;Lnsf;Landroid/graphics/Rect;)Lnsf;

    sget-object v4, Landroidx/appcompat/widget/ActionBarOverlayLayout;->W0:Landroid/graphics/Rect;
    ...
    iget-object v4, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->K0:Lnsf;

    iget-object v4, v4, Lnsf;->a:Llsf;

    invoke-virtual {v4, v2, v6, v2, v2}, Llsf;->l(IIII)Lnsf;

    move-result-object v2

    iput-object v2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->K0:Lnsf;

    goto :goto_3

    :cond_4
    iget-object v2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->K0:Lnsf;
    ...
    iget-object v6, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->K0:Lnsf;

    invoke-virtual {v6}, Lnsf;->c()I

    move-result v6

    iget-object v7, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->K0:Lnsf;

    invoke-virtual {v7}, Lnsf;->a()I

    move-result v7

    invoke-static {v2, v4, v6, v7}, Lqy6;->b(IIII)Lqy6;
    ...
    invoke-direct {v6, v4}, Ldsf;-><init>(Lnsf;)V
    ...
    invoke-direct {v6, v4}, Lcsf;-><init>(Lnsf;)V

    :goto_2
    invoke-virtual {v6, v2}, Lcsf;->f(Lqy6;)V

    invoke-virtual {v6}, Lcsf;->b()Lnsf;
    ...
    iget-object v2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->L0:Lnsf;

    iget-object v4, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->K0:Lnsf;

    invoke-virtual {v2, v4}, Lnsf;->equals(Ljava/lang/Object;)Z
    ...
    iput-object v2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->L0:Lnsf;

    iget-object v4, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->c:Landroidx/appcompat/widget/ContentFrameLayout;

    invoke-static {v4, v2}, Leaf;->b(Landroid/view/View;Lnsf;)Lnsf;
...
.method public final onNestedFling(Landroid/view/View;FFZ)Z
    ...
    iget-object p1, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->R0:Lm6;
    ...
    iget-object p1, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->Q0:Lm6;
...
.method public final onNestedScrollAccepted(Landroid/view/View;Landroid/view/View;I)V
    ...
    iget-object p1, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->S0:Lms;
    ...
    iget-object p0, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->M0:Ln6;

    if-eqz p0, :cond_0

    check-cast p0, Ltrf;

    iget-object p1, p0, Ltrf;->x:Lacf;

    if-eqz p1, :cond_0

    invoke-virtual {p1}, Lacf;->a()V
...
.method public final onStartNestedScroll(Landroid/view/View;Landroid/view/View;I)Z
    ...
    :cond_0
    iget-boolean p0, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->A0:Z
...
.method public final onWindowSystemUiVisibilityChanged(I)V
    ...
    :goto_1
    iget-object v4, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->M0:Ln6;
    ...
    iget-boolean p1, v4, Ltrf;->u:Z

    if-nez p1, :cond_4

    iput-boolean v3, v4, Ltrf;->u:Z

    invoke-virtual {v4, v3}, Ltrf;->j0(Z)V
    ...
    iget-object p1, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->M0:Ln6;
...
.method public setActionBarVisibilityCallback(Ln6;)V
    ...
    iput-object p1, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->M0:Ln6;
...
.method public setIcon(I)V
    ...
    .line 6
    :goto_0
    iput-object p1, p0, Lcme;->d:Landroid/graphics/drawable/Drawable;
...
.method public setLogo(I)V
    ...
    :goto_0
    iput-object p1, p0, Lcme;->e:Landroid/graphics/drawable/Drawable;
...
.method public setWindowCallback(Landroid/view/Window$Callback;)V
    ...
    iput-object p1, p0, Lcme;->k:Landroid/view/Window$Callback;
