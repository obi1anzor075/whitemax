...
.field public final t0:Landroid/media/MediaRouter$RouteCategory;
...
.method static constructor <clinit>()V
    ...
    sput-object v1, Lwge;->z0:Ljava/util/ArrayList;
    ...
    sput-object v1, Lwge;->A0:Ljava/util/ArrayList;
...
.method public constructor <init>(Landroid/content/Context;Ljg8;)V
    ...
    invoke-direct {v0, v2, v1}, Lhd7;-><init>(ILjava/lang/Object;)V
    ...
    iput-object v0, p0, Lwge;->x0:Ljava/util/ArrayList;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lwge;->y0:Ljava/util/ArrayList;

    iput-object p2, p0, Lwge;->p0:Lxge;
    ...
    iput-object p2, p0, Lwge;->q0:Ljava/lang/Object;
    ...
    invoke-direct {v1, v0}, Lsg8;-><init>(Lwge;)V

    iput-object v1, p0, Lwge;->r0:Ljava/lang/Object;

    new-instance v0, Lqg8;

    invoke-direct {v0, p0}, Lqg8;-><init>(Lpg8;)V

    iput-object v0, p0, Lwge;->s0:Lqg8;

    invoke-virtual {p1}, Landroid/content/Context;->getResources()Landroid/content/res/Resources;

    move-result-object p1

    sget v0, Lgzb;->mr_user_route_category_name:I
    ...
    iput-object p1, p0, Lwge;->t0:Landroid/media/MediaRouter$RouteCategory;
...
.method public static n(Ljava/lang/Object;)Lvge;
    .locals 1
...
.method public final a(Landroid/media/MediaRouter$RouteInfo;I)V
    ...
    invoke-static {p1}, Lwge;->n(Ljava/lang/Object;)Lvge;

    move-result-object p0

    if-eqz p0, :cond_0

    iget-object p0, p0, Lvge;->a:Lmg8;

    invoke-virtual {p0, p2}, Lmg8;->j(I)V
...
.method public final b(Landroid/media/MediaRouter$RouteInfo;I)V
    ...
    invoke-virtual {p0, p2}, Lmg8;->k(I)V
...
.method public final d(Ljava/lang/String;)Lbg8;
    ...
    invoke-virtual {p0, p1}, Lwge;->k(Ljava/lang/String;)I

    move-result p1

    if-ltz p1, :cond_0

    iget-object p0, p0, Lwge;->x0:Ljava/util/ArrayList;
    ...
    iget-object p0, p0, Luge;->a:Ljava/lang/Object;

    invoke-direct {p1, p0}, Ltge;-><init>(Ljava/lang/Object;)V
...
.method public final f(Lkf8;)V
    ...
    iget-object v1, p1, Lkf8;->b:Lfg8;

    invoke-virtual {v1}, Lfg8;->b()Ljava/util/ArrayList;
    ...
    :goto_2
    iget v1, p0, Lwge;->u0:I

    if-ne v1, v0, :cond_5

    iget-boolean v1, p0, Lwge;->v0:Z
    ...
    :cond_5
    :goto_3
    iput v0, p0, Lwge;->u0:I

    iput-boolean p1, p0, Lwge;->v0:Z
...
.method public final i(Ljava/lang/Object;)Z
    ...
    invoke-virtual {p0, p1}, Lwge;->j(Ljava/lang/Object;)I

    move-result v0

    if-gez v0, :cond_5

    invoke-virtual {p0}, Lwge;->m()Landroid/media/MediaRouter$RouteInfo;

    move-result-object v0

    const-string v1, ""

    iget-object v2, p0, Lcg8;->a:Landroid/content/Context;
    ...
    :goto_1
    invoke-virtual {p0, v0}, Lwge;->k(Ljava/lang/String;)I
    ...
    invoke-virtual {p0, v4}, Lwge;->k(Ljava/lang/String;)I
    ...
    invoke-direct {v3, p1, v0}, Luge;-><init>(Ljava/lang/Object;Ljava/lang/String;)V
    ...
    :cond_3
    invoke-direct {v4, v0, v1}, Ljab;-><init>(Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual {p0, v3, v4}, Lwge;->o(Luge;Ljab;)V

    invoke-virtual {v4}, Ljab;->d()Lif8;

    move-result-object p1

    iput-object p1, v3, Luge;->c:Lif8;
...
.method public final j(Ljava/lang/Object;)I
    ...
    iget-object v2, v2, Luge;->a:Ljava/lang/Object;
...
.method public final k(Ljava/lang/String;)I
    ...
    iget-object v2, v2, Luge;->b:Ljava/lang/String;
...
.method public final l(Lmg8;)I
    .locals 3

    iget-object p0, p0, Lwge;->y0:Ljava/util/ArrayList;
...
.method public o(Luge;Ljab;)V
    .locals 2

    iget-object p0, p2, Ljab;->a:Ljava/lang/Object;

    check-cast p0, Landroid/os/Bundle;

    iget-object p1, p1, Luge;->a:Ljava/lang/Object;
    ...
    sget-object v1, Lwge;->z0:Ljava/util/ArrayList;

    invoke-virtual {p2, v1}, Ljab;->c(Ljava/util/List;)V
    ...
    sget-object v0, Lwge;->A0:Ljava/util/ArrayList;

    invoke-virtual {p2, v0}, Ljab;->c(Ljava/util/List;)V
...
.method public final p(Lmg8;)V
    ...
    iget-object v1, p0, Lwge;->q0:Ljava/lang/Object;

    if-eq v0, p0, :cond_0

    check-cast v1, Landroid/media/MediaRouter;

    iget-object v0, p0, Lwge;->t0:Landroid/media/MediaRouter$RouteCategory;
    ...
    invoke-direct {v2, p1, v0}, Lvge;-><init>(Lmg8;Landroid/media/MediaRouter$UserRouteInfo;)V

    invoke-virtual {v0, v2}, Landroid/media/MediaRouter$RouteInfo;->setTag(Ljava/lang/Object;)V

    iget-object p1, p0, Lwge;->s0:Lqg8;
    ...
    invoke-virtual {p0, v2}, Lwge;->w(Lvge;)V
    ...
    invoke-virtual {p0, v0}, Lwge;->j(Ljava/lang/Object;)I
    ...
    iget-object p0, p0, Luge;->b:Ljava/lang/String;

    iget-object v0, p1, Lmg8;->b:Ljava/lang/String;
    ...
    invoke-virtual {p1}, Lmg8;->l()V

    :cond_1
    return-void
.end method

.method public final q(Lmg8;)V
    .locals 2
    ...
    invoke-virtual {p0, p1}, Lwge;->l(Lmg8;)I

    move-result p1

    if-ltz p1, :cond_0

    iget-object v0, p0, Lwge;->y0:Ljava/util/ArrayList;
    ...
    iget-object p1, p1, Lvge;->b:Ljava/lang/Object;
    ...
    iget-object p0, p0, Lwge;->q0:Ljava/lang/Object;
...
.method public final r(Lmg8;)V
    ...
    invoke-virtual {p0, p1}, Lwge;->t(Ljava/lang/Object;)V

    return-void

    :cond_1
    iget-object p1, p1, Lmg8;->b:Ljava/lang/String;
    ...
    iget-object v0, p0, Lwge;->x0:Ljava/util/ArrayList;
...
.method public final s()V
    ...
    invoke-direct {v0, v2, v3}, Ldg8;-><init>(Ljava/util/ArrayList;Z)V
...
.method public final v()V
    ...
    invoke-virtual {p0}, Lwge;->u()V

    iget-object v0, p0, Lwge;->q0:Ljava/lang/Object;
    ...
    invoke-virtual {p0, v1}, Lwge;->i(Ljava/lang/Object;)Z
    ...
    invoke-virtual {p0}, Lwge;->s()V

    :cond_2
    return-void
.end method

.method public w(Lvge;)V
    .locals 2

    iget-object p0, p1, Lvge;->b:Ljava/lang/Object;

    iget-object v0, p1, Lvge;->a:Lmg8;

    iget-object v1, v0, Lmg8;->d:Ljava/lang/String;
