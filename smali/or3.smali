...
.method public synthetic constructor <init>(Lone/me/sdk/arch/Widget;I)V
    ...
    iput-object p1, p0, Lor3;->e:Ljava/lang/Object;
...
.method public constructor <init>(Lone/me/startconversation/StartConversationScreen;Z)V
    ...
    .line 3
    invoke-direct {p0, p2}, Lww9;-><init>(Z)V

    return-void
.end method

.method public constructor <init>(ZLu16;)V
    .locals 1
...
.method public a()V
    ...
    iget-object p0, p0, Lor3;->e:Ljava/lang/Object;
    ...
    :cond_0
    iget-object v0, p0, Landroidx/fragment/app/c;->h:Lhd0;

    if-eqz v0, :cond_2

    const/4 v1, 0x0

    iput-boolean v1, v0, Lhd0;->r:Z
    ...
    iget-object v3, v0, Lhd0;->p:Ljava/util/ArrayList;
    ...
    iput-object v3, v0, Lhd0;->p:Ljava/util/ArrayList;

    :cond_1
    iget-object v0, v0, Lhd0;->p:Ljava/util/ArrayList;
...
.method public final b()V
    ...
    iget-object v2, p0, Lor3;->e:Ljava/lang/Object;
    ...
    iget-object v0, v2, Lone/me/startconversation/StartConversationScreen;->y0:Ln0c;
    ...
    invoke-virtual {v2}, Lone/me/login/inputname/InputNameScreen;->q0()V
    ...
    iget-object v4, v2, Landroidx/fragment/app/c;->h:Lhd0;

    iget-object v5, v2, Landroidx/fragment/app/c;->i:Lor3;
    ...
    iget-object v8, v2, Landroidx/fragment/app/c;->h:Lhd0;

    invoke-static {v8}, Landroidx/fragment/app/c;->G(Lhd0;)Ljava/util/HashSet;
    ...
    iget-object v4, v4, Lhd0;->a:Ljava/util/ArrayList;
    ...
    iget-object v6, v6, Ldy5;->b:Landroidx/fragment/app/a;

    if-eqz v6, :cond_6

    iput-boolean v1, v6, Landroidx/fragment/app/a;->C0:Z
    ...
    iget-object v6, v2, Landroidx/fragment/app/c;->h:Lhd0;
    ...
    iget-object v4, v1, Lxa4;->c:Ljava/util/ArrayList;

    invoke-virtual {v1, v4}, Lxa4;->j(Ljava/util/ArrayList;)V

    invoke-virtual {v1, v4}, Lxa4;->c(Ljava/util/ArrayList;)V

    goto :goto_3

    :cond_8
    iget-object v0, v2, Landroidx/fragment/app/c;->h:Lhd0;

    iget-object v0, v0, Lhd0;->a:Ljava/util/ArrayList;
    ...
    iget-object v1, v1, Ldy5;->b:Landroidx/fragment/app/a;

    if-eqz v1, :cond_9

    iget-object v4, v1, Landroidx/fragment/app/a;->X0:Landroid/view/ViewGroup;
    ...
    :cond_a
    iput-object v7, v2, Landroidx/fragment/app/c;->h:Lhd0;
    ...
    :cond_c
    iget-object p0, v2, Landroidx/fragment/app/c;->g:Lex9;
    ...
    invoke-virtual {v2, v1}, Lone/me/calls/ui/ui/call/CallScreen;->p0(Z)V
    ...
    invoke-virtual {v2}, Lone/me/calls/ui/ui/incoming/CallIncomingScreen;->l0()Lp71;

    move-result-object v3

    :cond_f
    iget-object p0, v3, Lp71;->x0:Lgrd;
    ...
    invoke-direct {v2, v1}, Lm71;-><init>(Z)V

    invoke-virtual {p0, v0, v2}, Lgrd;->b(Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    iget-object v3, v2, Lrr3;->router:Lsgc;

    invoke-virtual {v3}, Lsgc;->i()Lsgc;

    move-result-object v3

    invoke-virtual {v3}, Lsgc;->m()Z

    move-result v3

    if-nez v3, :cond_10

    invoke-virtual {p0, v1}, Lww9;->f(Z)V

    invoke-virtual {v2}, Lrr3;->getOnBackPressedDispatcher()Lex9;

    move-result-object v1

    invoke-virtual {v1}, Lex9;->d()V

    iget-boolean v1, v2, Lrr3;->isBeingDestroyed:Z
...
.method public c(Lgd0;)V
    ...
    iget-object v2, v2, Lxa4;->c:Ljava/util/ArrayList;
    ...
    iget-object v4, v4, Ljmd;->k:Ljava/util/ArrayList;

    invoke-static {v4, v3}, Lu23;->K(Ljava/lang/Iterable;Ljava/util/AbstractCollection;)V
    ...
    invoke-virtual {v5, p1}, Limd;->c(Lgd0;)V
...
.method public d()V
    ...
    invoke-direct {v0, p0}, Lux5;-><init>(Landroidx/fragment/app/c;)V

    const/4 v1, 0x0

    invoke-virtual {p0, v0, v1}, Landroidx/fragment/app/c;->y(Lsx5;Z)V
