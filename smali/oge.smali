...
.method static constructor <clinit>()V
    ...
    sput-object v0, Loge;->X:Ljava/lang/String;

    return-void
.end method

.method public constructor <init>(Landroid/content/Context;Lw8g;)V
    .locals 2
    ...
    invoke-direct {v1, p1}, Lnge;-><init>(Landroid/content/Context;)V

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Loge;->a:Landroid/content/Context;

    iput-object p2, p0, Loge;->c:Lw8g;

    iput-object v0, p0, Loge;->b:Landroid/app/job/JobScheduler;

    iput-object v1, p0, Loge;->o:Lnge;
...
.method public static a(Landroid/app/job/JobScheduler;I)V
    ...
    sget-object v1, Loge;->X:Ljava/lang/String;

    invoke-virtual {v0, v1, p1, p0}, Lfc2;->o(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public static d(Landroid/content/Context;Landroid/app/job/JobScheduler;)Ljava/util/ArrayList;
    ...
    sget-object v2, Loge;->X:Ljava/lang/String;

    const-string v3, "getAllPendingJobs() is not reliable on this device."

    invoke-virtual {v1, v2, v3, p1}, Lfc2;->o(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public static f(Landroid/app/job/JobInfo;)Lp8g;
    .locals 3
    ...
    invoke-direct {v2, p0, v1}, Lp8g;-><init>(Ljava/lang/String;I)V
    :try_end_0
...
.method public final c(Ljava/lang/String;)V
    ...
    iget-object v0, p0, Loge;->a:Landroid/content/Context;

    iget-object v1, p0, Loge;->b:Landroid/app/job/JobScheduler;

    invoke-static {v0, v1}, Loge;->d(Landroid/content/Context;Landroid/app/job/JobScheduler;)Ljava/util/ArrayList;
    ...
    invoke-static {v3}, Loge;->f(Landroid/app/job/JobInfo;)Lp8g;
    ...
    invoke-static {v1, v2}, Loge;->a(Landroid/app/job/JobScheduler;I)V

    goto :goto_2

    :cond_3
    iget-object p0, p0, Loge;->c:Lw8g;

    iget-object p0, p0, Lw8g;->c:Landroidx/work/impl/WorkDatabase;

    invoke-virtual {p0}, Landroidx/work/impl/WorkDatabase;->u()Lmge;
...
.method public final varargs e([Ll9g;)V
    ...
    iget-object v7, v5, Ll9g;->a:Ljava/lang/String;

    invoke-virtual {v6, v7}, Lm9g;->o(Ljava/lang/String;)Ll9g;
    ...
    sget-object v9, Loge;->X:Ljava/lang/String;
    ...
    invoke-virtual {v5, v9, v6}, Lfc2;->L(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v1}, Landroidx/work/impl/WorkDatabase;->u()Lmge;

    move-result-object v7

    invoke-virtual {v7, v6}, Lmge;->f(Lp8g;)Llge;
    ...
    iget-object v9, v2, Lly4;->b:Ljava/lang/Object;

    check-cast v9, Landroidx/work/impl/WorkDatabase;

    new-instance v10, Lht6;

    invoke-direct {v10, v2, v8}, Lht6;-><init>(Lly4;I)V

    invoke-virtual {v9, v10}, Lkjc;->o(Ljava/util/concurrent/Callable;)Ljava/lang/Object;
    ...
    iget-object v9, v6, Lp8g;->a:Ljava/lang/String;

    iget v6, v6, Lp8g;->b:I

    invoke-direct {v7, v9, v6, v8}, Llge;-><init>(Ljava/lang/String;II)V

    iget-object v6, v0, Lw8g;->c:Landroidx/work/impl/WorkDatabase;

    invoke-virtual {v6}, Landroidx/work/impl/WorkDatabase;->u()Lmge;

    move-result-object v6

    invoke-virtual {v6, v7}, Lmge;->h(Llge;)V

    :cond_3
    invoke-virtual {p0, v5, v8}, Loge;->g(Ll9g;I)V
...
.method public final g(Ll9g;I)V
    .locals 13

    iget-object v0, p0, Loge;->b:Landroid/app/job/JobScheduler;

    iget-object v1, p0, Loge;->o:Lnge;

    invoke-virtual {v1}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iget-object v2, p1, Ll9g;->j:Lej3;

    new-instance v3, Landroid/os/PersistableBundle;

    invoke-direct {v3}, Landroid/os/PersistableBundle;-><init>()V

    iget-object v4, p1, Ll9g;->a:Ljava/lang/String;
    ...
    sget-object v8, Lnge;->b:Ljava/lang/String;

    invoke-static {v3}, Lu88;->p(I)Ljava/lang/String;
    ...
    invoke-virtual {v7, v8, v3}, Lfc2;->g(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v3, p1, Ll9g;->l:Lef0;

    sget-object v5, Lef0;->b:Lef0;
    ...
    iget-boolean v7, v6, Ldj3;->b:Z

    new-instance v8, Landroid/app/job/JobInfo$TriggerContentUri;

    iget-object v6, v6, Ldj3;->a:Landroid/net/Uri;
    ...
    invoke-static {v1}, Luc8;->n(Landroid/app/job/JobInfo$Builder;)V
    ...
    sget-object v5, Loge;->X:Ljava/lang/String;

    invoke-virtual {v2, v5, v3}, Lfc2;->g(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v1, v5, v2}, Lfc2;->L(Ljava/lang/String;Ljava/lang/String;)V

    iget-boolean v1, p1, Ll9g;->q:Z

    if-eqz v1, :cond_d

    iget-object v1, p1, Ll9g;->r:Lcla;

    sget-object v2, Lcla;->a:Lcla;

    if-ne v1, v2, :cond_d

    iput-boolean v9, p1, Ll9g;->q:Z
    ...
    invoke-virtual {v2, v5, v1}, Lfc2;->g(Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual {p0, p1, p2}, Loge;->g(Ll9g;I)V
    :try_end_0
    ...
    invoke-virtual {p2, v5, p1, p0}, Lfc2;->o(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    return-void

    :goto_8
    iget-object p2, p0, Loge;->a:Landroid/content/Context;

    invoke-static {p2, v0}, Loge;->d(Landroid/content/Context;Landroid/app/job/JobScheduler;)Ljava/util/ArrayList;
    ...
    iget-object v1, p0, Lw8g;->c:Landroidx/work/impl/WorkDatabase;

    invoke-virtual {v1}, Landroidx/work/impl/WorkDatabase;->x()Lm9g;

    move-result-object v1

    invoke-virtual {v1}, Lm9g;->l()Ljava/util/ArrayList;
    ...
    invoke-virtual {v0, v5, p2}, Lfc2;->n(Ljava/lang/String;Ljava/lang/String;)V

    new-instance v0, Ljava/lang/IllegalStateException;

    invoke-direct {v0, p2, p1}, Ljava/lang/IllegalStateException;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V

    iget-object p0, p0, Lw8g;->b:Lfe3;
