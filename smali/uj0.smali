...
.method public constructor <init>(Lcrd;)V
    ...
    iput-object v0, p0, Luj0;->r:Landroid/graphics/Rect;

    iput-object p1, p0, Luj0;->q:Lcrd;
...
.method public final n(FF)I
    ...
    :goto_0
    iget-object v1, p0, Luj0;->q:Lcrd;

    invoke-virtual {v1}, Lwj0;->getValues()Ljava/util/List;
    ...
    iget-object v2, p0, Luj0;->r:Landroid/graphics/Rect;

    invoke-virtual {v1, v0, v2}, Lwj0;->u(ILandroid/graphics/Rect;)V
...
.method public final s(IILandroid/os/Bundle;)Z
    ...
    invoke-virtual {v0, p1, p2}, Lwj0;->s(IF)Z

    move-result p2

    if-eqz p2, :cond_8

    invoke-virtual {v0}, Lwj0;->v()V
    ...
    :cond_7
    invoke-virtual {v0}, Lwj0;->getValues()Ljava/util/List;
    ...
    invoke-static {p2, p3, v1}, Lus;->i(FFF)F
...
.method public final u(ILk4;)V
    ...
    sget-object v1, Lf4;->m:Lf4;

    invoke-virtual {p2, v1}, Lk4;->b(Lf4;)V
    ...
    invoke-virtual {v1}, Lcrd;->getValueFrom()F

    move-result v5

    invoke-virtual {v1}, Lcrd;->getValueTo()F
    ...
    invoke-virtual {p2, v7}, Lk4;->a(I)V
    ...
    invoke-virtual {p2, v5}, Lk4;->h(Ljava/lang/CharSequence;)V
    ...
    sget v5, Lpxb;->material_slider_value:I
    ...
    sget v4, Lpxb;->material_slider_range_end:I
    ...
    sget v4, Lpxb;->material_slider_range_start:I
    ...
    iget-object p0, p0, Luj0;->r:Landroid/graphics/Rect;

    invoke-virtual {v1, p1, p0}, Lwj0;->u(ILandroid/graphics/Rect;)V
