...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcqd;->e:Ljava/util/concurrent/ScheduledExecutorService;
    ...
    invoke-direct {v2, v3, v0, v1}, Lboc;-><init>(Ljava/lang/String;IZ)V

    sput-object v2, Lcqd;->d:Lboc;
...
.method public final a()Lesc;
    ...
    iget-object p0, p0, Lcqd;->c:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    invoke-direct {v0, p0}, Lbqd;-><init>(Ljava/util/concurrent/ScheduledExecutorService;)V
...
.method public final d(Ljava/lang/Runnable;JJLjava/util/concurrent/TimeUnit;)Lam4;
    ...
    sget-object v7, Lbz4;->a:Lbz4;

    iget-object v6, p0, Lcqd;->c:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    invoke-direct {v6, p1, v1}, Lv27;-><init>(Ljava/lang/Runnable;Ljava/util/concurrent/ScheduledExecutorService;)V
    ...
    :goto_0
    invoke-virtual {v6, v0}, Lv27;->a(Ljava/util/concurrent/Future;)V
    :try_end_0
    .catch Ljava/util/concurrent/RejectedExecutionException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-direct {v1, p1, v5}, Lh0;-><init>(Ljava/lang/Runnable;Z)V
    ...
    invoke-virtual {v1, v0}, Lh0;->a(Ljava/util/concurrent/Future;)V
    :try_end_1
