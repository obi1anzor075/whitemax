...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {v0, p1, p0, v1}, Ldqe;-><init>(Ljava/lang/Object;Lfqe;I)V

    iput-object v0, p0, Lfqe;->a:Ldqe;
    ...
    invoke-direct {p0}, Lfqe;->getTheme()Lyha;
    ...
    iput-object p1, p0, Lfqe;->b:Landroid/graphics/drawable/GradientDrawable;
    ...
    invoke-interface {v2}, Lyha;->i()Lu8e;
    ...
    iput-object v0, p0, Lfqe;->o:Landroid/graphics/Paint;

    new-instance v0, Landroid/graphics/Paint;

    invoke-direct {v0, v1}, Landroid/graphics/Paint;-><init>(I)V

    iput-object v0, p0, Lfqe;->o0:Landroid/graphics/Paint;

    new-instance v0, Landroid/graphics/RectF;

    invoke-direct {v0}, Landroid/graphics/RectF;-><init>()V

    iput-object v0, p0, Lfqe;->p0:Landroid/graphics/RectF;

    new-instance v0, Landroid/graphics/RectF;

    invoke-direct {v0}, Landroid/graphics/RectF;-><init>()V

    iput-object v0, p0, Lfqe;->q0:Landroid/graphics/RectF;
...
.method public static final synthetic a(Lfqe;)Lyha;
    .locals 0
...
.method private final getTheme()Lyha;
    .locals 3
    ...
    invoke-virtual {p0}, Lfqe;->getThemeName()Ljava/lang/String;
    ...
    invoke-virtual {v0, v2}, Lhjc;->k(Ljava/lang/String;)Lk9a;
...
.method public final b()V
    ...
    invoke-virtual {v0}, Lfqe;->getIncomingColors()[I
    ...
    iput-object v3, v0, Lfqe;->r0:Landroid/graphics/LinearGradient;
    ...
    invoke-virtual {v0}, Lfqe;->getOutgoingColors()[I
    ...
    iput-object v12, v0, Lfqe;->s0:Landroid/graphics/LinearGradient;
...
.method public final getPatternDrawable()Landroid/graphics/drawable/Drawable;
    ...
    sget-object v0, Lfqe;->t0:[Lbc7;

    const/4 v1, 0x1

    aget-object v0, v0, v1

    iget-object p0, p0, Lfqe;->c:Ldqe;
...
.method public final onDraw(Landroid/graphics/Canvas;)V
    ...
    iget-object v9, p0, Lfqe;->o:Landroid/graphics/Paint;
    ...
    iget-object v4, p0, Lfqe;->p0:Landroid/graphics/RectF;

    invoke-virtual {v4, p1, v1, v5, v7}, Landroid/graphics/RectF;->set(FFFF)V

    iget-object p1, p0, Lfqe;->r0:Landroid/graphics/LinearGradient;

    iget-object v1, p0, Lfqe;->o0:Landroid/graphics/Paint;
    ...
    iget-object v3, p0, Lfqe;->q0:Landroid/graphics/RectF;

    invoke-virtual {v3, p1, v7, v5, v4}, Landroid/graphics/RectF;->set(FFFF)V

    iget-object p0, p0, Lfqe;->s0:Landroid/graphics/LinearGradient;
...
.method public final onThemeChanged(Lyha;)V
    ...
    iget-object v0, p0, Lfqe;->o:Landroid/graphics/Paint;
    ...
    iget-object v0, p0, Lfqe;->b:Landroid/graphics/drawable/GradientDrawable;
