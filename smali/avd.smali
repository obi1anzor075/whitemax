...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lavd;->Z:Ljava/util/regex/Pattern;
...
.method public constructor <init>(Ljava/util/List;)V
    ...
    invoke-static {v0}, Lpaf;->p([B)Ljava/lang/String;
    ...
    invoke-static {v0}, Loe;->c(Ljava/lang/String;)Loe;

    move-result-object v0

    invoke-virtual {v0}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iput-object v0, p0, Lavd;->b:Loe;
    ...
    invoke-virtual {p0, v0, p1}, Lavd;->b(Lpna;Ljava/nio/charset/Charset;)V

    return-void

    :cond_0
    iput-boolean v0, p0, Lavd;->a:Z

    const/4 p1, 0x0

    iput-object p1, p0, Lavd;->b:Loe;
...
.method public static c(Ljava/lang/String;)J
    ...
    sget-object v0, Lavd;->Z:Ljava/util/regex/Pattern;
...
# virtual methods
.method public final b(Lpna;Ljava/nio/charset/Charset;)V
    .locals 26
    ...
    :cond_0
    :goto_0
    invoke-virtual/range {p1 .. p2}, Lpna;->h(Ljava/nio/charset/Charset;)Ljava/lang/String;
    ...
    invoke-virtual/range {p1 .. p1}, Lpna;->a()I

    move-result v2

    if-eqz v2, :cond_1

    invoke-virtual/range {p1 .. p2}, Lpna;->c(Ljava/nio/charset/Charset;)C
    ...
    invoke-static {v13}, Ld46;->M(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct/range {v13 .. v24}, Lcvd;-><init>(IIIIIIIIIII)V
    ...
    invoke-static {v12, v13, v10, v0, v11}, Lpg0;->j(Ljava/lang/String;ILjava/lang/String;ILjava/lang/String;)Ljava/lang/StringBuilder;
    ...
    invoke-static {v0}, Lgvd;->a(Ljava/lang/String;)I
    ...
    invoke-static {v0}, Lgvd;->c(Ljava/lang/String;)Ljava/lang/Integer;
    ...
    invoke-static {v0}, Lgvd;->b(Ljava/lang/String;)Z
    ...
    invoke-direct/range {v15 .. v25}, Lgvd;-><init>(Ljava/lang/String;ILjava/lang/Integer;Ljava/lang/Integer;FZZZZI)V
    :try_end_5
    ...
    iget-object v0, v15, Lgvd;->a:Ljava/lang/String;
    ...
    :cond_21
    iput-object v2, v1, Lavd;->o:Ljava/util/LinkedHashMap;
...
.method public final m([BIILz9e;Lij3;)V
    ...
    iget-object v9, v0, Lavd;->c:Lpna;

    move-object/from16 v10, p1

    invoke-virtual {v9, v8, v10}, Lpna;->E(I[B)V

    invoke-virtual {v9, v1}, Lpna;->G(I)V

    invoke-virtual {v9}, Lpna;->C()Ljava/nio/charset/Charset;
    ...
    :goto_0
    iget-boolean v8, v0, Lavd;->a:Z

    if-nez v8, :cond_1

    invoke-virtual {v0, v9, v1}, Lavd;->b(Lpna;Ljava/nio/charset/Charset;)V

    :cond_1
    if-eqz v8, :cond_2

    iget-object v8, v0, Lavd;->b:Loe;
    ...
    :goto_1
    invoke-virtual {v9, v1}, Lpna;->h(Ljava/nio/charset/Charset;)Ljava/lang/String;
    ...
    invoke-static {v11}, Loe;->c(Ljava/lang/String;)Loe;
    ...
    invoke-static {v10}, Lou0;->J(Ljava/lang/String;)V
    ...
    invoke-static {v10}, Lavd;->c(Ljava/lang/String;)J
    ...
    :cond_8
    iget-object v10, v0, Lavd;->o:Ljava/util/LinkedHashMap;
    ...
    sget-object v13, Levd;->a:Ljava/util/regex/Pattern;
    ...
    :try_start_0
    invoke-static {v1}, Levd;->a(Ljava/lang/String;)Landroid/graphics/PointF;
    ...
    :cond_a
    :try_start_1
    sget-object v13, Levd;->d:Ljava/util/regex/Pattern;
    ...
    invoke-static {v1}, Lgvd;->a(Ljava/lang/String;)I
    ...
    sget-object v1, Levd;->a:Ljava/util/regex/Pattern;
    ...
    iget v11, v0, Lavd;->X:F

    iget v12, v0, Lavd;->Y:F
    ...
    iget-boolean v1, v10, Lgvd;->g:Z

    iget-object v0, v10, Lgvd;->d:Ljava/lang/Integer;

    move-object/from16 v23, v0

    iget-object v0, v10, Lgvd;->c:Ljava/lang/Integer;
    ...
    :pswitch_0
    invoke-static {v0, v8}, Lu88;->n(ILjava/lang/String;)V
    ...
    invoke-direct/range {v21 .. v38}, Lq04;-><init>(Ljava/lang/CharSequence;Landroid/text/Layout$Alignment;Landroid/text/Layout$Alignment;Landroid/graphics/Bitmap;FIIFIIFFFZIIF)V

    move-object/from16 v0, v21

    invoke-static {v14, v15, v7, v6}, Lavd;->a(JLjava/util/ArrayList;Ljava/util/ArrayList;)I

    move-result v1

    invoke-static {v4, v5, v7, v6}, Lavd;->a(JLjava/util/ArrayList;Ljava/util/ArrayList;)I
    ...
    new-instance v19, Lt04;

    invoke-direct/range {v19 .. v24}, Lt04;-><init>(JJLjava/util/List;)V
    ...
    invoke-interface {v3, v1}, Lij3;->accept(Ljava/lang/Object;)V
