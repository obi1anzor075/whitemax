...
.method public constructor <init>(Lje7;Lje7;Lje7;)V
    ...
    iput-object p3, p0, Lwoa;->a:Lje7;

    iput-object p1, p0, Lwoa;->b:Lje7;

    iput-object p2, p0, Lwoa;->c:Lje7;
    ...
    iput-object p1, p0, Lwoa;->o:Lru/ok/android/externcalls/sdk/video/VideoRender;

    invoke-static {}, Ljava/util/concurrent/ConcurrentHashMap;->newKeySet()Ljava/util/concurrent/ConcurrentHashMap$KeySetView;

    move-result-object p1

    iput-object p1, p0, Lwoa;->X:Ljava/util/concurrent/ConcurrentHashMap$KeySetView;
...
.method public final clear()V
    ...
    iget-object v0, p0, Lwoa;->X:Ljava/util/concurrent/ConcurrentHashMap$KeySetView;
    ...
    invoke-virtual {v2}, Lgp1;->c()V

    const/4 v3, 0x0

    iput-object v3, v2, Lgp1;->p0:Liaf;

    const/4 v3, 0x0

    iput-boolean v3, v2, Lgp1;->q0:Z

    goto :goto_0

    :cond_0
    iget-object p0, p0, Lwoa;->o:Lru/ok/android/externcalls/sdk/video/VideoRender;
...
.method public final d(Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;Lru/ok/android/externcalls/sdk/ui/TextureViewRenderer;)V
    ...
    invoke-virtual {p0}, Lwoa;->c()Lru/ok/android/externcalls/sdk/Conversation;
...
.method public final onCameraChanged()V
    ...
    invoke-virtual {v2}, Ll21;->b()Z

    move-result v2

    check-cast v1, Lgp1;

    iget-object v3, v1, Lgp1;->r0:Ldmf;

    if-eqz v3, :cond_0

    iget-boolean v3, v3, Ldmf;->c:Z

    const/4 v4, 0x1

    if-ne v3, v4, :cond_0

    iget-object v1, v1, Lgp1;->c:Lru/ok/android/externcalls/sdk/ui/TextureViewRenderer;
...
.method public final rebindParticipantViews()V
    ...
    iget-object v5, p0, Lwoa;->o:Lru/ok/android/externcalls/sdk/video/VideoRender;
...
.method public final removeOwnVideoParticipantView(Lru/ok/android/externcalls/sdk/ui/RendererView;)V
    ...
    invoke-virtual {v0}, Ltoa;->c()Lxna;

    move-result-object v0

    iget-object v0, v0, Lxna;->a:Lyf1;

    invoke-interface {v0}, Lyf1;->s()Ldmf;

    move-result-object v0

    iget-object v0, v0, Ldmf;->b:Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;

    invoke-virtual {p0, v0, p1}, Lwoa;->d(Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;Lru/ok/android/externcalls/sdk/ui/TextureViewRenderer;)V
...
.method public final bridge synthetic removeParticipantView(Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;Lru/ok/android/externcalls/sdk/ui/RendererView;)V
    ...
    invoke-virtual {p0, p1, p2}, Lwoa;->d(Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;Lru/ok/android/externcalls/sdk/ui/TextureViewRenderer;)V
...
.method public final setOwnVideoParticipantView(Lru/ok/android/externcalls/sdk/ui/RendererView;Lru/ok/android/externcalls/sdk/ui/FrameDecorator;)V
    ...
    invoke-virtual {p2}, Ltoa;->c()Lxna;

    move-result-object p2

    iget-object p2, p2, Lxna;->a:Lyf1;

    invoke-interface {p2}, Lyf1;->s()Ldmf;

    move-result-object p2

    iget-object p2, p2, Ldmf;->b:Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;
...
.method public final setParticipantView(Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;Lru/ok/android/externcalls/sdk/ui/RendererView;Lru/ok/android/externcalls/sdk/ui/FrameDecorator;)V
    ...
    iget-object p3, p0, Lwoa;->o:Lru/ok/android/externcalls/sdk/video/VideoRender;
    ...
    sget-object v2, Lgmf;->a:Lgmf;

    if-ne v1, v2, :cond_1

    iget-object p0, p0, Lwoa;->a:Lje7;
    ...
    invoke-interface {p0}, Lru/ok/android/externcalls/sdk/video/VideoRenderManager;->getCallRenderer()Lee1;
    ...
    invoke-static/range {v0 .. v5}, Lru/ok/android/externcalls/sdk/ui/RendererView;->init$default(Lru/ok/android/externcalls/sdk/ui/RendererView;Lee1;Lorg/webrtc/RendererCommon$RendererEvents;Lru/ok/android/externcalls/sdk/ui/FrameDecorator;ILjava/lang/Object;)Z
