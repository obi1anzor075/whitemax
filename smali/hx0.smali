...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-direct {p0}, Lhx0;->getBackgroundDrawable()Landroid/graphics/drawable/RippleDrawable;
    ...
    invoke-direct {p0}, Lhx0;->getIconColor()Landroid/content/res/ColorStateList;
    ...
    iput-object p2, p0, Lhx0;->K0:Landroidx/appcompat/widget/AppCompatImageView;
    ...
    sget-object p1, Lnte;->i:Lnge;

    invoke-static {p1, v1}, Lnge;->d(Lnge;Landroid/widget/TextView;)V
    ...
    invoke-direct {p0}, Lhx0;->getTextColor()I

    move-result v0

    invoke-virtual {v1, v0}, Landroid/widget/TextView;->setTextColor(I)V

    iput-object v1, p0, Lhx0;->L0:Landroidx/appcompat/widget/AppCompatTextView;
    ...
    invoke-virtual {v2, v3, v5, v4, v5}, Lbf3;->d(IIII)V

    const/4 v4, 0x6

    invoke-virtual {v2, v3, v4, v0, v4}, Lbf3;->d(IIII)V
    ...
    invoke-virtual {v2, v3, v7, v6, v7}, Lbf3;->d(IIII)V

    invoke-virtual {v1}, Landroid/view/View;->getId()I

    move-result v1

    invoke-virtual {v2, v1, v5, v0, v5}, Lbf3;->d(IIII)V
    ...
    invoke-virtual {v2, v1, v4, p2, v3}, Lbf3;->d(IIII)V

    new-instance p2, Lhw9;

    const/4 v5, 0x4

    invoke-direct {p2, v2, v4, v1, v5}, Lhw9;-><init>(Ljava/lang/Object;III)V
    ...
    invoke-static {v4, v5, p2}, Lhr1;->q(FFLhw9;)V

    invoke-virtual {v2, v1, v3, v0, v3}, Lbf3;->d(IIII)V

    invoke-virtual {v2, v1, v7, v0, v7}, Lbf3;->d(IIII)V
...
.method public final onThemeChanged(Lpda;)V
    ...
    iget-object p1, p0, Lhx0;->K0:Landroidx/appcompat/widget/AppCompatImageView;
    ...
    iget-object p1, p0, Lhx0;->L0:Landroidx/appcompat/widget/AppCompatTextView;
...
.method public final setActionIcon(I)V
    ...
    iget-object p0, p0, Lhx0;->K0:Landroidx/appcompat/widget/AppCompatImageView;
...
.method public final setActionText(I)V
    ...
    iget-object p0, p0, Lhx0;->L0:Landroidx/appcompat/widget/AppCompatTextView;
