...
.method public constructor <init>(Lbpe;)V
    ...
    sget-object v0, Lpfa;->b:[B

    invoke-direct {p1, v0}, Lija;-><init>([B)V

    iput-object p1, p0, Lv8f;->c:Lija;
...
.method public final a2(JLija;)Z
    ...
    invoke-direct {v0, v2}, Lija;-><init>([B)V

    invoke-virtual {p3}, Lija;->a()I

    move-result v3

    invoke-virtual {p3, v1, v2, v3}, Lija;->e(I[BI)V

    invoke-static {v0}, Luc0;->a(Lija;)Luc0;
    ...
    iget-object v2, p3, Luc0;->l:Ljava/lang/String;

    iput-object v2, v0, Luu5;->i:Ljava/lang/String;
    ...
    iget-object p3, p3, Luc0;->a:Ljava/util/List;

    iput-object p3, v0, Luu5;->p:Ljava/util/List;

    invoke-virtual {v0}, Luu5;->a()Lxu5;

    move-result-object p3

    invoke-interface {p1, p3}, Lbpe;->e(Lxu5;)V

    iput-boolean p2, p0, Lv8f;->Y:Z
    ...
    iget-boolean v0, p0, Lv8f;->Y:Z

    if-eqz v0, :cond_4

    iget v0, p0, Lv8f;->w0:I
    ...
    iget-object v8, v0, Lija;->a:[B

    iget v9, p0, Lv8f;->X:I

    invoke-virtual {p3, v2, v8, v9}, Lija;->e(I[BI)V
    ...
    iget-object v9, p0, Lv8f;->c:Lija;

    invoke-virtual {v9, v1}, Lija;->G(I)V

    invoke-interface {p1, v9, v3, v1}, Lbpe;->b(Lija;II)V

    add-int/lit8 v7, v7, 0x4

    invoke-interface {p1, p3, v8, v1}, Lbpe;->b(Lija;II)V
