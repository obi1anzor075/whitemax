...
.method public constructor <init>(Lbw9;JLjava/util/concurrent/TimeUnit;Lomc;)V
    ...
    iput-object p1, p0, Lvv9;->a:Lbw9;

    iput-wide p2, p0, Lvv9;->b:J

    iput-object p4, p0, Lvv9;->c:Ljava/util/concurrent/TimeUnit;

    iput-object p5, p0, Lvv9;->o:Lomc;
    ...
    iput-object p1, p0, Lvv9;->X:Lbw1;

    new-instance p1, Ljava/util/concurrent/atomic/AtomicReference;

    invoke-direct {p1}, Ljava/util/concurrent/atomic/AtomicReference;-><init>()V

    iput-object p1, p0, Lvv9;->Y:Ljava/util/concurrent/atomic/AtomicReference;
...
.method public final a(J)V
    ...
    iget-object p1, p0, Lvv9;->Y:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    iget-object p2, p0, Lvv9;->c:Ljava/util/concurrent/TimeUnit;

    invoke-static {v0, v1, p2}, Li15;->e(JLjava/util/concurrent/TimeUnit;)Ljava/lang/String;

    move-result-object p2

    invoke-direct {p1, p2}, Ljava/util/concurrent/TimeoutException;-><init>(Ljava/lang/String;)V

    iget-object p2, p0, Lvv9;->a:Lbw9;

    invoke-interface {p2, p1}, Lbw9;->onError(Ljava/lang/Throwable;)V

    iget-object p0, p0, Lvv9;->o:Lomc;
...
.method public final c(Ljava/lang/Object;)V
    ...
    iget-object v1, p0, Lvv9;->a:Lbw9;

    invoke-interface {v1, p1}, Lbw9;->c(Ljava/lang/Object;)V

    new-instance p1, Lio5;

    invoke-direct {p1, v2, v3, p0}, Lio5;-><init>(JLwv9;)V

    iget-object v1, p0, Lvv9;->o:Lomc;

    iget-wide v2, p0, Lvv9;->b:J

    iget-object p0, p0, Lvv9;->c:Ljava/util/concurrent/TimeUnit;
...
.method public final d(Lxi4;)V
    ...
    iget-object p0, p0, Lvv9;->Y:Ljava/util/concurrent/atomic/AtomicReference;
...
.method public final f()V
    ...
    iget-object v0, p0, Lvv9;->Y:Ljava/util/concurrent/atomic/AtomicReference;
