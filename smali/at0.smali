...
.method public final run()V
    ...
    iget-object v0, p0, Lat0;->o:Ljava/lang/Object;
    ...
    invoke-interface {v0, v1, p0}, Lpgf;->l(II)V
    ...
    iget-object v0, v0, Lluc;->o:Lu26;

    if-eqz v0, :cond_3

    invoke-virtual {v0, v1, p0}, Lu26;->a(II)V
    ...
    iget-boolean v2, v0, Lu26;->p0:Z

    if-eqz v2, :cond_4

    iget-boolean v2, v0, Lu26;->q0:Z

    if-eqz v2, :cond_4

    iget-object v2, v0, Lu26;->Y:Lorg/webrtc/ScreenCapturerAndroid;
    ...
    invoke-interface {v0, p0, v2, v1}, Ls1c;->reportException(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    :cond_5
    iget-object v4, v0, Lct0;->i:Lql5;

    iget v5, v0, Lct0;->e:I

    invoke-virtual {v4}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    invoke-static {v3, v5}, Lqo8;->H(II)Lc37;
    ...
    invoke-virtual {v5}, La37;->iterator()Ljava/util/Iterator;
    ...
    invoke-virtual {v4, v7}, Lql5;->a(I)I
    ...
    iget-object v7, v0, Lct0;->l:Ljava/util/Set;
    ...
    iget-object v6, v0, Lct0;->f:Ljava/util/concurrent/ConcurrentHashMap;

    invoke-virtual {v6}, Ljava/util/concurrent/ConcurrentHashMap;->keySet()Ljava/util/Set;

    move-result-object v6

    invoke-static {v6, v4}, Lgad;->V(Ljava/util/Set;Ljava/util/Set;)Ljava/util/Set;
    ...
    iget-object v9, v0, Lct0;->f:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iget-object v11, v9, Lbt0;->a:Lh94;

    invoke-virtual {v11}, Lf33;->n()Lf33;
    ...
    iget-object v11, v0, Lct0;->a:Lh0b;

    invoke-virtual {v11}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    sget-object v12, Landroid/graphics/Bitmap$Config;->ARGB_8888:Landroid/graphics/Bitmap$Config;

    invoke-virtual {v11, v1, p0, v12}, Lh0b;->c(IILandroid/graphics/Bitmap$Config;)Lf33;
    ...
    invoke-direct {v9, v12}, Lbt0;-><init>(Lh94;)V

    invoke-virtual {v11}, Lf33;->m()Lf33;

    move-result-object v11

    :goto_8
    iput-boolean v8, v9, Lbt0;->b:Z

    :try_start_1
    invoke-virtual {v0, v7, v11}, Lct0;->f(ILf33;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_1

    invoke-interface {v11}, Ljava/io/Closeable;->close()V

    iget-object v8, v0, Lct0;->f:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    invoke-static {v11, p0}, Liz7;->d(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    ...
    invoke-static {v1, v3, p0}, Lqo8;->h(III)I
