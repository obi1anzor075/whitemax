...
.method public final b(Landroid/graphics/Canvas;Landroid/graphics/Paint;II)V
    ...
    invoke-static {p3, p4}, Lvx3;->j(II)I

    move-result p3

    iget-object p4, p0, Lqn4;->a:Loi0;
    ...
    invoke-virtual/range {v1 .. v7}, Lwc7;->h(Landroid/graphics/Canvas;Landroid/graphics/Paint;Landroid/graphics/PointF;Landroid/graphics/PointF;FF)V

    :cond_0
    return-void
.end method

.method public final c(Landroid/graphics/Canvas;Landroid/graphics/Paint;Lpn4;I)V
    .locals 9

    iget v0, p3, Lpn4;->c:I

    invoke-static {v0, p4}, Lvx3;->j(II)I
    ...
    invoke-virtual/range {v1 .. v8}, Lwc7;->g(Landroid/graphics/Canvas;Landroid/graphics/Paint;FFIII)V
...
.method public final d(Landroid/graphics/Canvas;Landroid/graphics/Paint;FFIII)V
    ...
    invoke-static {p5, p6}, Lvx3;->j(II)I
    ...
    invoke-virtual/range {v0 .. v7}, Lwc7;->g(Landroid/graphics/Canvas;Landroid/graphics/Paint;FFIII)V
...
.method public final g(Landroid/graphics/Canvas;Landroid/graphics/Paint;FFIII)V
    ...
    invoke-static {v1, v9, v0}, Lxy6;->i(FFF)F

    move-result v1

    move/from16 v2, p4

    invoke-static {v2, v9, v0}, Lxy6;->i(FFF)F
    ...
    invoke-static {v3, v0, v1}, Ln06;->y(FFF)F
    ...
    invoke-static {v3, v0, v2}, Ln06;->y(FFF)F
    ...
    invoke-static {v1, v9, v4}, Lxy6;->i(FFF)F
    ...
    invoke-static {v2, v6, v0}, Lxy6;->i(FFF)F
    ...
    invoke-virtual/range {v0 .. v6}, Lwc7;->h(Landroid/graphics/Canvas;Landroid/graphics/Paint;Landroid/graphics/PointF;Landroid/graphics/PointF;FF)V
