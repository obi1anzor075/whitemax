...
# direct methods
.method public constructor <init>(Lqr4;Lstf;Landroid/graphics/Rect;Z)V
    .locals 5
    ...
    .line 6
    iget-object p2, p2, Lstf;->a:Ljava/lang/Object;
...
.method public constructor <init>(Lvd8;Le88;Log0;)V
    .locals 1
    ...
    invoke-direct {p2, p1}, Lip9;-><init>(Landroid/content/Context;)V
    ...
    .line 36
    new-instance p3, Ly44;

    const/4 v0, 0x1

    invoke-direct {p3, p2, v0}, Ly44;-><init>(Landroid/os/Handler;I)V
...
.method public b(Lkc8;)Lr38;
    ...
    :cond_0
    :try_start_0
    invoke-static {p0}, Lswb;->u(Ljava/util/concurrent/Future;)Ljava/lang/Object;
...
.method public d(Z)V
    ...
    iget-object v1, v0, Lvd8;->a:Ljava/lang/Object;
    ...
    iget-object v0, v0, Lvd8;->c:Lyr;

    invoke-virtual {v0}, Lyr;->values()Ljava/util/Collection;
    ...
    invoke-virtual {p0, v3, v0}, Lue;->i(Lkc8;Z)Z
    ...
    invoke-static {v2, p1}, Lh88;->a(Lvd8;Z)V
...
.method public i(Lkc8;Z)Z
    .locals 0

    invoke-virtual {p0, p1}, Lue;->b(Lkc8;)Lr38;

    move-result-object p0

    if-eqz p0, :cond_2

    invoke-virtual {p0}, Lr38;->u()Z
...
.method public j(Lkc8;Log0;Z)V
    ...
    iget-object v2, p2, Log0;->c:Ljava/lang/Object;
    ...
    invoke-static {p3, p2}, Ljq3;->b(Landroid/content/Context;Landroid/content/Intent;)Landroid/content/ComponentName;
    ...
    invoke-static {p3, p1, v2, p2, v0}, Llze;->a(Landroid/app/Service;ILandroid/app/Notification;ILjava/lang/String;)V
    ...
    invoke-virtual {p3, p2, p1, v2}, Lip9;->a(Ljava/lang/String;ILandroid/app/Notification;)V
