...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lyg0;->i:Ljava/util/regex/Pattern;

    return-void
.end method

.method public constructor <init>(Lit4;Lcd3;Lund;Lyd3;)V
    .locals 2
    ...
    invoke-direct {v0, v1}, Lrc3;-><init>(Z)V

    iput-object v0, p0, Lyg0;->g:Lrc3;

    new-instance v0, Ljava/util/concurrent/ConcurrentHashMap;

    invoke-direct {v0}, Ljava/util/concurrent/ConcurrentHashMap;-><init>()V

    iput-object v0, p0, Lyg0;->h:Ljava/util/concurrent/ConcurrentHashMap;

    iput-object p1, p0, Lyg0;->a:Lit4;

    iput-object p4, p0, Lyg0;->b:Lyd3;

    iput-object p3, p0, Lyg0;->c:Lund;

    iput-object p2, p0, Lyg0;->f:Lcd3;
...
.method public static n(Ljavax/net/SocketFactory;)Ljava/net/Socket;
    ...
    :goto_0
    invoke-static {v0}, Lyg0;->q(Ljava/net/Socket;)V
...
.method public final b()V
    ...
    iget-object p0, p0, Lyg0;->h:Ljava/util/concurrent/ConcurrentHashMap;
...
.method public connect()Ljava/net/Socket;
    ...
    invoke-direct {v2, v3}, Lrc3;-><init>(Z)V

    iput-object v2, v0, Lyg0;->g:Lrc3;

    new-instance v2, Ljava/lang/StringBuilder;

    invoke-direct {v2}, Ljava/lang/StringBuilder;-><init>()V

    invoke-interface/range {p0 .. p0}, Lzz2;->i()Ljava/lang/String;

    move-result-object v4

    invoke-virtual {v2, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-interface/range {p0 .. p0}, Lzz2;->d()I
    ...
    :try_start_0
    iget-object v5, v0, Lyg0;->h:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iget-object v6, v0, Lyg0;->g:Lrc3;

    iput-object v2, v6, Lrc3;->g:Ljava/lang/String;

    iput v4, v6, Lrc3;->h:I

    invoke-virtual {v0, v5, v2, v4}, Lyg0;->m(Ljavax/net/SocketFactory;Ljava/lang/String;I)Ljava/net/Socket;

    move-result-object v5

    iput-object v5, v0, Lyg0;->d:Ljava/net/Socket;

    instance-of v6, v5, Ljavax/net/ssl/SSLSocket;

    if-nez v6, :cond_0

    iget-object v1, v0, Lyg0;->g:Lrc3;
    ...
    :cond_0
    iget-object v6, v0, Lyg0;->c:Lund;

    check-cast v5, Ljavax/net/ssl/SSLSocket;

    sget-object v7, Lyg0;->i:Ljava/util/regex/Pattern;
    ...
    iget-object v7, v0, Lyg0;->f:Lcd3;

    iget-object v7, v7, Lcd3;->a:Ljava/lang/String;
    ...
    iget-object v8, v6, Lvnd;->a:Ljava/lang/String;
    ...
    invoke-static {v12, v7, v13}, Lwn6;->i(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v12

    invoke-interface {v9, v11, v8, v12, v10}, Lfn6;->d(Ltn7;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    iget-object v11, v6, Lvnd;->d:Lnfc;

    iget-object v11, v11, Lnfc;->b:Ljava/lang/Object;
    ...
    iput-wide v12, v11, Lwnd;->g:J

    iget-wide v14, v11, Lwnd;->h:J

    add-long/2addr v14, v12

    iput-wide v14, v11, Lwnd;->h:J

    iget v10, v11, Lwnd;->i:I

    const/4 v12, 0x1

    add-int/2addr v10, v12

    iput v10, v11, Lwnd;->i:I
    ...
    iget-object v12, v6, Lvnd;->d:Lnfc;
    ...
    invoke-virtual {v12, v13, v14}, Lwnd;->a(J)V
    ...
    iget-object v5, v6, Lvnd;->a:Ljava/lang/String;
    ...
    invoke-static {v10, v11, v8, v9}, Lus8;->j(JLjava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v8

    const/4 v9, 0x0

    invoke-interface {v6, v7, v5, v8, v9}, Lfn6;->d(Ltn7;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    :cond_6
    :goto_3
    iget-object v5, v0, Lyg0;->g:Lrc3;
    ...
    iget-object v6, v6, Lvnd;->c:Lwnd;

    iget-wide v7, v6, Lwnd;->a:J

    iget v9, v6, Lwnd;->c:I

    const/4 v10, 0x1

    iget-wide v11, v6, Lwnd;->b:J
    ...
    iget-wide v11, v6, Lwnd;->d:J

    iget v13, v6, Lwnd;->f:I

    if-le v13, v10, :cond_a

    iget-wide v13, v6, Lwnd;->e:J

    iget v15, v6, Lwnd;->f:I
    ...
    iget-wide v1, v6, Lwnd;->h:J

    iget v10, v6, Lwnd;->i:I
    ...
    invoke-direct/range {v20 .. v35}, Lxnd;-><init>(JJIJJIJJI)V

    iget-object v1, v0, Lyg0;->g:Lrc3;

    iget-wide v3, v2, Lxnd;->l:J
    ...
    iput-wide v3, v1, Lrc3;->f:J

    invoke-static {v15}, Ljava/lang/Integer;->valueOf(I)Ljava/lang/Integer;

    move-result-object v1

    invoke-virtual {v2}, Lxnd;->toString()Ljava/lang/String;
    ...
    invoke-virtual {v12, v1, v2}, Lwnd;->a(J)V

    invoke-static {v5, v7}, Lete;->v(Ljavax/net/ssl/SSLSocket;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v1

    iget-object v2, v6, Lvnd;->a:Ljava/lang/String;
    ...
    iput-wide v2, v11, Lwnd;->g:J

    iget-wide v4, v11, Lwnd;->h:J

    add-long/2addr v4, v2

    iput-wide v4, v11, Lwnd;->h:J

    iget v2, v11, Lwnd;->i:I

    const/4 v1, 0x1

    add-int/2addr v2, v1

    iput v2, v11, Lwnd;->i:I
...
.method public final f()V
    ...
    iget-object v0, p0, Lyd3;->c:Ljava/lang/Object;
    ...
    invoke-static {p0, v3}, Lwn6;->h(ILjava/lang/String;)Ljava/lang/String;

    move-result-object p0

    const/4 v3, 0x0

    invoke-interface {v1, v2, v0, p0, v3}, Lfn6;->d(Ltn7;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public m(Ljavax/net/SocketFactory;Ljava/lang/String;I)Ljava/net/Socket;
    ...
    :try_start_0
    invoke-interface {p0}, Lzz2;->j()I

    move-result v0

    invoke-virtual {p0, p1, p2, p3, v0}, Lyg0;->l(Ljava/net/Socket;Ljava/lang/String;II)V
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    :goto_0
    invoke-static {p1}, Lyg0;->q(Ljava/net/Socket;)V
...
.method public final o(Ljava/lang/String;)Lkld;
    .locals 7
    ...
    iget-object p0, p0, Lyg0;->c:Lund;

    check-cast p0, Lvnd;

    iget-object v0, p0, Lvnd;->a:Ljava/lang/String;
    ...
    invoke-static {v4, p1, v5}, Lwn6;->i(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v4, p0, Lvnd;->b:Landroid/content/Context;

    invoke-direct {v3, v4, p1}, Lkld;-><init>(Landroid/content/Context;Ljava/lang/String;)V
    :try_end_0
    ...
    iput-wide v4, p1, Lwnd;->a:J

    iget-wide v0, p1, Lwnd;->b:J

    add-long/2addr v0, v4

    iput-wide v0, p1, Lwnd;->b:J
    ...
    invoke-static {v4, v5, v1, v6}, Lus8;->j(JLjava/lang/String;Ljava/lang/String;)Ljava/lang/String;
