...
# direct methods
.method public constructor <init>(Landroid/content/Context;Lcla;Lka7;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lzd;->b:Landroid/content/Context;

    iput-object p2, p0, Lzd;->c:Lcla;

    const-string p1, "MAX"

    iput-object p1, p0, Lzd;->d:Ljava/lang/String;

    iput-object p3, p0, Lzd;->e:Lka7;
...
# virtual methods
.method public final c(Llnc;Ljava/lang/String;)Landroid/net/Uri;
    .locals 8

    const/4 v0, 0x1

    invoke-interface {p1}, Llnc;->d()Ljava/lang/String;

    move-result-object v1

    invoke-interface {p1}, Llnc;->a()I
    ...
    iget-object v6, p0, Lzd;->d:Ljava/lang/String;
    ...
    invoke-direct {v1, v6, p2}, Lwia;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V

    invoke-static {v2}, Lus8;->f(I)Ljava/lang/String;
    ...
    invoke-direct {v2, v6, p2}, Lwia;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    invoke-direct {v6, v7, p2}, Lwia;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    invoke-direct {v3, v4, p2}, Lwia;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    invoke-direct {v4, v5, p2}, Lwia;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V

    filled-new-array {v1, v2, v6, v3, v4}, [Lwia;
    ...
    iget-object v5, v5, Lwia;->b:Ljava/lang/Object;
    ...
    :cond_a
    invoke-interface {p1}, Llnc;->e()Ljava/lang/Integer;
    ...
    :cond_b
    invoke-interface {p1}, Llnc;->getWidth()Ljava/lang/Integer;
    ...
    :cond_c
    invoke-interface {p1}, Llnc;->getHeight()Ljava/lang/Integer;
    ...
    invoke-interface {p1}, Llnc;->c()Landroid/net/Uri;
    ...
    invoke-interface {p1, v6, v4}, Llnc;->b(Landroid/content/ContentResolver;Landroid/net/Uri;)V
    ...
    iget-object p0, p0, Lzd;->b:Landroid/content/Context;
    ...
    sget-object p1, Ljnc;->a:Ljnc;

    sget-object p1, Ljnc;->b:Ljava/lang/String;
