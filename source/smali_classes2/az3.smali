...
# direct methods
.method public constructor <init>(Lorg/webrtc/DataChannel;Lxwb;)V
    .locals 1
    ...
    iput-object v0, p0, Laz3;->c:Ljava/util/concurrent/CopyOnWriteArrayList;

    new-instance v0, Ljava/util/concurrent/CopyOnWriteArrayList;

    invoke-direct {v0}, Ljava/util/concurrent/CopyOnWriteArrayList;-><init>()V

    iput-object v0, p0, Laz3;->d:Ljava/util/concurrent/CopyOnWriteArrayList;

    new-instance v0, Ljava/util/concurrent/CopyOnWriteArrayList;

    invoke-direct {v0}, Ljava/util/concurrent/CopyOnWriteArrayList;-><init>()V

    iput-object v0, p0, Laz3;->e:Ljava/util/concurrent/CopyOnWriteArrayList;

    iput-object p1, p0, Laz3;->a:Lorg/webrtc/DataChannel;

    iput-object p2, p0, Laz3;->b:Lxwb;

    new-instance p2, Lnu7;

    const/4 v0, 0x0

    invoke-direct {p2, p0, p1, v0}, Lnu7;-><init>(Ljava/lang/Object;Ljava/lang/Object;Z)V
...
.method public final a(Lnhc;)V
    ...
    iget-object p0, p0, Laz3;->d:Ljava/util/concurrent/CopyOnWriteArrayList;
...
.method public final b()Z
    ...
    iget-object p0, p0, Laz3;->a:Lorg/webrtc/DataChannel;
...
.method public final varargs d([Ljava/nio/ByteBuffer;)V
    ...
    iget-object v3, p0, Laz3;->b:Lxwb;

    const-string v4, "DataChannelRtcTransport"

    invoke-interface {v3, v4, v1, v2}, Lxwb;->reportException(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
