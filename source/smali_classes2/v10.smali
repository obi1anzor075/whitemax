...
# direct methods
.method public constructor <init>(Lvx5;Ljava/util/List;Landroid/content/Context;ZZ)V
    .locals 1

    invoke-direct {p0, p1}, Lfi5;-><init>(Lvx5;)V

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lv10;->j:Ljava/util/ArrayList;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Lv10;->o:Ljava/util/HashMap;

    iput-object p1, p0, Lv10;->i:Landroidx/fragment/app/c;

    iput-object p2, p0, Lv10;->k:Ljava/util/List;

    iput-object p3, p0, Lv10;->l:Landroid/content/Context;

    iput-boolean p4, p0, Lv10;->m:Z

    iput-boolean p5, p0, Lv10;->n:Z
...
.method public final a(Landroid/view/ViewGroup;ILandroidx/fragment/app/a;)V
    ...
    invoke-super {p0, p1, p2, p3}, Lfi5;->a(Landroid/view/ViewGroup;ILandroidx/fragment/app/a;)V

    invoke-virtual {p0, p2}, Lv10;->l(I)Lyia;
...
.method public final b()I
    ...
    iget-object p0, p0, Lv10;->j:Ljava/util/ArrayList;
...
.method public final c(Landroidx/fragment/app/a;)I
    ...
    iget-object p1, p1, Lru/ok/messages/media/attaches/fragments/FrgAttachView;->H1:Lo10;
...
.method public final g(I)Landroidx/fragment/app/a;
    ...
    invoke-virtual {p0, p1}, Lv10;->l(I)Lyia;

    move-result-object p1

    iget-object v0, p1, Lyia;->a:Ljava/lang/Object;

    move-object v1, v0

    check-cast v1, Lo10;

    iget-boolean v2, v1, Lo10;->s:Z
    ...
    iget-object v3, p0, Lv10;->p:Ljava/lang/String;
    ...
    :goto_0
    invoke-static {v1, p1, v4, v2, v3}, Lru/ok/messages/media/attaches/fragments/FrgAttachView;->t1(Lo10;Lxm8;ZZZ)Landroid/os/Bundle;
    ...
    invoke-virtual {v1, p1}, Landroidx/fragment/app/a;->Y0(Landroid/os/Bundle;)V
    ...
    iget-object v3, p0, Lv10;->q:Ljava/lang/String;
    ...
    iput-object v3, p0, Lv10;->q:Ljava/lang/String;
    ...
    iget-object v5, p0, Lv10;->p:Ljava/lang/String;

    invoke-virtual {v3, v5}, Ljava/lang/String;->equals(Ljava/lang/Object;)Z

    move-result v3

    invoke-static {v1, p1, v4, v3, v4}, Lru/ok/messages/media/attaches/fragments/FrgAttachView;->t1(Lo10;Lxm8;ZZZ)Landroid/os/Bundle;
    ...
    :cond_8
    iget-object v2, p0, Lv10;->l:Landroid/content/Context;
    ...
    invoke-static {v1, p1, v4, v4, v4}, Lru/ok/messages/media/attaches/fragments/FrgAttachView;->t1(Lo10;Lxm8;ZZZ)Landroid/os/Bundle;
    ...
    invoke-virtual {v3, p1}, Landroidx/fragment/app/a;->Y0(Landroid/os/Bundle;)V
    ...
    iget-object p1, v0, Lo10;->q:Ljava/lang/String;
...
.method public final i(Landroid/os/Bundle;)V
    ...
    invoke-super {p0, p1}, Lfi5;->i(Landroid/os/Bundle;)V
    ...
    :cond_1
    iget-object v2, p0, Lv10;->i:Landroidx/fragment/app/c;
    ...
    invoke-static {v2}, Lfu7;->a([B)Lo10;
    ...
    :cond_4
    iget-object v3, p0, Lv10;->o:Ljava/util/HashMap;
...
.method public final j(Ljava/util/List;Z)V
    ...
    :cond_0
    iget-object v1, p0, Lv10;->k:Ljava/util/List;
    ...
    invoke-virtual {v2, v1}, Ljj7;->u(I)Lo10;
...
.method public final l(I)Lyia;
    .locals 6

    iget-object p0, p0, Lv10;->k:Ljava/util/List;
    ...
    iget-object v5, p0, Lf10;->g:Lo10;

    :cond_2
    new-instance p0, Lyia;

    invoke-direct {p0, v5, v2}, Lyia;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V
