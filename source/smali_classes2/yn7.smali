...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Lyn7;->a:Landroid/content/Context;
    ...
    iput-object p1, p0, Lyn7;->h:Ljava/util/concurrent/ConcurrentLinkedQueue;

    invoke-static {}, Ljava/lang/System;->currentTimeMillis()J

    move-result-wide v0

    iput-wide v0, p0, Lyn7;->i:J
...
.method public final a(I)V
    ...
    :cond_1
    :try_start_1
    iget-object v2, p0, Lyn7;->a:Landroid/content/Context;
    ...
    invoke-static {v2, v3}, Lng5;->N(Ljava/io/File;Ljava/lang/String;)Ljava/io/File;

    move-result-object v3

    const-string v4, "b.log"

    invoke-static {v2, v4}, Lng5;->N(Ljava/io/File;Ljava/lang/String;)Ljava/io/File;

    move-result-object v4

    const-string v5, "stash-a.log"

    invoke-static {v2, v5}, Lng5;->N(Ljava/io/File;Ljava/lang/String;)Ljava/io/File;

    move-result-object v5

    const-string v6, "stash-b.log"

    invoke-static {v2, v6}, Lng5;->N(Ljava/io/File;Ljava/lang/String;)Ljava/io/File;
    ...
    sget-object v1, Lxn7;->$EnumSwitchMapping$1:[I
    ...
    invoke-static {v1}, Ldr9;->a([Ljava/io/File;)V
    ...
    invoke-static {v1}, Ldr9;->c([Ljava/io/File;)Llr;
    ...
    invoke-direct {v1, v3, v5}, Lwia;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V

    new-instance v3, Lwia;

    invoke-direct {v3, v4, v2}, Lwia;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V

    filled-new-array {v1, v3}, [Lwia;
