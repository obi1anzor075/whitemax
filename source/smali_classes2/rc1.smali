...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lrc1;->l:Ljava/util/concurrent/atomic/AtomicInteger;

    return-void
.end method

.method public constructor <init>(Lxwb;Landroid/opengl/EGLContext;[ILh87;Ljava/lang/String;)V
    .locals 16
    ...
    iput-object v9, v0, Lrc1;->a:Lxwb;

    move-object/from16 v1, p4

    iput-object v1, v0, Lrc1;->b:Lu16;
    ...
    iput-object v1, v0, Lrc1;->c:Landroid/os/HandlerThread;

    sget-object v2, Landroid/opengl/EGL14;->EGL_NO_SURFACE:Landroid/opengl/EGLSurface;

    iput-object v2, v0, Lrc1;->g:Landroid/opengl/EGLSurface;

    new-instance v10, Ljava/lang/Object;

    invoke-direct {v10}, Ljava/lang/Object;-><init>()V

    iput-object v10, v0, Lrc1;->h:Ljava/lang/Object;
    ...
    :goto_1
    iput-object v11, v0, Lrc1;->j:Ljava/lang/String;
    ...
    invoke-direct {v12, v13, v9, v14, v15}, Lbxf;-><init>(Landroid/os/Looper;Lxwb;Ljava/lang/String;Lh87;)V

    iput-object v12, v0, Lrc1;->k:Lbxf;

    const-string v1, "OpenGL context initialization requested"

    invoke-interface {v9, v11, v1}, Lxwb;->log(Ljava/lang/String;Ljava/lang/String;)V

    monitor-enter v10

    :try_start_0
    iget-boolean v1, v0, Lrc1;->i:Z

    if-eqz v1, :cond_2

    const-string v0, "OpenGL context is already initialized"

    invoke-interface {v9, v11, v0}, Lxwb;->log(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_0
    ...
    invoke-direct {v1, v0, v4, v3, v2}, Lg5;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;I)V
...
.method public final b(Landroid/opengl/EGLSurface;)V
    ...
    iget-object v0, p0, Lrc1;->d:Landroid/opengl/EGLContext;

    if-eqz v0, :cond_3

    iget-object v1, p0, Lrc1;->e:Landroid/opengl/EGLDisplay;
    ...
    iget-object v3, p0, Lrc1;->d:Landroid/opengl/EGLContext;
    ...
    iget-object v2, p0, Lrc1;->g:Landroid/opengl/EGLSurface;
    ...
    iput-object p1, p0, Lrc1;->g:Landroid/opengl/EGLSurface;
...
.method public final c(Lu16;)Z
    .locals 3

    :try_start_0
    iget-object v0, p0, Lrc1;->k:Lbxf;

    new-instance v1, Lqc1;

    const/4 v2, 0x0

    invoke-direct {v1, p1, p0, v2}, Lqc1;-><init>(Lu16;Lrc1;I)V
    ...
    invoke-interface {v1, p0, v0, p1}, Lxwb;->reportException(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public final e(Landroid/opengl/EGLSurface;)V
    ...
    iget-object v0, p0, Lrc1;->e:Landroid/opengl/EGLDisplay;

    if-eqz v0, :cond_0

    invoke-static {v0, p1}, Landroid/opengl/EGL14;->eglDestroySurface(Landroid/opengl/EGLDisplay;Landroid/opengl/EGLSurface;)Z

    sget-object p1, Lrc1;->l:Ljava/util/concurrent/atomic/AtomicInteger;
