...
# direct methods
.method public constructor <init>(Landroid/widget/EditText;Lc9;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Ltu7;->a:Landroid/widget/EditText;

    iput-object p2, p0, Ltu7;->b:Lc9;

    new-instance p1, Ljava/util/HashSet;

    invoke-direct {p1}, Ljava/util/HashSet;-><init>()V

    iput-object p1, p0, Ltu7;->c:Ljava/util/HashSet;
...
.method public final onActionItemClicked(Landroid/view/ActionMode;Landroid/view/MenuItem;)Z
    ...
    iget-object v1, p0, Ltu7;->a:Landroid/widget/EditText;
    ...
    sget v6, Larb;->markdown_bold:I

    if-ne v5, v6, :cond_1

    new-instance p0, Lso0;

    invoke-direct {p0, v4}, Lso0;-><init>(I)V

    invoke-static {v1, v2, v3, v4, p0}, Lmt0;->A(Landroid/text/Editable;IIZLuu7;)V
    ...
    :cond_1
    sget v6, Larb;->markdown_italic:I
    ...
    :cond_2
    sget v6, Larb;->markdown_underline:I

    if-ne v5, v6, :cond_3

    new-instance p0, Lwzd;

    invoke-direct {p0, v0}, Lwzd;-><init>(I)V

    invoke-static {v1, v2, v3, v0, p0}, Lmt0;->A(Landroid/text/Editable;IIZLuu7;)V
    ...
    :cond_4
    sget v6, Larb;->markdown_strikethrough:I

    if-ne v5, v6, :cond_5

    new-instance p0, Lwzd;

    invoke-direct {p0, v4}, Lwzd;-><init>(I)V
    ...
    :cond_6
    sget v6, Larb;->markdown_link:I

    if-ne v5, v6, :cond_c

    iget-object p0, p0, Ltu7;->b:Lc9;
    ...
    iget-object p1, v4, Llf7;->b:Ljava/lang/String;
    ...
    iget-object p0, p0, Lone/me/sdk/messagewrite/MessageWriteWidget;->c:Lt97;
    ...
    invoke-direct {p2, v2, v3, p1}, Laa;-><init>(IILjava/lang/String;)V

    iget-object p0, p0, Lvu7;->c:Ll05;
    ...
    invoke-direct {p1, v2, v3, p2}, Laa;-><init>(IILjava/lang/String;)V
    ...
    :cond_c
    sget p0, Larb;->markdown_heading:I

    if-ne v5, p0, :cond_d

    new-instance p0, Laf6;

    invoke-direct {p0}, Laf6;-><init>()V
    ...
    :cond_d
    sget p0, Larb;->markdown_regular:I
    ...
    invoke-static {v1, v5, v2, v3}, Lmt0;->B(Landroid/text/Spannable;Lqt3;II)V
...
.method public final onCreateActionMode(Landroid/view/ActionMode;Landroid/view/Menu;)Z
    ...
    iget-object p1, p0, Ltu7;->c:Ljava/util/HashSet;
    ...
    sget-object v0, Lpu7;->c:Lom3;

    invoke-virtual {v0}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    sget-object v0, Lpu7;->X:Ljava/util/LinkedHashSet;
    ...
    iget-object v3, p0, Ltu7;->a:Landroid/widget/EditText;
...
.method public final onDestroyActionMode(Landroid/view/ActionMode;)V
    ...
    iget-object p0, p0, Ltu7;->c:Ljava/util/HashSet;
