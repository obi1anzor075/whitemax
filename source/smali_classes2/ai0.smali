...
.method private final a(Ljava/lang/Object;)V
    ...
    invoke-virtual {p1, v6, v1}, Lalb;->a(Ljava/lang/Class;Z)Z
    ...
    invoke-virtual {p1, v6, v4}, Lalb;->a(Ljava/lang/Class;Z)Z
    ...
    invoke-virtual {p1, v7, v6}, Lalb;->a(Ljava/lang/Class;Z)Z
    ...
    invoke-virtual {p1, v9, v7}, Lalb;->a(Ljava/lang/Class;Z)Z
    ...
    invoke-virtual {p1, v9, v5}, Lalb;->a(Ljava/lang/Class;Z)Z
    ...
    invoke-virtual {p1, v8, v5}, Lalb;->a(Ljava/lang/Class;Z)Z
    ...
    :cond_f
    sget-object v5, Landroidx/camera/camera2/internal/compat/quirk/ExtraSupportedSurfaceCombinationsQuirk;->a:Li4e;
    ...
    invoke-virtual {p1, v7, v5}, Lalb;->a(Ljava/lang/Class;Z)Z
    ...
    invoke-virtual {p1, v5, v4}, Lalb;->a(Ljava/lang/Class;Z)Z
    ...
    invoke-virtual {p1, v10, v7}, Lalb;->a(Ljava/lang/Class;Z)Z
    ...
    invoke-virtual {p1, v5, v2}, Lalb;->a(Ljava/lang/Class;Z)Z
    ...
    invoke-virtual {p1, v1, v3}, Lalb;->a(Ljava/lang/Class;Z)Z
    ...
    :cond_2d
    invoke-direct {p0, v0}, Lxe6;-><init>(Ljava/util/List;)V

    sput-object p0, Lzf4;->a:Lxe6;

    sget-object p0, Lzf4;->a:Lxe6;

    invoke-static {p0}, Lxe6;->o(Lxe6;)V
...
.method public final accept(Ljava/lang/Object;)V
    ...
    :cond_1
    iget-object v1, v0, Lvd9;->o:Lol7;

    iget-boolean v1, v1, Lol7;->a:Z
    ...
    :cond_2
    iget-object v1, v0, Lvd9;->G0:Lpn1;

    invoke-static {v1}, Ltic;->c(Lxi4;)Z
    ...
    :cond_3
    iget-object v1, v0, Lvd9;->x0:Lf3f;

    iget-object v2, v0, Lvd9;->D0:Lg15;
    ...
    invoke-virtual {v2, v0, v9}, Lr4a;->c(Ljava/lang/Throwable;Z)V

    goto/16 :goto_1

    :cond_4
    iget-object v1, v0, Lvd9;->Z:Ljava/util/List;
    ...
    iget-object v2, v0, Lvd9;->x0:Lf3f;
    ...
    iget-object v2, v0, Lvd9;->Z:Ljava/util/List;
    ...
    iget-object v11, v4, Lrjb;->a:Lqjb;

    iget-wide v6, v4, Lrjb;->e:J
    ...
    iget v12, v4, Lrjb;->b:I

    iget-boolean v8, v4, Lrjb;->f:Z

    iget v13, v4, Lrjb;->c:I

    iget v14, v4, Lrjb;->d:I
    ...
    invoke-direct/range {v10 .. v17}, Lrjb;-><init>(Lqjb;IIIJZ)V
    ...
    iget-object v2, v2, Lf3f;->a:Lqjb;

    iget-object v0, v0, Lvd9;->c:Lnd9;

    check-cast v0, Lru/ok/messages/media/mediabar/ActLocalMedias;

    invoke-virtual {v0}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    invoke-static {v1, v2, v9}, Lru/ok/messages/views/dialogs/VideoQualityPickerDialog;->o1(Ljava/util/ArrayList;Lqjb;Z)Lru/ok/messages/views/dialogs/VideoQualityPickerDialog;
    ...
    invoke-virtual {v1, v2, v3}, Landroidx/fragment/app/DialogFragment;->l1(Landroidx/fragment/app/c;Ljava/lang/String;)V

    invoke-virtual {v0}, Landroidx/fragment/app/b;->P()Lvx5;

    move-result-object v1

    invoke-virtual {v0}, Lru/ok/messages/media/mediabar/ActLocalMedias;->j0()Lru/ok/messages/media/mediabar/FrgLocalMedia;

    move-result-object v2

    invoke-virtual {v2}, Landroidx/fragment/app/a;->m0()Lnc7;

    move-result-object v2

    new-instance v3, Lg6;

    invoke-direct {v3, v0}, Lg6;-><init>(Lru/ok/messages/media/mediabar/ActLocalMedias;)V

    new-instance v0, Lqzf;

    invoke-direct {v0, v9}, Lqzf;-><init>(I)V

    new-instance v4, Lo2f;

    invoke-direct {v4, v0, v3, v9}, Lo2f;-><init>(Ljava/lang/Runnable;Lqf3;I)V

    const-string v0, "VideoQualityPickerDialog:result:request"

    invoke-virtual {v1, v0, v2, v4}, Landroidx/fragment/app/c;->f0(Ljava/lang/String;Lnc7;Lyx5;)V
    ...
    invoke-static {v4, v1}, Ludd;->n(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v0, v0, Lvd9;->c:Lnd9;

    check-cast v0, Lru/ok/messages/media/mediabar/ActLocalMedias;

    invoke-virtual {v0}, Lru/ok/messages/media/mediabar/ActLocalMedias;->n0()V
    ...
    iget-object v0, v0, Ljd9;->c:Lxz;

    iget-object v1, v0, Lxz;->c:Ljava/lang/Object;

    check-cast v1, Landroid/view/WindowManager;

    iget-object v2, v0, Lxz;->o:Ljava/lang/Object;

    check-cast v2, Lqe9;

    iget-object v0, v0, Lxz;->b:Ljava/lang/Object;
    ...
    :catch_0
    iput-object v3, v0, Ljwa;->I0:Ljd9;
    ...
    :pswitch_e
    invoke-direct/range {p0 .. p1}, Lai0;->a(Ljava/lang/Object;)V
    ...
    invoke-virtual {v0, v4, v2}, Lalb;->a(Ljava/lang/Class;Z)Z
    ...
    invoke-virtual {v0, v2, v8}, Lalb;->a(Ljava/lang/Class;Z)Z
    ...
    :cond_f
    invoke-direct {v1, v3}, Lxe6;-><init>(Ljava/util/List;)V

    sput-object v1, Lyf4;->a:Lxe6;

    sget-object v0, Lyf4;->a:Lxe6;

    invoke-static {v0}, Lxe6;->o(Lxe6;)V
    ...
    invoke-virtual {v3, v6, v8}, Lalb;->a(Ljava/lang/Class;Z)Z
    ...
    invoke-virtual {v3, v10, v9}, Lalb;->a(Ljava/lang/Class;Z)Z
    ...
    invoke-virtual {v3, v9, v8}, Lalb;->a(Ljava/lang/Class;Z)Z
    ...
    invoke-static {}, Lp20;->o()Ljava/lang/String;
    ...
    invoke-virtual {v3, v8, v2}, Lalb;->a(Ljava/lang/Class;Z)Z
    ...
    invoke-virtual {v3, v2, v1}, Lalb;->a(Ljava/lang/Class;Z)Z
    ...
    invoke-virtual {v3, v10, v2}, Lalb;->a(Ljava/lang/Class;Z)Z
    ...
    invoke-virtual {v3, v0, v2}, Lalb;->a(Ljava/lang/Class;Z)Z
    ...
    invoke-virtual {v3, v2, v0}, Lalb;->a(Ljava/lang/Class;Z)Z
    ...
    invoke-virtual {v3, v8, v0}, Lalb;->a(Ljava/lang/Class;Z)Z
    ...
    invoke-virtual {v3, v0, v8}, Lalb;->a(Ljava/lang/Class;Z)Z
    ...
    :cond_4c
    invoke-direct {v4, v5}, Lxe6;-><init>(Ljava/util/List;)V

    sput-object v4, Lxf4;->a:Lxe6;
    ...
    invoke-virtual {v2, v7, v6}, Lalb;->a(Ljava/lang/Class;Z)Z
    ...
    invoke-virtual {v2, v6, v7}, Lalb;->a(Ljava/lang/Class;Z)Z
    ...
    invoke-virtual {v2, v9, v7}, Lalb;->a(Ljava/lang/Class;Z)Z
    ...
    invoke-virtual {v2, v8, v7}, Lalb;->a(Ljava/lang/Class;Z)Z
    ...
    invoke-virtual {v2, v7, v1}, Lalb;->a(Ljava/lang/Class;Z)Z
    ...
    invoke-virtual {v2, v0, v8}, Lalb;->a(Ljava/lang/Class;Z)Z
    ...
    :cond_5a
    invoke-direct {v3, v4}, Lxe6;-><init>(Ljava/util/List;)V

    sput-object v3, Lwf4;->a:Lxe6;
    ...
    invoke-virtual {v0, v1}, Lbe9;->a2(I)V
    ...
    invoke-virtual {v0, v7}, Lbe9;->a2(I)V
    ...
    :cond_5b
    iget-object v1, v0, Lbe9;->I0:Lav7;

    invoke-virtual {v1}, Lav7;->a()Lzu7;

    move-result-object v1

    const/4 v2, 0x1

    iput-boolean v2, v1, Lzu7;->i:Z

    new-instance v2, Lav7;

    invoke-direct {v2, v1}, Lav7;-><init>(Lzu7;)V

    iput-object v2, v0, Lbe9;->I0:Lav7;

    invoke-virtual {v0}, Lbe9;->f2()V
    ...
    :cond_5c
    iget-object v3, v0, Lbe9;->c:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iget-object v2, v0, Lbe9;->F0:Lru/ok/messages/location/FrgLocationMap;
    ...
    iget-object v1, v1, Lav7;->a:Ldm7;

    iget-wide v4, v1, Ldm7;->a:D

    iget-wide v6, v1, Ldm7;->b:D
    ...
    iget-object v3, v0, Lbe9;->F0:Lru/ok/messages/location/FrgLocationMap;
    ...
    :cond_5e
    iget-object v4, v0, Lbe9;->c:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    :cond_5f
    iget-object v2, v0, Lbe9;->G0:Lhm7;

    iget-wide v7, v2, Lhm7;->o:J

    cmp-long v2, v7, v5

    if-eqz v2, :cond_61

    iget-object v2, v0, Lbe9;->o:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iget-object v7, v0, Lbe9;->G0:Lhm7;

    iget-wide v7, v7, Lhm7;->o:J

    cmp-long v5, v5, v7

    if-nez v5, :cond_60

    invoke-virtual {v3, v4}, Lru/ok/messages/location/FrgLocationMap;->s1(Lav7;)V

    goto :goto_22

    :cond_61
    invoke-virtual {v3, v1}, Lru/ok/messages/location/FrgLocationMap;->s1(Lav7;)V
    ...
    iget-object v1, v0, Lbe9;->F0:Lru/ok/messages/location/FrgLocationMap;
    ...
    iget-object v2, v0, Lbe9;->H0:Ldm7;

    invoke-virtual {v2}, Ldm7;->a()Z
    ...
    :cond_64
    iget-object v2, v0, Lbe9;->c:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iget-object v4, v0, Lbe9;->G0:Lhm7;

    iget-object v4, v4, Lhm7;->e:Lgm7;

    iget-object v7, v1, Lru/ok/messages/location/FrgLocationMap;->K1:Lhm7;
    ...
    iget-object v5, v1, Lru/ok/messages/views/fragments/base/FrgBase;->u1:Lnqc;

    invoke-virtual {v5}, Lnqc;->b()Lbd;

    move-result-object v5

    const-string v6, "VIEWER"

    invoke-virtual {v5, v8, v6}, Lbd;->g(Ljava/lang/String;Ljava/lang/String;)V

    iget-wide v5, v1, Lru/ok/messages/location/FrgLocationMap;->L1:J

    new-instance v7, Lx0d;

    invoke-direct {v7, v5, v6}, Le1d;-><init>(J)V

    const/4 v5, 0x0

    iput-boolean v5, v7, Lx0d;->l:Z

    iput-object v2, v7, Lx0d;->m:Ldm7;

    iget-wide v4, v4, Lgm7;->b:J

    iput-wide v4, v7, Lx0d;->o:J
    ...
    invoke-direct {v2, v7}, Ly0d;-><init>(Lx0d;)V

    iget-object v4, v1, Lru/ok/messages/views/fragments/base/FrgBase;->t1:Lv2b;
    ...
    invoke-static {v1, v2}, La06;->E(Landroid/content/Context;I)V

    goto :goto_23

    :cond_65
    iget-object v7, v1, Lru/ok/messages/views/fragments/base/FrgBase;->u1:Lnqc;

    invoke-virtual {v7}, Lnqc;->b()Lbd;

    move-result-object v7

    const-string v9, "PICKER"

    invoke-virtual {v7, v8, v9}, Lbd;->g(Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual {v1}, Lru/ok/messages/views/fragments/base/FrgBase;->h1()Lr5;
    ...
    invoke-virtual {v1}, Lr5;->finish()V
    ...
    invoke-virtual {v0, v3}, Lbe9;->h2(Lyd9;)V
    ...
    :cond_68
    iget-object v4, v0, Lbe9;->I0:Lav7;

    iget-object v4, v4, Lav7;->a:Ldm7;

    invoke-virtual {v4}, Ldm7;->a()Z
    ...
    invoke-direct {v9, v10, v11, v12, v13}, Ldm7;-><init>(DD)V

    iput-object v9, v4, Lzu7;->a:Ldm7;

    new-instance v2, Lav7;

    invoke-direct {v2, v4}, Lav7;-><init>(Lzu7;)V

    iput-object v2, v0, Lbe9;->I0:Lav7;

    :cond_69
    iget-object v0, v0, Lbe9;->I0:Lav7;
    ...
    :cond_6a
    iget-object v4, v1, Lru/ok/messages/location/FrgLocationMap;->F1:Lgy5;

    iget v3, v3, Lkt7;->g:F

    if-eqz v4, :cond_6b

    iget v4, v1, Lru/ok/messages/location/FrgLocationMap;->M1:I
    ...
    iget-object v0, v1, Lru/ok/messages/location/FrgLocationMap;->F1:Lgy5;

    iget v1, v1, Lru/ok/messages/location/FrgLocationMap;->M1:I

    invoke-interface {v0, v1, v5, v4}, Lgy5;->Q(IILandroid/content/Intent;)V

    invoke-virtual {v2}, Lr5;->onBackPressed()V

    goto :goto_24

    :cond_6b
    iget-object v4, v1, Lru/ok/messages/location/FrgLocationMap;->G1:Lbe9;

    iget-object v9, v4, Lbe9;->G0:Lhm7;
    ...
    invoke-virtual {v9}, Laf9;->E()Lkt7;

    iget-object v4, v4, Lbe9;->H0:Ldm7;

    iget-object v9, v1, Lru/ok/messages/location/FrgLocationMap;->I1:Lwae;

    iget-wide v11, v0, Ldm7;->a:D

    iget-wide v13, v4, Ldm7;->a:D

    move-object v10, v9

    check-cast v10, Lod;

    iget-wide v7, v0, Ldm7;->b:D

    move-object/from16 v19, v6

    iget-wide v5, v4, Ldm7;->b:D
    ...
    invoke-virtual/range {v10 .. v18}, Lod;->f(DDDD)Z

    move-result v4

    if-nez v4, :cond_6c

    iget-object v4, v1, Lru/ok/messages/views/fragments/base/FrgBase;->u1:Lnqc;

    invoke-virtual {v4}, Lnqc;->b()Lbd;

    move-result-object v4

    const-string v5, "LOCATION_SEND_DIFFERENT_LOCATION"

    invoke-virtual {v4, v5}, Lbd;->f(Ljava/lang/String;)V
    ...
    invoke-virtual {v2}, Lr5;->finish()V
    ...
    iget-object v1, v0, Lbe9;->C0:Lduf;

    invoke-virtual {v1}, Lduf;->v()V

    iget-object v1, v0, Lbe9;->H0:Ldm7;

    invoke-virtual {v1}, Ldm7;->a()Z
    ...
    :goto_25
    iput-boolean v8, v0, Lbe9;->J0:Z

    iget-object v1, v0, Lbe9;->I0:Lav7;

    iget-object v1, v1, Lav7;->a:Ldm7;

    iget-wide v9, v1, Ldm7;->a:D

    iget-object v2, v0, Lbe9;->H0:Ldm7;

    iget-wide v13, v2, Ldm7;->a:D

    iget-object v3, v0, Lbe9;->Z:Lwae;

    move-object v8, v3

    check-cast v8, Lod;

    iget-wide v11, v1, Ldm7;->b:D

    iget-wide v1, v2, Ldm7;->b:D

    move-wide v15, v1

    invoke-virtual/range {v8 .. v16}, Lod;->f(DDDD)Z
    ...
    iget-object v4, v0, Lbe9;->H0:Ldm7;

    iget-wide v5, v4, Ldm7;->a:D

    iget-wide v7, v4, Ldm7;->b:D

    invoke-direct {v3, v5, v6, v7, v8}, Ldm7;-><init>(DD)V

    iput-object v3, v1, Lzu7;->a:Ldm7;

    new-instance v3, Lav7;

    invoke-direct {v3, v1}, Lav7;-><init>(Lzu7;)V

    iput-object v3, v0, Lbe9;->I0:Lav7;

    invoke-virtual {v0}, Lbe9;->d2()V
    ...
    iget-object v0, v0, Lbe9;->H0:Ldm7;

    iget-wide v4, v0, Ldm7;->a:D

    iget-wide v6, v0, Ldm7;->b:D
    ...
    iget-object v0, v0, Lbe9;->F0:Lru/ok/messages/location/FrgLocationMap;
    ...
    invoke-virtual {v0}, Lru/ok/messages/views/fragments/base/FrgBase;->f1()V

    goto :goto_28

    :cond_71
    invoke-virtual {v1}, Le83;->onBackPressed()V
    ...
    invoke-virtual {v1}, Laf9;->D()[D

    move-result-object v1

    iget-object v2, v0, Lbe9;->I0:Lav7;
    ...
    invoke-direct {v3, v4, v5, v8, v9}, Ldm7;-><init>(DD)V

    iput-object v3, v2, Lzu7;->a:Ldm7;

    new-instance v1, Lav7;

    invoke-direct {v1, v2}, Lav7;-><init>(Lzu7;)V

    iput-object v1, v0, Lbe9;->I0:Lav7;
