...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput v0, p0, Lru/ok/messages/views/widgets/SlideOutLayout;->x0:F

    iput v0, p0, Lru/ok/messages/views/widgets/SlideOutLayout;->y0:F

    iput-boolean p1, p0, Lru/ok/messages/views/widgets/SlideOutLayout;->A0:Z

    iput-boolean p1, p0, Lru/ok/messages/views/widgets/SlideOutLayout;->B0:Z

    new-instance v1, Ljava/util/ArrayList;

    invoke-direct {v1}, Ljava/util/ArrayList;-><init>()V

    iput-object v1, p0, Lru/ok/messages/views/widgets/SlideOutLayout;->D0:Ljava/util/ArrayList;

    const/4 v1, 0x2

    new-array v2, v1, [I

    iput-object v2, p0, Lru/ok/messages/views/widgets/SlideOutLayout;->E0:[I

    invoke-virtual {p0}, Landroid/view/View;->getContext()Landroid/content/Context;

    move-result-object v2

    sget-object v3, Lzvb;->SlideOutLayout:[I

    invoke-virtual {v2, p2, v3}, Landroid/content/Context;->obtainStyledAttributes(Landroid/util/AttributeSet;[I)Landroid/content/res/TypedArray;

    move-result-object p2

    sget v2, Lzvb;->SlideOutLayout_chistyakov_orientation:I
    ...
    sget v2, Lzvb;->SlideOutLayout_type:I
    ...
    iput-object p1, p0, Lru/ok/messages/views/widgets/SlideOutLayout;->a:Lzg4;
    ...
    iput p1, p0, Lru/ok/messages/views/widgets/SlideOutLayout;->z0:F

    cmpg-float p1, p1, v0

    if-gtz p1, :cond_3

    iget-object p1, p0, Lru/ok/messages/views/widgets/SlideOutLayout;->a:Lzg4;
...
.method public final c(Landroid/view/MotionEvent;)V
    ...
    iget v0, p0, Lru/ok/messages/views/widgets/SlideOutLayout;->x0:F
    ...
    :cond_0
    iget v0, p0, Lru/ok/messages/views/widgets/SlideOutLayout;->y0:F
    ...
    iget v2, p0, Lru/ok/messages/views/widgets/SlideOutLayout;->y0:F
    ...
    :cond_1
    iget v2, p0, Lru/ok/messages/views/widgets/SlideOutLayout;->x0:F
    ...
    iget v1, p0, Lru/ok/messages/views/widgets/SlideOutLayout;->z0:F
    ...
    iput-boolean v4, p0, Lru/ok/messages/views/widgets/SlideOutLayout;->A0:Z
    ...
    :cond_6
    iget-object v0, p0, Lru/ok/messages/views/widgets/SlideOutLayout;->C0:Lojd;

    if-eqz v0, :cond_8

    invoke-interface {v0}, Lojd;->Q()V
    ...
    iput p1, p0, Lru/ok/messages/views/widgets/SlideOutLayout;->w0:F
...
.method public final onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iput-boolean v1, p0, Lru/ok/messages/views/widgets/SlideOutLayout;->A0:Z
    ...
    :cond_0
    iget-object v0, p0, Lru/ok/messages/views/widgets/SlideOutLayout;->D0:Ljava/util/ArrayList;
    ...
    iget-object v4, p0, Lru/ok/messages/views/widgets/SlideOutLayout;->E0:[I
    ...
    :goto_1
    iget-boolean p0, p0, Lru/ok/messages/views/widgets/SlideOutLayout;->A0:Z
...
.method public final onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    :cond_1
    iget-boolean v0, p0, Lru/ok/messages/views/widgets/SlideOutLayout;->A0:Z
    ...
    iget-object v7, p0, Lru/ok/messages/views/widgets/SlideOutLayout;->F0:Landroid/view/VelocityTracker;
    ...
    sget-object v8, Lu0f;->a:Ljava/util/Map;
    ...
    iput-object v7, p0, Lru/ok/messages/views/widgets/SlideOutLayout;->F0:Landroid/view/VelocityTracker;
    ...
    iget-object p1, p0, Lru/ok/messages/views/widgets/SlideOutLayout;->C0:Lojd;

    if-eqz p1, :cond_11

    invoke-interface {p1}, Lojd;->p()V
    ...
    :cond_a
    :goto_4
    iget-object v5, p0, Lru/ok/messages/views/widgets/SlideOutLayout;->C0:Lojd;

    if-eqz v5, :cond_b

    invoke-interface {v5}, Lojd;->D()Z
    ...
    invoke-interface {p1, v4}, Lojd;->N(I)V
    ...
    invoke-direct {v2, p0, v4}, Lnjd;-><init>(Lru/ok/messages/views/widgets/SlideOutLayout;I)V
    ...
    invoke-direct {v2, v4, p0}, Lc00;-><init>(ILjava/lang/Object;)V
    ...
    iget-boolean v2, p0, Lru/ok/messages/views/widgets/SlideOutLayout;->B0:Z

    if-eq v2, p1, :cond_13

    iget-object v2, p0, Lru/ok/messages/views/widgets/SlideOutLayout;->C0:Lojd;
    ...
    :cond_15
    iget v7, p0, Lru/ok/messages/views/widgets/SlideOutLayout;->w0:F
    ...
    :cond_1c
    iput-boolean v1, p0, Lru/ok/messages/views/widgets/SlideOutLayout;->B0:Z
    ...
    :goto_12
    iget-object v0, p0, Lru/ok/messages/views/widgets/SlideOutLayout;->F0:Landroid/view/VelocityTracker;
    ...
    iput-object v0, p0, Lru/ok/messages/views/widgets/SlideOutLayout;->F0:Landroid/view/VelocityTracker;

    :cond_20
    iget-object p0, p0, Lru/ok/messages/views/widgets/SlideOutLayout;->F0:Landroid/view/VelocityTracker;
...
.method public setSlideOutListener(Lojd;)V
    .locals 0

    iput-object p1, p0, Lru/ok/messages/views/widgets/SlideOutLayout;->C0:Lojd;
