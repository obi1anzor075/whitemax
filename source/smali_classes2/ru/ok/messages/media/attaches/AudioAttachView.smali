...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object v5, v0, Lru/ok/messages/media/attaches/AudioAttachView;->y0:Lr7e;
    ...
    sget v7, Lyqb;->view_audio_attach__btn_play:I
    ...
    invoke-direct {v7, v3}, Lb20;-><init>(I)V

    invoke-static {v5, v7}, La24;->a0(Landroid/view/View;Landroid/view/View$OnClickListener;)V
    ...
    sget v8, Lyqb;->view_audio_attach__wave:I

    invoke-virtual {v7, v8}, Landroid/view/View;->setId(I)V

    invoke-virtual {v7, v0}, Lru/ok/messages/views/widgets/audiowave/AudioWaveView;->setListener(Lr60;)V

    new-instance v8, Lb20;

    invoke-direct {v8, v3}, Lb20;-><init>(I)V

    invoke-static {v7, v8}, La24;->a0(Landroid/view/View;Landroid/view/View$OnClickListener;)V

    new-instance v8, Lc20;

    invoke-direct {v8, v3}, Lc20;-><init>(I)V
    ...
    sget-object v8, Lnte;->a:Lnge;

    sget-object v8, Ljp2;->d:Lnge;

    invoke-static {v8, v7}, Lnge;->d(Lnge;Landroid/widget/TextView;)V

    sget v8, Lyqb;->view_audio_attach__duration:I
    ...
    sget v11, Lyqb;->view_audio_attach__btn_play:I

    invoke-virtual {v8, v5, v11}, Landroid/widget/RelativeLayout$LayoutParams;->addRule(II)V

    sget v11, Lyqb;->view_audio_attach__wave:I
    ...
    invoke-direct {v7, v1, v2, v3}, Le50;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V

    sget v2, Lyqb;->view_audio_attach__seek:I

    invoke-virtual {v7, v2}, Landroid/view/View;->setId(I)V

    invoke-virtual {v7, v4}, Landroid/view/View;->setVisibility(I)V

    iput-object v7, v0, Lru/ok/messages/media/attaches/AudioAttachView;->o:Le50;

    new-instance v2, Landroid/widget/RelativeLayout$LayoutParams;

    invoke-direct {v2, v10, v10}, Landroid/widget/RelativeLayout$LayoutParams;-><init>(II)V

    sget v3, Lyqb;->view_audio_attach__btn_play:I
    ...
    sget v3, Lyqb;->view_audio_attach__transcription_status:I
    ...
    sget v4, Lyqb;->view_audio_attach__duration:I

    invoke-virtual {v3, v5, v4}, Landroid/widget/RelativeLayout$LayoutParams;->addRule(II)V

    sget v4, Lyqb;->view_audio_attach__wave:I
    ...
    iput-object v2, v0, Lru/ok/messages/media/attaches/AudioAttachView;->w0:Landroidx/appcompat/widget/AppCompatTextView;
    ...
    iput-object v1, v0, Lru/ok/messages/media/attaches/AudioAttachView;->z0:Ljava/util/HashMap;

    return-void
.end method

.method private final getAudioController()Lh30;
    .locals 0

    iget-object p0, p0, Lru/ok/messages/media/attaches/AudioAttachView;->y0:Lr7e;
...
.method public final a(F)V
    ...
    iget-object p0, p0, Lru/ok/messages/media/attaches/AudioAttachView;->o:Le50;

    invoke-virtual {p0, v0}, Le50;->setLayoutPosition(F)V
...
.method public final c()V
    ...
    :goto_1
    iget-object v1, v1, Lwce;->g:Ldr0;

    iget-object v2, v1, Ldr0;->c:Ler0;
    ...
    invoke-static {v2, v0}, Ln1g;->c0(IF)I
    ...
    invoke-static {v0, v5, v5}, Lswb;->H(Ljava/lang/Integer;Ljava/lang/Integer;Ljava/lang/Integer;)Landroid/graphics/drawable/GradientDrawable;

    move-result-object v0

    invoke-static {v4, v0, v5}, Lswb;->Q(Landroid/graphics/drawable/GradientDrawable;Landroid/graphics/drawable/GradientDrawable;Landroid/graphics/drawable/GradientDrawable;)Landroid/graphics/drawable/StateListDrawable;
    ...
    iget-object p0, p0, Lru/ok/messages/media/attaches/AudioAttachView;->w0:Landroidx/appcompat/widget/AppCompatTextView;
...
.method public final d(F)V
    ...
    invoke-direct {p0}, Lru/ok/messages/media/attaches/AudioAttachView;->getAudioController()Lh30;

    move-result-object p1

    iget-object p1, p1, Lh30;->c:Lnb9;

    const-wide/16 v0, 0x0

    invoke-virtual {p1, v0, v1}, Lnb9;->p(J)Z
    ...
    invoke-virtual {p0, v0, v1}, Le50;->setCurrentAudioPosition(J)V
...
.method public final e(F)V
    ...
    invoke-static {p0}, Lbm3;->j(Landroid/view/View;)Ltg;
    ...
    :cond_5
    iget-boolean p1, p0, Le50;->D0:Z

    if-eqz p1, :cond_6

    iget-object p1, p0, Le50;->C0:Landroid/animation/Animator;
    ...
    :cond_6
    iput-boolean v1, p0, Le50;->D0:Z

    iget-object p1, p0, Le50;->C0:Landroid/animation/Animator;

    if-eqz p1, :cond_7

    invoke-static {p1}, Lvx3;->f(Landroid/animation/Animator;)V
    ...
    invoke-virtual {p0, p1, v0}, Le50;->j(FF)Landroid/animation/ObjectAnimator;
    ...
    iput-object p1, p0, Le50;->C0:Landroid/animation/Animator;
...
.method public final f()V
    ...
    :cond_1
    iget-boolean v1, p0, Le50;->E0:Z

    if-eqz v1, :cond_2

    iget-object v1, p0, Le50;->C0:Landroid/animation/Animator;
    ...
    invoke-virtual {p0, v1, v2}, Le50;->j(FF)Landroid/animation/ObjectAnimator;
    ...
    invoke-interface {v2}, Llg;->n()Landroid/view/animation/Interpolator;
    ...
    invoke-direct {v2, p0, v0, v0, v3}, Ld50;-><init>(Landroid/view/View;Ljava/lang/Object;Ljava/lang/Object;I)V

    invoke-virtual {v1, v2}, Landroid/animation/Animator;->addListener(Landroid/animation/Animator$AnimatorListener;)V

    iput-object v1, p0, Le50;->C0:Landroid/animation/Animator;
...
.method public setCurrentPosition(J)V
    ...
    iget-object v0, v0, Lh30;->c:Lnb9;

    const-wide/16 v1, 0x0

    invoke-virtual {v0, v1, v2}, Lnb9;->p(J)Z

    iget-object p0, p0, Lru/ok/messages/media/attaches/AudioAttachView;->o:Le50;

    invoke-virtual {p0, p1, p2}, Le50;->setCurrentAudioPosition(J)V
