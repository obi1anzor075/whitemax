...
# direct methods
.method public synthetic constructor <init>(Landroid/view/View;Lsy6;Lu16;)V
    .locals 1

    const/4 v0, 0x7

    .line 1
    invoke-direct {p0, p1, p2, p3, v0}, Lrrd;-><init>(Landroid/view/View;Lsy6;Lu16;I)V

    return-void
.end method

.method public constructor <init>(Landroid/view/View;Lsy6;Lu16;I)V
    .locals 3
    ...
    .line 4
    iput-object p2, p0, Lrrd;->b:Lsy6;

    .line 5
    iput-object p3, p0, Lrrd;->c:Lu16;
    ...
    iput-object p3, p0, Lrrd;->h:Landroid/graphics/Rect;
    ...
    .line 12
    :goto_1
    iput-object p4, p0, Lrrd;->i:Landroid/graphics/Rect;
...
# virtual methods
.method public final a(Lqy6;Lup0;)V
    .locals 2
    ...
    iget-object p0, p0, Lrrd;->i:Landroid/graphics/Rect;
    ...
    :cond_3
    iget-object p0, p0, Lrrd;->h:Landroid/graphics/Rect;
...
.method public c(Lnsf;)V
    .locals 6

    iget-object v0, p0, Lrrd;->b:Lsy6;

    iget v1, v0, Lsy6;->a:I

    if-eqz v1, :cond_5

    iget-object v2, p1, Lnsf;->a:Llsf;
    ...
    iget-object v4, p0, Lrrd;->a:Landroid/view/View;
    ...
    iget-object v3, p0, Lrrd;->i:Landroid/graphics/Rect;
    ...
    :cond_3
    iget-object v1, p0, Lrrd;->h:Landroid/graphics/Rect;
    ...
    :cond_5
    :goto_0
    iget-object v0, v0, Lsy6;->b:Lup0;

    if-eqz v0, :cond_6

    invoke-virtual {p0, p1, v0}, Lrrd;->b(Lnsf;Lup0;)V

    :cond_6
    iget-object p0, p0, Lrrd;->c:Lu16;
