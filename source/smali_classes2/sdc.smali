...
# direct methods
.method public synthetic constructor <init>(Ludc;Lpec;I)V
    .locals 0

    iput p3, p0, Lsdc;->a:I

    iput-object p1, p0, Lsdc;->c:Ludc;

    iput-object p2, p0, Lsdc;->b:Lpec;
...
.method public final call()Ljava/lang/Object;
    ...
    iget-object v2, v0, Lsdc;->b:Lpec;

    move-object/from16 v17, v1

    iget-object v1, v0, Lsdc;->c:Ludc;
    ...
    invoke-virtual {v1, v2, v0}, Laec;->o(Lf4e;Landroid/os/CancellationSignal;)Landroid/database/Cursor;
    ...
    :goto_9
    invoke-static {v2}, Lkjd;->M(Ljava/lang/String;)Ljava/util/EnumSet;
    ...
    :goto_f
    invoke-static {v0}, Lkjd;->t([B)Ljava/util/Map;
    ...
    :goto_10
    invoke-static {v0}, Lkjd;->v([B)Ljava/util/List;
    ...
    :goto_11
    invoke-static {v0}, Lkjd;->u([B)Ljava/util/Set;
    ...
    invoke-direct/range {v19 .. v32}, Lhdc;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ILjava/util/Set;ZZLjava/util/List;Ljava/lang/Long;Ljava/util/Map;Ljava/util/List;Ljava/util/Set;Z)V
    ...
    invoke-static {v3, v2}, Lgr8;->mergeFrom(Lgr8;[B)Lgr8;

    invoke-static {v3}, Lgp8;->a(Lru/ok/tamtam/nano/Protos$MessageElements;)Ljava/util/ArrayList;
    ...
    :goto_2d
    invoke-static {v2}, Lkjd;->t([B)Ljava/util/Map;
    ...
    :goto_2e
    invoke-static {v2}, Lkjd;->v([B)Ljava/util/List;
    ...
    :goto_2f
    invoke-static {v2}, Lkjd;->u([B)Ljava/util/Set;
    ...
    invoke-direct/range {v18 .. v31}, Lhdc;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ILjava/util/Set;ZZLjava/util/List;Ljava/lang/Long;Ljava/util/Map;Ljava/util/List;Ljava/util/Set;Z)V
