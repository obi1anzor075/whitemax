...
.method public constructor <init>(Lm80;Landroid/content/Context;)V
    ...
    iput-object p1, p0, Lg60;->b:Lm80;

    invoke-virtual {p1}, Lm80;->a()I
    ...
    invoke-static {v0, p1, p2}, Lg60;->c(ILm80;Landroid/content/Context;)Landroid/media/AudioRecord;
...
.method public static c(ILm80;Landroid/content/Context;)Landroid/media/AudioRecord;
    .locals 4
...
.method public final a(Lnfc;Lryc;)V
    ...
    iput-object p1, p0, Lg60;->h:Lnfc;

    iput-object p2, p0, Lg60;->i:Ljava/util/concurrent/Executor;

    iget-object p1, p0, Lg60;->k:Lf60;
    ...
    iput-object p1, p0, Lg60;->k:Lf60;

    :cond_1
    iget-object p1, p0, Lg60;->a:Landroid/media/AudioRecord;

    iget-object p0, p0, Lg60;->k:Lf60;
...
.method public final b()V
    ...
    iget-object p0, p0, Lg60;->c:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public final d(Z)V
    ...
    iget-object v0, p0, Lg60;->i:Ljava/util/concurrent/Executor;

    iget-object v1, p0, Lg60;->h:Lnfc;

    if-eqz v0, :cond_0

    if-eqz v1, :cond_0

    iget-object p0, p0, Lg60;->e:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    invoke-direct {p0, v1, p1, v2}, Lt50;-><init>(Ljava/lang/Object;ZI)V
...
.method public final read(Ljava/nio/ByteBuffer;)Lp80;
    ...
    invoke-static {v11, v9}, Le07;->j(Ljava/lang/String;Z)V
    ...
    invoke-static {v9, v6}, Le07;->j(Ljava/lang/String;Z)V

    iget-wide v11, p1, Landroid/media/AudioTimestamp;->framePosition:J

    sub-long/2addr v7, v11

    invoke-static {v5, v7, v8}, Lr1g;->j(IJ)J
    ...
    invoke-static {p1, v5, v6}, Lr1g;->D(IJ)J
    ...
    invoke-direct {p0, v0, v1, v2}, Lp80;-><init>(IJ)V
...
.method public final release()V
    ...
    :cond_0
    iget-object v0, p0, Lg60;->k:Lf60;

    if-eqz v0, :cond_1

    iget-object v1, p0, Lg60;->a:Landroid/media/AudioRecord;
    ...
    :cond_1
    iget-object p0, p0, Lg60;->a:Landroid/media/AudioRecord;
...
.method public final start()V
    ...
    :goto_1
    invoke-virtual {p0, v1}, Lg60;->d(Z)V
...
.method public final stop()V
    ...
    iget-object v0, p0, Lg60;->b:Lm80;

    const/4 v1, 0x0

    iget v2, p0, Lg60;->f:I

    invoke-static {v2, v0, v1}, Lg60;->c(ILm80;Landroid/content/Context;)Landroid/media/AudioRecord;

    move-result-object v0

    iput-object v0, p0, Lg60;->a:Landroid/media/AudioRecord;
