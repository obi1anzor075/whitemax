...
.method public constructor <init>(Ljava/util/List;IFLjava/lang/String;)V
    ...
    iput-object p4, p0, Lrf6;->d:Ljava/lang/String;

    return-void
.end method

.method public static a(Lyze;)Lrf6;
    .locals 24
    ...
    :try_start_0
    invoke-virtual {v0, v1}, Lyze;->I(I)V
    ...
    iget-object v7, v0, Lyze;->a:[B

    iget v15, v0, Lyze;->b:I
    ...
    invoke-static {v10, v3, v5}, Lkjd;->G(I[BI)Ltf9;
    ...
    invoke-static/range {v16 .. v21}, Lez3;->g(IZII[II)Ljava/lang/String;
    ...
    invoke-direct {v2, v0, v1, v5, v8}, Lrf6;-><init>(Ljava/util/List;IFLjava/lang/String;)V
    :try_end_0
