...
.method public constructor <init>(Ljava/util/concurrent/ThreadFactory;)V
    ...
    sget-boolean p1, Lwmc;->a:Z

    invoke-virtual {v0, p1}, Ljava/util/concurrent/ScheduledThreadPoolExecutor;->setRemoveOnCancelPolicy(Z)V

    iput-object v0, p0, Luj9;->a:Ljava/util/concurrent/ScheduledThreadPoolExecutor;
...
.method public final b(Ljava/lang/Runnable;)Lxi4;
    ...
    invoke-virtual {p0, p1, v0, v1, v2}, Luj9;->c(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;)Lxi4;
...
.method public final e(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;Lyi4;)Lulc;
    .locals 3
    ...
    invoke-direct {v0, p1, p5}, Lulc;-><init>(Ljava/lang/Runnable;Lyi4;)V

    if-eqz p5, :cond_0

    invoke-interface {p5, v0}, Lyi4;->a(Lxi4;)Z
    ...
    :goto_0
    invoke-virtual {v0, p0}, Lulc;->a(Ljava/util/concurrent/Future;)V
    :try_end_0
    ...
    invoke-interface {p5, v0}, Lyi4;->b(Lxi4;)Z
