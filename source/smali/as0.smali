...
.method public synthetic constructor <init>(Ljava/lang/Object;III)V
    ...
    iput-object p1, p0, Las0;->o:Ljava/lang/Object;
...
.method public final run()V
    ...
    iget-object p0, p0, Las0;->o:Ljava/lang/Object;
    ...
    :pswitch_2
    iget-object v0, p0, Las0;->o:Ljava/lang/Object;
    ...
    invoke-interface {v0, v1, p0}, Lz4f;->o(II)V
    ...
    invoke-virtual {v0, v1, p0}, Lpy5;->a(II)V
    ...
    iget-boolean v2, v0, Lpy5;->x0:Z

    if-eqz v2, :cond_4

    iget-boolean v2, v0, Lpy5;->y0:Z

    if-eqz v2, :cond_4

    iget-object v2, v0, Lpy5;->Y:Lorg/webrtc/ScreenCapturerAndroid;
    ...
    invoke-interface {v0, p0, v2, v1}, Lxwb;->reportException(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    :cond_5
    iget-object v4, v0, Lcs0;->i:Lii5;

    iget v5, v0, Lcs0;->e:I

    invoke-virtual {v4}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    invoke-static {v3, v5}, Lgwf;->S(II)Lfz6;
    ...
    invoke-virtual {v4, v7}, Lii5;->a(I)I
    ...
    iget-object v7, v0, Lcs0;->l:Ljava/util/Set;
    ...
    iget-object v6, v0, Lcs0;->f:Ljava/util/concurrent/ConcurrentHashMap;

    invoke-virtual {v6}, Ljava/util/concurrent/ConcurrentHashMap;->keySet()Ljava/util/Set;

    move-result-object v6

    invoke-static {v4, v6}, Lz3d;->F(Ljava/lang/Iterable;Ljava/util/Set;)Ljava/util/Set;
    ...
    iget-object v9, v0, Lcs0;->f:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iget-object v12, v9, Lbs0;->a:Le13;

    if-eqz v12, :cond_c

    invoke-virtual {v12}, Le13;->n()Le13;
    ...
    iget-object v12, v0, Lcs0;->a:Lmxa;

    invoke-virtual {v12}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    sget-object v13, Landroid/graphics/Bitmap$Config;->ARGB_8888:Landroid/graphics/Bitmap$Config;

    invoke-virtual {v12, v1, p0, v13}, Lmxa;->c(IILandroid/graphics/Bitmap$Config;)Le13;
    ...
    invoke-direct {v9, v13}, Lbs0;-><init>(Lt54;)V

    invoke-virtual {v12}, Le13;->m()Le13;

    move-result-object v12

    :goto_8
    iput-boolean v8, v9, Lbs0;->b:Z

    :try_start_1
    invoke-virtual {v0, v7, v12}, Lcs0;->f(ILe13;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_1

    invoke-static {v12, v11}, Lurd;->l(Ljava/io/Closeable;Ljava/lang/Throwable;)V

    iget-object v8, v0, Lcs0;->f:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    invoke-static {v12, p0}, Lurd;->l(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    ...
    invoke-static {v1, v3, p0}, Lgwf;->j(III)I
