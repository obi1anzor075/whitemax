...
.method public final onRouteAdded(Landroid/media/MediaRouter;Landroid/media/MediaRouter$RouteInfo;)V
    ...
    iget-object p0, p0, Lec8;->a:Lac8;

    check-cast p0, Lt8e;

    invoke-virtual {p0, p2}, Lt8e;->i(Ljava/lang/Object;)Z
...
.method public final onRouteChanged(Landroid/media/MediaRouter;Landroid/media/MediaRouter$RouteInfo;)V
    ...
    invoke-virtual {p0, p2}, Lt8e;->j(Ljava/lang/Object;)I

    move-result p1

    if-ltz p1, :cond_1

    iget-object p2, p0, Lt8e;->F0:Ljava/util/ArrayList;
    ...
    iget-object v0, p1, Lr8e;->b:Ljava/lang/String;

    iget-object v1, p1, Lr8e;->a:Ljava/lang/Object;
    ...
    :goto_0
    invoke-direct {p2, v0, v1}, Lul7;-><init>(Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual {p0, p1, p2}, Lt8e;->o(Lr8e;Lul7;)V

    invoke-virtual {p2}, Lul7;->o()Lta8;

    move-result-object p2

    iput-object p2, p1, Lr8e;->c:Lta8;
...
.method public final onRoutePresentationDisplayChanged(Landroid/media/MediaRouter;Landroid/media/MediaRouter$RouteInfo;)V
    ...
    :goto_1
    iget-object v2, p1, Lr8e;->c:Lta8;

    iget-object v2, v2, Lta8;->a:Landroid/os/Bundle;
    ...
    iget-object v1, p1, Lr8e;->c:Lta8;

    if-eqz v1, :cond_5

    new-instance v2, Landroid/os/Bundle;

    iget-object v4, v1, Lta8;->a:Landroid/os/Bundle;

    invoke-direct {v2, v4}, Landroid/os/Bundle;-><init>(Landroid/os/Bundle;)V

    invoke-virtual {v1}, Lta8;->b()Ljava/util/List;
    ...
    iget-object v5, v1, Lta8;->c:Ljava/util/List;
    ...
    invoke-direct {p2, v2}, Lta8;-><init>(Landroid/os/Bundle;)V
...
.method public final onRouteSelected(Landroid/media/MediaRouter;ILandroid/media/MediaRouter$RouteInfo;)V
    ...
    iget-object p1, p0, Lt8e;->y0:Ljava/lang/Object;
    ...
    :cond_0
    invoke-static {p3}, Lt8e;->n(Ljava/lang/Object;)Ls8e;
    ...
    invoke-virtual {p0}, Lxb8;->l()V

    goto :goto_0

    :cond_1
    invoke-virtual {p0, p3}, Lt8e;->j(Ljava/lang/Object;)I
    ...
    iget-object p1, p1, Lr8e;->b:Ljava/lang/String;

    iget-object p0, p0, Lt8e;->x0:Lu8e;

    check-cast p0, Lub8;

    iget-object p2, p0, Lub8;->m:Lsb8;

    const/16 p3, 0x106

    invoke-virtual {p2, p3}, Landroid/os/Handler;->removeMessages(I)V

    iget-object p2, p0, Lub8;->c:Lp8e;

    invoke-virtual {p0, p2}, Lub8;->d(Lob8;)Lwb8;

    move-result-object p0

    if-eqz p0, :cond_2

    invoke-virtual {p0, p1}, Lwb8;->a(Ljava/lang/String;)Lxb8;
...
.method public final onRouteVolumeChanged(Landroid/media/MediaRouter;Landroid/media/MediaRouter$RouteInfo;)V
    ...
    iget-object v0, p1, Lr8e;->c:Lta8;

    iget-object v0, v0, Lta8;->a:Landroid/os/Bundle;
    ...
    iget-object v3, v0, Lta8;->a:Landroid/os/Bundle;

    invoke-direct {v2, v3}, Landroid/os/Bundle;-><init>(Landroid/os/Bundle;)V

    invoke-virtual {v0}, Lta8;->b()Ljava/util/List;
    ...
    iget-object v5, v0, Lta8;->c:Ljava/util/List;
    ...
    iget-object v0, v0, Lta8;->c:Ljava/util/List;
