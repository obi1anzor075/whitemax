...
.method public synthetic constructor <init>(Lcom/google/firebase/iid/FirebaseInstanceIdReceiver;Landroid/content/Intent;Landroid/content/Context;ZLandroid/content/BroadcastReceiver$PendingResult;)V
    ...
    iput-object p1, p0, Lb4g;->a:Lcom/google/firebase/iid/FirebaseInstanceIdReceiver;

    iput-object p2, p0, Lb4g;->b:Landroid/content/Intent;

    iput-object p3, p0, Lb4g;->c:Landroid/content/Context;

    iput-boolean p4, p0, Lb4g;->o:Z

    iput-object p5, p0, Lb4g;->X:Landroid/content/BroadcastReceiver$PendingResult;
...
.method public final run()V
    ...
    iget-object v1, v0, Lb4g;->a:Lcom/google/firebase/iid/FirebaseInstanceIdReceiver;

    iget-object v2, v0, Lb4g;->b:Landroid/content/Intent;

    iget-object v3, v0, Lb4g;->c:Landroid/content/Context;

    iget-boolean v4, v0, Lb4g;->o:Z

    iget-object v5, v0, Lb4g;->X:Landroid/content/BroadcastReceiver$PendingResult;
    ...
    invoke-direct {v6, v10, v11}, Lzf9;-><init>(Ljava/lang/String;I)V
    ...
    invoke-direct {v1, v3, v0, v7}, Lue3;-><init>(Landroid/content/Context;Lh13;Ljava/util/concurrent/CountDownLatch;)V
    ...
    invoke-direct {v0, v3, v1}, Lafc;-><init>(Landroid/content/Context;I)V

    invoke-virtual {v0, v2}, Lafc;->E(Landroid/content/Intent;)Ln6g;

    move-result-object v0

    invoke-static {v0}, Lgwf;->a(Lcom/google/android/gms/tasks/Task;)Ljava/lang/Object;
