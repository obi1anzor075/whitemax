...
.method public final b(Lb0d;)V
    ...
    iget-object v3, v0, Lrn9;->e:Landroidx/core/graphics/drawable/IconCompat;
    ...
    iget-object v1, v1, Lb0d;->b:Ljava/lang/Object;
    ...
    invoke-static {v3, v1}, Lzn6;->d(Landroidx/core/graphics/drawable/IconCompat;Landroid/content/Context;)Landroid/graphics/drawable/Icon;

    move-result-object v3

    invoke-static {v2, v3}, Lqn9;->a(Landroid/app/Notification$BigPictureStyle;Landroid/graphics/drawable/Icon;)V
    ...
    invoke-static {v3}, Lbo6;->c(Ljava/lang/Object;)I
    ...
    iget-object v7, v0, Lrn9;->e:Landroidx/core/graphics/drawable/IconCompat;
    ...
    :cond_6
    :goto_1
    iget-boolean v3, v0, Lrn9;->g:Z

    if-eqz v3, :cond_8

    iget-object v3, v0, Lrn9;->f:Landroidx/core/graphics/drawable/IconCompat;
    ...
    invoke-static {v2, v1}, Lpn9;->a(Landroid/app/Notification$BigPictureStyle;Landroid/graphics/drawable/Icon;)V

    :cond_8
    :goto_2
    iget-boolean v1, v0, Lio9;->a:Z

    if-eqz v1, :cond_9

    iget-object v0, v0, Lio9;->d:Ljava/lang/Object;
    ...
    invoke-static {v2, v0}, Lqn9;->c(Landroid/app/Notification$BigPictureStyle;Z)V

    invoke-static {v2, v5}, Lqn9;->b(Landroid/app/Notification$BigPictureStyle;Ljava/lang/CharSequence;)V
