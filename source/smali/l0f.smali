...
.method static constructor <clinit>()V
    ...
    sput-object v0, Ll0f;->p:Landroid/graphics/Matrix;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Ll0f;->c:Landroid/graphics/Matrix;
    ...
    .line 8
    iput-object v0, p0, Ll0f;->m:Ljava/lang/String;

    .line 9
    iput-object v0, p0, Ll0f;->n:Ljava/lang/Boolean;
    ...
    iput-object v0, p0, Ll0f;->a:Landroid/graphics/Path;
    ...
    iput-object v0, p0, Ll0f;->b:Landroid/graphics/Path;
...
.method public constructor <init>(Ll0f;)V
    ...
    iget-object v2, p1, Ll0f;->g:Li0f;

    invoke-direct {v1, v2, v0}, Li0f;-><init>(Li0f;Lyr;)V

    iput-object v1, p0, Ll0f;->g:Li0f;

    .line 29
    new-instance v1, Landroid/graphics/Path;

    iget-object v2, p1, Ll0f;->a:Landroid/graphics/Path;

    invoke-direct {v1, v2}, Landroid/graphics/Path;-><init>(Landroid/graphics/Path;)V

    iput-object v1, p0, Ll0f;->a:Landroid/graphics/Path;

    .line 30
    new-instance v1, Landroid/graphics/Path;

    iget-object v2, p1, Ll0f;->b:Landroid/graphics/Path;

    invoke-direct {v1, v2}, Landroid/graphics/Path;-><init>(Landroid/graphics/Path;)V

    iput-object v1, p0, Ll0f;->b:Landroid/graphics/Path;
    ...
    .line 36
    iget-object v1, p1, Ll0f;->m:Ljava/lang/String;

    iput-object v1, p0, Ll0f;->m:Ljava/lang/String;
    ...
    .line 39
    :cond_0
    iget-object p1, p1, Ll0f;->n:Ljava/lang/Boolean;

    iput-object p1, p0, Ll0f;->n:Ljava/lang/Boolean;
...
# virtual methods
.method public final a(Li0f;Landroid/graphics/Matrix;Landroid/graphics/Canvas;II)V
    .locals 18
    ...
    iget-object v0, v7, Li0f;->a:Landroid/graphics/Matrix;

    move-object/from16 v1, p2

    invoke-virtual {v0, v1}, Landroid/graphics/Matrix;->set(Landroid/graphics/Matrix;)V

    iget-object v10, v7, Li0f;->a:Landroid/graphics/Matrix;

    iget-object v0, v7, Li0f;->j:Landroid/graphics/Matrix;
    ...
    :goto_0
    iget-object v0, v7, Li0f;->b:Ljava/util/ArrayList;
    ...
    invoke-virtual/range {v0 .. v5}, Ll0f;->a(Li0f;Landroid/graphics/Matrix;Landroid/graphics/Canvas;II)V
    ...
    iget-object v13, v6, Ll0f;->c:Landroid/graphics/Matrix;
    ...
    iget-object v3, v6, Ll0f;->a:Landroid/graphics/Path;

    invoke-virtual {v3}, Landroid/graphics/Path;->reset()V

    iget-object v4, v0, Lk0f;->a:[Lela;

    if-eqz v4, :cond_3

    invoke-static {v4, v3}, Lh2g;->u([Lela;Landroid/graphics/Path;)V

    :cond_3
    iget-object v4, v6, Ll0f;->b:Landroid/graphics/Path;

    invoke-virtual {v4}, Landroid/graphics/Path;->reset()V

    instance-of v5, v0, Lg0f;
    ...
    iget v14, v0, Lh0f;->k:F

    add-float/2addr v14, v9

    rem-float/2addr v14, v10

    iget-object v9, v6, Ll0f;->f:Landroid/graphics/PathMeasure;
    ...
    iput-object v9, v6, Ll0f;->f:Landroid/graphics/PathMeasure;
    ...
    iget-object v10, v6, Ll0f;->f:Landroid/graphics/PathMeasure;

    const/4 v15, 0x1

    invoke-virtual {v10, v5, v9, v3, v15}, Landroid/graphics/PathMeasure;->getSegment(FFLandroid/graphics/Path;Z)Z

    iget-object v5, v6, Ll0f;->f:Landroid/graphics/PathMeasure;
    ...
    iget-object v5, v6, Ll0f;->e:Landroid/graphics/Paint;
    ...
    iput-object v5, v6, Ll0f;->e:Landroid/graphics/Paint;
    ...
    iget v11, v0, Lh0f;->i:F

    sget-object v16, Lo0f;->y0:Landroid/graphics/PorterDuff$Mode;
    ...
    :goto_9
    iget-object v5, v6, Ll0f;->d:Landroid/graphics/Paint;
    ...
    iput-object v5, v6, Ll0f;->d:Landroid/graphics/Paint;
    ...
    iget-object v11, v0, Lh0f;->n:Landroid/graphics/Paint$Join;
    ...
    :cond_12
    iget-object v11, v0, Lh0f;->m:Landroid/graphics/Paint$Cap;
    ...
    iget v11, v0, Lh0f;->h:F

    sget-object v13, Lo0f;->y0:Landroid/graphics/PorterDuff$Mode;
...
.method public setAlpha(F)V
    ...
    invoke-virtual {p0, p1}, Ll0f;->setRootAlpha(I)V
